...
// node_modules/@splinetool/runtime/build/runtime-particles-ZHE2MC33.js
var N = new Mr();
var U = new Ki();
var O2 = new Gi();
var L = new Gi();
...
var q = class extends $s {
  ...
  init(n2) {
    ...
    let c2 = (function({ size: e }) {
      ...
      let i = new Qa(t2, e, e, Rt, zt);
      return i.needsUpdate = true, i;
    })({ size: this.emitterShape.textureSize }), d = { uOriginalPosition: { value: this.emitterShape.positionsTexture }, uWorldOffset: { value: new Ki(0, 0, 0) }, uWorldQuaternion: { value: new vs(0, 0, 0, 1) }, uTime: { value: 0 }, uFPSRatio: { value: 1 }, uMaxLifeTime: { value: n2.life }, uEmitterSize: { value: new Ki(Number(this.shared.getVariable(n2.shape.size[0], [this.uuid, "particles", "shape_size_0"])), Number(this.shared.getVariable(n2.shape.size[1], [this.uuid, "particles", "shape_size_1"])), Number(this.shared.getVariable(n2.shape.size[2], [this.uuid, "particles", "shape_size_2"]))) }, particleSize: { value: 0 } };
    a2.material.uniforms = d;
...
`);
  ...
  createPrimaryEmitter(e) {
    ...
    return this.updateGeometryAttributes(i, e), this.material.needsUpdate = true, i.onBeforeRender = () => {
...
c("Particle", (e, t2, i) => new X(e, t2, i)), n("Particles", ({ data: e, page: t2, shared: i, actionCondition: n2 }) => new j(e, t2, i, n2)), a("particles");
//# sourceMappingURL=runtime-particles-ZHE2MC33-YJ45S23E.js.map
