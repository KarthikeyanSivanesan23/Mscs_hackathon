...
// node_modules/@splinetool/runtime/build/runtime-mouseHover-HG6AHA2L.js
var d = class {
...
var f2 = class extends s2 {
  ...
  connect() {
    let { page: t, sharedAssets: e2 } = this.eventContext, s4 = (s5, i2) => {
      ...
      if (s5.visible && ((_a = s5.data) == null ? void 0 : _a.events.length)) {
        for (let { id: i3, data: n2 } of s5.data.events) if (!n2.disabled && "MouseHover" === n2.type) try {
          let r2 = new d(i3, n2, s5, t, e2, this.eventManager);
    ...
    if (t.traverseEntity((t2) => {
      var _a;
      (s(t2) || t2 instanceof q) && ((_a = t2.frame) == null ? void 0 : _a.traverse((e3) => {
        s4(e3, t2);
      })), s4(t2);
...
//# sourceMappingURL=runtime-mouseHover-HG6AHA2L-2E4FN26Z.js.map
