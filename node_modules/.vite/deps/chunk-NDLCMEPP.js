...
// node_modules/@splinetool/runtime/build/runtime-chunk-32KZP4YN.js
var C = new Ki();
var j = new $o();
var T = class extends Pn {
  constructor(t) {
    let e = new ha(), r = new Mn({ color: 16777215, vertexColors: true, toneMapped: false }), i = [], a = [], o2 = {}, s = new rr(15711266), n = new rr(15711266), p = new rr(2857471);
    function h(t2, e2, r2) {
      c2(t2, r2), c2(e2, r2);
    }
    function c2(t2, e2) {
      i.push(0, 0, 0), a.push(e2.r, e2.g, e2.b), void 0 === o2[t2] && (o2[t2] = []), o2[t2].push(i.length / 3 - 1);
    }
    h("n1", "n2", s), h("n2", "n4", s), h("n4", "n3", s), h("n3", "n1", s), h("f1", "f2", s), h("f2", "f4", s), h("f4", "f3", s), h("f3", "f1", s), h("n1", "f1", s), h("n2", "f2", s), h("n3", "f3", s), h("n4", "f4", s), h("p", "n1", n), h("p", "n2", n), h("p", "n3", n), h("p", "n4", n), h("u1", "u2", p), h("u2", "u3", p), h("u3", "u1", p), e.setAttribute("position", new Hr(i, 3)), e.setAttribute("color", new Hr(a, 3)), super(e, r), this.type = "CameraHelper", this.camera = t, this.camera.updateProjectionMatrix && this.camera.updateProjectionMatrix(), this.matrix = t.matrixWorld, this.matrixAutoUpdate = false, this.pointMap = o2, this.update();
  }
  update() {
    ...
    let a = i;
    y("u1", e, t, j, 0.35, 1.1, a), y("u2", e, t, j, -0.35, 1.1, a), y("u3", e, t, j, 0, 1.55, a), t.getAttribute("position").needsUpdate = true;
  }
  dispose() {
    this.geometry.dispose(), this.material.dispose();
  }
};
function y(t, e, r, i, a, o2, s) {
  C.set(a, o2, s).unproject(i);
  let n = e[t];
  if (void 0 !== n) {
...
var A = class extends l($o, w) {
  constructor(t = "", e = { ...Qr.defaultData, name: "" }) {
    ...
    this.orthoCamera = new hl(-0.5 * r, 0.5 * r, 0.5 * i, -0.5 * i, -5e4, 1e4), this.perspCamera = new il(45, r / i, 50, 1e4), this.left = this.orthoCamera.left, this.right = this.orthoCamera.right, this.top = this.orthoCamera.top, this.bottom = this.orthoCamera.bottom, this.far = this.orthoCamera.far, this.view = this.orthoCamera.view, this.aspect = this.perspCamera.aspect, this.focus = this.perspCamera.focus, this.filmGauge = this.perspCamera.filmGauge, this.filmOffset = this.perspCamera.filmOffset, this.objectHelper.update();
  }
  ...
  _applyProjectionTransition() {
    ...
    let r = P(e), i = t.from.elements, a = this._activeSubCamera.projectionMatrix.elements, o2 = t.blend.elements, s = t.referenceDepth, n = Math.max(1e-6, i[15] - i[11] * s), p = r * n / (r * n + (1 - r) * Math.max(1e-6, a[15] - a[11] * s));
    for (let t2 = 0; t2 < 16; t2++) o2[t2] = i[t2] + (a[t2] - i[t2]) * p;
  ...
  setViewOffset(t, e, r, i, a, o2) {
    "PerspectiveCamera" === this._cameraType ? this.perspCamera.setViewOffset(t, e, r, i, a, o2) : this.orthoCamera.setViewOffset(t, e, r, i, a, o2), this._applyProjectionTransition();
  }
  clearViewOffset() {
...
//# sourceMappingURL=chunk-NDLCMEPP.js.map
