...
// node_modules/@splinetool/runtime/build/runtime-bloom-XRHHZNNT.js
...
var F = null;
var T = class {
  constructor(e = "Pass", t4 = new hr(), n = S) {
...
var z = (new rr(), -1);
var U = class extends Ei {
  constructor(e, t4 = z, n = z, r = 1) {
  ...
  get width() {
    ...
    return e = n.width !== z ? n.width : n.height !== z ? Math.round(n.height * (t4.width / Math.max(t4.height, 1))) : Math.round(t4.width * r), e;
  }
  set width(e) {
  ...
  get height() {
    let e, { base: t4, preferred: n, scale: r } = this;
    return e = n.height !== z ? n.height : n.width !== z ? Math.round(n.width / Math.max(t4.width / Math.max(t4.height, 1), 1)) : Math.round(t4.height * r), e;
  }
  set height(e) {
  ...
  set scale(e) {
    this.s !== e && (this.s = e, this.preferred.setScalar(z), this.dispatchEvent({ type: "change" }), this.resizable.setSize(this.base.width, this.base.height));
  }
  getScale() {
    return this.scale;
  }
...
var B = class extends Ei {
  ...
  getShaderCode() {
    return M.get(this.blendFunction);
  }
};
var R = class extends Ei {
  constructor(e, t4, { attributes: n = 0, blendFunction: r = E, defines: i = /* @__PURE__ */ new Map(), uniforms: s = /* @__PURE__ */ new Map(), extensions: a = null, vertexShader: l = null } = {}) {
...
var P = class extends T {
  constructor({ width: e = U.AUTO_SIZE, height: t4 = U.AUTO_SIZE, renderTarget: n, luminanceRange: r, colorOutput: i } = {}) {
    super("LuminancePass"), this.fullscreenMaterial = new A(i, r), this.needsSwap = false, this.renderTarget = n, void 0 === this.renderTarget && (this.renderTarget = new Ms(1, 1, { minFilter: ft, magFilter: ft, stencilBuffer: false, depthBuffer: false }), this.renderTarget.texture.name = "LuminancePass.Target", this.renderTarget.texture.generateMipmaps = false);
...
var L = class extends R {
  constructor({ blendFunction: e = E, luminanceThreshold: t4 = 0.9, luminanceSmoothing: n = 0.025, resolutionScale: r = 0.5, intensity: i = 1, width: s = U.AUTO_SIZE, height: a = U.AUTO_SIZE, kernelSize: o = I.LARGE } = {}) {
    super("BloomEffect", "#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D map;\n#else\nuniform lowp sampler2D map;\n#endif\nuniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=clamp(texture2D(map,uv)*intensity,0.0,1.0);}", { blendFunction: e, uniforms: /* @__PURE__ */ new Map([["map", new Vl(null)], ["intensity", new Vl(i)]]) }), this.renderTarget = new Ms(1, 1, { minFilter: ft, magFilter: ft, stencilBuffer: false, depthBuffer: false }), this.renderTarget.texture.name = "Bloom.Target", this.renderTarget.texture.generateMipmaps = false, this.uniforms.get("map").value = this.renderTarget.texture, this.luminancePass = new P({ renderTarget: this.renderTarget, colorOutput: true }), this.luminanceMaterial.threshold = t4, this.luminanceMaterial.smoothingFactor = n, this.blurPass = new O({ resolutionScale: r, width: s, height: a, kernelSize: o });
...
t3("bloom", () => new D());
//# sourceMappingURL=runtime-bloom-XRHHZNNT-ZT2DAKZG.js.map
