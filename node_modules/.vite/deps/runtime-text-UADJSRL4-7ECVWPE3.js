...
// node_modules/@splinetool/runtime/build/runtime-text-UADJSRL4.js
var m = class {
  constructor() {
  ...
  toShapes() {
    ...
    this.subPaths.forEach((t3) => {
      ...
      s <= l2 && (s = l2 + 1), n >= u && (n = u - 1), e3.length && a2.push({ curves: t3.curves, points: e3, isCW: Lh.isClockWise(e3), identifier: i2++, boundingBox: new Xl(new Gi(u, o2), new Gi(l2, r2)) });
    });
    let o = a2.map((t3) => {
      var _a;
...
v("TextGeometry", b), v("InputGeometry", b), Pe(class {
  ...
  generateShapes(t2, e2, r) {
    ...
    for (let h3 = 0; h3 < t2.length; h3++) {
      ...
      let b2 = this.computeSpaceWidthForLine(t2, h3, e2, r), P = 0, S = x2[0];
      S && 2 === e2.horizontalAlign && void 0 !== S.leftSideBearing && (c -= S.leftSideBearing * n);
      try {
...
//# sourceMappingURL=runtime-text-UADJSRL4-7ECVWPE3.js.map
