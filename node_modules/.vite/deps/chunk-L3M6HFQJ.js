...
// node_modules/@splinetool/runtime/build/runtime-chunk-23QXG35G.js
var p = null;
function b(e) {
  p = e;
}
...
var G = class extends $t {
  ...
  collectBaseSources(e) {
    ...
    let r = L.clone(), n = (o) => {
      ...
      if (true === o.isMesh && l && (((_a = l.getAttribute("position")) == null ? void 0 : _a.count) ?? 0) >= 3) {
        ...
        t.push({ geometry: l, matrix: n2, sampleColor: A(d, this.context.shared) ?? void 0 }), s.push(G.matrixHash(n2)), i += (function(e2, t2) {
          var _a2;
        ...
        if (c) {
          let e2 = 0, t2 = 1;
          n2 ? (z.copy(c.center).applyMatrix4(n2), e2 = z.length(), t2 = G.matrixMaxScale(n2)) : e2 = c.center.length(), a = Math.max(a, e2 + c.radius * t2);
        }
      }
  ...
  baseWorldScale(e) {
    return L.copy(e.matrixWorld).decompose(z, P, q), Math.max(Math.abs(q.x), Math.abs(q.y), Math.abs(q.z), 1e-6);
  }
  get widthWorldScale() {
...
//# sourceMappingURL=chunk-L3M6HFQJ.js.map
