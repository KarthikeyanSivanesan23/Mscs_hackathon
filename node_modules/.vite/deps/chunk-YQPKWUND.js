...
// node_modules/@splinetool/runtime/build/runtime-chunk-KNL33WN7.js
var A = 200;
var W = null;
function O2(t3) {
  W = t3;
...
function lt(t3) {
  return rt || (rt = (async function() {
    let e3 = t3 ?? "https://cdn.spline.design/@splinetool/runtime@2.0.8/build", i = import("./physics-DYQOQH5X.js"), [s3, o3] = await Promise.all([i, fetch(`${e3}/physics.wasm`).then((t4) => t4.arrayBuffer())]);
...
function ct2(t3, e3) {
  ...
  let { positions: s3, triIndices: o3 } = _s(t3.getAttribute("position"), t3.getIndex());
...
var mt = class {
  ...
  dispatch(t3) {
    ...
    }), this.object.dispatchEvent({ type: "beginEvent", eventName: "Collision" }), this.actions.Transition.forEach((t4) => {
      "Toggle" === t4.data.runMode ? t4.toggle() : t4.play();
    }), this.actions.Animation.forEach((t4) => {
      "Toggle" === t4.data.runMode ? t4.toggle() : t4.play();
...
var ut = class {
  ...
  dispatch() {
    ...
    }), this.object.dispatchEvent({ type: "beginEvent", eventName: "Trigger" }), this.actions.Transition.forEach((t3) => {
      "Toggle" === t3.data.runMode ? t3.toggle() : t3.play();
    }), this.actions.SwitchCamera.forEach((t3) => {
      "Toggle" === t3.data.runMode ? t3.toggle() : t3.play();
...
var It = class {
  ...
  initBVH() {
    ...
    if (this.page.traverseChildren((t3) => {
      ...
      let o3 = e3.map((t3) => ct2(t3.geometry, t3.matrixWorld)), a2 = ve(o3, false), n4 = new (r2())(a2);
  ...
  addRigidBody(t3, e3, i) {
    ...
    if (void 0 !== (o3 == null ? void 0 : o3.getAttribute("position")) && s3.push(ct2(o3, t3.shearScale)), a2.physics.fusedBody) {
  ...
  addBoundsTree(e3) {
    var _a, _b;
    let i = [];
    if (void 0 !== ((_a = e3.geometry) == null ? void 0 : _a.getAttribute("position")) && ((_b = e3.geometry) == null ? void 0 : _b.getAttribute("position").count) > 0 && i.push(ct2(e3.geometry, e3.shearScale)), e3.traverseObject(this.gatherChildrenGeom(e3, i)), e3.children.forEach((t3) => t3.updateMatrixWorld(true)), i.length > 0) {
      let s3 = ve(i, false);
  ...
  gatherChildrenGeom(t3, e3) {
    ...
    return (s3, o3) => {
      ...
      let r3 = s3.geometry;
      return void 0 !== (r3 == null ? void 0 : r3.getAttribute("position")) && e3.push(ct2(r3, s3.matrixWorld)), !!Bt(s3) || void 0;
    };
  }
  activate(t3) {
    var _a;
    ...
    if (this.page.traverseChildren((i2) => {
      ...
      for (let t4 of a3.events) if (true !== t4.data.disabled) {
        if ("Collision" === t4.data.type) {
          h = true;
          let e4 = new mt(t4.id, t4.data, s4, this.page, this.sharedAssets, this.eventManager);
      ...
      if (void 0 !== o4) {
      ...
      } else "dynamic" === a3.physics.rigidBody || n4 || c2 || l || d || h ? (this.addRigidBody(i2, s4, { hasFollow: c2, hasTransformAnim: n4, hasDrag: d }), this.generateSensorColliderDescs(s4, a3.physics.fusedBody)) : (p && t3.push(ct2(p, i2.matrixWorld)), a3.physics.fusedBody && !Bt(i2) && i2.traverseObject((e4, i3) => {
        var _a3;
        if (0 === i3) return;
        let s5;
        if (o(e4)) {
        ...
        let a4 = e4.geometry;
        return void 0 !== (a4 == null ? void 0 : a4.getAttribute("position")) && t3.push(ct2(a4, e4.matrixWorld)), !!Bt(e4) || void 0;
  ...
  checkTrigger() {
    ...
    for (let e3 = 0; e3 < this.sharedGameControlGlobals.triggers.length; e3++) {
      ...
      for (let e4 = 0; e4 < this.sharedGameControlGlobals.entitiesWithTransformAnim.length; e4++) {
        ...
        if (o3 === n4 || false === a2.isValidTriggeringObject(ct.is(n4) ? n4 : n4.object)) continue;
...
function kt(t3) {
  return Ot || (Ot = (async function() {
    let e3 = t3 ?? "https://cdn.spline.design/@splinetool/runtime@2.0.8/build";
    typeof window < "u" && (Wt = new URL(e3.endsWith("/") ? e3 : `${e3}/`, window.location.href).href);
    let i = import("./navmesh-WL2SSGPF.js"), [s3, o3] = await Promise.all([i, fetch(`${e3}/navmesh.wasm`).then((t4) => t4.arrayBuffer())]), a2 = s3.default, n4 = await a2({ wasmBinary: o3 });
    At(n4);
  })());
}
...
//# sourceMappingURL=chunk-YQPKWUND.js.map
