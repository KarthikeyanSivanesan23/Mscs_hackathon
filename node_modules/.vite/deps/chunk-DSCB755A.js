...
// node_modules/@splinetool/runtime/build/runtime-chunk-AELTGHV2.js
var s;
(s || (s = {})).is = (e) => "objectHelper" in e;
var l = (r, i) => class extends Pt(r) {
  constructor() {
  ...
  showGizmos() {
    for (let e in this.gizmos) {
      let t = this.gizmos[e];
      t instanceof pu && (t.visible = true);
    }
  }
  ...
  hideGizmos() {
    for (let e in this.gizmos) {
      let t = this.gizmos[e];
      t instanceof pu && (t.visible = false);
    }
  }
};
var c = (e) => {
...
var f = (e, t, i, n, a = false, o = e) => {
  ...
  if (false === a) {
    for (g = Math.max(0, w.start), y = Math.min(x.count, w.start + w.count); g < y; g += 3) if (f2 = x.getX(g), h = x.getX(g + 1), d = x.getX(g + 2), c2 = H(e, i, p, b, f2, h, d), c2) return c2.faceIndex = Math.floor(g / 3), void n.push(c2);
  } else {
  ...
  function H(e2, t2, i2, n2, a2, o2, s3) {
...
//# sourceMappingURL=chunk-DSCB755A.js.map
