...
// node_modules/@splinetool/runtime/build/runtime-chunk-OFPUAZKY.js
...
var C = class extends to {
  constructor() {
    super({ name: "CopyMaterial", uniforms: { inputBuffer: new Vl(null), opacity: new Vl(1) }, blending: p, depthWrite: false, depthTest: false, fragmentShader: "#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D inputBuffer;\n#else\nuniform lowp sampler2D inputBuffer;\n#endif\nuniform float opacity;varying vec2 vUv;void main(){vec4 texel=texture2D(inputBuffer,vUv);gl_FragColor=opacity*texel;\n#include <colorspace_fragment>\n}", vertexShader: "varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}" }), this.toneMapped = false;
  }
  set inputBuffer(e2) {
    this.uniforms.inputBuffer.value = e2;
  }
...
var N = class extends to {
  constructor(e2, t2, r, n, s = false) {
    super({ name: "EffectMaterial", defines: { THREE_REVISION: t.replace(/\D+/g, ""), DEPTH_PACKING: "0", ENCODE_OUTPUT: "1" }, uniforms: { inputBuffer: new Vl(null), depthBuffer: new Vl(null), resolution: new Vl(new Gi()), texelSize: new Vl(new Gi()), cameraNear: new Vl(0.3), cameraFar: new Vl(1e3), aspect: new Vl(1), time: new Vl(0) }, blending: p, depthWrite: false, depthTest: false, dithering: s }), this.toneMapped = false, e2 && this.setShaderParts(e2), t2 && this.setDefines(t2), r && this.setUniforms(r), this.adoptCameraSettings(n);
  }
  set inputBuffer(e2) {
    this.uniforms.inputBuffer.value = e2;
  }
...
var $ = class extends Ei {
  constructor(e2, t2 = 1) {
    super(), this.f = e2, this.opacity = new Vl(t2);
  }
  getOpacity() {
...
//# sourceMappingURL=chunk-5KDVJVEN.js.map
