...
import {
  p as p2,
  v
} from "./chunk-GKWHISB2.js";
import {
  r as r2
} from "./chunk-XXUZJAYE.js";
import {
  F,
  P,
  j,
  k
} from "./chunk-KTNZXI2Q.js";
import {
  V
} from "./chunk-NDLCMEPP.js";
import {
  r as r3
} from "./chunk-FSXIZLLX.js";
import {
  y
...
import {
  i as i2,
  s as s3
} from "./chunk-5REV3WFT.js";
import {
  e as e2
} from "./chunk-5ED5EIAE.js";
import {
  c as c3
} from "./chunk-6DGYBOLZ.js";
import {
  l
} from "./chunk-DSCB755A.js";
import {
  Xt,
  er,
  ir,
...
// node_modules/@splinetool/runtime/build/runtime-chunk-BMA5KYBS.js
var St = null;
function Bt(t2) {
  St = t2;
}
...
var qt = class extends Za {
  ...
  static buildMesh(t2, e3, n3 = false, s4 = 1, i3, r4) {
    let a3 = qt.buildGeomtery(e3), o2 = qt.buildMaterial(i3);
    return new qt(t2, e3, a3, o2, n3, s4, i3, r4);
  }
  ...
  static buildGeomtery(t2) {
    ...
    let i3 = new yl().copy(e3), r4 = new Uint32Array(t2), a3 = new en(r4, 1, false);
  ...
  allocateAndStoreLocalSplatDataInTextures() {
    ...
    for (let e4 = 0; e4 < t2; e4++) {
      ...
      r4[s5] = Gt(this.colors[t3], this.colors[t3 + 1], this.colors[t3 + 2], this.colors[t3 + 3]), r4[s5 + 1] = Nt(this.centers[n4]), r4[s5 + 2] = Nt(this.centers[n4 + 1]), r4[s5 + 3] = Nt(this.centers[n4 + 2]);
    }
...
function Xt2() {
  if (!Zt) return Yt || (Yt = (async function() {
    let t2 = await import("./gaussian-splat-compression-32MIRTPZ.js");
    Lt(t2), Zt = true;
  })());
}
var Kt = new As();
...
function re(t2, e3, n3, s4, i3, r4, a3, o2, l2) {
  ...
  for (let t3 = m; t3 + 2 < f2; t3 += 3) {
    ...
    if (Jt.fromBufferAttribute(c4, d3).applyMatrix4(Kt), $t2.fromBufferAttribute(c4, u2).applyMatrix4(Kt), te.fromBufferAttribute(c4, m2).applyMatrix4(Kt), Jt.z > n3 && $t2.z > n3 && te.z > n3 || Jt.z < -n3 && $t2.z < -n3 && te.z < -n3) continue;
    ee2.subVectors($t2, Jt), ne.subVectors(te, Jt), se.crossVectors(ee2, ne);
    let f3 = se.length();
    if (!(0 === f3 || se.z / f3 <= 0.01)) {
      if (y2.length = 0, void 0 !== h) ee2.fromBufferAttribute(h, d3).applyMatrix3(Ht), y2.push({ px: Jt.x, py: Jt.y, pz: Jt.z, nx: ee2.x, ny: ee2.y, nz: ee2.z }), ee2.fromBufferAttribute(h, u2).applyMatrix3(Ht), y2.push({ px: $t2.x, py: $t2.y, pz: $t2.z, nx: ee2.x, ny: ee2.y, nz: ee2.z }), ee2.fromBufferAttribute(h, m2).applyMatrix3(Ht), y2.push({ px: te.x, py: te.y, pz: te.z, nx: ee2.x, ny: ee2.y, nz: ee2.z });
      else {
        se.divideScalar(f3);
        for (let t4 of [Jt, $t2, te]) y2.push({ px: t4.x, py: t4.y, pz: t4.z, nx: se.x, ny: se.y, nz: se.z });
      }
      for (let t4 of e3) {
...
var le = new As();
var de = new Ki();
var ce = class extends ir {
  constructor(t2, e3, n3) {
    super(t2, e3), this.data = e3, this.geometry = new ha(), this.lastSignature = [], this.nextSignature = [], this.scanned = [], this.lastParams = { width: 0, height: 0, depth: 0, offset: 0 }, this.context = n3;
  ...
  scanTargets(t2, e3, n3) {
    ...
    return i3.traverse((t3) => {
      var _a;
      if (t3 === this || !ct.is(t3) || !(t3 instanceof $t) || t3 instanceof ce || "Mesh" !== ((_a = t3.dataPatched) == null ? void 0 : _a.type) || !t3.visible || t3.destroyedInAction || 512 & t3.layers.mask) return;
...
function ue(n3, s4, i3) {
  if (console.assert(void 0 !== s4.type), "Mesh" === s4.type) return (function(t2, e3, n4) {
    ...
    if (void 0 !== pe && (e3 == null ? void 0 : e3.geometry) && "subdivisions" in e3.geometry && (e3.geometry.subdivisions ?? 0) > pe && Object.assign(e3.geometry, { subdivisions: pe }), "TextGeometry" === e3.geometry.type || "InputGeometry" === e3.geometry.type) {
      ...
      return s6 ? s6(t2, e3, n4) : (s2("InputGeometry" === e3.geometry.type ? "textinputs" : "text", `a Mesh with ${e3.geometry.type}`), new lr(t2, e3, n4));
    }
    if ("SubdivGeometry" === e3.geometry.type) s5 = new y(t2, e3, n4);
      ...
      i4 ? s5 = i4(t2, e3, n4) : (s2("ShapeBlendGeometry" === e3.geometry.type ? "shape-blends" : "PathGeometry" === e3.geometry.type ? "3d-paths" : "vector-shapes", `a Mesh with ${e3.geometry.type}`), s5 = new lr(t2, e3, n4));
    } else if ("BooleanGeometry" === e3.geometry.type) s5 = new P(t2, e3, n4);
    else if ("DecalGeometry" === e3.geometry.type) s5 = new ce(t2, e3, n4);
    else if ("UIGeometry" === e3.geometry.type) {
      let i4 = o("UIGeometry");
      i4 ? s5 = i4(t2, e3, n4) : (s2("ui-2d", "a Mesh with UIGeometry"), s5 = new lr(t2, e3, n4));
    } else s5 = new lr(t2, e3, n4);
    return s5;
  })(n3, s4, i3);
  ...
  if ("Page" === s4.type) return new q(n3, s4, i3);
  ...
  return nt.is(s4.type) ? new V(n3, s4) : (console.error(s4), new r2(n3, s4));
}
...
var ge = class {
  ...
  setupSplatMesh(t2, e3, n3 = new Ki(), s4 = new Qi(), i3 = false, r4 = 1, a3, o2) {
    this.splatMesh = qt.buildMesh(t2, e3, i3, r4, a3, o2), this.splatMesh.position.copy(n3), this.splatMesh.quaternion.copy(s4), this.splatMesh.frustumCulled = false, this.splatMesh.renderOrder = 99999, this.splatRenderCount = e3, this.splatMesh.onBeforeRender = (t3, e4, n4) => this.update(t3, n4);
  }
  setupSortWorker(t2) {
...
var Ae = class extends hr {
  ...
  needsReflection() {
    return this.needsReflectionDirty && (this._needsReflection = J(this), this.needsReflectionDirty = false), this._needsReflection;
  }
  ...
  markPenumbraSizeDirty() {
    for (let t2 of this.children) t2 instanceof q && (t2.penumbraSizeArrayCache = null);
  }
  findInstance(t2) {
  ...
  find2D(t2) {
    for (let e3 of this.children) if (e3 instanceof q && e3.uiScene) {
      let n3 = e3.uiScene.find(t2);
      if (n3) return n3;
    }
  }
  findScene2DfromObject2D(t2) {
    for (let e3 of this.children) if (e3 instanceof q && e3.uiScene && e3.uiScene.find(t2)) return e3.uiScene;
  }
  ...
  traverse2D(t2) {
    for (let e3 of this.children) e3 instanceof q && e3.uiScene && e3.uiScene.traverse(t2);
  }
  ...
  updateTreeByOp(t2, e3) {
    ...
    if (0 === t2.path.length && 7 === t2.type) {
      ...
      s4.children.splice(i3, 0, s4.children.pop()), F(e4) && (e4.invalidateUpstreamBooleanData(), j(e4.parent) ? e4.parent.invalidateDownstreamBooleanData().recomputeBoolean() : n3 instanceof P && n3.invalidateDownstreamBooleanData().recomputeBoolean()), e4.updatePathSnapping();
    }
  ...
  updatePage(t2) {
    ...
    for (let e3 of this.children) e3 instanceof q && (e3.visible = e3.uuid === t2, e3.visible && (this.activePage = e3, this.activePage.onActive(this)));
  ...
  updateEntityByOp(t2, e3, n3, s4) {
    ...
    if (i3) try {
      ...
      })(i3, e3, n3, { scene: this, shared: s4 }), i3 instanceof lr && i3.updateGeometryGroupsIfNeeded();
    } catch (t3) {
      console.error(t3);
    }
  }
  updateEntity2DByOp(t2, e3, n3, s4, i3, r4 = []) {
    t2.updateEntityByOp(e3, n3, s4, i3), this.traverseEntity((t3) => {
      (s(t3) || t3 instanceof q) && (r4.includes(t3.frameId ?? "") || t3.frameId === e3) && t3.updateEntity2DByOp(e3, n3, s4, i3);
    });
  }
  get activeCamera() {
  ...
  markNeedsRecomputeInstancesForAncessors(t2) {
    ct.is(t2) && ("Component" === t2.data.type && this.markNeedsRecomputeInstances(), t2.traverseAncestors((t3) => {
      ct.is(t3) && "Component" === t3.data.type && this.markNeedsRecomputeInstances();
    }));
  }
      ...
      if (a(t2) && "string" == typeof t2.identity && "Component" === t2.data.type) return t2.traverseEntity((e3, n3) => {
        e3.data.events.forEach((s4) => {
          if ("GameControl" === s4.data.type) {
            ...
            }), false === i3) for (let i4 of Na.list) this.rewriteActions(s4.data.gameActions[i4], ["gameActions", i4], t2, e3, n3, s4);
  ...
  clearScene() {
    ...
    for (let t2 of this.children) ct.is(t2) && t2.disposeRecursively();
  ...
  raycast1(t2, e3) {
    let n3 = [], s4 = (i3) => {
      for (let a3 of i3.children) {
        let i4 = a3.cloner;
        if (ct.is(a3) && !a3.raycastLock && (a3.visible || (i4 == null ? void 0 : i4.object.data.visible))) if (true === e3 && a3.isInstanceRoot) {
          let e4 = [];
        ...
        } else (F(a3) || k(a3) && this.enableHelpers && a3.objectHelper.visible) && (t2.intersectObject(a3, false, n3), Q(a3, t2, n3)), s4(a3);
      }
    };
  ...
  raycastWithClones(t2) {
    let e3 = [], n3 = (s4) => {
      for (let i3 of s4.children) {
        let s5 = i3.cloner;
        ct.is(i3) && (i3.visible || (s5 == null ? void 0 : s5.object.data.visible)) && ((F(i3) || k(i3) && this.enableHelpers && i3.objectHelper.visible) && (t2.intersectObject(i3, false, e3), Q(i3, t2, e3, true)), n3(i3));
      }
    };
    return n3(this), e3;
  }
  forEachEntity(t2) {
    for (let e3 of this.children) ct.is(e3) && t2(e3);
  }
  traverseConcreteEntity(t2) {
    for (let e3 of this.children) ct.is(e3) && e3.isConcreteEntity && e3.traverseEntity(t2);
  }
  traverseEntity(t2) {
    for (let e3 of this.children) ct.is(e3) && e3.traverseEntity(t2);
  }
  updateFont(t2, e3) {
    this.traverseEntity((n3) => {
      if (n3 instanceof lr && "Mesh" === n3.data.type && ("TextGeometry" === n3.data.geometry.type || "InputGeometry" === n3.data.geometry.type) && n3.data.geometry.font === t2) {
  ...
  traverseObject(t2) {
    for (let e3 of this.children) Y2.is(e3) && e3.traverseObject(t2);
  }
  traverseVisibleEntity(t2) {
    for (let e3 of this.children) ct.is(e3) && e3.visible && e3.traverseVisibleEntity(t2);
  }
  dispose() {
    this.clearScene();
  }
  ...
  traverseMaterial(t2) {
    this.traverseEntity((e3) => {
      if (e3 instanceof $t) if (Array.isArray(e3.material)) for (let n3 = 0; n3 < e3.material.length; n3++) er(e3.material[n3]) && t2(e3.material[n3]);
      else er(e3.material) && t2(e3.material);
    });
  }
  updateViewPlaneSize(t2, e3, n3 = false) {
    this.traverseConcreteEntity((s4) => {
      s4 instanceof V && s4.setViewplaneSize(t2, e3, n3);
    });
  }
...
//# sourceMappingURL=chunk-V2NKXKGT.js.map
