...
// node_modules/@splinetool/runtime/build/runtime-chunk-5H2Z5KYI.js
...
var Ei2 = [/^StackTrace\.js$/, /^TSLCore\.js$/, /^.*Node\.js$/, /^three\.webgpu.*\.js$/];
var Ai = class {
  constructor(e = null) {
    this.isStackTrace = true, this.stack = (function(e2) {
      ...
      }).filter((e3) => e3 && !Ei2.some((t3) => t3.test(e3.file)));
    })(e || new Error().stack);
  }
  getLocation() {
...
var Mi2 = (e) => Ri(e);
var Bi = (...e) => Ri(e);
var Fi = /* @__PURE__ */ new Map([[1, "float"], [2, "vec2"], [3, "vec3"], [4, "vec4"], [9, "mat3"], [16, "mat4"]]);
...
function Di(e) {
  return /float|int|uint|bool/.test(e) ? 1 : /vec2/.test(e) ? 2 : /vec3/.test(e) ? 3 : /vec4/.test(e) || /mat2/.test(e) ? 4 : /mat3/.test(e) ? 9 : /mat4/.test(e) ? 16 : void Pi(`TSL: Unsupported type: ${e}`, new Ai());
}
function Oi2(e) {
  return /float|int|uint|bool/.test(e) ? 1 : /vec2/.test(e) ? 2 : /vec3/.test(e) ? 3 : /vec4/.test(e) || /mat2/.test(e) ? 4 : /mat3/.test(e) ? 12 : /mat4/.test(e) ? 16 : void Pi(`TSL: Unsupported type: ${e}`, new Ai());
}
function Ii(e) {
  return /float|int|uint|bool/.test(e) ? 1 : /vec2/.test(e) ? 2 : /vec3/.test(e) || /vec4/.test(e) ? 4 : /mat2/.test(e) ? 2 : /mat3/.test(e) || /mat4/.test(e) ? 4 : void Pi(`TSL: Unsupported type: ${e}`, new Ai());
}
function Vi2(e) {
...
function ki2(e, ...t2) {
  ...
  return 1 === t2.length && ("vec2" === r2 ? t2 = [t2[0], t2[0]] : "vec3" === r2 ? t2 = [t2[0], t2[0], t2[0]] : "vec4" === r2 && (t2 = [t2[0], t2[0], t2[0], t2[0]])), "color" === e ? new rr(...t2) : "vec2" === r2 ? new Gi(...t2) : "vec3" === r2 ? new Ki(...t2) : "vec4" === r2 ? new vs(...t2) : "mat2" === r2 ? new Jl(...t2) : "mat3" === r2 ? new ss(...t2) : "mat4" === r2 ? new As(...t2) : "bool" === e ? t2[0] || false : "float" === e || "int" === e || "uint" === e ? t2[0] || 0 : "string" === e ? t2[0] || "" : "ArrayBuffer" === e ? (function(e2) {
...
var Qi = class extends Ei {
  ...
  constructor(e = null) {
    super(), this.nodeType = e, this.updateType = zi2.NONE, this.updateBeforeType = zi2.NONE, this.updateAfterType = zi2.NONE, this.version = 0, this.name = "", this.global = false, this.parents = false, this.isNode = true, this._beforeNodes = null, this._cacheKey = null, this._uuid = null, this._cacheKeyVersion = 0, this.id = Yi++, this.stackTrace = null, true === Qi.captureStackTrace && (this.stackTrace = new Ai());
  }
  set needsUpdate(e) {
    true === e && this.version++;
  }
...
Qi.prototype.assign = function(...e) {
  if (true !== this.isStackNode) return null !== ds ? ds.assign(this, ...e) : Pi("TSL: No stack defined for assign operation. Make sure the assign is inside a Fn().", new Ai()), this;
  {
...
var Ts = function(e, t2 = null, r2 = null, i2 = null) {
  ...
  function u2(t3) {
    let r3;
    return r3 = l2 ? /[a-z]/i.test(l2) ? l2 + "()" : l2 : e.type, void 0 !== n2 && t3.length < n2 ? (Pi(`TSL: "${r3}" parameter length is less than minimum required.`, new Ai()), t3.concat(new Array(n2 - t3.length).fill(0))) : void 0 !== o2 && t3.length > o2 ? (Pi(`TSL: "${r3}" parameter length exceeds limit.`, new Ai()), t3.slice(0, o2)) : t3;
  }
...
for (let e of [false, true]) As2.set(e, new ls(e));
var Rs = /* @__PURE__ */ new Map();
for (let e of [0, 1, 2, 3]) Rs.set(e, new ls(e, "uint"));
var Cs = new Map([...Rs].map((e) => new ls(e.value, "int")));
for (let e of [-1, -2]) Cs.set(e, new ls(e, "int"));
var Ms = new Map([...Cs].map((e) => new ls(e.value)));
for (let e of Es) Ms.set(e, new ls(e));
for (let e of Es) Ms.set(-e, new ls(-e));
var Bs = { bool: As2, uint: Rs, ints: Cs, float: Ms };
var Fs = new Map([...As2, ...Ms]);
var Ps = (e, t2) => Fs.has(e) ? Fs.get(e) : true === e.isNode ? e : new ls(e, t2);
var Ls = function(e, t2 = null) {
  return (...r2) => {
    for (let t3 of r2) if (void 0 === t3) return Pi(`TSL: Invalid parameter for the type "${e}".`, new Ai()), new ls(0, e);
...
var js = class extends Qi {
  constructor(e, t2 = null) {
    super();
    let r2 = null;
    null !== t2 && ("object" == typeof t2 ? r2 = t2.return : ("string" == typeof t2 ? r2 = t2 : Pi("TSL: Invalid layout type.", new Ai()), t2 = null)), this.shaderNode = new Os(e, r2), null !== t2 && this.setLayout(t2), this.isFn = true;
  }
  setLayout(e) {
...
cs("element", xa), cs("convert", _a), cs("append", (e) => (Oi("TSL: .append() has been renamed to .toStack().", new Ai()), Zs(e)));
...
var Aa = zs(Ta, "float", "Roughness");
var Ra = zs(Ta, "float", "Metalness");
...
var ln = class extends ns {
  ...
  label(e) {
    return Oi('TSL: "label()" has been deprecated. Use "setName()" instead.', new Ai()), this.setName(e);
  }
  setGroup(e) {
...
var En2 = Ws(fn, "<=").setParameterLength(2).setName("lessThanEqual");
var An = Ws(fn, ">=").setParameterLength(2).setName("greaterThanEqual");
var Rn = Ws(fn, "&&").setParameterLength(2, 1 / 0).setName("and");
...
var Fn = Ws(fn, "&").setParameterLength(2).setName("bitAnd");
...
cs("add", bn2), cs("sub", yn), cs("mul", xn2), cs("div", _n), cs("mod", Tn), cs("equal", vn), cs("notEqual", Nn2), cs("lessThan", Sn), cs("greaterThan", wn), cs("lessThanEqual", En2), cs("greaterThanEqual", An), cs("and", Rn), cs("or", Cn), cs("not", Mn2), cs("xor", Bn), cs("bitAnd", Fn), cs("bitNot", Pn), cs("bitOr", Ln2), cs("bitXor", Un), cs("shiftLeft", Dn2), cs("shiftRight", On), cs("incrementBefore", In), cs("decrementBefore", Vn2), cs("increment", kn), cs("decrement", Gn);
...
var Ao = Ws($n, $n.DFDX).setParameterLength(1);
var Ro = Ws($n, $n.DFDY).setParameterLength(1);
...
var nl2 = (e, t2, r2) => Jo2(t2, r2, e);
var ol = (e, t2, r2) => il2(t2, r2, e);
var ll2 = (e, t2) => Io(t2, e);
var ul2 = sl;
var dl2 = so2;
cs("all", Kn), cs("any", Yn), cs("radians", Qn), cs("degrees", Zn), cs("exp", Jn), cs("exp2", eo), cs("log", to), cs("log2", ro2), cs("sqrt", io2), cs("inverseSqrt", so2), cs("floor", ao2), cs("ceil", no2), cs("normalize", oo), cs("fract", lo), cs("sin", uo2), cs("sinh", ho2), cs("cos", co2), cs("cosh", po), cs("tan", mo), cs("tanh", go), cs("asin", fo), cs("asinh", bo), cs("acos", yo), cs("acosh", xo), cs("atan", _o), cs("atanh", To), cs("abs", vo), cs("sign", No), cs("length", So), cs("lengthSq", Zo), cs("negate", wo), cs("oneMinus", Eo), cs("dFdx", Ao), cs("dFdy", Ro), cs("round", Co), cs("reciprocal", Mo), cs("trunc", Bo), cs("fwidth", Fo), cs("min", Do), cs("max", Oo), cs("step", ll2), cs("reflect", Vo), cs("distance", ko), cs("dot", $o), cs("cross", zo), cs("pow", Wo), cs("pow2", Ho), cs("pow3", qo), cs("pow4", jo), cs("transformDirection", Xo), cs("transformNormalByViewMatrix", Ko), cs("transformNormalByInverseViewMatrix", Yo), cs("mix", nl2), cs("clamp", el), cs("refract", rl2), cs("smoothstep", ol), cs("faceForward", sl), cs("difference", Go), cs("saturate", tl), cs("cbrt", Qo), cs("transpose", Po), cs("determinant", Lo), cs("inverse", Uo), cs("rand", al);
...
var ml = (e) => pl(e, { uniformFlow: true });
var gl = (e, t2) => pl(e, { nodeName: t2 });
function fl(e, t2, r2 = null) {
  return pl(r2, { getShadow: ({ light: r3, shadowColorNode: i2 }) => t2 === r3 ? i2.mul(e) : i2 });
}
function bl(e, t2 = null) {
  return pl(t2, { getAO: (t3, { material: r2 }) => true === r2.transparent ? t3 : null !== t3 ? t3.mul(e) : e });
}
function yl(e, t2) {
  return Oi('TSL: "label()" has been deprecated. Use "setName()" instead.'), gl(e, t2);
}
cs("context", pl), cs("label", yl), cs("uniformFlow", ml), cs("setName", gl), cs("builtinShadowContext", (e, t2, r2) => fl(t2, r2, e)), cs("builtinAOContext", (e, t2) => bl(t2, e));
var xl2 = class extends Qi {
  static get type() {
    return "VarNode";
  }
...
var vl = (e, t2 = null) => _l(e, t2, true).toStack();
var Nl = (e) => _l(e).setIntent(true).toStack();
cs("toVar", Tl), cs("toConst", vl), cs("toVarIntent", Nl);
...
var Al = (e) => El2(e);
cs("toVarying", El2), cs("toVertexStage", Al);
var Rl = Xs(([e]) => {
...
var Bl = class extends es {
  ...
  setup(e) {
    ...
    return false === hs.enabled || r2 === i2 || !r2 || !i2 || (hs.getTransfer(r2) === je && (s2 = ca(Rl(s2.rgb), s2.a)), hs.getPrimaries(r2) !== hs.getPrimaries(i2) && (s2 = ca(ba(hs._getMatrix(new ss(), r2, i2)).mul(s2.rgb), s2.a)), hs.getTransfer(i2) === je && (s2 = ca(Cl(s2.rgb), s2.a))), s2;
  }
};
...
var ql = (e, t2 = null, r2 = 0, i2 = 0) => Wl(e, t2, r2, i2, gi, true);
...
var Jl2 = zs(Xl, Xl.INVOCATION_LOCAL);
...
var ru = (e, t2 = [64]) => {
  (0 === t2.length || t2.length > 3) && Pi("TSL: compute() workgroupSize must have 1, 2, or 3 elements", new Ai());
  for (let e2 = 0; e2 < t2.length; e2++) {
    let r2 = t2[e2];
    ("number" != typeof r2 || r2 <= 0 || !Number.isInteger(r2)) && Pi(`TSL: compute() workgroupSize element at index [ ${e2} ] must be a positive integer`, new Ai());
  }
...
var mu2 = Xs(([e]) => e.a.equal(0).select(ca(0), ca(e.rgb.div(e.a), e.a)), { color: "vec4", return: "vec4" });
var gu = class extends es {
  ...
  setup({ context: e }) {
    ...
    t2 = ca(t2.rgb, t2.a.clamp(0, 1)), t2 = mu2(t2);
...
var yu = (e, t2 = null) => new bu(Is(e), t2).toStack();
cs("debug", yu);
var xu = class extends Ei {
  constructor() {
...
var Bu = class extends ln {
  ...
  setupUV(e, t2) {
    return e.isFlipY() && (null === this._flipYUniform && (this._flipYUniform = un(false)), t2 = t2.toVar(), t2 = this.sampler ? this._flipYUniform.select(t2.flipY(), t2) : this._flipYUniform.select(t2.setY(ta(Au(this, this.levelNode).y).sub(t2.y).sub(1)), t2)), t2;
  }
  setup(e) {
  ...
  generate(e, t2) {
    ...
    if (e.isReference(t2)) return s2;
    {
      ...
      if (void 0 === o2) {
        ...
        let A2 = e.getVarFromNode(this);
        o2 = e.getPropertyName(A2);
        let R = this.generateSnippet(e, s2, f2, b2, y2, E, _2, v2, N2, S2, w2);
        if (null !== T2) {
          let t4 = r2.compareFunction;
          R = t4 === di || t4 === yi ? Io(hu(R, n2), hu(T2, "float")).build(e, n2) : Io(hu(T2, "float"), hu(R, n2)).build(e, n2);
        }
        e.addLineFlowCode(`${o2} = ${R}`, this), a2.snippet = R, a2.propertyName = o2;
      }
      let l2 = o2;
  ...
  blur(e) {
    let t2 = this.clone();
    t2.biasNode = Is(e).mul(Ru(t2)), t2.referenceNode = this.getBase();
    let r2 = t2.value;
...
var Xu = Hu.sub(qu.xy);
var Ku = Xu.div(ju);
var Yu = Xs(() => (Oi('TSL: "viewportResolution" is deprecated. Use "screenSize" instead.', new Ai()), Wu), "vec2").once()();
var Qu = null;
var Zu = null;
var Ju = null;
var ed = null;
...
var Ad = $s2(vd, vd.VIEW_POSITION).setParameterLength(1);
var Rd = $s2(vd, vd.RADIUS).setParameterLength(1);
...
var Rh = (e, t2, r2 = null) => new Ah(e, t2, r2);
var Ch = Eu();
var Mh = Xd.dFdx();
var Bh = Xd.dFdy();
var Fh = Ch.dFdx();
...
var ec = Xs(() => {
  let e = Va2.cross(Kd);
  return e = e.cross(Va2).normalize(), e = Jo2(e, sh, Oa.mul(Aa.oneMinus()).oneMinus().pow2().pow2()).normalize(), e;
}).once()();
...
var sc = $s2(class extends es {
  ...
  constructor(e, t2 = null) {
    super("vec3"), this.node = e, this.scaleNode = t2, this.normalMapType = Ee, this.unpackNormalMode = Je;
  }
  setup(e) {
    let { normalMapType: t2, scaleNode: r2, unpackNormalMode: i2 } = this, s2 = this.node.mul(2).sub(1);
    if (t2 === Ee ? i2 === qe ? s2 = ic(s2.xy) : i2 === Xe ? s2 = ic(s2.yw) : i2 !== Je && Pi(`THREE.NodeMaterial: Unexpected unpack normal mode: ${i2}`) : i2 !== Je && Pi(`THREE.NodeMaterial: Normal map type '${t2}' is not compatible with unpack normal mode '${i2}'`), null !== r2) {
      let t3 = r2;
      true === e.isFlatShading() && (t3 = Zd(t3)), s2 = la(s2.xy.mul(t3), s2.z);
    }
    let a2 = null;
    return t2 === Fe ? a2 = lh(s2) : t2 === Ee ? a2 = Zh2.mul(s2).normalize() : (Pi(`NodeMaterial: Unsupported normal map type: ${t2}`), a2 = sh), a2;
  }
}).setParameterLength(1, 2);
...
var uc = class extends Qi {
  ...
  getCache(e, t2) {
    let r2 = lc.get(e);
    return void 0 === r2 && (r2 = Rh(e, t2), lc.set(e, r2)), r2;
  }
  getFloat(e) {
...
var Ac = zs(uc, uc.SHEEN);
var Rc = zs(uc, uc.SHEEN_ROUGHNESS);
...
function ap(e, t2, r2) {
  ...
  if (true === t2.isStorageInstancedBufferAttribute) i2 = tp(t2, "mat4", Math.max(r2, 1)).element(Yl);
    ...
    let r3 = t2.usage === xi ? jl : ql, s2 = [r3(e2, "vec4", 16, 0), r3(e2, "vec4", 16, 4), r3(e2, "vec4", 16, 8), r3(e2, "vec4", 16, 12)];
    i2 = ya(...s2);
  }
  return i2;
}
...
var up = Xs(([e, t2]) => {
  let r2 = ta(Au(Lu(e), 0).x).toConst(), i2 = ta(t2), s2 = i2.mod(r2).toConst(), a2 = i2.div(r2).toConst();
  return Lu(e, aa(s2, a2));
});
var dp = Xs(([e, t2]) => {
  let r2 = ta(Au(Lu(e), 0).x).toConst(), i2 = ta(t2).mod(r2).toConst(), s2 = ta(t2).div(r2).toConst();
  return Lu(e, aa(i2, s2)).x;
});
var hp = Na("vec4", "vBatchColor");
var cp = Xs(([e], t2) => {
  let r2 = null === t2.getDrawIndex() ? Yl : eu, i2 = dp(e._indirectTexture, ta(r2)), s2 = e._matricesTexture, a2 = ta(Au(Lu(s2), 0).x).toConst(), n2 = ea(i2).mul(4).toInt().toConst(), o2 = n2.mod(a2).toConst(), l2 = n2.div(a2).toConst(), u2 = ya(Lu(s2, aa(o2, l2)), Lu(s2, aa(o2.add(1), l2)), Lu(s2, aa(o2.add(2), l2)), Lu(s2, aa(o2.add(3), l2))), d2 = e._colorsTexture;
  if (null !== d2) {
    let e2 = up(d2, i2);
    hp.assign(e2);
  }
...
var im = class extends pa {
  ...
  setupPosition(e) {
    ...
    if ((r2.morphAttributes.position || r2.morphAttributes.normal || r2.morphAttributes.color) && Ap(t2), true === t2.isSkinnedMesh && yp(t2), this.displacementMap) {
      let e2 = Rh("displacementMap", "texture"), t3 = Rh("displacementScale", "float"), r3 = Rh("displacementBias", "float");
  ...
  setupEnvironment() {
    let e = null;
    return this.envNode ? e = this.envNode : this.envMap && (e = this.envMap.isCubeTexture ? Rh("envMap", "cubeTexture") : Rh("envMap", "texture")), e;
  }
  setupLightMap(e) {
    let t2 = null;
...
var vm = class extends bs {
  constructor(e = 1, t2 = {}) {
    ...
    this.texture = new En(i2), this._setTextureOptions(t2), this.texture.isRenderTargetTexture = true;
  }
  fromEquirectangularTexture(e, t2) {
    ...
    let u2 = new xl(1, 10, this), d2 = e.getMRT();
...
var Fm = class extends im {
  ...
  setupEnvironment(e) {
    ...
    return t2 ? new Am(t2) : null;
  }
  setupLightMap(e) {
    let t2 = null;
    return e.material.lightMap && (t2 = new Rm(Hc)), t2;
  }
  setupOutgoingLight() {
    return Sa.rgb;
  }
...
var Ag = Xs(([e, t2, r2, i2, s2, a2, n2, o2, l2, u2, d2, h2, c2, p2, m2]) => {
  let g2, f2;
  if (m2) {
...
var Rg = ba(3.2404542, -0.969266, 0.0556434, -1.5371385, 1.8760108, -0.2040259, -0.4985314, 0.041556, 1.0572252);
...
var Mg = Xs(({ outsideIOR: e, eta2: t2, cosTheta1: r2, thinFilmThickness: i2, baseF0: s2 }) => {
  ...
  return Tp({ start: 1, end: 2, condition: "<=", name: "m" }, ({ m: e2 }) => {
    ...
    let t3 = ((e3, t4) => {
      ...
      return o3 = la(o3.x.add(n3), o3.y, o3.z).div(10685e-11), Rg.mul(o3);
...
var Lg = class extends Cm {
  ...
  start(e) {
    if (true === this.clearcoat && (this.clearcoatRadiance = la().toVar("clearcoatRadiance"), this.clearcoatSpecularDirect = la().toVar("clearcoatSpecularDirect"), this.clearcoatSpecularIndirect = la().toVar("clearcoatSpecularIndirect")), true === this.sheen && (this.sheenSpecularDirect = la().toVar("sheenSpecularDirect"), this.sheenSpecularIndirect = la().toVar("sheenSpecularIndirect")), true === this.iridescence) {
      ...
      this.iridescenceFresnel = Jo2(t2, r2, Ra), this.iridescenceF0Dielectric = tg({ f: t2, f90: 1, dotVH: e2 }), this.iridescenceF0Metallic = tg({ f: r2, f90: 1, dotVH: e2 }), this.iridescenceF0 = Jo2(this.iridescenceF0Dielectric, this.iridescenceF0Metallic, Ra);
    }
    if (true === this.transmission) {
      let t2 = qd, r2 = xd.sub(qd).normalize(), i2 = ah, s2 = e.context;
      s2.backdrop = Ag(i2, r2, Aa, wa, Ga, $a, t2, Bd, fd, md, Xa, Ya, Za2, Qa2, this.dispersion ? Ja : null), s2.backdropAlpha = Ka, Sa.a.mulAssign(Jo2(1, s2.backdrop.a, Ka));
    }
    super.start(e);
  }
  computeMultiscattering(e, t2, r2, i2, s2 = null) {
    let a2 = sh.dot(Kd).clamp(), n2 = Zm({ roughness: Aa, dotNV: a2 }), o2 = s2 ? Pa.mix(i2, s2) : i2, l2 = o2.mul(n2.x).add(r2.mul(n2.y)), u2 = n2.x.add(n2.y).oneMinus(), d2 = o2.add(o2.oneMinus().mul(0.047619)), h2 = l2.mul(d2).div(u2.mul(d2).oneMinus());
  ...
  direct({ lightDirection: e, lightColor: t2, reflectedLight: r2 }) {
    ...
    r2.directDiffuse.addAssign(i2.mul(Lm({ diffuseColor: wa }))), r2.directSpecular.addAssign(i2.mul(Jm({ lightDirection: e, f0: Ga, f90: 1, roughness: Aa, f: this.iridescenceFresnel, USE_IRIDESCENCE: this.iridescence, USE_ANISOTROPY: this.anisotropy })));
  }
  directRectArea({ lightColor: e, lightPosition: t2, halfWidth: r2, halfHeight: i2, reflectedLight: s2, ltc_1: a2, ltc_2: n2 }) {
    let o2 = t2.add(r2).sub(i2), l2 = t2.sub(r2).sub(i2), u2 = t2.sub(r2).add(i2), d2 = t2.add(r2).add(i2), h2 = sh, c2 = Kd, p2 = Xd.toVar(), m2 = ag({ N: h2, V: c2, roughness: Aa }), g2 = a2.sample(m2).toVar(), f2 = n2.sample(m2).toVar(), b2 = ba(la(g2.x, 0, g2.y), la(0, 1, 0), la(g2.z, 0, g2.w)).toVar(), y2 = Ga.mul(f2.x).add($a.sub(Ga).mul(f2.y)).toVar();
  ...
  indirectSpecular(e) {
    ...
    let l2 = Jo2(s2, n2, Ra), u2 = Jo2(a2, o2, Ra), d2 = s2.add(a2), h2 = wa.mul(d2.oneMinus()), c2 = r2.mul(1 / Math.PI), p2 = t2.mul(l2).add(u2.mul(c2)).toVar(), m2 = h2.mul(c2).toVar();
    if (true === this.sheen) {
      let e2 = Bg({ normal: sh, viewDir: Kd, roughness: Fa }), t3 = Ba.r.max(Ba.g).max(Ba.b).mul(e2).oneMinus();
  ...
  ambientOcclusion(e) {
    let { ambientOcclusion: t2, reflectedLight: r2 } = e.context, i2 = sh.dot(Kd).clamp().add(t2), s2 = Aa.mul(-16).oneMinus().negate().exp2(), a2 = t2.sub(i2.pow(s2).oneMinus()).clamp();
...
var Ef = class extends Rp {
  ...
  setup(e) {
    ...
    let i2 = true === t2.useAnisotropy || t2.anisotropy > 0 ? ec : sh, s2 = r2.context(Af(Aa, i2)).mul(mh), a2 = r2.context(Rf(ah)).mul(Math.PI).mul(mh), n2 = au(s2), o2 = au(a2);
    e.context.radiance.addAssign(n2), e.context.iblIrradiance.addAssign(o2);
    let l2 = e.context.lightingModel.clearcoatRadiance;
    if (l2) {
      let e2 = r2.context(Af(Ma, nh)).mul(mh), t3 = au(e2);
      l2.addAssign(t3);
    }
  }
...
var Rf = (e) => ({ getUV: () => e, getTextureLevel: () => ea(1) });
var Cf = new io();
var Mf = class extends im {
  ...
  setupVariants() {
    ...
    t2 = zm({ roughness: t2 }), Aa.assign(t2), this.setupSpecular(), wa.assign(Sa.rgb.mul(e.oneMinus()));
  }
};
var Bf = new so();
var Ff = class extends Mf {
  ...
  setupSpecular() {
    ...
    Xa.assign(e), ka.assign(Do(Ho(Xa.sub(1).div(Xa.add(1))).mul(bc), la(1)).mul(fc)), Ga.assign(Jo2(ka, Sa.rgb, Ra)), $a.assign(Jo2(fc, 1, Ra));
  }
  setupLightingModel() {
  ...
  setupVariants(e) {
    ...
    if (this.useSheen) {
      let e2 = this.sheenNode ? la(this.sheenNode) : Ac, t2 = this.sheenRoughnessNode ? ea(this.sheenRoughnessNode) : Rc;
    ...
    if (this.useAnisotropy) {
      ...
      }), Da.assign(Oa.pow2().mix(Aa.pow2(), 1)), Ia.assign(Zh2[0].mul(e2.x).add(Zh2[1].mul(e2.y))), Va2.assign(Zh2[1].mul(e2.x).sub(Zh2[0].mul(e2.y)));
    }
...
var Pf = Xs(({ normal: e, lightDirection: t2, builder: r2 }) => {
  ...
  if (r2.material.gradientMap) {
    let e2 = Rh("gradientMap", "texture").context({ getUV: () => s2 });
    return la(e2.r);
  }
  {
...
var Vf = class extends im {
  ...
  setupVariants(e) {
    let t2, r2 = Of;
    t2 = e.material.matcap ? Rh("matcap", "texture").context({ getUV: () => r2 }) : la(Jo2(0.2, 0.8, r2.y)), Sa.rgb.mulAssign(t2.rgb);
  }
};
...
var sb = class {
  ...
  _fail(e, t2) {
    ...
    !r2 && t2.stack && (r2 = new Ai(t2.stack)), Pi("TSL: " + t2, r2), e.builder = null, this.rememberFailure(e.target.initialCacheKey), this.stats.failed++;
    let i2 = e.owner;
...
var ob = class {
  ...
  updateClassification(e) {
    ...
    void 0 === t2 && (t2 = { transparent: false, doublePass: false }, this._classifications.set(e, t2)), t2.transparent = Ab(e), t2.doublePass = Rb(e);
  }
  ...
  get(e, t2, r2, i2, s2, a2, n2, o2) {
    let l2 = this.getChainMap(o2);
    nb[0] = e, nb[1] = t2, nb[2] = a2, nb[3] = s2;
    let u2 = l2.get(nb);
    if (void 0 === u2) u2 = this.createRenderObject(this.nodes, this.geometries, this.renderer, e, t2, r2, i2, s2, a2, n2, o2), l2.set(nb, u2), true === this.renderer._asyncCompilation && false === this.renderer._compilation._updating && true !== e.isQuadMesh && (u2.drawState = eb(t2), this.renderer._compilation.request(u2, o2));
    else {
      u2.camera = i2, u2.updateClipping(n2);
      let l3 = false, d2 = false;
      if (u2.needsGeometryUpdate && (l3 = true, u2.setGeometry(e.geometry), d2 = u2.initialCacheKey !== u2.getCacheKey()), d2 || u2.version !== t2.version || u2.needsUpdate) if (true === this.renderer._asyncCompilation && false === this.renderer._compilation._updating && true !== e.isQuadMesh && true === this.pipelines.isReady(u2) && false === l3) {
        let e2 = u2.getCacheKey();
        u2.initialCacheKey !== e2 && this.requestPending(u2, e2, false, o2), u2.version = t2.version;
      } else u2.initialCacheKey !== u2.getCacheKey() ? (u2.dispose(), u2 = this.get(e, t2, r2, i2, s2, a2, n2, o2)) : u2.version = t2.version;
    }
    return nb[0] = null, nb[1] = null, nb[2] = null, nb[3] = null, u2;
  }
  requestPending(e, t2, r2 = false, i2) {
    ...
    l2.drawState = n2, e.pending = l2, s2.request(e, i2);
  }
  promote(e, t2, r2) {
  ...
  createRenderObject(e, t2, r2, i2, s2, a2, n2, o2, l2, u2, d2) {
    ...
    return c2.onDispose = () => {
      this.pipelines.delete(c2), this.bindings.deleteForRender(c2), this.nodes.delete(c2);
      let e2 = c2.pending;
...
function pb(e) {
  ...
  return a2.version = hb(e), a2.__id = cb(e), a2;
}
var mb = class extends lb {
  constructor(e, t2) {
  ...
  getIndex(e) {
    ...
    if (true === e.drawMaterial.wireframe) {
      ...
      void 0 === i2 ? (i2 = pb(t2), e2.set(t2, i2)) : (i2.version !== hb(t2) || i2.__id !== cb(t2)) && (this.attributes.delete(i2), i2 = pb(t2), e2.set(t2, i2)), r2 = i2;
    }
    return r2;
  }
  dispose() {
...
var gb = class {
  ...
  _getTextureMemorySize(e) {
    ...
    let r2 = 4;
    e.format === Pt || e.format === Ft || e.format === Lt || e.format === Vt || e.format === Et ? r2 = 1 : e.format === Dt || e.format === Wt ? r2 = 2 : (e.format === Nt || e.format === Ut) && (r2 = 3);
    let i2 = t2 * r2;
...
var _b = class {
  constructor(e, t2, r2, i2 = null, s2 = null) {
    this.id = xb++, this.code = e, this.stage = t2, this.name = r2, this.transforms = i2, this.attributes = s2, this.usedTimes = 0;
  }
};
var Tb = class extends lb {
  constructor(e, t2, r2) {
  ...
  getForCompute(e, t2) {
    ...
    if (this._needsComputeUpdate(e)) {
      ...
      void 0 === n2 && (s2 && 0 === s2.computeProgram.usedTimes && this._releaseProgram(s2.computeProgram), n2 = new _b(a2.computeShader, "compute", e.name, a2.transforms, a2.nodeAttributes), this.programs.compute.set(a2.computeShader, n2), r2.createProgram(n2), this.info.createProgram(n2));
  ...
  getForRenderAsync(e) {
    ...
    if (void 0 === r2) {
      ...
      if (r2 = this.caches.get(o2), void 0 === r2) {
        r2 = new bb(o2, a2, n2), this.caches.set(o2, r2), e.pipeline = r2;
        let t3 = [];
  ...
  _getComputePipeline(e, t2, r2, i2) {
    ...
    return void 0 === s2 && (s2 = new yb(r2, t2), this.caches.set(r2, s2), this.backend.createComputePipeline(s2, i2)), s2;
  }
  _getRenderPipeline(e, t2, r2, i2) {
    i2 = i2 || this._getRenderCacheKey(e, t2, r2);
    let s2 = this.caches.get(i2);
    return void 0 === s2 && (s2 = new bb(i2, t2, r2), this.caches.set(i2, s2), e.pipeline = s2, this.backend.createRenderPipeline(e, null)), s2;
  }
  ...
  _getProgramStage(e, t2, r2, i2 = null) {
    ...
    return void 0 === s2 && (null !== i2 && 0 === i2.usedTimes && this._releaseProgram(i2), s2 = new _b(t2, e, r2), this.programs[e].set(t2, s2), this.backend.createProgram(s2), this.info.createProgram(s2)), s2;
  }
  _releasePipeline(e) {
  ...
  _createBindings(e) {
    for (let t2 of e) {
      ...
      if (void 0 === r2.bindGroup) {
        ...
        else if (e2.isSampledTexture) (null === e2.texture || void 0 === e2.texture) && (e2.texture = e2.textureNode && e2.textureNode.value || PS()), this.textures.updateTexture(e2.texture);
...
var Sb = { transparent: false, doublePass: false };
function wb(e, t2) {
...
var Cb = class {
  ...
  _classify(e) {
    ...
    return Sb.transparent = Ab(e), Sb.doublePass = Sb.transparent && Rb(e), Sb;
  }
  begin() {
  ...
  sort(e, t2, r2) {
    this.opaque.length > 1 && this.opaque.sort(e || wb), this.transparentDoublePass.length > 1 && this.transparentDoublePass.sort(t2 || Eb), this.transparent.length > 1 && this.transparent.sort(t2 || Eb), r2 && (this.opaque.reverse(), this.transparentDoublePass.reverse(), this.transparent.reverse());
  }
  finish() {
    this.lightsNode.setLights(this.lighting.enabled ? this.lightsArray : Nb);
...
var Bb = class {
  ...
  get(e, t2) {
    ...
    Mb[0] = e, Mb[1] = t2;
    let i2 = r2.get(Mb);
    return void 0 === i2 && (i2 = new Cb(this.lighting, e, t2, this.objects), r2.set(Mb, i2)), Mb[0] = null, Mb[1] = null, i2;
  }
  dispose() {
    this.lists = new Qf();
  }
...
var Pb = class {
  constructor() {
    this.id = Fb++, this.nodeCacheKey = "", this.mrt = null, this.color = true, this.clearColor = true, this.clearColorValue = { r: 0, g: 0, b: 0, a: 1 }, this.depth = true, this.clearDepth = true, this.clearDepthValue = 1, this.stencil = false, this.clearStencil = true, this.clearStencilValue = 1, this.viewport = false, this.viewportValue = new vs(), this.scissor = false, this.scissorValue = new vs(), this.renderTarget = null, this.textures = null, this.depthTexture = null, this.activeCubeFace = 0, this.activeMipmapLevel = 0, this.sampleCount = 1, this.width = 0, this.height = 0, this.occlusionQueryCount = 0, this.clippingContext = null, this.camera = null, this.isRenderContext = true;
  }
  getCacheKey() {
    return Lb(this);
  }
...
var Ub = class {
  ...
  get(e = null, t2 = null, r2 = 0) {
    ...
    return void 0 === n2 && (n2 = new Pb(), n2.mrt = t2, n2.nodeCacheKey = i2 + "-" + s2, this._renderContexts[a2] = n2), null !== e && (n2.sampleCount = 0 === e.samples ? 1 : e.samples), n2.clearDepthValue = this.renderer.getClearDepth(), n2.clearStencilValue = this.renderer.getClearStencil(), n2;
  }
  dispose() {
...
function kb(e, t2 = null, r2 = null) {
  if (t2 && t2.isNode) {
    let e2 = t2;
    t2 = () => e2;
  }
  return new Vb(/* @__PURE__ */ new Map([[e, t2]]), r2);
}
function Gb(e, t2 = null) {
...
cs("overrideNode", (e, t2, r2) => kb(t2, r2, e)), cs("overrideNodes", (e, t2) => Gb(t2, e));
var $b = class extends Ta {
  static get type() {
  ...
  getMemberType(e, t2) {
    ...
    return null !== s2 ? r2 = s2.getMemberType(e, t2) : (Pi(`TSL: Member "${t2}" not found in struct "${i2}".`, new Ai()), r2 = "float"), r2;
  }
  getHash() {
    return String(this.id);
  }
...
var zb = $s2(class extends Qi {
  ...
  addToStack(e, t2 = -1) {
    if (true !== e.isNode) return Pi("TSL: Invalid node added to stack.", new Ai()), this;
  ...
  Case(...e) {
    ...
    else Pi("TSL: Invalid parameter length. Case() requires at least two parameters.", new Ai());
...
var qb = class extends Qi {
  ...
  generate(e) {
    ...
    if (void 0 === t2.membersLayout) {
      let r3 = this.members, i3 = [];
      for (let t3 = 0; t3 < r3.length; t3++) {
        let s3 = "m" + t3, a2 = r3[t3].getNodeType(e);
        i3.push({ name: s3, type: a2, index: t3 });
      }
      t2.membersLayout = i3, t2.structType = e.getOutputStructTypeFromNode(this, t2.membersLayout);
    }
    let r2 = e.getOutputStructName(), i2 = this.members, s2 = "" !== r2 ? r2 + "." : "";
    for (let r3 = 0; r3 < i2.length; r3++) {
      let a2 = i2[r3].build(e, t2.membersLayout[r3].type);
      e.addLineFlowCode(`${s2}m${r3} = ${a2}`, this);
    }
    return r2;
  }
};
...
var Zb = $s2(class extends qb {
  static get type() {
    return "MRTNode";
  }
  constructor(e) {
    super(), this.outputNodes = e, this.blendModes = { output: Yb }, this.isMRTNode = true;
  }
  setBlendMode(e, t2) {
    return this.blendModes[e] = t2, this;
  }
  getBlendMode(e) {
    return this.blendModes[e] || Kb;
  }
  has(e) {
  ...
  merge(e) {
    let t2 = { ...this.outputNodes, ...e.outputNodes }, r2 = { ...this.blendModes, ...e.blendModes }, i2 = Zb(t2);
    return i2.blendings = r2, i2;
  }
  setup(e) {
    let t2 = this.outputNodes, r2 = [], i2 = e.renderer.getRenderTarget().textures;
    for (let s2 in t2) {
      let a2 = Qb(i2, s2), n2 = e.getOutputType(a2);
      r2[a2] = t2[s2].convert(n2);
    }
    return this.members = r2, super.setup(e);
  }
});
...
var ey = Ws(Jb).setParameterLength(2);
var ty = (e) => new Jb(e, "uint", "float");
var ry = {};
var iy = class extends $n {
  static get type() {
    return "BitcountNode";
  }
  constructor(e, t2) {
  ...
  _resolveElementType(e, t2, r2) {
    "int" === r2 ? t2.assign(ey(e, "uint")) : t2.assign(e);
  }
  _returnDataNode(e) {
    switch (e) {
      case "uint":
  ...
  _createTrailingZerosBaseLayout(e, t2) {
    ...
    return Xs(([e2]) => {
      ...
      let s2 = ea(i2.bitAnd(wo(i2))), a2 = ty(s2).shiftRight(23).sub(127);
      return r2(a2);
  ...
  setup(e) {
    ...
    let s2 = this.getInputType(e), a2 = e.getElementType(s2), n2 = e.getTypeLength(s2), o2 = `${t2}_base_${a2}`, l2 = `${t2}_${s2}`, u2 = ry[o2];
    if (void 0 === u2) {
      switch (t2) {
        case iy.COUNT_LEADING_ZEROS:
          u2 = this._createLeadingZerosBaseLayout(o2, a2);
          break;
        case iy.COUNT_TRAILING_ZEROS:
          u2 = this._createTrailingZerosBaseLayout(o2, a2);
          break;
        case iy.COUNT_ONE_BITS:
          u2 = this._createOneBitsBaseLayout(o2, a2);
      }
      ry[o2] = u2;
    }
    let d2 = ry[l2];
    return void 0 === d2 && (d2 = this._createMainLayout(l2, s2, n2, u2), ry[l2] = d2), Xs(() => d2(r2))();
  }
};
iy.COUNT_TRAILING_ZEROS = "countTrailingZeros", iy.COUNT_LEADING_ZEROS = "countLeadingZeros", iy.COUNT_ONE_BITS = "countOneBits";
var sy = Ws(iy, iy.COUNT_TRAILING_ZEROS).setParameterLength(1);
var ay = Ws(iy, iy.COUNT_LEADING_ZEROS).setParameterLength(1);
var ny = Ws(iy, iy.COUNT_ONE_BITS).setParameterLength(1);
var oy = Xs(([e]) => {
...
var ly = (e, t2) => Wo(xn2(4, e.mul(yn(1, e))), t2);
var uy = class extends es {
  static get type() {
...
var dy = Ws(uy, "snorm").setParameterLength(1);
var hy = Ws(uy, "unorm").setParameterLength(1);
var cy = Ws(uy, "float16").setParameterLength(1);
var py = class extends es {
  static get type() {
...
var my = Ws(py, "snorm").setParameterLength(1);
var gy = Ws(py, "unorm").setParameterLength(1);
var fy = Ws(py, "float16").setParameterLength(1);
var by = Xs(([e]) => e.fract().sub(0.5).abs()).setLayout({ name: "tri", type: "float", inputs: [{ name: "x", type: "float" }] });
var yy = Xs(([e]) => la(by(e.z.add(by(e.y.mul(1)))), by(e.z.add(by(e.x.mul(1)))), by(e.y.add(by(e.x.mul(1)))))).setLayout({ name: "tri3", type: "vec3", inputs: [{ name: "p", type: "vec3" }] });
var xy = Xs(([e, t2, r2]) => {
  let i2 = la(e).toVar(), s2 = ea(1.4).toVar(), a2 = ea(0).toVar(), n2 = la(i2).toVar();
  return Tp({ start: ea(0), end: ea(3), type: "float", condition: "<=" }, () => {
    let e2 = la(yy(n2.mul(2))).toVar();
    i2.addAssign(e2.add(r2.mul(ea(0.1).mul(t2)))), n2.mulAssign(1.8), s2.mulAssign(1.5), i2.mulAssign(1.2);
    let o2 = ea(by(i2.z.add(by(i2.x.add(by(i2.y)))))).toVar();
...
var Ty = (e) => (...t2) => _y(e, ...t2);
var vy = un(0).setGroup(nn).onRenderUpdate((e) => e.time);
var Ny = un(0).setGroup(nn).onRenderUpdate((e) => e.deltaTime);
var Sy = un(0, "uint").setGroup(nn).onRenderUpdate((e) => e.frameId);
var wy = Xs(([e, t2, r2 = sa(0.5)]) => kf(e.sub(r2), t2).add(r2));
var Ey = Xs(([e, t2, r2 = sa(0.5)]) => {
...
var My = Xs(([e, t2 = null, r2 = null, i2 = ea(1), s2 = Wd, a2 = eh]) => {
...
var $y = new bs();
var zy = zu.flipX();
$y.depthTexture = new Ln(1, 1);
var Wy = false;
var Hy = class extends Bu {
  static get type() {
    return "ReflectorNode";
  }
  constructor(e = {}) {
    super(e.defaultTexture || $y.texture, zy), this._reflectorBaseNode = e.reflector || new qy(this, e), this._depthNode = null, this.setUpdateMatrix(false);
  }
  get reflector() {
  ...
  getDepthNode() {
    if (null === this._depthNode) {
      ...
      this._depthNode = new Hy({ defaultTexture: $y.depthTexture, reflector: this._reflectorBaseNode });
    }
...
var qy = class extends Qi {
  ...
  _updateResolution(e, t2) {
    ...
    t2.getDrawingBufferSize(Gy), e.setSize(Math.round(Gy.width * r2), Math.round(Gy.height * r2));
  }
  setup(e) {
    return this._updateResolution($y, e.renderer), super.setup(e);
  }
  dispose() {
    super.dispose();
  ...
  updateBefore(e) {
    if (false === this.bounces && Wy) return false;
    Wy = true;
    let { scene: t2, camera: r2, renderer: i2, material: s2 } = e, { target: a2 } = this, n2 = this.getVirtualCamera(r2), o2 = this.getRenderTarget(n2);
    i2.getDrawingBufferSize(Gy), this._updateResolution(o2, i2), Py.setFromMatrixPosition(a2.matrixWorld), Ly.setFromMatrixPosition(r2.matrixWorld), Uy.extractRotation(a2.matrixWorld), Fy.set(0, 0, 1), Fy.applyMatrix4(Uy), Iy.subVectors(Py, Ly);
    let l2 = false;
    if (true == Iy.dot(Fy) > 0 && false === this.forceUpdate) {
      if (false === this.hasOutput) return void (Wy = false);
      l2 = true;
    }
    Iy.reflect(Fy).negate(), Iy.add(Py), Uy.extractRotation(r2.matrixWorld), Dy.set(0, 0, -1), Dy.applyMatrix4(Uy), Dy.add(Ly), Vy.subVectors(Py, Dy), Vy.reflect(Fy).negate(), Vy.add(Py), n2.coordinateSystem = r2.coordinateSystem, n2.position.copy(Iy), n2.up.set(0, 1, 0), n2.up.applyMatrix4(Uy), n2.up.reflect(Fy), n2.lookAt(Vy), n2.near = r2.near, n2.far = r2.far, n2.updateMatrixWorld(), n2.projectionMatrix.copy(r2.projectionMatrix), By.setFromNormalAndCoplanarPoint(Fy, Py), By.applyMatrix4(n2.matrixWorldInverse), Oy.set(By.normal.x, By.normal.y, By.normal.z, By.constant);
    let u2 = n2.projectionMatrix;
    ky.x = (Math.sign(Oy.x) + u2.elements[8]) / u2.elements[0], ky.y = (Math.sign(Oy.y) + u2.elements[9]) / u2.elements[5], ky.z = -1, ky.w = (1 + u2.elements[10]) / u2.elements[14], Oy.multiplyScalar(1 / Oy.dot(ky)), u2.elements[2] = Oy.x, u2.elements[6] = Oy.y, u2.elements[10] = i2.coordinateSystem === Mi ? Oy.z - 0 : Oy.z + 1 - 0, u2.elements[14] = Oy.w, this.textureNode.value = o2.texture, true === this.depth && (this.textureNode.getDepthNode().value = o2.depthTexture), s2.visible = false;
    let d2 = i2.getRenderTarget(), h2 = i2.getMRT(), c2 = i2.autoClear;
    i2.setMRT(null), i2.setRenderTarget(o2), i2.autoClear = true;
    let p2 = t2.name;
    t2.name = (t2.name || "Scene") + " [ Reflector ]", l2 ? (i2.clear(), this.hasOutput = false) : (i2.render(t2, n2), this.hasOutput = true), t2.name = p2, i2.setMRT(h2), i2.setRenderTarget(d2), i2.autoClear = c2, s2.visible = true, Wy = false, this.forceUpdate = false;
  }
  get resolution() {
...
var jy = new hl(-1, 1, 1, -1, 0, 1);
var Xy = new class extends ha {
  constructor(e = false) {
    super();
...
var Ky = class extends Za {
  constructor(e = null) {
    super(Xy, e), this.camera = jy, this.isQuadMesh = true;
  }
  async renderAsync(e) {
    Ni('QuadMesh: "renderAsync()" has been deprecated. Use "render()" and "await renderer.init();" when creating the renderer.'), await e.init(), e.render(this, jy);
  }
  render(e) {
    e.render(this, jy);
  }
...
var Qy = class extends Bu {
  ...
  constructor(e, t2 = null, r2 = null, i2 = { type: Tt }) {
    ...
    super(s2.texture, Eu()), this.isRTTNode = true, this.node = e, this.width = t2, this.height = r2, this.renderTarget = s2, this.textureNeedsUpdate = true, this.autoUpdate = true, this._resolutionScale = 1, this._rttNode = null, this._quadMesh = new Ky(new im()), this.updateBeforeType = zi2.RENDER;
  }
  get autoResize() {
  ...
  updateBefore({ renderer: e }) {
    ...
    if (true === this.autoResize) {
      let t3 = e.getDrawingBufferSize(Yy), r3 = Math.floor(t3.width * this._resolutionScale), i2 = Math.floor(t3.height * this._resolutionScale);
...
var Zy = (e, ...t2) => new Qy(Is(e), ...t2);
var Jy = Xs(([e, t2, r2], i2) => {
  let s2;
...
var tx = Xs(([e, t2, r2]) => {
  let i2 = Au(Lu(t2)), s2 = aa(e.mul(i2)).toVar(), a2 = Lu(t2, s2).toVar(), n2 = Lu(t2, s2.sub(aa(2, 0))).toVar(), o2 = Lu(t2, s2.sub(aa(1, 0))).toVar(), l2 = Lu(t2, s2.add(aa(1, 0))).toVar(), u2 = Lu(t2, s2.add(aa(2, 0))).toVar(), d2 = Lu(t2, s2.add(aa(0, 2))).toVar(), h2 = Lu(t2, s2.add(aa(0, 1))).toVar(), c2 = Lu(t2, s2.sub(aa(0, 1))).toVar(), p2 = Lu(t2, s2.sub(aa(0, 2))).toVar(), m2 = vo(yn(ea(2).mul(o2).sub(n2), a2)).toVar(), g2 = vo(yn(ea(2).mul(l2).sub(u2), a2)).toVar(), f2 = vo(yn(ea(2).mul(h2).sub(d2), a2)).toVar(), b2 = vo(yn(ea(2).mul(c2).sub(p2), a2)).toVar(), y2 = Jy(e, a2, r2).toVar(), x2 = m2.lessThan(g2).select(y2.sub(Jy(e.sub(sa(ea(1).div(i2.x), 0)), o2, r2)), y2.negate().add(Jy(e.add(sa(ea(1).div(i2.x), 0)), l2, r2))), _2 = f2.lessThan(b2).select(y2.sub(Jy(e.add(sa(0, ea(1).div(i2.y))), h2, r2)), y2.negate().add(Jy(e.sub(sa(0, ea(1).div(i2.y))), c2, r2)));
  return oo(zo(x2, _2));
});
var rx = Xs(([e]) => lo(ea(52.9829189).mul(lo($o(e, sa(0.06711056, 583715e-8)))))).setLayout({ name: "interleavedGradientNoise", type: "float", inputs: [{ name: "position", type: "vec2" }] });
var ix = Xs(([e, t2, r2]) => {
...
var lx = new As();
var ux = un(0).setGroup(nn).onRenderUpdate(({ scene: e }) => e.backgroundBlurriness);
var dx = un(1).setGroup(nn).onRenderUpdate(({ scene: e }) => e.backgroundIntensity);
var hx = un(new As()).setGroup(nn).onRenderUpdate(({ scene: e }) => {
  let t2 = e.background;
  return null !== t2 && t2.isTexture && t2.mapping !== rt ? lx.makeRotationFromEuler(e.backgroundRotation).transpose() : lx.identity(), lx;
});
var cx = class extends Bu {
  static get type() {
...
var px = $s2(cx).setParameterLength(1, 3);
var mx = $s2(class extends cx {
  static get type() {
...
var fx = $s2(class extends Bu {
  ...
  normal(e) {
    return gx({ texture: this, uv: e });
  }
}).setParameterLength(1, 3);
var bx = class extends Sh {
  static get type() {
    return "UserDataNode";
  }
  constructor(e, t2, r2 = null) {
...
function xx(e) {
  let t2 = yx.get(e);
  return void 0 === t2 && (t2 = {}, yx.set(e, t2)), t2;
}
function _x(e, t2 = 0) {
  let r2 = xx(e), i2 = r2[t2];
  return void 0 === i2 && (r2[t2] = i2 = new As(), r2[t2].copy(e.matrixWorld)), i2;
}
var Tx = zs(class extends es {
  static get type() {
    return "VelocityNode";
  }
  constructor() {
...
var vx = Xs(([e, t2]) => Do(1, e.oneMinus().div(t2)).oneMinus()).setLayout({ name: "blendBurn", type: "vec3", inputs: [{ name: "base", type: "vec3" }, { name: "blend", type: "vec3" }] });
var Nx = Xs(([e, t2]) => Do(e.div(t2.oneMinus()), 1)).setLayout({ name: "blendDodge", type: "vec3", inputs: [{ name: "base", type: "vec3" }, { name: "blend", type: "vec3" }] });
var Sx = Xs(([e, t2]) => e.oneMinus().mul(t2.oneMinus()).oneMinus()).setLayout({ name: "blendScreen", type: "vec3", inputs: [{ name: "base", type: "vec3" }, { name: "blend", type: "vec3" }] });
var wx = Xs(([e, t2]) => Jo2(e.mul(2).mul(t2), e.oneMinus().mul(2).mul(t2.oneMinus()).oneMinus(), Io(0.5, e))).setLayout({ name: "blendOverlay", type: "vec3", inputs: [{ name: "base", type: "vec3" }, { name: "blend", type: "vec3" }] });
var Ex = Xs(([e, t2]) => {
...
var Ax = Xs(([e]) => Bx(e.rgb));
var Rx = Xs(([e, t2 = ea(1)]) => t2.mix(Bx(e.rgb), e.rgb).max(0));
var Cx = Xs(([e, t2 = ea(0)]) => {
...
var Bx = (e, t2 = la(hs.getLuminanceCoefficients(new Ki()))) => $o(e, t2);
var Fx = Xs(([e, t2 = la(1), r2 = la(0), i2 = la(1), s2 = ea(1), a2 = la(hs.getLuminanceCoefficients(new Ki(), We))]) => {
...
var Px = Xs(([e, t2]) => e.mul(t2).floor().div(t2));
var Lx = null;
var Ux = $s2(class extends Pp {
  static get type() {
    return "ViewportSharedTextureNode";
  }
  constructor(e = zu, t2 = null) {
    null === Lx && (Lx = new Vn()), super(e, t2, Lx);
  }
...
var Vx = class extends es {
  ...
  getTextureNode(e = "output") {
    ...
    return void 0 === t2 && (t2 = new Ix(this, e), t2.updateTexture(), this._textureNodes[e] = t2), t2;
  }
  getPreviousTextureNode(e = "output") {
    let t2 = this._previousTextureNodes[e];
    return void 0 === t2 && (void 0 === this._textureNodes[e] && this.getTextureNode(e), t2 = new Ix(this, e, true), t2.updateTexture(), this._previousTextureNodes[e] = t2), t2;
  }
  ...
  setup({ renderer: e }) {
    return this.renderTarget.samples = void 0 === this.options.samples ? e.samples : this.options.samples, this.renderTarget.texture.type = e.getOutputBufferType(), true === e.reversedDepthBuffer && null !== this.renderTarget.depthTexture && (this.renderTarget.depthTexture.type = zt), this.scope === Vx.COLOR ? this.getTextureNode() : this.getLinearDepthNode();
  }
  updateBefore(e) {
    let t2, { renderer: r2 } = e, { scene: i2 } = this, s2 = r2.getOutputRenderTarget();
    s2 && true === s2.isXRRenderTarget ? (t2 = r2.xr.getCamera(), r2.xr.updateCamera(t2), Dx.set(s2.width, s2.height)) : (t2 = this.camera, r2.getDrawingBufferSize(Dx)), this.setSize(Dx.width, Dx.height);
    ...
    null !== this.overrideMaterial && (i2.overrideMaterial = this.overrideMaterial), r2.setRenderTarget(this.renderTarget), r2.setMRT(this._mrt), r2.autoClear = true, r2.transparent = this.transparent, r2.opaque = this.opaque, null !== this.contextNode && ((null === this._contextNodeCache || this._contextNodeCache.version !== this.version) && (this._contextNodeCache = { version: this.version, context: pl({ ...r2.contextNode.getFlowContextData(), ...this.contextNode.getFlowContextData() }) }), r2.contextNode = this._contextNodeCache.context);
    let p2 = i2.name;
...
Vx.COLOR = "color", Vx.DEPTH = "depth";
var kx = class extends Vx {
  static get type() {
    return "ToonOutlinePassNode";
  }
  constructor(e, t2, r2, i2, s2) {
    super(Vx.COLOR, e, t2), this.colorNode = r2, this.thicknessNode = i2, this.alphaNode = s2, this._materialCache = /* @__PURE__ */ new WeakMap(), this.name = "Outline Pass";
  }
  updateBefore(e) {
...
var Gx = Xs(([e, t2]) => e.mul(t2).clamp()).setLayout({ name: "linearToneMapping", type: "vec3", inputs: [{ name: "color", type: "vec3" }, { name: "exposure", type: "float" }] });
var $x = Xs(([e, t2]) => (e = e.mul(t2)).div(e.add(1)).clamp()).setLayout({ name: "reinhardToneMapping", type: "vec3", inputs: [{ name: "color", type: "vec3" }, { name: "exposure", type: "float" }] });
var zx = Xs(([e, t2]) => {
...
var Hx = Xs(([e, t2]) => {
  ...
  return e = e.mul(t2).div(0.6), e = r2.mul(e), e = Wx(e), (e = i2.mul(e)).clamp();
}).setLayout({ name: "acesFilmicToneMapping", type: "vec3", inputs: [{ name: "color", type: "vec3" }, { name: "exposure", type: "float" }] });
var qx = ba(la(1.6605, -0.1246, -0.0182), la(-0.5876, 1.1329, -0.1006), la(-0.0728, -83e-4, 1.1187));
var jx = ba(la(0.6274, 0.0691, 0.0164), la(0.3293, 0.9195, 0.088), la(0.0433, 0.0113, 0.8956));
var Xx = Xs(([e]) => {
...
var Kx = Xs(([e, t2]) => {
  ...
  return r2.mulAssign(t2), r2.assign(jx.mul(r2)), r2.assign(i2.mul(r2)), r2.assign(Oo(r2, 1e-10)), r2.assign(ro2(r2)), r2.assign(r2.sub(a2).div(n2.sub(a2))), r2.assign(el(r2, 0, 1)), r2.assign(Xx(r2)), r2.assign(s2.mul(r2)), r2.assign(Wo(Oo(la(0), r2), la(2.2))), r2.assign(qx.mul(r2)), r2.assign(el(r2, 0, 1)), r2;
...
var Zx = $s2(Qx).setParameterLength(1, 3);
var Jx = class extends Qx {
  static get type() {
    return "FunctionNode";
  }
  constructor(e = "", t2 = [], r2 = "") {
...
var s_ = Xs(([e, t2], r2) => {
  let i2 = t_(r2), s2 = t2.sub(qd.y).max(0).toConst().mul(i2).toConst();
  return e.mul(e, s2, s2).negate().exp().oneMinus();
});
var a_ = Xs(([e, t2]) => ca(t2.toFloat().mix(Wa.rgb, e.toVec3()), Wa.a));
var n_ = null;
var o_ = null;
var l_ = $s2(class extends Qi {
  static get type() {
    return "RangeNode";
  }
  ...
  setup(e) {
    ...
    if (t2.count > 1) {
      ...
      n_ = n_ || new vs(), o_ = o_ || new vs(), n_.setScalar(0), o_.setScalar(0), 1 === o2 ? n_.setScalar(a2) : a2.isColor ? n_.set(a2.r, a2.g, a2.b, 1) : n_.set(a2.x, a2.y, a2.z || 0, a2.w || 0), 1 === l2 ? o_.setScalar(n2) : n2.isColor ? o_.set(n2.r, n2.g, n2.b, 1) : o_.set(n2.x, n2.y, n2.z || 0, n2.w || 0);
      let u2 = 4, d2 = u2 * t2.count, h2 = new Float32Array(d2);
      for (let e2 = 0; e2 < d2; e2++) {
        let t3 = e2 % u2, r3 = n_.getComponent(t3), i3 = o_.getComponent(t3);
      ...
      if (4 * t2.count * 4 <= e.getUniformBufferLimit()) r2 = Du(h2, "vec4", t2.count).element(Yl).convert(c2);
        ...
        let t3 = new en(h2, 4);
        e.geometry.setAttribute("__range" + this.id, t3), r2 = ql(t3).convert(c2);
      }
    } else r2 = ea(0);
    return r2;
  }
}).setParameterLength(2);
var u_ = class extends Qi {
  static get type() {
...
var d_ = (e, t2) => new u_(e, t2);
var h_ = d_("numWorkgroups", "uvec3");
var c_ = d_("workgroupId", "uvec3");
var p_ = d_("globalId", "uvec3");
var m_ = d_("localId", "uvec3");
var g_ = d_("subgroupSize", "uint");
var f_ = $s2(class extends Qi {
  constructor(e) {
...
x_.ATOMIC_LOAD = "atomicLoad", x_.ATOMIC_STORE = "atomicStore", x_.ATOMIC_ADD = "atomicAdd", x_.ATOMIC_SUB = "atomicSub", x_.ATOMIC_MAX = "atomicMax", x_.ATOMIC_MIN = "atomicMin", x_.ATOMIC_AND = "atomicAnd", x_.ATOMIC_OR = "atomicOr", x_.ATOMIC_XOR = "atomicXor";
var __ = $s2(x_);
var T_ = (e, t2, r2) => __(e, t2, r2).toStack();
var v_ = class extends es {
  static get type() {
  ...
  generateNodeType(e) {
    let t2 = this.method;
    return t2 === v_.SUBGROUP_ELECT ? "bool" : t2 === v_.SUBGROUP_BALLOT ? "uvec4" : this.getInputType(e);
  }
  generate(e, t2) {
    let r2 = this.method, i2 = this.getNodeType(e), s2 = this.getInputType(e), a2 = this.aNode, n2 = this.bNode, o2 = [];
    if (r2 === v_.SUBGROUP_BROADCAST || r2 === v_.SUBGROUP_SHUFFLE || r2 === v_.QUAD_BROADCAST) {
      let t3 = n2.getNodeType(e);
      o2.push(a2.build(e, i2), n2.build(e, "float" === t3 ? "int" : i2));
    } else r2 === v_.SUBGROUP_SHUFFLE_XOR || r2 === v_.SUBGROUP_SHUFFLE_DOWN || r2 === v_.SUBGROUP_SHUFFLE_UP ? o2.push(a2.build(e, i2), n2.build(e, "uint")) : (null !== a2 && o2.push(a2.build(e, s2)), null !== n2 && o2.push(n2.build(e, s2)));
...
v_.SUBGROUP_ELECT = "subgroupElect", v_.SUBGROUP_BALLOT = "subgroupBallot", v_.SUBGROUP_ADD = "subgroupAdd", v_.SUBGROUP_INCLUSIVE_ADD = "subgroupInclusiveAdd", v_.SUBGROUP_EXCLUSIVE_AND = "subgroupExclusiveAdd", v_.SUBGROUP_MUL = "subgroupMul", v_.SUBGROUP_INCLUSIVE_MUL = "subgroupInclusiveMul", v_.SUBGROUP_EXCLUSIVE_MUL = "subgroupExclusiveMul", v_.SUBGROUP_AND = "subgroupAnd", v_.SUBGROUP_OR = "subgroupOr", v_.SUBGROUP_XOR = "subgroupXor", v_.SUBGROUP_MIN = "subgroupMin", v_.SUBGROUP_MAX = "subgroupMax", v_.SUBGROUP_ALL = "subgroupAll", v_.SUBGROUP_ANY = "subgroupAny", v_.SUBGROUP_BROADCAST_FIRST = "subgroupBroadcastFirst", v_.QUAD_SWAP_X = "quadSwapX", v_.QUAD_SWAP_Y = "quadSwapY", v_.QUAD_SWAP_DIAGONAL = "quadSwapDiagonal", v_.SUBGROUP_BROADCAST = "subgroupBroadcast", v_.SUBGROUP_SHUFFLE = "subgroupShuffle", v_.SUBGROUP_SHUFFLE_XOR = "subgroupShuffleXor", v_.SUBGROUP_SHUFFLE_UP = "subgroupShuffleUp", v_.SUBGROUP_SHUFFLE_DOWN = "subgroupShuffleDown", v_.QUAD_BROADCAST = "quadBroadcast";
var N_;
var S_ = Ws(v_, v_.SUBGROUP_ELECT).setParameterLength(0);
var w_ = Ws(v_, v_.SUBGROUP_BALLOT).setParameterLength(1);
var E_ = Ws(v_, v_.SUBGROUP_ADD).setParameterLength(1);
var A_ = Ws(v_, v_.SUBGROUP_INCLUSIVE_ADD).setParameterLength(1);
var R_ = Ws(v_, v_.SUBGROUP_EXCLUSIVE_AND).setParameterLength(1);
var C_ = Ws(v_, v_.SUBGROUP_MUL).setParameterLength(1);
var M_ = Ws(v_, v_.SUBGROUP_INCLUSIVE_MUL).setParameterLength(1);
var B_ = Ws(v_, v_.SUBGROUP_EXCLUSIVE_MUL).setParameterLength(1);
var F_ = Ws(v_, v_.SUBGROUP_AND).setParameterLength(1);
var P_ = Ws(v_, v_.SUBGROUP_OR).setParameterLength(1);
var L_ = Ws(v_, v_.SUBGROUP_XOR).setParameterLength(1);
var U_ = Ws(v_, v_.SUBGROUP_MIN).setParameterLength(1);
var D_ = Ws(v_, v_.SUBGROUP_MAX).setParameterLength(1);
var O_ = Ws(v_, v_.SUBGROUP_ALL).setParameterLength(0);
var I_ = Ws(v_, v_.SUBGROUP_ANY).setParameterLength(0);
var V_ = Ws(v_, v_.SUBGROUP_BROADCAST_FIRST).setParameterLength(2);
var k_ = Ws(v_, v_.QUAD_SWAP_X).setParameterLength(1);
var G_ = Ws(v_, v_.QUAD_SWAP_Y).setParameterLength(1);
var $_ = Ws(v_, v_.QUAD_SWAP_DIAGONAL).setParameterLength(1);
var z_ = Ws(v_, v_.SUBGROUP_BROADCAST).setParameterLength(2);
var W_ = Ws(v_, v_.SUBGROUP_SHUFFLE).setParameterLength(2);
var H_ = Ws(v_, v_.SUBGROUP_SHUFFLE_XOR).setParameterLength(2);
var q_ = Ws(v_, v_.SUBGROUP_SHUFFLE_UP).setParameterLength(2);
var j_ = Ws(v_, v_.SUBGROUP_SHUFFLE_DOWN).setParameterLength(2);
var X_ = Ws(v_, v_.QUAD_BROADCAST).setParameterLength(1);
function K_(e) {
  let t2 = (N_ = N_ || /* @__PURE__ */ new WeakMap()).get(e);
  return void 0 === t2 && N_.set(e, t2 = {}), t2;
}
function Y_(e) {
  let t2 = K_(e);
...
var tT = (e) => fd.transformDirection(Z_(e).sub(J_(e)));
var rT = va("vec3", "totalDiffuse");
var iT = va("vec3", "totalSpecular");
var sT = va("vec3", "outgoingLight");
var aT = (e, t2) => {
...
var oT = [];
var lT = class extends Qi {
  static get type() {
    return "LightsNode";
  }
  constructor() {
    super("vec3"), this.totalDiffuseNode = rT, this.totalSpecularNode = iT, this.outgoingLightNode = sT, this._lights = [], this.global = true;
  }
  customCacheKey() {
    let e = this._lights;
    for (let t3 = 0; t3 < e.length; t3++) {
      let r2 = e[t3];
      if (oT.push(r2.id), oT.push(r2.castShadow ? 1 : 0), true === r2.isSpotLight) {
        let e2 = null !== r2.map ? r2.map.id : -1, t4 = r2.colorNode ? r2.colorNode.getCacheKey() : -1;
        oT.push(e2, t4);
      }
    }
    let t2 = Mi2(oT);
    return oT.length = 0, t2;
  }
  getHash(e) {
    let t2 = e.getDataFromNode(this);
...
var uT = class extends Qi {
  ...
  setupShadowPosition({ context: e, material: t2 }) {
    dT.assign(t2.receivedShadowPositionNode || e.shadowPositionWorld || qd);
  }
};
var dT = va("vec3", "shadowPositionWorld");
function hT(e, t2 = {}) {
...
function cT(e, t2) {
  return t2 = hT(e, t2), e.setMRT(null), e.setRenderObjectFunction(null), e.setClearColor(0, 1), e.autoClear = true, t2;
}
function pT(e, t2) {
...
function gT(e, t2) {
  return t2 = mT(e, t2), e.background = null, e.backgroundNode = null, e.overrideMaterial = null, t2;
}
function fT(e, t2) {
...
var xT;
var _T = Object.freeze({ __proto__: null, resetRendererAndSceneState: bT, resetRendererState: cT, resetSceneState: gT, restoreRendererAndSceneState: yT, restoreRendererState: pT, restoreSceneState: fT, saveRendererAndSceneState: function(e, t2, r2 = {}) {
  return mT(t2, r2 = hT(e, r2));
}, saveRendererState: hT, saveSceneState: mT });
var TT = /* @__PURE__ */ new WeakMap();
var vT = Xs(({ depthTexture: e, shadowCoord: t2, depthLayer: r2 }) => {
  let i2 = Pu(e, t2.xy).setName("t_basic");
  return e.isArrayTexture && (i2 = i2.depth(r2)), i2.compare(t2.z);
});
var NT = Xs(({ depthTexture: e, shadowCoord: t2, shadow: r2, depthLayer: i2 }) => {
  let s2 = (t3, r3) => {
    let s3 = Pu(e, t3);
    return e.isArrayTexture && (s3 = s3.depth(i2)), s3.compare(r3);
  }, a2 = wh("mapSize", "vec2", r2).setGroup(nn), n2 = wh("radius", "float", r2).setGroup(nn), o2 = sa(1).div(a2), l2 = n2.mul(o2.x), u2 = rx(Hu.xy).mul(6.28318530718);
  return bn2(s2(t2.xy.add(ix(0, 5, u2).mul(l2)), t2.z), s2(t2.xy.add(ix(1, 5, u2).mul(l2)), t2.z), s2(t2.xy.add(ix(2, 5, u2).mul(l2)), t2.z), s2(t2.xy.add(ix(3, 5, u2).mul(l2)), t2.z), s2(t2.xy.add(ix(4, 5, u2).mul(l2)), t2.z)).mul(0.2);
});
...
var wT = Xs(({ depthTexture: e, shadowCoord: t2, depthLayer: r2 }, i2) => {
...
var ET = (e) => {
  let t2 = TT.get(e);
  return void 0 === t2 && (t2 = new im(), t2.colorNode = ca(0, 0, 0, 1), t2.isShadowPassMaterial = true, t2.name = "ShadowMaterial", t2.blending = p, t2.fog = false, TT.set(e, t2)), t2;
};
var AT = (e) => {
  let t2 = TT.get(e);
  void 0 !== t2 && (t2.dispose(), TT.delete(e));
};
var RT = new Qf();
var CT = [];
var MT = (e, t2, r2, i2) => {
  ...
  }, s2.shadowType = r2, s2.useVelocity = i2, RT.set(CT, s2)), CT[0] = null, CT[1] = null, s2;
};
var BT = Xs(({ samples: e, radius: t2, size: r2, shadowPass: i2, depthLayer: s2 }) => {
...
var UT = class extends uT {
  ...
  setupShadow(e) {
    ...
    if (o2 !== n && o2 !== h || !l2 ? (a2.minFilter = dt, a2.magFilter = dt) : (a2.minFilter = ft, a2.magFilter = ft), s2.camera.coordinateSystem = r2.coordinateSystem, s2.camera.updateProjectionMatrix(), o2 === o && true !== s2.isPointLightShadow) {
      ...
      u3.fragmentNode = BT({ samples: i3, radius: o3, size: l3, shadowPass: t3, depthLayer: this.depthLayer }).context(e.getSharedContext()), u3.name = "VSMVertical", u3 = this.vsmMaterialHorizontal || (this.vsmMaterialHorizontal = new im()), u3.fragmentNode = FT({ samples: i3, radius: o3, size: l3, shadowPass: r3, depthLayer: this.depthLayer }).context(e.getSharedContext()), u3.name = "VSMHorizontal";
    }
    let u2, h2 = wh("intensity", "float", s2).setGroup(nn), c2 = wh("normalBias", "float", s2).setGroup(nn), p2 = Y_(i2), m2 = ah.mul(c2);
    u2 = !t2.highPrecision || e.material.receivedShadowPositionNode || e.context.shadowPositionWorld ? p2.mul(dT.add(m2)) : un("mat4").onObjectUpdate(({ object: e2 }, t3) => t3.value.multiplyMatrices(p2.value, e2.matrixWorld)).mul(Wd).add(p2.mul(ca(m2, 0)));
  ...
  updateShadow(e) {
    ...
    xT = bT(s2, a2, xT), a2.overrideMaterial = ET(r2), s2.setRenderObjectFunction(MT(s2, i2, o2, c2)), s2.setClearColor(0, 0), s2.setRenderTarget(t2), this.renderShadow(e), s2.setRenderObjectFunction(d2), o2 === o && true !== i2.isPointLightShadow && this.vsmPass(s2), i2.camera.layers.mask = u2, yT(s2, a2, xT);
  }
  vsmPass(e) {
    let { shadow: t2 } = this, r2 = this.shadowMap.depth;
    this.vsmShadowMapVertical.setSize(t2.mapSize.width, t2.mapSize.height, r2), this.vsmShadowMapHorizontal.setSize(t2.mapSize.width, t2.mapSize.height, r2), e.setRenderTarget(this.vsmShadowMapVertical), LT.material = this.vsmMaterialVertical, LT.render(e), e.setRenderTarget(this.vsmShadowMapHorizontal), LT.material = this.vsmMaterialHorizontal, LT.render(e);
  }
  dispose() {
...
var DT = (e, t2) => new UT(e, t2);
var OT = new rr();
var IT = new As();
var VT = new Ki();
var kT = new Ki();
var GT = [new Ki(1, 0, 0), new Ki(-1, 0, 0), new Ki(0, -1, 0), new Ki(0, 1, 0), new Ki(0, 0, 1), new Ki(0, 0, -1)];
var $T = [new Ki(0, -1, 0), new Ki(0, -1, 0), new Ki(0, 0, -1), new Ki(0, 0, 1), new Ki(0, -1, 0), new Ki(0, -1, 0)];
var zT = [new Ki(1, 0, 0), new Ki(-1, 0, 0), new Ki(0, 1, 0), new Ki(0, -1, 0), new Ki(0, 0, 1), new Ki(0, 0, -1)];
var WT = [new Ki(0, -1, 0), new Ki(0, -1, 0), new Ki(0, 0, 1), new Ki(0, 0, -1), new Ki(0, -1, 0), new Ki(0, -1, 0)];
var HT = Xs(({ depthTexture: e, bd3D: t2, dp: r2 }) => vh(e, t2).compare(r2));
var qT = Xs(({ depthTexture: e, bd3D: t2, dp: r2, shadow: i2 }) => {
  let s2 = wh("radius", "float", i2).setGroup(nn), a2 = wh("mapSize", "vec2", i2).setGroup(nn), n2 = s2.div(a2.x), o2 = vo(t2), l2 = oo(zo(t2, o2.x.greaterThan(o2.z).select(la(0, 1, 0), la(1, 0, 0)))), u2 = zo(t2, l2), d2 = rx(Hu.xy).mul(6.28318530718), h2 = ix(0, 5, d2), c2 = ix(1, 5, d2), p2 = ix(2, 5, d2), m2 = ix(3, 5, d2), g2 = ix(4, 5, d2);
...
var jT = Xs(({ filterFn: e, depthTexture: t2, shadowCoord: r2, shadow: i2 }, s2) => {
...
var XT = class extends UT {
  ...
  setupShadowFilter(e, { filterFn: t2, depthTexture: r2, shadowCoord: i2, shadow: s2 }) {
    return jT({ filterFn: t2, depthTexture: r2, shadowCoord: i2, shadow: s2 });
  }
  setupRenderTarget(e, t2) {
  ...
  renderShadow(e) {
    let { shadow: t2, shadowMap: r2, light: i2 } = this, { renderer: s2, scene: a2 } = e, n2 = t2.camera, o2 = t2.matrix, l2 = s2.coordinateSystem === Mi, u2 = l2 ? GT : zT, d2 = l2 ? $T : WT;
    r2.setSize(t2.mapSize.width, t2.mapSize.width);
    let h2 = s2.autoClear, c2 = s2.getClearColor(OT), p2 = s2.getClearAlpha();
    ...
    for (let e2 = 0; e2 < 6; e2++) {
      ...
      l3 !== n2.far && (n2.far = l3, n2.updateProjectionMatrix()), VT.setFromMatrixPosition(i2.matrixWorld), n2.position.copy(VT), kT.copy(n2.position), kT.add(u2[e2]), n2.up.copy(d2[e2]), n2.lookAt(kT), n2.updateMatrixWorld(), o2.makeTranslation(-VT.x, -VT.y, -VT.z), IT.multiplyMatrices(n2.projectionMatrix, n2.matrixWorldInverse), t2._frustum.setFromProjectionMatrix(IT, n2.coordinateSystem, n2.reversedDepth);
      let h3 = a2.name;
...
var KT = (e, t2) => new XT(e, t2);
var YT = class extends Rp {
  static get type() {
  ...
  getLightVector(e) {
    return eT(this.light).sub(e.context.positionView || Xd);
  }
  setupDirect() {
  }
  setupDirectRectArea() {
...
var QT = Xs(({ lightDistance: e, cutoffDistance: t2, decayExponent: r2 }) => {
  let i2 = e.pow(r2).max(0.01).reciprocal();
  return t2.greaterThan(0).select(i2.mul(e.div(t2).pow4().oneMinus().clamp().pow2()), i2);
});
var ZT = ({ color: e, lightVector: t2, cutoffDistance: r2, decayExponent: i2 }) => {
  let s2 = t2.normalize(), a2 = t2.length(), n2 = QT({ lightDistance: a2, cutoffDistance: r2, decayExponent: i2 });
...
var JT = class extends YT {
  ...
  setupShadowNode() {
    return KT(this.light);
  }
  setupDirect(e) {
    return ZT({ color: this.colorNode, lightVector: this.getLightVector(e), cutoffDistance: this.cutoffDistanceNode, decayExponent: this.decayExponentNode });
  }
};
var ev = Xs(([e = Eu()]) => {
...
var tv = Xs(([e = Eu()], { renderer: t2, material: r2 }) => {
...
var av = Xs(([e, t2]) => {
  let r2 = ea(e).toVar();
  return t2.assign(sv(r2)), r2.sub(ea(t2));
});
var nv = Ty([Xs(([e, t2, r2, i2, s2, a2]) => {
...
var ov = Ty([Xs(([e, t2, r2, i2, s2, a2, n2, o2, l2, u2, d2]) => {
...
var lv = Ty([Xs(([e, t2, r2]) => {
  let i2 = ea(r2).toVar(), s2 = ea(t2).toVar(), a2 = ra(e).toVar(), n2 = ra(a2.bitAnd(ra(7))).toVar(), o2 = ea(rv(n2.lessThan(ra(4)), s2, i2)).toVar(), l2 = ea(xn2(2, rv(n2.lessThan(ra(4)), i2, s2))).toVar();
  return iv(o2, ia(n2.bitAnd(ra(1)))).add(iv(l2, ia(n2.bitAnd(ra(2)))));
  ...
  let s2 = ea(i2).toVar(), a2 = ea(r2).toVar(), n2 = ea(t2).toVar(), o2 = ra(e).toVar(), l2 = ra(o2.bitAnd(ra(15))).toVar(), u2 = ea(rv(l2.lessThan(ra(8)), n2, a2)).toVar(), d2 = ea(rv(l2.lessThan(ra(4)), a2, rv(l2.equal(ra(12)).or(l2.equal(ra(14))), n2, s2))).toVar();
  return iv(u2, ia(l2.bitAnd(ra(1)))).add(iv(d2, ia(l2.bitAnd(ra(2)))));
...
var uv = Ty([Xs(([e, t2, r2]) => {
  let i2 = ea(r2).toVar(), s2 = ea(t2).toVar(), a2 = da2(e).toVar();
  return la(lv(a2.x, s2, i2), lv(a2.y, s2, i2), lv(a2.z, s2, i2));
  ...
  return la(lv(o2.x, n2, a2, s2), lv(o2.y, n2, a2, s2), lv(o2.z, n2, a2, s2));
...
var gv = Xs(([e, t2, r2]) => {
  e.subAssign(r2), e.bitXorAssign(mv(r2, ta(4))), r2.addAssign(t2), t2.subAssign(e), t2.bitXorAssign(mv(e, ta(6))), e.addAssign(r2), r2.subAssign(t2), r2.bitXorAssign(mv(t2, ta(8))), t2.addAssign(e), e.subAssign(r2), e.bitXorAssign(mv(r2, ta(16))), r2.addAssign(t2), t2.subAssign(e), t2.bitXorAssign(mv(e, ta(19))), e.addAssign(r2), r2.subAssign(t2), r2.bitXorAssign(mv(t2, ta(4))), t2.addAssign(e);
});
var fv = Xs(([e, t2, r2]) => {
  let i2 = ra(r2).toVar(), s2 = ra(t2).toVar(), a2 = ra(e).toVar();
  return i2.bitXorAssign(s2), i2.subAssign(mv(s2, ta(14))), a2.bitXorAssign(i2), a2.subAssign(mv(i2, ta(11))), s2.bitXorAssign(a2), s2.subAssign(mv(a2, ta(25))), i2.bitXorAssign(s2), i2.subAssign(mv(s2, ta(16))), a2.bitXorAssign(i2), a2.subAssign(mv(i2, ta(4))), s2.bitXorAssign(a2), s2.subAssign(mv(a2, ta(14))), i2.bitXorAssign(s2), i2.subAssign(mv(s2, ta(24))), i2;
...
var xv = Ty([Xs(([e]) => {
  ...
  return a2.assign(n2.assign(o2.assign(ra(ta(3735928559)).add(s2.shiftLeft(ra(2))).add(ra(13))))), a2.addAssign(ra(i2)), n2.addAssign(ra(r2)), fv(a2, n2, o2);
  ...
  return o2.assign(l2.assign(u2.assign(ra(ta(3735928559)).add(n2.shiftLeft(ra(2))).add(ra(13))))), o2.addAssign(ra(a2)), l2.addAssign(ra(s2)), u2.addAssign(ra(i2)), fv(o2, l2, u2);
  ...
  return u2.assign(d2.assign(h2.assign(ra(ta(3735928559)).add(l2.shiftLeft(ra(2))).add(ra(13))))), u2.addAssign(ra(o2)), d2.addAssign(ra(n2)), h2.addAssign(ra(a2)), gv(u2, d2, h2), u2.addAssign(ra(s2)), fv(u2, d2, h2);
  ...
  return h2.assign(c2.assign(p2.assign(ra(ta(3735928559)).add(d2.shiftLeft(ra(2))).add(ra(13))))), h2.addAssign(ra(u2)), c2.addAssign(ra(l2)), p2.addAssign(ra(o2)), gv(h2, c2, p2), h2.addAssign(ra(n2)), c2.addAssign(ra(a2)), fv(h2, c2, p2);
...
var _v = Ty([Xs(([e, t2]) => {
  let r2 = ta(t2).toVar(), i2 = ta(e).toVar(), s2 = ra(xv(i2, r2)).toVar(), a2 = da2().toVar();
  ...
  let i2 = ta(r2).toVar(), s2 = ta(t2).toVar(), a2 = ta(e).toVar(), n2 = ra(xv(a2, s2, i2)).toVar(), o2 = da2().toVar();
...
var Tv = Ty([Xs(([e]) => {
  let t2 = sa(e).toVar(), r2 = ta().toVar(), i2 = ta().toVar(), s2 = ea(av(t2.x, r2)).toVar(), a2 = ea(av(t2.y, i2)).toVar(), n2 = ea(yv(s2)).toVar(), o2 = ea(yv(a2)).toVar(), l2 = ea(nv(lv(xv(r2, i2), s2, a2), lv(xv(r2.add(ta(1)), i2), s2.sub(1), a2), lv(xv(r2, i2.add(ta(1))), s2, a2.sub(1)), lv(xv(r2.add(ta(1)), i2.add(ta(1))), s2.sub(1), a2.sub(1)), n2, o2)).toVar();
  return cv(l2);
}).setLayout({ name: "mx_perlin_noise_float_0", type: "float", inputs: [{ name: "p", type: "vec2" }] }), Xs(([e]) => {
  let t2 = la(e).toVar(), r2 = ta().toVar(), i2 = ta().toVar(), s2 = ta().toVar(), a2 = ea(av(t2.x, r2)).toVar(), n2 = ea(av(t2.y, i2)).toVar(), o2 = ea(av(t2.z, s2)).toVar(), l2 = ea(yv(a2)).toVar(), u2 = ea(yv(n2)).toVar(), d2 = ea(yv(o2)).toVar(), h2 = ea(ov(lv(xv(r2, i2, s2), a2, n2, o2), lv(xv(r2.add(ta(1)), i2, s2), a2.sub(1), n2, o2), lv(xv(r2, i2.add(ta(1)), s2), a2, n2.sub(1), o2), lv(xv(r2.add(ta(1)), i2.add(ta(1)), s2), a2.sub(1), n2.sub(1), o2), lv(xv(r2, i2, s2.add(ta(1))), a2, n2, o2.sub(1)), lv(xv(r2.add(ta(1)), i2, s2.add(ta(1))), a2.sub(1), n2, o2.sub(1)), lv(xv(r2, i2.add(ta(1)), s2.add(ta(1))), a2, n2.sub(1), o2.sub(1)), lv(xv(r2.add(ta(1)), i2.add(ta(1)), s2.add(ta(1))), a2.sub(1), n2.sub(1), o2.sub(1)), l2, u2, d2)).toVar();
  return pv(h2);
}).setLayout({ name: "mx_perlin_noise_float_1", type: "float", inputs: [{ name: "p", type: "vec3" }] })]);
var vv = Ty([Xs(([e]) => {
  let t2 = sa(e).toVar(), r2 = ta().toVar(), i2 = ta().toVar(), s2 = ea(av(t2.x, r2)).toVar(), a2 = ea(av(t2.y, i2)).toVar(), n2 = ea(yv(s2)).toVar(), o2 = ea(yv(a2)).toVar(), l2 = la(nv(uv(_v(r2, i2), s2, a2), uv(_v(r2.add(ta(1)), i2), s2.sub(1), a2), uv(_v(r2, i2.add(ta(1))), s2, a2.sub(1)), uv(_v(r2.add(ta(1)), i2.add(ta(1))), s2.sub(1), a2.sub(1)), n2, o2)).toVar();
  return cv(l2);
}).setLayout({ name: "mx_perlin_noise_vec3_0", type: "vec3", inputs: [{ name: "p", type: "vec2" }] }), Xs(([e]) => {
  let t2 = la(e).toVar(), r2 = ta().toVar(), i2 = ta().toVar(), s2 = ta().toVar(), a2 = ea(av(t2.x, r2)).toVar(), n2 = ea(av(t2.y, i2)).toVar(), o2 = ea(av(t2.z, s2)).toVar(), l2 = ea(yv(a2)).toVar(), u2 = ea(yv(n2)).toVar(), d2 = ea(yv(o2)).toVar(), h2 = la(ov(uv(_v(r2, i2, s2), a2, n2, o2), uv(_v(r2.add(ta(1)), i2, s2), a2.sub(1), n2, o2), uv(_v(r2, i2.add(ta(1)), s2), a2, n2.sub(1), o2), uv(_v(r2.add(ta(1)), i2.add(ta(1)), s2), a2.sub(1), n2.sub(1), o2), uv(_v(r2, i2, s2.add(ta(1))), a2, n2, o2.sub(1)), uv(_v(r2.add(ta(1)), i2, s2.add(ta(1))), a2.sub(1), n2, o2.sub(1)), uv(_v(r2, i2.add(ta(1)), s2.add(ta(1))), a2, n2.sub(1), o2.sub(1)), uv(_v(r2.add(ta(1)), i2.add(ta(1)), s2.add(ta(1))), a2.sub(1), n2.sub(1), o2.sub(1)), l2, u2, d2)).toVar();
  return pv(h2);
}).setLayout({ name: "mx_perlin_noise_vec3_1", type: "vec3", inputs: [{ name: "p", type: "vec3" }] })]);
var Nv = Ty([Xs(([e]) => {
  let t2 = ea(e).toVar(), r2 = ta(sv(t2)).toVar();
  return bv(xv(r2));
}).setLayout({ name: "mx_cell_noise_float_0", type: "float", inputs: [{ name: "p", type: "float" }] }), Xs(([e]) => {
  let t2 = sa(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar();
  return bv(xv(r2, i2));
}).setLayout({ name: "mx_cell_noise_float_1", type: "float", inputs: [{ name: "p", type: "vec2" }] }), Xs(([e]) => {
  let t2 = la(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar(), s2 = ta(sv(t2.z)).toVar();
  return bv(xv(r2, i2, s2));
}).setLayout({ name: "mx_cell_noise_float_2", type: "float", inputs: [{ name: "p", type: "vec3" }] }), Xs(([e]) => {
  let t2 = ca(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar(), s2 = ta(sv(t2.z)).toVar(), a2 = ta(sv(t2.w)).toVar();
  return bv(xv(r2, i2, s2, a2));
}).setLayout({ name: "mx_cell_noise_float_3", type: "float", inputs: [{ name: "p", type: "vec4" }] })]);
var Sv = Ty([Xs(([e]) => {
  let t2 = ea(e).toVar(), r2 = ta(sv(t2)).toVar();
  return la(bv(xv(r2, ta(0))), bv(xv(r2, ta(1))), bv(xv(r2, ta(2))));
}).setLayout({ name: "mx_cell_noise_vec3_0", type: "vec3", inputs: [{ name: "p", type: "float" }] }), Xs(([e]) => {
  let t2 = sa(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar();
  return la(bv(xv(r2, i2, ta(0))), bv(xv(r2, i2, ta(1))), bv(xv(r2, i2, ta(2))));
}).setLayout({ name: "mx_cell_noise_vec3_1", type: "vec3", inputs: [{ name: "p", type: "vec2" }] }), Xs(([e]) => {
  let t2 = la(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar(), s2 = ta(sv(t2.z)).toVar();
  return la(bv(xv(r2, i2, s2, ta(0))), bv(xv(r2, i2, s2, ta(1))), bv(xv(r2, i2, s2, ta(2))));
}).setLayout({ name: "mx_cell_noise_vec3_2", type: "vec3", inputs: [{ name: "p", type: "vec3" }] }), Xs(([e]) => {
  let t2 = ca(e).toVar(), r2 = ta(sv(t2.x)).toVar(), i2 = ta(sv(t2.y)).toVar(), s2 = ta(sv(t2.z)).toVar(), a2 = ta(sv(t2.w)).toVar();
  return la(bv(xv(r2, i2, s2, a2, ta(0))), bv(xv(r2, i2, s2, a2, ta(1))), bv(xv(r2, i2, s2, a2, ta(2))));
}).setLayout({ name: "mx_cell_noise_vec3_3", type: "vec3", inputs: [{ name: "p", type: "vec4" }] })]);
var wv = Xs(([e, t2, r2, i2]) => {
  let s2 = ea(i2).toVar(), a2 = ea(r2).toVar(), n2 = ta(t2).toVar(), o2 = la(e).toVar(), l2 = ea(0).toVar(), u2 = ea(1).toVar();
  return Tp(n2, () => {
    l2.addAssign(u2.mul(Tv(o2))), u2.mulAssign(s2), o2.mulAssign(a2);
  }), l2;
...
var Av = Xs(([e, t2, r2, i2]) => {
  ...
  return sa(wv(o2, n2, a2, s2), wv(o2.add(la(ta(19), ta(193), ta(17))), n2, a2, s2));
...
var Rv = Xs(([e, t2, r2, i2]) => {
  let s2 = ea(i2).toVar(), a2 = ea(r2).toVar(), n2 = ta(t2).toVar(), o2 = la(e).toVar(), l2 = la(Ev(o2, n2, a2, s2)).toVar(), u2 = ea(wv(o2.add(la(ta(19), ta(193), ta(17))), n2, a2, s2)).toVar();
  return ca(l2, u2);
...
var Cv = Ty([Xs(([e, t2, r2, i2, s2, a2, n2]) => {
  let o2 = ta(n2).toVar(), l2 = ea(a2).toVar(), u2 = ta(s2).toVar(), d2 = ta(i2).toVar(), h2 = ta(r2).toVar(), c2 = ta(t2).toVar(), p2 = sa(e).toVar(), m2 = la(Sv(sa(c2.add(d2), h2.add(u2)))).toVar(), g2 = sa(m2.x, m2.y).toVar();
  ...
  let u2 = ta(l2).toVar(), d2 = ea(o2).toVar(), h2 = ta(n2).toVar(), c2 = ta(a2).toVar(), p2 = ta(s2).toVar(), m2 = ta(i2).toVar(), g2 = ta(r2).toVar(), f2 = ta(t2).toVar(), b2 = la(e).toVar(), y2 = la(Sv(la(f2.add(p2), g2.add(c2), m2.add(h2)))).toVar();
...
var Mv = Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = sa(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = sa(av(a2.x, n2), av(a2.y, o2)).toVar(), u2 = ea(1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      let r3 = ea(Cv(l2, e2, t3, n2, o2, s2, i2)).toVar();
      u2.assign(Do(u2, r3));
    });
  }), Qs(i2.equal(ta(0)), () => {
    u2.assign(io2(u2));
...
var Bv = Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = sa(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = sa(av(a2.x, n2), av(a2.y, o2)).toVar(), u2 = sa(1e6, 1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      let r3 = ea(Cv(l2, e2, t3, n2, o2, s2, i2)).toVar();
      Qs(r3.lessThan(u2.x), () => {
...
var Fv = Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = sa(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = sa(av(a2.x, n2), av(a2.y, o2)).toVar(), u2 = la(1e6, 1e6, 1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      let r3 = ea(Cv(l2, e2, t3, n2, o2, s2, i2)).toVar();
      Qs(r3.lessThan(u2.x), () => {
...
var Pv = Ty([Mv, Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = la(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = ta().toVar(), u2 = la(av(a2.x, n2), av(a2.y, o2), av(a2.z, l2)).toVar(), d2 = ea(1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      Tp({ start: -1, end: ta(1), name: "z", condition: "<=" }, ({ z: r3 }) => {
        let a3 = ea(Cv(u2, e2, t3, r3, n2, o2, l2, s2, i2)).toVar();
        d2.assign(Do(d2, a3));
      });
    });
  }), Qs(i2.equal(ta(0)), () => {
...
var Lv = Ty([Bv, Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = la(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = ta().toVar(), u2 = la(av(a2.x, n2), av(a2.y, o2), av(a2.z, l2)).toVar(), d2 = sa(1e6, 1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      Tp({ start: -1, end: ta(1), name: "z", condition: "<=" }, ({ z: r3 }) => {
        let a3 = ea(Cv(u2, e2, t3, r3, n2, o2, l2, s2, i2)).toVar();
...
var Uv = Ty([Fv, Xs(([e, t2, r2]) => {
  let i2 = ta(r2).toVar(), s2 = ea(t2).toVar(), a2 = la(e).toVar(), n2 = ta().toVar(), o2 = ta().toVar(), l2 = ta().toVar(), u2 = la(av(a2.x, n2), av(a2.y, o2), av(a2.z, l2)).toVar(), d2 = la(1e6, 1e6, 1e6).toVar();
  return Tp({ start: -1, end: ta(1), name: "x", condition: "<=" }, ({ x: e2 }) => {
    Tp({ start: -1, end: ta(1), name: "y", condition: "<=" }, ({ y: t3 }) => {
      Tp({ start: -1, end: ta(1), name: "z", condition: "<=" }, ({ z: r3 }) => {
        let a3 = ea(Cv(u2, e2, t3, r3, n2, o2, l2, s2, i2)).toVar();
...
var Dv = Xs(([e, t2, r2, i2, s2, a2, n2, o2, l2, u2, d2]) => {
  ...
  return Qs(h2.equal(ta(0)), () => {
    ...
    N2.assign(Uv(v2, g2, ta(0)));
  }), Qs(h2.equal(ta(3)), () => {
    N2.assign(Ev(la(v2, 0), x2, _2, T2));
...
var $v = (e, t2, r2, i2) => Jo2(e, t2, r2[i2].clamp());
var zv = (e, t2, r2, i2, s2) => Jo2(e, t2, Gv(r2, i2[s2]));
var Wv = Xs(([e, t2, r2]) => {
...
var qv = Object.freeze({ __proto__: null, BRDF_GGX: Km, BRDF_Lambert: Lm, BasicPointShadowFilter: HT, BasicShadowFilter: vT, Break: vp, Const: vl, Continue: () => hu("continue").toStack(), DFGLUT: Zm, D_GGX: qm, Discard: cu, EPSILON: zn, F_Schlick: Pm, Fn: Xs, HALF_PI: Xn, INFINITY: Wn2, If: Qs, Loop: Tp, NodeAccess: Wi, NodeShaderStage: $i, NodeType: { BOOLEAN: "bool", INTEGER: "int", FLOAT: "float", VECTOR2: "vec2", VECTOR3: "vec3", VECTOR4: "vec4", MATRIX2: "mat2", MATRIX3: "mat3", MATRIX4: "mat4" }, NodeUpdateType: zi2, OnBeforeFrameUpdate: (e) => Yc(Kc.BEFORE_FRAME, e), OnBeforeMaterialUpdate: (e) => Yc(Kc.BEFORE_MATERIAL, e), OnBeforeObjectUpdate: (e) => Yc(Kc.BEFORE_OBJECT, e), OnFrameUpdate: Zc, OnMaterialUpdate: (e) => Yc(Kc.MATERIAL, e), OnObjectUpdate: Qc, PCFShadowFilter: NT, PCFSoftShadowFilter: ST, PI: Hn, PI2: qn, PointShadowFilter: qT, Return: () => hu("return").toStack(), Schlick_to_F0: tg, ShaderNode: Os, Stack: Zs, Switch: (...e) => ds.Switch(...e), TBNViewMatrix: Zh2, TWO_PI: jn, VSMShadowFilter: wT, V_GGX_SmithCorrelated: Wm, Var: Tl, VarIntent: Nl, abs: vo, acesFilmicToneMapping: Hx, acos: yo, acosh: xo, add: bn2, addMethodChaining: cs, addNodeElement: function(e) {
  Oi("TSL: AddNodeElement has been removed in favor of tree-shaking. Trying add", e);
}, agxToneMapping: Kx, all: Kn, alphaT: Da, ambientOcclusion: en2, and: Rn, anisotropy: Oa, anisotropyB: Va2, anisotropyT: Ia, any: Yn, append: (e) => (Oi("TSL: append() has been renamed to Stack().", new Ai()), Zs(e)), array: hn, asin: fo, asinh: bo, assign: cn, atan: _o, atanh: To, atomicAdd: (e, t2) => T_(x_.ATOMIC_ADD, e, t2), atomicAnd: (e, t2) => T_(x_.ATOMIC_AND, e, t2), atomicFunc: T_, atomicLoad: (e) => T_(x_.ATOMIC_LOAD, e, null), atomicMax: (e, t2) => T_(x_.ATOMIC_MAX, e, t2), atomicMin: (e, t2) => T_(x_.ATOMIC_MIN, e, t2), atomicOr: (e, t2) => T_(x_.ATOMIC_OR, e, t2), atomicStore: (e, t2) => T_(x_.ATOMIC_STORE, e, t2), atomicSub: (e, t2) => T_(x_.ATOMIC_SUB, e, t2), atomicXor: (e, t2) => T_(x_.ATOMIC_XOR, e, t2), attenuationColor: Za2, attenuationDistance: Qa2, attribute: wu, attributeArray: (e, t2 = "float") => {
  let r2, i2;
  true === t2.isStructTypeNode ? (r2 = t2.getLength(), i2 = Ui("float")) : (r2 = Di(t2), i2 = Ui(t2));
  let s2 = new nx(e, r2, i2);
  return tp(s2, t2, e);
}, backgroundBlurriness: ux, backgroundIntensity: dx, backgroundRotation: hx, batch: cp, batchColor: hp, bentNormalView: ec, billboarding: Ay, bitAnd: Fn, bitNot: Pn, bitOr: Ln2, bitXor: Un, bitangentGeometry: Xh, bitangentLocal: Kh, bitangentView: Yh, bitangentWorld: Qh, bitcast: ey, blendBurn: vx, blendColor: Ex, blendDodge: Nx, blendOverlay: wx, blendScreen: Sx, blur: ef, bool: ia, buffer: Du, bufferAttribute: Hl, builtin: ku, builtinAOContext: bl, builtinShadowContext: fl, bumpMap: oc, bvec2: oa2, bvec3: ha2, bvec4: ga, bypass: ou, cache: nu, call: mn2, cameraFar: pd, cameraIndex: hd, cameraNear: cd, cameraNormalMatrix: yd, cameraPosition: xd, cameraProjectionMatrix: md, cameraProjectionMatrixInverse: gd, cameraViewMatrix: fd, cameraViewport: _d, cameraWorldMatrix: bd, cbrt: Qo, cdl: Fx, ceil: no2, checker: ev, cineonToneMapping: zx, clamp: el, clearcoat: Ca, clearcoatNormalView: nh, clearcoatRoughness: Ma, clipSpace: $d, code: Zx, color: Js, colorSpaceToWorking: Pl, colorToDirection: (e) => (Ni('TSL: "colorToDirection()" has been renamed to "unpackRGBToNormal()".'), rc(e)), compute: iu, computeKernel: ru, computeSkinning: xp, context: pl, convert: _a, convertColorSpace: (e, t2, r2) => new Bl(Is(e), t2, r2), convertToTexture: (e, ...t2) => e.isSampleNode || e.isTextureNode ? e : e.isPassNode ? e.getTextureNode() : Zy(e, ...t2), cos: co2, cosh: po, countLeadingZeros: ay, countOneBits: ny, countTrailingZeros: sy, cross: zo, cubeTexture: vh, cubeTextureBase: Th, dFdx: Ao, dFdy: Ro, dashSize: Ha, debug: yu, decrement: Gn, decrementBefore: Vn2, defaultBuildStages: qi, defaultShaderStages: Hi, defined: Us, degrees: Zn, deltaTime: Ny, densityFogFactor: i_, depth: Xp, depthPass: (e, t2, r2) => new Vx(Vx.DEPTH, e, t2, r2), determinant: Lo, difference: Go, diffuseColor: Sa, diffuseContribution: wa, directPointLight: ZT, directionToColor: (e) => (Ni('TSL: "directionToColor()" has been renamed to "packNormalToRGB()".'), tc(e)), directionToFaceDirection: (e) => (Ni('TSL: "directionToFaceDirection()" has been renamed to "negateOnBackSide()".'), Zd(e)), dispersion: Ja, disposeShadowMaterial: AT, distance: ko, div: _n, dot: $o, drawIndex: eu, dynamicBufferAttribute: (e, t2 = null, r2 = 0, i2 = 0) => Wl(e, t2, r2, i2, xi), element: xa, emissive: Ea, equal: vn, equirectDirection: Tm, equirectUV: _m, exp: Jn, exp2: eo, exponentialHeightFogFactor: s_, expression: hu, faceDirection: Qd, faceForward: sl, faceforward: ul2, float: ea, floatBitsToInt: (e) => new Jb(e, "int", "float"), floatBitsToUint: ty, floor: ao2, fog: a_, fract: lo, frameGroup: an, frameId: Sy, frontFacing: Yd, fwidth: Fo, gain: (e, t2) => e.lessThan(0.5) ? ly(e.mul(2), t2).div(2) : yn(1, ly(xn2(yn(1, e), 2), t2).div(2)), gapSize: qa, getConstNodeType: Ds, getCurrentStack: Ys, getDirection: Yg, getDistanceAttenuation: QT, getGeometryRoughness: $m, getNormalFromDepth: tx, getParallaxCorrectNormal: Wv, getRoughness: zm, getScreenPosition: ex, getShIrradianceAt: Hv, getShadowMaterial: ET, getShadowRenderObjectFunction: MT, getTextureIndex: Qb, getViewPosition: Jy, ggxConvolution: af, globalId: p_, glsl: (e, t2) => Zx(e, t2, "glsl"), glslFn: (e, t2) => e_(e, t2, "glsl"), grayscale: Ax, greaterThan: wn, greaterThanEqual: An, hash: oy, highpModelNormalViewMatrix: Gd, highpModelViewMatrix: kd, hue: Mx, increment: kn, incrementBefore: In, inspector: Tu, instance: op, instanceColor: np, instanceIndex: Yl, instancedArray: (e, t2 = "float") => {
  let r2, i2;
  true === t2.isStructTypeNode ? (r2 = t2.getLength(), i2 = Ui("float")) : (r2 = Di(t2), i2 = Ui(t2));
  let s2 = new ax(e, r2, i2);
  return tp(s2, t2, s2.count);
}, instancedBufferAttribute: ql, instancedDynamicBufferAttribute: jl, instancedMesh: lp, int: ta, intBitsToFloat: (e) => new Jb(e, "float", "int"), interleavedGradientNoise: rx, inverse: Uo, inverseSqrt: so2, inversesqrt: dl2, invocationLocalIndex: Jl2, invocationSubgroupIndex: Zl, ior: Xa, iridescence: Pa, iridescenceIOR: La, iridescenceThickness: Ua, isolate: au, ivec2: aa, ivec3: ua2, ivec4: pa2, js: (e, t2) => Zx(e, t2, "js"), label: yl, length: So, lengthSq: Zo, lessThan: Sn, lessThanEqual: En2, lightPosition: Z_, lightProjectionUV: Q_, lightShadowMatrix: Y_, lightTargetDirection: tT, lightTargetPosition: J_, lightViewPosition: eT, lightingContext: Mp, lights: (e = []) => new lT().setLights(e), linearDepth: Kp, linearToneMapping: Gx, localId: m_, log: to, log2: ro2, logarithmicDepthToViewZ: (e, t2, r2) => {
  let i2 = e.mul(to(r2.div(t2)));
  return ea(Math.E).pow(i2).mul(t2).negate();
}, luminance: Bx, mat2: fa, mat3: ba, mat4: ya, matcapUV: Of, materialAO: qc, materialAlphaTest: dc, materialAnisotropy: Cc, materialAnisotropyVector: jc, materialAttenuationColor: Oc, materialAttenuationDistance: Dc, materialClearcoat: Nc, materialClearcoatNormal: wc, materialClearcoatRoughness: Sc, materialColor: hc, materialDispersion: Wc, materialEmissive: pc, materialEnvIntensity: mh, materialEnvRotation: gh, materialIOR: Uc, materialIridescence: Mc, materialIridescenceIOR: Bc, materialIridescenceThickness: Fc, materialLightMap: Hc, materialLineDashOffset: $c, materialLineDashSize: Vc, materialLineGapSize: kc, materialLineScale: Ic, materialLineWidth: Gc, materialMetalness: Tc, materialNormal: vc, materialOpacity: mc, materialPointSize: zc, materialReference: Rh, materialReflectivity: xc, materialRefractionRatio: ph, materialRotation: Ec, materialRoughness: _c, materialSheen: Ac, materialSheenRoughness: Rc, materialShininess: cc, materialSpecular: gc, materialSpecularColor: bc, materialSpecularIntensity: fc, materialSpecularStrength: yc, materialThickness: Lc, materialTransmission: Pc, max: Oo, maxMipLevel: Ru, mediumpModelViewMatrix: Vd, metalness: Ra, min: Do, mix: Jo2, mixElement: nl2, mod: Tn, modelDirection: Md, modelNormalMatrix: Dd, modelPosition: Fd, modelRadius: Ud, modelScale: Pd, modelViewMatrix: Id, modelViewPosition: Ld, modelViewProjection: Xc, modelWorldMatrix: Bd, modelWorldMatrixInverse: Od, morphReference: Ap, mrt: Zb, mul: xn2, mx_aastep: Gv, mx_add: (e, t2 = ea(0)) => bn2(e, t2), mx_atan2: (e = ea(0), t2 = ea(1)) => _o(e, t2), mx_cell_noise_float: (e = Eu()) => Nv(e.convert("vec2|vec3")), mx_contrast: (e, t2 = 1, r2 = 0.5) => ea(e).sub(r2).mul(t2).add(r2), mx_divide: (e, t2 = ea(1)) => _n(e, t2), mx_fractal_noise_float: (e = Eu(), t2 = 3, r2 = 2, i2 = 0.5, s2 = 1) => wv(e, ta(t2), r2, i2).mul(s2), mx_fractal_noise_vec2: (e = Eu(), t2 = 3, r2 = 2, i2 = 0.5, s2 = 1) => Av(e, ta(t2), r2, i2).mul(s2), mx_fractal_noise_vec3: (e = Eu(), t2 = 3, r2 = 2, i2 = 0.5, s2 = 1) => Ev(e, ta(t2), r2, i2).mul(s2), mx_fractal_noise_vec4: (e = Eu(), t2 = 3, r2 = 2, i2 = 0.5, s2 = 1) => Rv(e, ta(t2), r2, i2).mul(s2), mx_frame: () => Sy, mx_heighttonormal: (e, t2) => (e = la(e), t2 = ea(t2), oc(e, t2)), mx_hsvtorgb: Iv, mx_ifequal: (e, t2, r2, i2) => e.equal(t2).mix(r2, i2), mx_ifgreater: (e, t2, r2, i2) => e.greaterThan(t2).mix(r2, i2), mx_ifgreatereq: (e, t2, r2, i2) => e.greaterThanEqual(t2).mix(r2, i2), mx_invert: (e, t2 = ea(1)) => yn(t2, e), mx_modulo: (e, t2 = ea(1)) => Tn(e, t2), mx_multiply: (e, t2 = ea(1)) => xn2(e, t2), mx_noise_float: (e = Eu(), t2 = 1, r2 = 0) => Tv(e.convert("vec2|vec3")).mul(t2).add(r2), mx_noise_vec3: (e = Eu(), t2 = 1, r2 = 0) => vv(e.convert("vec2|vec3")).mul(t2).add(r2), mx_noise_vec4: (e = Eu(), t2 = 1, r2 = 0) => (e = e.convert("vec2|vec3"), ca(vv(e), Tv(e.add(sa(19, 73)))).mul(t2).add(r2)), mx_place2d: (e, t2 = sa(0.5, 0.5), r2 = sa(1, 1), i2 = ea(0), s2 = sa(0, 0)) => {
  let a2 = e;
  ...
  return Jo2(o2, l2, n2);
}, mx_ramplr: (e, t2, r2 = Eu()) => $v(e, t2, r2, "x"), mx_ramptb: (e, t2, r2 = Eu()) => $v(e, t2, r2, "y"), mx_rgbtohsv: Vv, mx_rotate2d: (e, t2) => {
  e = sa(e);
  ...
  return e;
}, mx_splitlr: (e, t2, r2, i2 = Eu()) => zv(e, t2, r2, i2, "x"), mx_splittb: (e, t2, r2, i2 = Eu()) => zv(e, t2, r2, i2, "y"), mx_srgb_texture_to_lin_rec709: kv, mx_subtract: (e, t2 = ea(0)) => yn(e, t2), mx_timer: () => vy, mx_transform_uv: (e = 1, t2 = 0, r2 = Eu()) => r2.mul(e).add(t2), mx_unifiednoise2d: (e, t2 = Eu(), r2 = sa(1, 1), i2 = sa(0, 0), s2 = 1, a2 = 0, n2 = 1, o2 = false, l2 = 1, u2 = 2, d2 = 0.5) => Dv(e, t2.convert("vec2|vec3"), r2, i2, s2, a2, n2, o2, l2, u2, d2), mx_unifiednoise3d: (e, t2 = Eu(), r2 = sa(1, 1), i2 = sa(0, 0), s2 = 1, a2 = 0, n2 = 1, o2 = false, l2 = 1, u2 = 2, d2 = 0.5) => Ov(e, t2.convert("vec2|vec3"), r2, i2, s2, a2, n2, o2, l2, u2, d2), mx_worley_noise_float: (e = Eu(), t2 = 1) => Pv(e.convert("vec2|vec3"), t2, ta(1)), mx_worley_noise_vec2: (e = Eu(), t2 = 1) => Lv(e.convert("vec2|vec3"), t2, ta(1)), mx_worley_noise_vec3: (e = Eu(), t2 = 1) => Uv(e.convert("vec2|vec3"), t2, ta(1)), negate: wo, negateOnBackSide: Zd, neutralToneMapping: Yx, nodeArray: Gs, nodeImmutable: zs, nodeObject: Is, nodeObjectIntent: Vs, nodeObjects: ks, nodeProxy: $s2, nodeProxyConstructor: Hs, nodeProxyIntent: Ws, normalFlat: th, normalGeometry: Jd, normalLocal: eh, normalMap: sc, normalView: sh, normalViewGeometry: rh, normalWorld: ah, normalWorldGeometry: ih, normalize: oo, not: Mn2, notEqual: Nn2, numWorkgroups: h_, objectDirection: Nd, objectGroup: on, objectPosition: wd, objectRadius: Rd, objectScale: Ed, objectViewPosition: Ad, objectWorldMatrix: Sd, oneMinus: Eo, or: Cn, orthographicDepthToViewZ: $p, oscSawtooth: (e = vy) => e.fract(), oscSine: (e = vy) => e.add(0.75).mul(2 * Math.PI).sin().mul(0.5).add(0.5), oscSquare: (e = vy) => e.fract().round(), oscTriangle: (e = vy) => e.add(0.5).fract().mul(2).sub(1).abs(), output: Wa, outputStruct: jb, overloadingFn: Ty, overrideNode: kb, overrideNodes: Gb, packHalf2x16: cy, packNormalToRGB: tc, packSnorm2x16: dy, packUnorm2x16: hy, parabola: ly, parallaxDirection: Jh, parallaxUV: (e, t2) => e.sub(Jh.mul(t2)), parameter: (e, t2) => new $b(e, t2), pass: (e, t2, r2) => new Vx(Vx.COLOR, e, t2, r2), passTexture: (e, t2) => new Ox(e, t2), pcurve: (e, t2, r2) => Wo(_n(Wo(e, t2), bn2(Wo(e, t2), Wo(yn(1, e), r2))), 1 / t2), perspectiveDepthToViewZ: Hp, pmremTexture: Sf, pointShadow: KT, pointUV: ox, pointWidth: ja, positionGeometry: zd, positionLocal: Wd, positionPrevious: Hd, positionView: Xd, positionViewDirection: Kd, positionWorld: qd, positionWorldDirection: jd, posterize: Px, pow: Wo, pow2: Ho, pow3: qo, pow4: jo, premultiplyAlpha: pu, property: va, quadBroadcast: X_, quadSwapDiagonal: $_, quadSwapX: k_, quadSwapY: G_, radians: Qn, rand: al, range: l_, rangeFogFactor: r_, reciprocal: Mo, reference: wh, referenceBuffer: Eh, reflect: Vo, reflectVector: yh, reflectView: fh, reflector: (e) => new Hy(e), refract: rl2, refractVector: xh, refractView: bh, reinhardToneMapping: $x, remap: lu, remapClamp: uu, renderGroup: nn, renderOutput: fu, rendererReference: Ol, replaceDefaultUV: function(e, t2 = null) {
  return pl(t2, { getUV: "function" == typeof e ? e : () => e });
}, rotate: kf, rotateUV: wy, roughness: Aa, round: Co, rtt: Zy, sRGBTransferEOTF: Rl, sRGBTransferOETF: Cl, sample: (e, t2 = null) => new sx(e, Is(t2)), sampler: (e) => (true === e.isNode ? e : Pu(e)).convert("sampler"), samplerComparison: (e) => (true === e.isNode ? e : Pu(e)).convert("samplerComparison"), saturate: tl, saturation: Rx, screenCoordinate: Hu, screenDPR: $u, screenSize: Wu, screenUV: zu, select: hl2, setCurrentStack: Ks, setName: gl, shaderStages: ji, shadow: DT, shadowPositionWorld: dT, shapeCircle: tv, sharedUniformGroup: sn, sheen: Ba, sheenRoughness: Fa, shiftLeft: Dn2, shiftRight: On, shininess: za, sign: No, sin: uo2, sinc: (e, t2) => uo2(Hn.mul(t2.mul(e).sub(1))).div(Hn.mul(t2.mul(e).sub(1))), sinh: ho2, skinning: yp, smoothstep: il2, smoothstepElement: ol, specularColor: ka, specularColorBlended: Ga, specularF90: $a, spherizeUV: Ey, split: (e, t2) => new is(Is(e), t2), spritesheetUV: Cy, sqrt: io2, stack: zb, step: Io, stepElement: ll2, storage: tp, storageBarrier: () => f_("storage").toStack(), storageTexture: px, storageTexture3D: mx, struct: (e, t2 = null) => {
  let r2 = new Wb(e, t2);
  return Hs((...t3) => {
    let i2 = null;
...
}, sub: yn, subBuild: wl, subgroupAdd: E_, subgroupAll: O_, subgroupAnd: F_, subgroupAny: I_, subgroupBallot: w_, subgroupBroadcast: z_, subgroupBroadcastFirst: V_, subgroupElect: S_, subgroupExclusiveAdd: R_, subgroupExclusiveMul: B_, subgroupInclusiveAdd: A_, subgroupInclusiveMul: M_, subgroupIndex: Ql, subgroupMax: D_, subgroupMin: U_, subgroupMul: C_, subgroupOr: P_, subgroupShuffle: W_, subgroupShuffleDown: j_, subgroupShuffleUp: q_, subgroupShuffleXor: H_, subgroupSize: g_, subgroupXor: L_, tan: mo, tangentGeometry: zh, tangentLocal: Wh, tangentView: Hh, tangentWorld: qh2, tanh: go, texture: Pu, texture3D: fx, texture3DLevel: (e, t2, r2) => fx(e, t2).level(r2), texture3DLoad: (...e) => fx(...e).setSampler(false), textureBarrier: () => f_("texture").toStack(), textureBicubic: _g, textureBicubicLevel: xg, textureCubeUV: Qg, textureLevel: (e, t2, r2) => Pu(e, t2).level(r2), textureLoad: Lu, textureSize: Au, textureStore: (e, t2, r2) => {
  let i2;
  return true === e.isStorageTextureNode ? i2 = e.store(t2, r2) : (i2 = px(e, t2, r2), null !== r2 && i2.toStack()), i2;
}, thickness: Ya, time: vy, toneMapping: Vl, toneMappingExposure: kl, toonOutlinePass: (e, t2, r2 = new rr(0, 0, 0), i2 = 3e-3, s2 = 1) => new kx(e, t2, Is(r2), Is(i2), Is(s2)), transformDirection: Xo, transformNormal: oh, transformNormalByInverseViewMatrix: Yo, transformNormalByViewMatrix: Ko, transformNormalToView: lh, transformedClearcoatNormalView: hh, transformedNormalView: uh, transformedNormalWorld: dh, transmission: Ka, transpose: Po, triNoise3D: xy, triplanarTexture: (...e) => My(...e), triplanarTextures: My, trunc: Bo, uint: ra, uintBitsToFloat: (e) => new Jb(e, "float", "uint"), uniform: un, uniformArray: Vu, uniformCubeTexture: (e = _h) => Th(e), uniformFlow: ml, uniformGroup: rn, uniformTexture: (e = Mu) => Pu(e), unpackHalf2x16: fy, unpackNormal: ic, unpackRGBToNormal: rc, unpackSnorm2x16: my, unpackUnorm2x16: gy, unpremultiplyAlpha: mu2, userData: (e, t2, r2) => new bx(e, t2, r2), uv: Eu, uvec2: na, uvec3: da2, uvec4: ma, varying: El2, varyingProperty: Na, vec2: sa, vec3: la, vec4: ca, vectorComponents: Xi, velocity: Tx, vertexColor: rm, vertexIndex: Kl, vertexStage: Al, vibrance: Cx, viewZToLogarithmicDepth: qp, viewZToOrthographicDepth: Gp, viewZToPerspectiveDepth: zp, viewZToReversedOrthographicDepth: (e, t2, r2) => e.add(r2).div(r2.sub(t2)), viewZToReversedPerspectiveDepth: Wp, viewport: qu, viewportCoordinate: Xu, viewportDepthTexture: Vp, viewportLinearDepth: Yp, viewportMipTexture: Up, viewportOpaqueMipTexture: Op, viewportResolution: Yu, viewportSafeUV: Ry, viewportSharedTexture: Ux, viewportSize: ju, viewportTexture: Lp, viewportUV: Ku, vogelDiskSample: ix, wgsl: (e, t2) => Zx(e, t2, "wgsl"), wgslFn: (e, t2) => e_(e, t2, "wgsl"), workgroupArray: (e, t2) => new y_("Workgroup", e, t2), workgroupBarrier: () => f_("workgroup").toStack(), workgroupId: c_, workingToColorSpace: Fl, xor: Bn });
var jv = new Ib();
var Xv = class extends lb {
  constructor(e, t2) {
    super(), this.renderer = e, this.nodes = t2;
  }
  update(e, t2, r2) {
    let i2 = this.renderer, s2 = this.nodes.getBackgroundNode(e) || e.background, a2 = false;
    if (null === s2) i2._clearColor.getRGB(jv), jv.a = i2._clearColor.a;
    else if (true === s2.isColor) s2.getRGB(jv), jv.a = 1, a2 = true;
    else if (true === s2.isNode) {
      let r3 = this.get(e), a3 = s2;
      jv.copy(i2._clearColor);
      let n3 = r3.backgroundMesh;
      if (void 0 === n3) {
        let e2 = function() {
          s2.removeEventListener("dispose", e2), n3.material.dispose(), n3.geometry.dispose();
        }, t3 = ca(a3).mul(dx).context({ getUV: () => hx.mul(ih), getTextureLevel: () => ux }), i3 = md.element(3).element(3).equal(1), o3 = _n(1, md.element(1).element(1)).mul(3), l2 = i3.select(Wd.mul(o3), Wd), u2 = Id.mul(ca(l2, 0)), d2 = md.mul(ca(u2.xyz, 1));
        d2 = d2.setZ(d2.w);
        let h2 = new im();
      ...
      r3.backgroundCacheKey !== o2 && (r3.backgroundMeshNode.node = ca(a3).mul(dx), r3.backgroundMeshNode.needsUpdate = true, n3.material.needsUpdate = true, r3.backgroundCacheKey = o2), t2.unshift(n3, n3.geometry, n3.material, 0, 0, null, null);
    } else Pi("Renderer: Unsupported background configuration.", s2);
    let n2 = i2.xr.getEnvironmentBlendMode();
    if ("additive" === n2 ? jv.set(0, 0, 0, 1) : "alpha-blend" === n2 && jv.set(0, 0, 0, 0), true === i2.autoClear || true === a2) {
      let e2 = r2.clearColorValue;
      e2.r = jv.r, e2.g = jv.g, e2.b = jv.b, e2.a = jv.a, (true === i2.backend.isWebGLBackend || true === i2.alpha) && (e2.r *= e2.a, e2.g *= e2.a, e2.b *= e2.a), r2.depthClearValue = i2.getClearDepth(), r2.stencilClearValue = i2.getClearStencil(), r2.clearColor = true === i2.autoClearColor, r2.clearDepth = true === i2.autoClearDepth, r2.clearStencil = true === i2.autoClearStencil;
...
var Yv = class {
  constructor(e = "", t2 = []) {
    this.name = e, this.bindings = t2, this.id = Kv++;
  }
};
var Qv = class {
...
var sN = class {
  constructor(e = null) {
    this.id = iN++, this.nodesData = /* @__PURE__ */ new WeakMap(), this.parent = e;
  }
  getData(e) {
...
var cN = class extends nN {
  constructor(e, t2 = new Jl()) {
...
var MN = class {
  ...
  getOutputType(e = 0) {
    ...
    if (null !== r2) {
      ...
      i2 === _t ? a2 = "ivec" : i2 === At && (a2 = "uvec"), t2 = s2 === Ft || s2 === Lt ? i2 === _t ? "int" : i2 === At ? "uint" : "float" : s2 === Dt || s2 === Wt ? `${a2}2` : s2 === Nt || s2 === Ut ? `${a2}3` : `${a2}4`;
    }
    return t2;
  }
  getOutputStructName() {
  ...
  _getBindGroup(e, t2) {
    ...
    if (s2) {
      ...
      let s3 = this.renderer._currentRenderContext || this.renderer, a2 = SN.get(s3);
      void 0 === a2 && (a2 = /* @__PURE__ */ new Map(), SN.set(s3, a2));
      let n2 = Ci2(i3);
      r2 = a2.get(n2), void 0 === r2 && (r2 = new Yv(e, t2), a2.set(n2, r2));
    } else r2 = new Yv(e, t2);
    return r2;
  }
  ...
  getCacheFromNode(e, t2 = true) {
    ...
    return void 0 === r2.cache && (r2.cache = new sN(t2 ? this.getCache() : null)), r2.cache;
  }
  isAvailable() {
    return false;
  }
  ...
  hasWriteUsage(e) {
    ...
    if (void 0 !== r2) {
      for (let e2 in r2) if (CN(r2[e2])) return true;
    }
    return false;
  }
  generateTexture() {
  ...
  generateConst(e, t2 = null) {
    if (null === t2 && ("float" === e || "int" === e || "uint" === e ? t2 = 0 : "bool" === e ? t2 = false : "color" === e ? t2 = new rr() : "vec2" === e || "uvec2" === e || "ivec2" === e ? t2 = new Gi() : "vec3" === e || "uvec3" === e || "ivec3" === e ? t2 = new Ki() : ("vec4" === e || "uvec4" === e || "ivec4" === e) && (t2 = new vs())), "float" === e) return RN(t2);
    if ("int" === e) return `${Math.round(t2)}`;
    if ("uint" === e) return t2 >= 0 ? `${Math.round(t2)}u` : "0u";
    if ("bool" === e) return t2 ? "true" : "false";
    if ("color" === e) return `${this.getType("vec3")}( ${RN(t2.r)}, ${RN(t2.g)}, ${RN(t2.b)} )`;
  ...
  getBufferAttributeFromNode(e, t2, r2 = null) {
    ...
    if (void 0 === s2) {
      ...
      null === r2 && (r2 = "nodeAttribute" + a2), s2 = new Zv(r2, t2, e), this.bufferAttributes.push(s2), i2.bufferAttribute = s2;
    }
    return s2;
  }
  ...
  getStructTypeFromNode(e, t2, r2 = null, i2 = this.shaderStage) {
    ...
    if (void 0 === a2) {
      ...
      null === r2 && (r2 = "StructType" + n2), a2 = new aN(r2, t2), this.structs[i2].push(a2), this.types[i2][r2] = e, s2.structType = a2;
    }
    return a2;
  }
  ...
  getUniformFromNode(e, t2, r2 = this.shaderStage, i2 = null) {
    ...
    if (void 0 === a2) {
      ...
      a2 = new Jv(i2 || "nodeUniform" + n2, t2, e), this.uniforms[r2].push(a2), this.registerDeclaration(a2), s2.uniform = a2;
    }
    return a2;
  }
  getVarFromNode(e, t2 = null, r2 = e.getNodeType(this), i2 = this.shaderStage, s2 = false) {
    ...
    if (void 0 === o2) {
      ...
      o2 = new eN(t2, r2, s2, h2), s2 || u2.push(o2), this.registerDeclaration(o2), a2[n2] = o2;
    }
    return o2;
  }
  isDeterministic(e) {
  ...
  getVaryingFromNode(e, t2 = null, r2 = e.getNodeType(this), i2 = null, s2 = null) {
    ...
    if (void 0 === o2) {
      ...
      null === t2 && (t2 = "nodeVarying" + l2), "varying" !== n2 && (t2 = this.getSubBuildProperty(t2, a2.subBuilds)), o2 = new tN(t2, r2, i2, s2), e2.push(o2), this.registerDeclaration(o2), a2[n2] = o2;
    }
    return o2;
  }
  ...
  getCodeFromNode(e, t2, r2 = this.shaderStage) {
    ...
    if (void 0 === s2) {
      ...
      s2 = new rN("nodeCode" + a2, t2), e2.push(s2), i2.code = s2;
    }
    return s2;
  }
  ...
  buildFunctionNode(e) {
    let t2 = this.renderer.backend, r2 = wN.get(t2);
    void 0 === r2 && (r2 = /* @__PURE__ */ new WeakMap(), wN.set(t2, r2));
    let i2 = r2.get(e);
    if (void 0 === i2) {
      i2 = new Jx();
  ...
  flowShaderNode(e) {
    ...
    for (let e2 of t2.inputs) r2[e2.name] = new $b(e2.type, e2.name);
    e.layout = null;
  ...
  flowStagesNode(e, t2 = null) {
    ...
    this.flow = l2, this.vars = {}, this.declarations = {}, this.cache = new sN(), this.stack = zb();
...
`), this.flowCode[e] = this.flowCode[e] + s3.code, u2 = s3;
  ...
  getNodeUniform(e, t2) {
    ...
    if (void 0 === i2) {
      if ("float" === t2 || "int" === t2 || "uint" === t2) i2 = new gN(e);
      else if ("vec2" === t2 || "ivec2" === t2 || "uvec2" === t2) i2 = new fN(e);
      else if ("vec3" === t2 || "ivec3" === t2 || "uvec3" === t2) i2 = new bN(e);
      else if ("vec4" === t2 || "ivec4" === t2 || "uvec4" === t2) i2 = new yN(e);
      else if ("color" === t2) i2 = new xN(e);
      else if ("mat2" === t2) i2 = new _N(e);
      else if ("mat3" === t2) i2 = new TN(e);
      else {
...
var LN = class extends YT {
  ...
  setupDirect() {
    ...
    return { lightDirection: tT(this.light), lightColor: e };
  }
};
var UN = class extends YT {
  ...
  constructor(e = null) {
    super(e), this.lightPositionNode = Z_(e), this.lightDirectionNode = this.lightPositionNode.normalize(), this.groundColorNode = un(new rr()).setGroup(nn);
  }
  update(e) {
    let { light: t2 } = this;
...
var DN = class extends YT {
  ...
  getLightCoord(e) {
    ...
    return void 0 === r2 && (r2 = Q_(this.light, e.context.positionWorld), t2.projectionUV = r2), r2;
  }
  setupDirect(e) {
    let t2, r2, { colorNode: i2, cutoffDistanceNode: s2, decayExponentNode: a2, light: n2 } = this, o2 = this.getLightVector(e), l2 = o2.normalize(), u2 = l2.dot(tT(n2)), d2 = this.getSpotAttenuation(e, u2), h2 = o2.length(), c2 = QT({ lightDistance: h2, cutoffDistance: s2, decayExponent: a2 }), p2 = i2.mul(d2).mul(c2);
...
var kN = class extends DN {
  ...
  getSpotAttenuation(e) {
    let t2 = ea(0), r2 = this.penumbraCosNode, i2 = Y_(this.light).mul(e.context.positionWorld || qd);
    return Qs(i2.w.greaterThan(0), () => {
      let e2 = i2.xyz.div(i2.w), s2 = VN(e2.xy.sub(sa(0.5)), sa(0.5)), a2 = _n(-1, yn(1, yo(r2)).sub(1));
...
var WN = class extends YT {
  ...
  update(e) {
    ...
    $N.identity(), GN.copy(t2.matrixWorld), GN.premultiply(r2), $N.extractRotation(GN), this.halfWidth.value.set(0.5 * t2.width, 0, 0), this.halfHeight.value.set(0, 0.5 * t2.height, 0), this.halfWidth.value.applyMatrix4($N), this.halfHeight.value.applyMatrix4($N);
  }
  setupDirectRectArea(e) {
    let t2, r2;
    e.isAvailable("float32Filterable") ? (t2 = Pu(zN.LTC_FLOAT_1), r2 = Pu(zN.LTC_FLOAT_2)) : (t2 = Pu(zN.LTC_HALF_1), r2 = Pu(zN.LTC_HALF_2));
    let { colorNode: i2, light: s2 } = this;
    return { lightColor: i2, lightPosition: eT(s2), halfWidth: this.halfWidth, halfHeight: this.halfHeight, ltc_1: t2, ltc_2: r2 };
  }
  static setLTC(e) {
    zN = e;
  }
...
qN.isNodeFunction = true;
var jN = /^\s*(highp|mediump|lowp)?\s*([a-z_0-9]+)\s*([a-z_0-9]+)?\s*\(([\s\S]*?)\)/i;
var XN = /[a-z_0-9]+/gi;
var KN = class extends qN {
  constructor(e) {
    let { type: t2, inputs: r2, name: i2, precision: s2, inputsCode: a2, blockCode: n2, headerCode: o2 } = ((e2) => {
      let t3 = (e2 = e2.trim()).indexOf("#pragma main"), r3 = -1 !== t3 ? e2.slice(t3 + 12) : e2, i3 = r3.match(jN);
      if (null !== i3 && 5 === i3.length) {
        let s3 = i3[4], a3 = [], n3 = null;
        for (; null !== (n3 = XN.exec(s3)); ) a3.push(n3);
        let o3 = [], l2 = 0;
        for (; l2 < a3.length; ) {
...
var QN = [];
var ZN = [];
var JN = un(0, "int").setGroup(nn);
var eS = class extends lb {
  constructor(e, t2) {
    super(), this.renderer = e, this.backend = t2, this.nodeFrame = new BN(), this.nodeBuilderCache = /* @__PURE__ */ new Map(), this.callHashCache = new Qf(), this.groupsData = new Qf(), this.cacheLib = {};
  }
  updateGroup(e) {
    let t2 = e.groupNode;
    if (t2.updateType === zi2.OBJECT) return true;
    QN[0] = t2, QN[1] = e;
    let r2 = this.groupsData.get(QN);
    return void 0 === r2 && this.groupsData.set(QN, r2 = {}), QN[0] = null, QN[1] = null, r2.version !== t2.version && (r2.version = t2.version, true);
  }
    ...
    if (void 0 === r2) {
      ...
      if (r2 = i2.get(s2), void 0 === r2 && (r2 = this._spResurrectRetired(s2)), void 0 === r2) {
        ...
        try {
          ...
          !i3 && r3.stack && (i3 = new Ai(r3.stack)), Pi("TSL: " + r3, i3);
        }
  ...
  _createNodeBuilderState(e) {
    return new Qv(e.vertexShader, e.fragmentShader, e.computeShader, e.getAttributesArray(), e.getBindings(), e.updateNodes, e.updateBeforeNodes, e.updateAfterNodes, e.observer, e.hardwareClipping, e.transforms);
  }
  ...
  getCacheKey(e, t2) {
    QN[0] = e, QN[1] = t2;
    let r2 = this.renderer.info.calls, i2 = this.callHashCache.get(QN) || {};
    if (i2.callId !== r2) {
      if (ZN.push(this.renderer.getOutputRenderTarget() && this.renderer.getOutputRenderTarget().multiview ? 1 : 0), ZN.push(this.renderer.lighting.enabled ? 1 : 0), this.renderer.lighting.enabled) {
        ZN.push(t2.getCacheKey(true)), ZN.push(this.renderer.shadowMap.enabled ? 1 : 0), ZN.push(this.renderer.shadowMap.type);
        let r3 = this.getEnvironmentNode(e);
        r3 && ZN.push(r3.getCacheKey());
      }
      let s2 = this.getFogNode(e);
      s2 && ZN.push(s2.getCacheKey()), i2.callId = r2, i2.cacheKey = Mi2(ZN), this.callHashCache.set(QN, i2), ZN.length = 0;
    }
    return QN[0] = null, QN[1] = null, i2.cacheKey;
  }
  ...
  getOutputNode(e) {
    ...
    return t2 = e.isArrayTexture ? this.backend.isWebGLBackend ? Pu(e, zu).depth(ku("gl_ViewID_OVR")).renderOutput(r2.toneMapping, r2.currentColorSpace) : Pu(e, zu).depth(JN).renderOutput(r2.toneMapping, r2.currentColorSpace) : Pu(e, zu).renderOutput(r2.toneMapping, r2.currentColorSpace), t2;
  }
  ...
  dispose() {
    super.dispose(), this.nodeFrame = new BN(), this.nodeBuilderCache = /* @__PURE__ */ new Map(), this._spRetiredNodeStates = void 0, this.cacheLib = {};
  }
};
var tS = new mn();
var rS = class {
  ...
  projectPlanes(e, t2, r2) {
    ...
    for (let s2 = 0; s2 < i2; s2++) {
      tS.copy(e[s2]).applyMatrix4(this.viewMatrix, this.viewNormalMatrix);
      let i3 = t2[r2 + s2], a2 = tS.normal;
      i3.x = -a2.x, i3.y = -a2.y, i3.z = -a2.z, i3.w = tS.constant;
    }
  }
  updateGlobal(e, t2) {
  ...
  getGroupContext(e) {
    ...
    return void 0 === t2 && (t2 = new rS(this), this.clippingGroupContexts.set(e, t2)), t2.update(this, e), t2;
  }
...
var aS = class {
  ...
  get(e, t2, r2) {
    let i2 = this.bundles;
    sS[0] = e, sS[1] = t2, sS[2] = r2;
    let s2 = i2.get(sS);
    return void 0 === s2 && (s2 = new iS(e, t2, r2), i2.set(sS, s2)), sS[0] = null, sS[1] = null, sS[2] = null, s2;
  }
  dispose() {
    this.bundles = new Qf();
  }
...
var uS = class {
  ...
  createNode(e = []) {
    return new lT().setLights(e);
  }
  getNode(e) {
    if (true !== e.isScene && true !== e.isGroup) return oS;
    let t2 = lS.get(e);
    return void 0 === t2 && (t2 = this.createNode(), lS.set(e, t2)), t2;
  }
  beginRender(e) {
...
var xS = class {
  constructor(e, t2 = {}) {
    ...
    this.backend = e, this.autoClear = true, this.autoClearColor = true, this.autoClearDepth = true, this.autoClearStencil = true, this.alpha = s2, this.logarithmicDepthBuffer = r2, this.reversedDepthBuffer = i2, this.outputColorSpace = De, this.toneMapping = G, this.toneMappingExposure = 1, this.sortObjects = true, this.depth = a2, this.stencil = n2, this.info = new gb(), this.contextNode = pl(), this.library = new nS(), this.lighting = new uS(), this._samples = l2 || true === o2 ? 4 : 0, this._onCanvasTargetResize = this._onCanvasTargetResize.bind(this), this._canvasTarget = new dS(e.getDomElement()), this._canvasTarget.addEventListener("resize", this._onCanvasTargetResize), this._canvasTarget.isDefaultCanvasTarget = true, this._inspector = new xu(), this._inspector.setRenderer(this), this._getFallback = u2, this._attributes = null, this._geometries = null, this._nodes = null, this._animation = null, this._bindings = null, this._objects = null, this._pipelines = null, this._bundles = null, this._renderLists = null, this._renderContexts = null, this._textures = null, this._background = null, this._quadCache = /* @__PURE__ */ new Map(), this._currentRenderContext = null, this._opaqueSort = null, this._transparentSort = null, this._frameBufferTargets = /* @__PURE__ */ new Map();
    let m2 = true === this.alpha ? 0 : 1;
    this._clearColor = new Ib(0, 0, 0, m2), this._clearDepth = 1, this._clearStencil = 0, this._renderTarget = null, this._activeCubeFace = 0, this._activeMipmapLevel = 0, this._outputRenderTarget = null, this._mrt = null, this._renderObjectFunction = null, this._currentRenderObjectFunction = null, this._currentRenderBundle = null, this._handleObjectFunction = this._renderObjectDirect, this._isDeviceLost = false, this.onDeviceLost = this._onDeviceLost, this.onError = this._onError, this._outputBufferType = h2, this._cacheShadowNodes = /* @__PURE__ */ new WeakMap(), this._initialized = false, this._callDepth = -1, this._initPromise = null, this._asyncCompilation = true === p2, this._compilationBurst = false, this._compilation = null, this.onBackgroundWorkReady = null, this._compilationPromises = null, this._currentSourceMaterial = null, this.transparent = true, this.opaque = true, this.shadowMap = { enabled: false, transmitted: false, type: n }, this.xr = { enabled: false, isPresenting: false, cameraAutoUpdate: true, updateCamera() {
  ...
  async init() {
    return null !== this._initPromise || (this._initPromise = new Promise(async (e, t2) => {
      ...
      this._nodes = new eS(this, r2), this._animation = new Yf(this, this._nodes, this.info), this._attributes = new db(r2, this.info), this._background = new Xv(this, this._nodes), this._geometries = new mb(this._attributes, this.info), this._textures = new Ob(this, r2, this.info), this._pipelines = new Tb(r2, this._nodes, this.info), this._bindings = new vb(r2, this._nodes, this._textures, this._attributes, this._pipelines, this.info), this._objects = new ob(this, this._nodes, this._geometries, this._pipelines, this._bindings, this.info), this._renderLists = new Bb(this.lighting, this._objects), this._bundles = new aS(), this._renderContexts = new Ub(this), this._compilation = new sb(this), this._compilation.burst = this._compilationBurst, this._animation.start(), this._initialized = true, this._inspector.init(), e(this);
    })), this._initPromise;
  }
  get domElement() {
  ...
  async compileAsync(e, t2, r2 = null) {
    ...
    null === r2 && (r2 = e);
    let u2 = true === e.isScene ? e : true === r2.isScene ? r2 : hS, d2 = this.needsFrameBufferTarget && null === this._renderTarget ? this._getFrameBufferTarget() : this._renderTarget || this._outputRenderTarget, h2 = this._renderContexts.get(d2, this._mrt), c2 = this._activeMipmapLevel;
    h2.renderTarget = d2, h2.activeCubeFace = this._activeCubeFace, h2.activeMipmapLevel = c2;
    let p2 = [];
    this._currentRenderContext = h2, this._currentRenderObjectFunction = this.renderObject, this._handleObjectFunction = this._createObjectPipeline, this._compilationPromises = p2, i2.renderId++, i2.update(), h2.depth = this.depth, h2.stencil = this.stencil, h2.clippingContext || (h2.clippingContext = new rS()), h2.clippingContext.updateGlobal(u2, t2), true === e.matrixWorldAutoUpdate && e.updateMatrixWorld(), t2 = this._updateCamera(t2), u2.onBeforeRender(this, e, t2, d2);
    let m2 = t2.isArrayCamera ? gS : mS;
    t2.isArrayCamera ? m2.setFromArrayCamera(t2) : (fS.multiplyMatrices(t2.projectionMatrix, t2.matrixWorldInverse), m2.setFromProjectionMatrix(fS, t2.coordinateSystem, t2.reversedDepth));
...
Reason: ${e.reason}`), Pi(t2), this._isDeviceLost = true, null !== this._compilation && this._compilation.clear("cancelled");
  ...
  _getFrameBufferTarget() {
    ...
    let { width: s2, height: a2 } = this.getDrawingBufferSize(cS), { depth: n2, stencil: o2 } = this, l2 = this._outputRenderTarget || this._canvasTarget, u2 = this._frameBufferTargets.get(l2);
    if (void 0 === u2) {
  ...
  _renderScene(e, t2, r2 = true) {
    ...
    let d2, h2 = true === e.isScene ? e : hS, c2 = this._renderTarget || this._outputRenderTarget, p2 = this._activeCubeFace, m2 = this._activeMipmapLevel;
    ...
    null !== d2 && (b2 = d2.viewport, y2 = d2.scissor, x2 = 1), this.getDrawingBufferSize(cS), pS.set(0, 0, cS.width, cS.height);
    let _2 = void 0 === b2.minDepth ? 0 : b2.minDepth, T2 = void 0 === b2.maxDepth ? 1 : b2.maxDepth;
    g2.viewportValue.copy(b2).multiplyScalar(x2).floor(), g2.viewportValue.width >>= m2, g2.viewportValue.height >>= m2, g2.viewportValue.minDepth = _2, g2.viewportValue.maxDepth = T2, g2.viewport = false === g2.viewportValue.equals(pS), g2.scissorValue.copy(y2).multiplyScalar(x2).floor(), g2.scissor = f2._scissorTest && false === g2.scissorValue.equals(pS), g2.scissorValue.width >>= m2, g2.scissorValue.height >>= m2, g2.clippingContext || (g2.clippingContext = new rS()), g2.clippingContext.updateGlobal(h2, t2), h2.onBeforeRender(this, e, t2, d2);
    let v2 = t2.isArrayCamera ? gS : mS;
    t2.isArrayCamera ? v2.setFromArrayCamera(t2) : (fS.multiplyMatrices(t2.projectionMatrix, t2.matrixWorldInverse), v2.setFromProjectionMatrix(fS, t2.coordinateSystem, t2.reversedDepth));
    ...
    } else g2.textures = null, g2.depthTexture = null, g2.width = cS.width, g2.height = cS.height, g2.depth = this.depth, g2.stencil = this.stencil;
    g2.width >>= m2, g2.height >>= m2, g2.activeCubeFace = p2, g2.activeMipmapLevel = m2, g2.occlusionQueryCount = N2.occlusionQueryCount, g2.scissorValue.max(bS.set(0, 0, 0, 0)), g2.scissorValue.x + g2.scissorValue.width > g2.width && (g2.scissorValue.width = Math.max(g2.width - g2.scissorValue.x, 0)), g2.scissorValue.y + g2.scissorValue.height > g2.height && (g2.scissorValue.height = Math.max(g2.height - g2.scissorValue.y, 0)), this._background.update(h2, N2, g2), g2.camera = t2, this.backend.beginRender(g2);
    let { bundles: S2, lightsNode: w2, transparentDoublePass: E, transparent: A2, opaque: R } = N2;
    return S2.length > 0 && this._renderBundles(S2, h2, w2), true === this.opaque && R.length > 0 && this._renderObjects(R, t2, h2, w2), true === this.transparent && A2.length > 0 && this._renderTransparents(A2, E, t2, h2, w2), this.backend.finishRender(g2), s2.renderId = a2, this._currentRenderContext = n2, this._currentRenderObjectFunction = o2, this._handleObjectFunction = l2, this._currentRenderBundle = u2, this.lighting.finishRender(e), this._callDepth--, null !== i2 && (this.setRenderTarget(c2, p2, m2), this._renderOutput(d2)), h2.onAfterRender(this, e, t2, d2), this.inspector.finishRender(this.backend.getTimestampUID(g2)), g2;
  }
  ...
  _renderOutput(e) {
    ...
    if (void 0 === i2) {
      t2 = new Ky(new im()), t2.name = "Output Color Transform", t2.material.name = "outputColorTransform", t2.material.fragmentNode = this._nodes.getOutputNode(e.texture), i2 = { quad: t2, cacheKey: r2 }, this._quadCache.set(e.texture, i2);
      let s3 = () => {
  ...
  copyFramebufferToTexture(e, t2 = null) {
    if (null !== t2) if (t2.isVector2) t2 = bS.set(t2.x, t2.y, e.image.width, e.image.height).floor();
    else {
      if (!t2.isVector4) return void Pi("Renderer.copyFramebufferToTexture: Invalid rectangle.");
      t2 = bS.copy(t2).floor();
    }
    else t2 = bS.set(0, 0, e.image.width, e.image.height);
  ...
  _projectObject(e, t2, r2, i2, s2) {
    ...
    if (e.layers.test(t2.layers)) {
      if (e.isGroup) r2 = e.renderOrder, e.isClippingGroup && e.enabled && (s2 = s2.getGroupContext(e));
        ...
        let a3 = t2.isArrayCamera ? gS : mS;
        if (!e.frustumCulled || a3.intersectsSprite(e)) {
          true === this.sortObjects && bS.setFromMatrixPosition(e.matrixWorld).applyMatrix4(fS);
          let { geometry: t3, material: a4 } = e;
          a4.visible && i2.push(e, t3, a4, r2, bS.z, null, s2);
        }
        ...
        if (!e.frustumCulled || a3.intersectsObject(e)) {
          let { geometry: t3, material: a4 } = e;
          if (true === this.sortObjects && (null === t3.boundingSphere && t3.computeBoundingSphere(), bS.copy(t3.boundingSphere.center).applyMatrix4(e.matrixWorld).applyMatrix4(fS)), Array.isArray(a4)) {
            let n2 = t3.groups;
            for (let o2 = 0, l2 = n2.length; o2 < l2; o2++) {
              let l3 = n2[o2], u2 = a4[l3.materialIndex];
              u2 && u2.visible && i2.push(e, t3, u2, r2, bS.z, l3, s2);
            }
          } else a4.visible && i2.push(e, t3, a4, r2, bS.z, null, s2);
        }
      }
    }
  ...
  renderObject(e, t2, r2, i2, s2, a2, n2, o2 = null, l2 = null) {
    ...
    if (e.onBeforeRender(this, t2, r2, i2, s2, a2), true === s2.allowOverride && null !== t2.overrideMaterial) {
      ...
      if (f2 = true, u2 = e2.isNodeMaterial ? e2.colorNode : null, d2 = e2.isNodeMaterial ? e2.depthNode : null, h2 = e2.isNodeMaterial ? e2.positionNode : null, c2 = t2.overrideMaterial.side, p2 = e2.displacementMap, m2 = e2.displacementScale, g2 = e2.displacementBias, s2.positionNode && s2.positionNode.isNode && (e2.positionNode = s2.positionNode), e2.alphaTest = s2.alphaTest, e2.alphaMap = s2.alphaMap, e2.displacementMap = s2.displacementMap, e2.displacementScale = s2.displacementScale, e2.displacementBias = s2.displacementBias, e2.transparent = s2.transparent || s2.transmission > 0 || s2.transmissionNode && s2.transmissionNode.isNode || s2.backdropNode && s2.backdropNode.isNode, e2.isShadowPassMaterial) {
        ...
        this.shadowMap.type === o ? e2.side = null !== s2.shadowSide ? s2.shadowSide : s2.side : e2.side = null !== s2.shadowSide ? s2.shadowSide : yS[s2.side], null !== t3 && (e2.colorNode = t3), null !== r3 && (e2.depthNode = r3), null !== i3 && (e2.positionNode = i3);
      }
      s2 = e2;
    }
  ...
  _renderObjectDirect(e, t2, r2, i2, s2, a2, n2, o2) {
    let l2 = this._objects.get(e, t2, r2, i2, s2, this._currentRenderContext, n2, o2);
...
var vS = class extends _S {
  ...
  get byteLength() {
    return TS(this._buffer.byteLength);
  }
  get buffer() {
    return this._buffer;
  }
...
var wS = class extends NS {
  constructor(e, t2) {
    super("UniformBuffer_" + SS++, e ? e.value : null), this.nodeUniform = e, this.groupNode = t2, this.isNodeUniformBuffer = true;
  }
  set updateRanges(e) {
  ...
  get byteLength() {
    return TS(this.buffer.byteLength);
  }
  get buffer() {
    return this.nodeUniform.value;
  }
};
var ES = class extends NS {
  constructor(e) {
  ...
  get byteLength() {
    ...
    for (let r2 = 0, i2 = this.uniforms.length; r2 < i2; r2++) {
      let i3 = this.uniforms[r2], s2 = i3.boundary, a2 = i3.itemSize * e, n2 = t2 % ub, o2 = n2 % s2, l2 = n2 + o2;
      t2 += o2, 0 !== l2 && ub - l2 < a2 && (t2 += ub - l2), i3.offset = t2 / e, i3.index = r2, t2 += a2;
    }
    return Math.ceil(t2 / ub) * ub;
  }
  update() {
    let e = false;
...
var BS = class extends CS {
  constructor(e, t2) {
    super(e, t2), this.id = MS++, this.store = false, this.mipLevel = 0, this.isSampledTexture = true;
  }
};
var FS = null;
function PS() {
  return null === FS && ((FS = new Qa(new Uint8Array([255, 255, 255, 255]), 1, 1)).needsUpdate = true), FS;
}
var LS;
var US;
var DS;
...
var VS = class extends BS {
  constructor(e, t2, r2, i2 = null) {
    super(e, (t2 ? t2.value : null) || PS()), this.textureNode = t2, this.groupNode = r2, this.access = i2;
  }
  update() {
...
var KS = class extends MN {
  ...
  getMethod(e) {
    return void 0 !== $S[e] && this._include(e), zS[e] || e;
  }
...
${r2.code}
  ...
  setupPBO(e) {
    let t2 = e.value;
    if (void 0 === t2.pbo) {
      let e2 = t2.array, r2 = t2.count * t2.itemSize, { itemSize: i2 } = t2, s2 = t2.array.constructor.name.toLowerCase().includes("int"), n2 = s2 ? Lt : Ft;
...
`;
        ...
        if (void 0 === i2[t4]) {
          ...
          if (void 0 !== e3) {
            ...
            for (let t5 of e3.uniforms) {
              ...
              null !== s4 && (a2 = WS[s4] + " " + a2), r3.push("	" + a2);
            }
            i2[t4] = r3;
          }
        }
      ...
      if (!s3) {
        ...
        null !== i3 && (t3 = WS[i3] + " " + t3), t3 = "uniform " + t3, r2.push(t3);
      }
    }
    let s2 = "";
    for (let e2 in i2) {
...
`;
  ...
  getVaryings(e) {
    ...
    if ("vertex" === e || "compute" === e) for (let i2 of r2) {
      ...
      i2.needsInterpolation ? i2.interpolationType ? t2 += `${qS[i2.interpolationType] || i2.interpolationType} ${jS[i2.interpolationSampling] || ""} out ${r3} ${i2.name};
...
`;
      ...
      for (let e2 of r2) if (e2.needsInterpolation) {
        ...
        e2.interpolationType ? t2 += `${qS[e2.interpolationType] || e2.interpolationType} ${jS[e2.interpolationSampling] || ""} in ${r3} ${e2.name};
...
`;
  ...
  getUniformFromNode(e, t2, r2, i2 = null) {
    ...
    if (void 0 === n2) {
      ...
      if ("texture" === t2) n2 = new VS(s2.name, s2.node, i3), l2.push(n2);
      else if ("cubeTexture" === t2 || "cubeDepthTexture" === t2) n2 = new kS(s2.name, s2.node, i3), l2.push(n2);
      else if ("texture3D" === t2) n2 = new GS(s2.name, s2.node, i3), l2.push(n2);
      else if ("buffer" === t2) {
        s2.name = `buffer${e.id}`;
        let t3 = this.getSharedDataFromNode(e), r3 = t3.buffer;
        void 0 === r3 && (e.name = `NodeBuffer_${e.id}`, r3 = new wS(e, i3), r3.name = e.name, t3.buffer = r3), l2.push(r3), n2 = r3;
      } else {
        let e2 = this.uniformGroups[o2];
        void 0 === e2 ? (e2 = new RS(o2, i3), this.uniformGroups[o2] = e2, l2.push(e2)) : -1 === l2.indexOf(e2) && l2.push(e2), n2 = this.getNodeUniform(s2, t2);
        let r3 = n2.name;
...
var ZS = class {
  ...
  getDrawingBufferSize() {
    return YS = YS || new Gi(), this.renderer.getDrawingBufferSize(YS);
  }
  setScissorTest() {
  }
  getClearColor() {
    let e = this.renderer;
    return QS = QS || new Ib(), e.getClearColor(QS), QS.getRGB(QS), QS;
  }
  getDomElement() {
...
var tw = class {
  ...
  createAttribute(e, t2) {
    ...
    let d2 = { bufferGPU: u2, bufferType: t2, type: r2, byteLength: a2.byteLength, bytesPerElement: a2.BYTES_PER_ELEMENT, version: e.version, pbo: e.pbo, isInteger: r2 === s2.INT || r2 === s2.UNSIGNED_INT || e.gpuType === _t, id: JS++ };
...
var rw = class {
  ...
  _init() {
    let e = this.gl;
    LS = { [v]: e.FUNC_ADD, [b]: e.FUNC_SUBTRACT, [M]: e.FUNC_REVERSE_SUBTRACT }, US = { [_]: e.ZERO, [A]: e.ONE, [z]: e.SRC_COLOR, [C]: e.SRC_ALPHA, [N]: e.SRC_ALPHA_SATURATE, [O]: e.DST_COLOR, [k]: e.DST_ALPHA, [T]: e.ONE_MINUS_SRC_COLOR, [I]: e.ONE_MINUS_SRC_ALPHA, [P]: e.ONE_MINUS_DST_COLOR, [B]: e.ONE_MINUS_DST_ALPHA };
  ...
  _setMRTBlendingIndex(e, t2) {
    ...
    if (s2 === g) {
      ...
      i2.blendEquationSeparateiOES(e, LS[o2], LS[l3]), i2.blendFuncSeparateiOES(e, US[a2], US[n2], US[r3], US[s3]);
  ...
  setBlending(e, t2, r2, i2, s2, a2, n2, o2) {
    let { gl: l2 } = this;
    if (e !== p) {
      if (false === this.currentBlendingEnabled && (this.enable(l2.BLEND), this.currentBlendingEnabled = true), e === g) s2 = s2 || t2, a2 = a2 || r2, n2 = n2 || i2, (t2 !== this.currentBlendEquation || s2 !== this.currentBlendEquationAlpha) && (l2.blendEquationSeparate(LS[t2], LS[s2]), this.currentBlendEquation = t2, this.currentBlendEquationAlpha = s2), (r2 !== this.currentBlendSrc || i2 !== this.currentBlendDst || a2 !== this.currentBlendSrcAlpha || n2 !== this.currentBlendDstAlpha) && (l2.blendFuncSeparate(US[r2], US[i2], US[a2], US[n2]), this.currentBlendSrc = r2, this.currentBlendDst = i2, this.currentBlendSrcAlpha = a2, this.currentBlendDstAlpha = n2), this.currentBlending = e, this.currentPremultipledAlpha = false;
...
var iw = class {
  ...
  convert(e, r2 = Le) {
    ...
    if (e === Et) return s2.DEPTH_STENCIL;
    if (e === Ft) return s2.RED;
...
var aw = class {
  constructor(e) {
    this.backend = e, this.gl = e.gl, this.extensions = e.extensions, this.defaultTextures = {}, this._srcFramebuffer = null, this._dstFramebuffer = null, false === sw && (this._init(), sw = true);
  }
  _init() {
    let e = this.gl;
    DS = { [ut]: e.REPEAT, [ct]: e.CLAMP_TO_EDGE, [pt]: e.MIRRORED_REPEAT }, OS = { [dt]: e.NEAREST, [mt]: e.NEAREST_MIPMAP_NEAREST, [yt]: e.NEAREST_MIPMAP_LINEAR, [ft]: e.LINEAR, [gt]: e.LINEAR_MIPMAP_NEAREST, [xt]: e.LINEAR_MIPMAP_LINEAR }, IS = { [li]: e.NEVER, [fi]: e.ALWAYS, [ui]: e.LESS, [pi]: e.LEQUAL, [ci]: e.EQUAL, [yi]: e.GEQUAL, [di]: e.GREATER, [mi]: e.NOTEQUAL };
  }
  getGLTextureType(e) {
    let t2, { gl: r2 } = this;
  ...
  setTextureParameters(e, t2) {
    ...
    n2.pixelStorei(r2.UNPACK_FLIP_Y_WEBGL, t2.flipY), n2.pixelStorei(r2.UNPACK_PREMULTIPLY_ALPHA_WEBGL, t2.premultiplyAlpha), n2.pixelStorei(r2.UNPACK_ALIGNMENT, t2.unpackAlignment), n2.pixelStorei(r2.UNPACK_COLORSPACE_CONVERSION_WEBGL, u2), r2.texParameteri(e, r2.TEXTURE_WRAP_S, DS[t2.wrapS]), r2.texParameteri(e, r2.TEXTURE_WRAP_T, DS[t2.wrapT]), (e === r2.TEXTURE_3D || e === r2.TEXTURE_2D_ARRAY) && (t2.isArrayTexture || r2.texParameteri(e, r2.TEXTURE_WRAP_R, DS[t2.wrapR])), r2.texParameteri(e, r2.TEXTURE_MAG_FILTER, OS[t2.magFilter]);
    let d2 = void 0 !== t2.mipmaps && t2.mipmaps.length > 0, h2 = t2.minFilter === ft && d2 ? xt : t2.minFilter;
    if (r2.texParameteri(e, r2.TEXTURE_MIN_FILTER, OS[h2]), t2.compareFunction && (r2.texParameteri(e, r2.TEXTURE_COMPARE_MODE, r2.COMPARE_REF_TO_TEXTURE), r2.texParameteri(e, r2.TEXTURE_COMPARE_FUNC, IS[t2.compareFunction])), true === i2.has("EXT_texture_filter_anisotropic")) {
  ...
  updateTexture(e, t2) {
    ...
    if (!e.isRenderTargetTexture && void 0 !== a2) if (this.backend.state.bindTexture(n2, a2), this.setTextureParameters(n2, e), e.isCompressedTexture) {
      ...
      if (e.layerUpdates.size > 0) {
        let t3 = mu(i3.width, i3.height, e.format, e.type);
  ...
  copyTextureToTexture(e, t2, r2 = null, i2 = null, s2 = 0, a2 = 0) {
    ...
    let N2 = l2.getParameter(n2.UNPACK_ROW_LENGTH), S2 = l2.getParameter(n2.UNPACK_IMAGE_HEIGHT), w2 = l2.getParameter(n2.UNPACK_SKIP_PIXELS), E = l2.getParameter(n2.UNPACK_SKIP_ROWS), A2 = l2.getParameter(n2.UNPACK_SKIP_IMAGES);
    ...
    let R = e.isDataArrayTexture || e.isData3DTexture || t2.isArrayTexture, C2 = t2.isDataArrayTexture || t2.isData3DTexture || t2.isArrayTexture;
    if (e.isDepthTexture) {
      ...
      for (let e2 = 0; e2 < g2; e2++) R && (n2.framebufferTextureLayer(n2.READ_FRAMEBUFFER, n2.COLOR_ATTACHMENT0, r3.textureGPU, s2, y2 + e2), n2.framebufferTextureLayer(n2.DRAW_FRAMEBUFFER, n2.COLOR_ATTACHMENT0, u2, a2, T2 + e2)), n2.blitFramebuffer(f2, b2, p2, m2, x2, _2, p2, m2, n2.DEPTH_BUFFER_BIT, n2.NEAREST);
    ...
    l2.pixelStorei(n2.UNPACK_ROW_LENGTH, N2), l2.pixelStorei(n2.UNPACK_IMAGE_HEIGHT, S2), l2.pixelStorei(n2.UNPACK_SKIP_PIXELS, w2), l2.pixelStorei(n2.UNPACK_SKIP_ROWS, E), l2.pixelStorei(n2.UNPACK_SKIP_IMAGES, A2), 0 === a2 && t2.generateMipmaps && n2.generateMipmap(d2), l2.unbindTexture();
  }
...
var pw = class extends ZS {
  ...
  init(e) {
    ...
    this._onContextLost = s2, e.domElement.addEventListener("webglcontextlost", s2, false), this.gl = i2, this.extensions = new ow(this), this.capabilities = new lw(this), this.attributeUtils = new tw(this), this.textureUtils = new aw(this), this.bufferRenderer = new dw(this), this.state = new rw(this), this.utils = new iw(this), this.extensions.get("EXT_color_buffer_float"), this.extensions.get("WEBGL_clip_cull_distance"), this.extensions.get("OES_texture_float_linear"), this.extensions.get("EXT_color_buffer_half_float"), this.extensions.get("WEBGL_multisampled_render_to_texture"), this.extensions.get("WEBGL_render_shared_exponent"), this.extensions.get("WEBGL_multi_draw"), this.extensions.get("OVR_multiview2"), this.extensions.get("EXT_clip_control"), this.disjoint = this.extensions.get("EXT_disjoint_timer_query_webgl2"), this.parallel = this.extensions.get("KHR_parallel_shader_compile"), this.drawBuffersIndexedExt = this.extensions.get("OES_draw_buffers_indexed"), t2.reversedDepthBuffer && (this.extensions.has("EXT_clip_control") ? e.reversedDepthBuffer = true : (Oi("WebGPURenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer."), e.reversedDepthBuffer = false)), e.reversedDepthBuffer && this.state.setReversedDepth(true);
  }
  get coordinateSystem() {
    return bi;
  }
  ...
  initTimestampQuery(e, t2) {
    ...
    this.timestampQueryPool[e] || (this.timestampQueryPool[e] = new cw(this.gl, e, 2048));
  ...
  hasFeature(e) {
    let t2 = Object.keys(uw).filter((t3) => uw[t3] === e), r2 = this.extensions;
  ...
  _setFramebuffer(e) {
    ...
    if (null !== e.textures) {
      let s2, a2 = e.renderTarget, n2 = this.get(a2), { samples: o2, depthBuffer: l2, stencilBuffer: u2 } = a2, d2 = true === a2.isCubeRenderTarget, h2 = true === a2.isRenderTarget3D, c2 = a2.depth > 1, p2 = true === a2.isXRRenderTarget, m2 = true === p2 && true === a2._hasExternalTextures, g2 = n2.msaaFrameBuffer, f2 = n2.depthRenderbuffer, b2 = this.extensions.get("WEBGL_multisampled_render_to_texture"), y2 = this.extensions.get("OVR_multiview2"), x2 = this._useMultisampledExtension(a2), _2 = Lb(e);
...
var mw = "triangle-list";
var gw = typeof self < "u" && self.GPUShaderStage ? self.GPUShaderStage : { VERTEX: 1, FRAGMENT: 2, COMPUTE: 4 };
var fw = "never";
var bw = "less";
var yw = "equal";
var xw = "less-equal";
...
var qw = "rg16float";
var jw = "rgba8unorm";
var Xw = "rgba8unorm-srgb";
var Kw = "rgba8snorm";
var Yw = "rgba8uint";
var Qw = "rgba8sint";
var Zw = "bgra8unorm";
var Jw = "bgra8unorm-srgb";
var eE = "rg16unorm";
var tE = "rg16snorm";
var rE = "rgb9e5ufloat";
var iE = "rgb10a2unorm";
var sE = "rg11b10ufloat";
var aE = "rg32uint";
var nE = "rg32sint";
var oE = "rg32float";
var lE = "rgba16uint";
...
var gE = "rgba32float";
var fE = "depth24plus";
var bE = "depth24plus-stencil8";
var yE = "depth32float";
var xE = "depth32float-stencil8";
var _E = "bc1-rgba-unorm";
var TE = "bc1-rgba-unorm-srgb";
var vE = "bc2-rgba-unorm";
var NE = "bc2-rgba-unorm-srgb";
var SE = "bc3-rgba-unorm";
var wE = "bc3-rgba-unorm-srgb";
var EE = "bc4-r-unorm";
var AE = "bc4-r-snorm";
var RE = "bc5-rg-unorm";
var CE = "bc5-rg-snorm";
var ME = "bc6h-rgb-ufloat";
var BE = "bc6h-rgb-float";
var FE = "bc7-rgba-unorm";
var PE = "bc7-rgba-unorm-srgb";
var LE = "etc2-rgb8unorm";
var UE = "etc2-rgb8unorm-srgb";
var DE = "etc2-rgba8unorm";
var OE = "etc2-rgba8unorm-srgb";
var IE = "eac-r11unorm";
var VE = "eac-r11snorm";
var kE = "eac-rg11unorm";
var GE = "eac-rg11snorm";
var $E = "astc-4x4-unorm";
var zE = "astc-4x4-unorm-srgb";
var WE = "astc-5x4-unorm";
var HE = "astc-5x4-unorm-srgb";
var qE = "astc-5x5-unorm";
var jE = "astc-5x5-unorm-srgb";
var XE = "astc-6x5-unorm";
var KE = "astc-6x5-unorm-srgb";
var YE = "astc-6x6-unorm";
var QE = "astc-6x6-unorm-srgb";
var ZE = "astc-8x5-unorm";
var JE = "astc-8x5-unorm-srgb";
var eA = "astc-8x6-unorm";
var tA = "astc-8x6-unorm-srgb";
var rA = "astc-8x8-unorm";
var iA = "astc-8x8-unorm-srgb";
var sA = "astc-10x5-unorm";
var aA = "astc-10x5-unorm-srgb";
var nA = "astc-10x6-unorm";
var oA = "astc-10x6-unorm-srgb";
var lA = "astc-10x8-unorm";
var uA = "astc-10x8-unorm-srgb";
var dA = "astc-10x10-unorm";
var hA = "astc-10x10-unorm-srgb";
var cA = "astc-12x10-unorm";
var pA = "astc-12x10-unorm-srgb";
var mA = "astc-12x12-unorm";
var gA = "astc-12x12-unorm-srgb";
var fA = "linear";
var bA = "nearest";
var yA = "zero";
var xA = "one";
var _A = "one-minus-src";
var TA = "src-alpha";
var vA = "one-minus-src-alpha";
var NA = "add";
var SA = "unfilterable-float";
var wA = "2d";
var EA = "2d-array";
var AA = "cube";
var RA = "3d";
var CA = "vertex";
var MA = "instance";
var BA = { CoreFeaturesAndLimits: "core-features-and-limits", DepthClipControl: "depth-clip-control", Depth32FloatStencil8: "depth32float-stencil8", TextureCompressionBC: "texture-compression-bc", TextureCompressionBCSliced3D: "texture-compression-bc-sliced-3d", TextureCompressionETC2: "texture-compression-etc2", TextureCompressionASTC: "texture-compression-astc", TextureCompressionASTCSliced3D: "texture-compression-astc-sliced-3d", TimestampQuery: "timestamp-query", IndirectFirstInstance: "indirect-first-instance", ShaderF16: "shader-f16", RG11B10UFloat: "rg11b10ufloat-renderable", BGRA8UNormStorage: "bgra8unorm-storage", Float32Filterable: "float32-filterable", Float32Blendable: "float32-blendable", ClipDistances: "clip-distances", DualSourceBlending: "dual-source-blending", Subgroups: "subgroups", TextureFormatsTier1: "texture-formats-tier1", TextureFormatsTier2: "texture-formats-tier2" };
var FA = { "texture-compression-s3tc": "texture-compression-bc", "texture-compression-etc1": "texture-compression-etc2" };
var PA = class extends CS {
  constructor(e, t2, r2) {
    super(e, (t2 ? t2.value : null) || PS()), this.textureNode = t2, this.groupNode = r2;
  }
  update() {
    let { textureNode: e } = this, t2 = e.value;
    if (null == t2) {
...
var DA = class extends LA {
  constructor(e, t2) {
    super("StorageBuffer_" + UA++, e ? e.value : null), this.nodeUniform = e, this.access = e ? e.access : Wi.READ_WRITE, this.groupNode = t2;
  }
  get attribute() {
    return this.nodeUniform.value;
  }
...
var IA = class {
  ...
  getCurrentDepthStencilFormat(e) {
    let t2;
    return e.depth && (t2 = null !== e.depthTexture ? this.getTextureFormatGPU(e.depthTexture) : e.stencil ? true === this.backend.renderer.reversedDepthBuffer ? xE : bE : true === this.backend.renderer.reversedDepthBuffer ? yE : fE), t2;
  }
  ...
  getPrimitiveTopology(e, t2) {
    return e.isPoints ? "point-list" : e.isLineSegments || e.isMesh && true === t2.wireframe ? "line-list" : e.isLine ? "line-strip" : e.isMesh ? mw : void 0;
  }
  getSampleCount(e) {
    return e >= 4 ? 4 : 1;
  }
...
function VA(e, t2) {
  OA[0] = t2, e.queue.submit(OA), OA[0] = null;
}
var kA = class {
  constructor() {
...
var qA = class {
  constructor() {
    this.label = "", this.layout = null, this.vertex = null, this.primitive = {}, this.depthStencil = void 0, this.multisample = new jA(), this.fragment = null;
  }
  reset() {
...
var aR = new KA();
var nR = new YA();
var oR = class extends lb {
  constructor(e) {
    super(), this.device = e, this.mipmapSampler = e.createSampler({ minFilter: fA }), this.flipYSampler = e.createSampler({ minFilter: bA }), ZA.size = 4, ZA.usage = GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, this.flipUniformBuffer = e.createBuffer(ZA), ZA.reset(), e.queue.writeBuffer(this.flipUniformBuffer, 0, new Uint32Array([1])), ZA.size = 4, ZA.usage = GPUBufferUsage.UNIFORM, this.noFlipUniformBuffer = e.createBuffer(ZA), ZA.reset(), this.transferPipelines = {}, sR.label = "mipmap", sR.code = "\nstruct VarysStruct {\n	@builtin( position ) Position: vec4f,\n	@location( 0 ) vTex : vec2f,\n	@location( 1 ) @interpolate(flat, either) vBaseArrayLayer: u32,\n};\n\n@group( 0 ) @binding ( 2 )\nvar<uniform> flipY: u32;\n\n@vertex\nfn mainVS(\n		@builtin( vertex_index ) vertexIndex : u32,\n		@builtin( instance_index ) instanceIndex : u32 ) -> VarysStruct {\n\n	var Varys : VarysStruct;\n\n	var pos = array(\n		vec2f( -1, -1 ),\n		vec2f( -1,  3 ),\n		vec2f(  3, -1 ),\n	);\n\n	let p = pos[ vertexIndex ];\n	let mult = select( vec2f( 0.5, -0.5 ), vec2f( 0.5, 0.5 ), flipY != 0 );\n	Varys.vTex = p * mult + vec2f( 0.5 );\n	Varys.Position = vec4f( p, 0, 1 );\n	Varys.vBaseArrayLayer = instanceIndex;\n\n	return Varys;\n\n}\n\n@group( 0 ) @binding( 0 )\nvar imgSampler : sampler;\n\n@group( 0 ) @binding( 1 )\nvar img2d : texture_2d<f32>;\n\n@fragment\nfn main_2d( Varys: VarysStruct ) -> @location( 0 ) vec4<f32> {\n\n	return textureSample( img2d, imgSampler, Varys.vTex );\n\n}\n\n@group( 0 ) @binding( 1 )\nvar img2dArray : texture_2d_array<f32>;\n\n@fragment\nfn main_2d_array( Varys: VarysStruct ) -> @location( 0 ) vec4<f32> {\n\n	return textureSample( img2dArray, imgSampler, Varys.vTex, Varys.vBaseArrayLayer );\n\n}\n\nconst faceMat = array(\n  mat3x3f(  0,  0,  -2,  0, -2,   0,  1,  1,   1 ),   \n  mat3x3f(  0,  0,   2,  0, -2,   0, -1,  1,  -1 ),   \n  mat3x3f(  2,  0,   0,  0,  0,   2, -1,  1,  -1 ),   \n  mat3x3f(  2,  0,   0,  0,  0,  -2, -1, -1,   1 ),   \n  mat3x3f(  2,  0,   0,  0, -2,   0, -1,  1,   1 ),   \n  mat3x3f( -2,  0,   0,  0, -2,   0,  1,  1,  -1 ),   \n);\n\n@group( 0 ) @binding( 1 )\nvar imgCube : texture_cube<f32>;\n\n@fragment\nfn main_cube( Varys: VarysStruct ) -> @location( 0 ) vec4<f32> {\n\n	return textureSample( imgCube, imgSampler, faceMat[ Varys.vBaseArrayLayer ] * vec3f( fract( Varys.vTex ), 1 ) );\n\n}\n", this.mipmapShaderModule = e.createShaderModule(sR), sR.reset();
  }
  getTransferPipeline(e, t2) {
    let r2 = `${e}-${t2 = t2 || "2d-array"}`, i2 = this.transferPipelines[r2];
    return void 0 === i2 && (rR.label = `mipmap-${e}-${t2}`, rR.vertex = { module: this.mipmapShaderModule }, rR.fragment = { module: this.mipmapShaderModule, entryPoint: `main_${t2.replace("-", "_")}`, targets: [{ format: e }] }, rR.layout = "auto", i2 = this.device.createRenderPipeline(rR), rR.reset(), this.transferPipelines[r2] = i2), i2;
  }
  flipY(e, t2, r2 = 0) {
    let i2 = t2.format, { width: s2, height: a2 } = t2.size;
    aR.size.width = s2, aR.size.height = a2, aR.format = i2, aR.usage = GPUTextureUsage.RENDER_ATTACHMENT | GPUTextureUsage.TEXTURE_BINDING;
    let n2 = this.device.createTexture(aR);
    aR.reset();
    let o2 = this.getTransferPipeline(i2, e.textureBindingViewDimension), l2 = this.getTransferPipeline(i2, n2.textureBindingViewDimension), u2 = this.device.createCommandEncoder(JA), d2 = (e2, t3, r3, i3, s3, a3) => {
      let n3 = e2.getBindGroupLayout(0);
      nR.dimension = t3.textureBindingViewDimension || "2d-array", nR.mipLevelCount = 1;
      let o3 = t3.createView(nR);
      nR.reset(), QA.layout = n3, QA.entries.push({ binding: 0, resource: this.flipYSampler }, { binding: 1, resource: o3 }, { binding: 2, resource: { buffer: a3 ? this.flipUniformBuffer : this.noFlipUniformBuffer } });
      let l3 = this.device.createBindGroup(QA);
      QA.reset(), nR.dimension = "2d", nR.mipLevelCount = 1, nR.baseArrayLayer = s3, nR.arrayLayerCount = 1;
      let d3 = i3.createView(nR);
      nR.reset(), iR.view = d3, iR.loadOp = Ew, iR.storeOp = Sw, tR.colorAttachments.push(iR);
      let h2 = u2.beginRenderPass(tR);
      tR.reset(), iR.reset(), h2.setPipeline(e2), h2.setBindGroup(0, l3), h2.draw(3, 1, 0, r3), h2.end();
    };
    d2(o2, e, r2, n2, 0, false), d2(l2, n2, 0, e, r2, true), VA(this.device, u2.finish()), n2.destroy();
  }
  generateMipmaps(e, t2 = null) {
    let r2 = this.get(e), i2 = r2.layers || this._mipmapCreateBundles(e), s2 = t2;
    null === s2 && (JA.label = "mipmapEncoder", s2 = this.device.createCommandEncoder(JA), JA.reset()), this._mipmapRunBundles(s2, i2), null === t2 && VA(this.device, s2.finish()), r2.layers = i2;
  }
  _mipmapCreateBundles(e) {
    ...
    for (let a2 = 1; a2 < e.mipLevelCount; a2++) for (let n2 = 0; n2 < e.depthOrArrayLayers; n2++) {
      nR.dimension = t2, nR.baseMipLevel = a2 - 1, nR.mipLevelCount = 1;
      let o2 = e.createView(nR);
      nR.reset(), QA.layout = i2, QA.entries.push({ binding: 0, resource: this.mipmapSampler }, { binding: 1, resource: o2 }, { binding: 2, resource: { buffer: this.noFlipUniformBuffer } });
      let l2 = this.device.createBindGroup(QA);
      QA.reset(), nR.dimension = "2d", nR.baseMipLevel = a2, nR.mipLevelCount = 1, nR.baseArrayLayer = n2, nR.arrayLayerCount = 1;
      let u2 = e.createView(nR);
      nR.reset();
      let d2 = new WA();
      d2.view = u2, d2.loadOp = Ew, d2.storeOp = Sw;
      let h2 = new HA();
      h2.colorAttachments.push(d2), eR.colorFormats = [e.format];
      let c2 = this.device.createRenderBundleEncoder(eR);
      eR.reset(), c2.setPipeline(r2), c2.setBindGroup(0, l2), c2.draw(3, 1, 0, n2), s2.push({ renderBundles: [c2.finish()], passDescriptor: h2 });
    }
    return s2;
  }
...
var yR = new KA();
var xR = new uR();
var _R = { [li]: "never", [ui]: "less", [ci]: "equal", [pi]: "less-equal", [di]: "greater", [yi]: "greater-equal", [fi]: "always", [mi]: "not-equal" };
var TR = [0, 1, 3, 2, 4, 5];
function vR(e, t2, r2, i2, s2, a2, n2, o2, l2, u2) {
  pR.texture = t2, pR.mipLevel = r2, pR.origin.z = i2, gR.offset = i2 * a2, gR.bytesPerRow = n2, gR.rowsPerImage = o2, xR.width = l2, xR.height = u2, e.queue.writeTexture(pR, s2.data, gR, xR), pR.reset(), gR.reset(), xR.reset();
}
var NR = class {
  constructor(e) {
  ...
  updateSampler(e) {
    ...
    null == r2 && (r2 = e.textureNode && e.textureNode.value || PS(), e.texture = r2), e.textureNode;
    ...
    if (void 0 === s2) {
      cR.addressModeU = this._convertAddressMode(r2.wrapS), cR.addressModeV = this._convertAddressMode(r2.wrapT), cR.addressModeW = this._convertAddressMode(r2.wrapR), cR.magFilter = this._convertFilterMode(r2.magFilter), cR.minFilter = this._convertFilterMode(r2.minFilter), cR.mipmapFilter = this._convertMipmapFilterMode(r2.minFilter), r2.isDepthTexture && null === r2.compareFunction && (cR.magFilter = bA, cR.minFilter = bA, cR.mipmapFilter = bA), cR.magFilter === fA && cR.minFilter === fA && cR.mipmapFilter === fA && (cR.maxAnisotropy = r2.anisotropy), r2.isDepthTexture && null !== r2.compareFunction && t2.hasCompatibility(Si.TEXTURE_COMPARE) && (cR.compare = _R[r2.compareFunction]);
      let e2 = t2.device.createSampler(cR);
      cR.reset(), s2 = { sampler: e2, usedTimes: 0 }, this._samplerCache.set(i2, s2);
    }
    let a2 = t2.get(e);
  ...
  createDefaultTexture(e) {
    let t2, r2 = SR(e, this.backend.device);
  ...
  createTexture(e, t2 = {}) {
    ...
    let l2 = this._getDimension(e), u2 = e.internalFormat || t2.format || SR(e, r2.device);
    i2.format = u2;
    ...
    true === e.isStorageTexture && (p2 |= GPUTextureUsage.STORAGE_BINDING), true !== e.isCompressedTexture && true !== e.isCompressedArrayTexture && u2 !== rE && true !== e.is3DTexture && true !== e.isData3DTexture && (p2 |= GPUTextureUsage.RENDER_ATTACHMENT);
    let m2 = new KA();
    ...
    e.isCubeTexture && (m2.textureBindingViewDimension = AA);
    try {
  ...
  getColorBuffer() {
    ...
    let o2 = n2.texture;
    return o2 && o2.destroy(), yR.label = "colorBuffer", yR.size.width = r2, yR.size.height = i2, yR.sampleCount = e.utils.getSampleCount(e.renderer.currentSamples), yR.format = e.utils.getPreferredCanvasFormat(), yR.usage = GPUTextureUsage.RENDER_ATTACHMENT | GPUTextureUsage.COPY_SRC, o2 = e.device.createTexture(yR), yR.reset(), a2.source.width = r2, a2.source.height = i2, a2.samples = s2, n2.texture = o2, o2;
  }
  getDepthBuffer(e = true, t2 = false) {
    ...
    if (t2 ? (u2 = Et, d2 = true === r2.renderer.reversedDepthBuffer ? zt : kt) : e && (u2 = Vt, d2 = true === r2.renderer.reversedDepthBuffer ? zt : At), void 0 !== h2) {
  ...
  async copyTextureToBuffer(e, t2, r2, i2, s2, a2) {
    ...
    h2 = 256 * Math.ceil(h2 / 256), dR.size = (s2 - 1) * h2 + i2 * d2, dR.usage = GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ;
    let c2 = n2.createBuffer(dR);
    dR.reset();
    let p2 = n2.createCommandEncoder(hR);
    pR.texture = l2, pR.origin.x = t2, pR.origin.y = r2, pR.origin.z = a2, mR.buffer = c2, mR.bytesPerRow = h2, xR.width = i2, xR.height = s2, p2.copyTextureToBuffer(pR, mR, xR), pR.reset(), mR.reset(), xR.reset();
    let m2 = this._getTypedArrayType(u2);
    VA(n2, p2.finish()), await c2.mapAsync(GPUMapMode.READ);
  ...
  _copyCubeMapToTexture(e, t2, r2) {
    ...
    for (let a2 = 0; a2 < 6; a2++) {
      let n2 = i2[a2], o2 = true === e.flipY ? TR[a2] : a2;
  ...
  _copyImageToTexture(e, t2, r2, i2, s2, a2, n2 = 0) {
    ...
    fR.source = e, fR.flipY = s2, bR.texture = t2, bR.mipLevel = n2, bR.origin.z = i2, bR.premultipliedAlpha = a2, xR.width = l2, xR.height = u2;
    try {
      o2.queue.copyExternalImageToTexture(fR, bR, xR);
    } catch {
    } finally {
      fR.reset(), bR.reset(), xR.reset();
    }
  }
  _getPassUtils() {
    let e = this._passUtils;
    return null === e && (this._passUtils = e = new oR(this.backend.device)), e;
  }
  ...
  _copyBufferToTexture(e, t2, r2, i2, s2, a2 = 0, n2 = 0) {
    ...
    pR.texture = t2, pR.mipLevel = n2, pR.origin.z = i2, gR.offset = e.width * e.height * u2 * a2, gR.bytesPerRow = d2, xR.width = e.width, xR.height = e.height, o2.queue.writeTexture(pR, l2, gR, xR), pR.reset(), gR.reset(), xR.reset(), true === s2 && this._flipY(t2, r2, i2);
  }
  _copyCompressedBufferToTexture(e, t2, r2, i2 = null) {
    ...
    for (let i3 = 0; i3 < e.length; i3++) {
      ...
      if (null !== o2) for (let e2 of o2) vR(s2, t2, i3, e2, l2, m2, c2, p2, g2, f2);
      else for (let e2 = 0; e2 < h2; e2++) vR(s2, t2, i3, e2, l2, m2, c2, p2, g2, f2);
    }
  }
  _getBlockData(e) {
    return e === _E || e === TE ? { byteLength: 8, width: 4, height: 4 } : e === vE || e === NE || e === SE || e === wE ? { byteLength: 16, width: 4, height: 4 } : e === EE || e === AE ? { byteLength: 8, width: 4, height: 4 } : e === RE || e === CE || e === ME || e === BE || e === FE || e === PE ? { byteLength: 16, width: 4, height: 4 } : e === LE || e === UE || "etc2-rgb8a1unorm" === e || "etc2-rgb8a1unorm-srgb" === e ? { byteLength: 8, width: 4, height: 4 } : e === DE || e === OE ? { byteLength: 16, width: 4, height: 4 } : e === IE || e === VE ? { byteLength: 8, width: 4, height: 4 } : e === kE || e === GE || e === $E || e === zE ? { byteLength: 16, width: 4, height: 4 } : e === WE || e === HE ? { byteLength: 16, width: 5, height: 4 } : e === qE || e === jE ? { byteLength: 16, width: 5, height: 5 } : e === XE || e === KE ? { byteLength: 16, width: 6, height: 5 } : e === YE || e === QE ? { byteLength: 16, width: 6, height: 6 } : e === ZE || e === JE ? { byteLength: 16, width: 8, height: 5 } : e === eA || e === tA ? { byteLength: 16, width: 8, height: 6 } : e === rA || e === iA ? { byteLength: 16, width: 8, height: 8 } : e === sA || e === aA ? { byteLength: 16, width: 10, height: 5 } : e === nA || e === oA ? { byteLength: 16, width: 10, height: 6 } : e === lA || e === uA ? { byteLength: 16, width: 10, height: 8 } : e === dA || e === hA ? { byteLength: 16, width: 10, height: 10 } : e === cA || e === pA ? { byteLength: 16, width: 12, height: 10 } : e === mA || e === gA ? { byteLength: 16, width: 12, height: 12 } : void 0;
  }
  ...
  _convertFilterMode(e) {
    let t2 = fA;
    return (e === dt || e === mt || e === yt) && (t2 = bA), t2;
  }
  _convertMipmapFilterMode(e) {
    return e === yt || e === xt ? fA : bA;
  }
  _getBytesPerTexel(e) {
    return e === Rw || e === Cw || e === Mw || e === Bw ? 1 : e === Fw || e === Pw || e === Lw || e === Uw || e === Dw || e === Ow || e === Iw || e === Vw || e === kw ? 2 : e === Gw || e === $w || e === zw || e === Ww || e === Hw || e === qw || e === jw || e === Xw || e === Kw || e === Yw || e === Qw || e === Zw || e === Jw || e === eE || e === tE || e === rE || e === iE || e === sE || e === yE || e === fE || e === bE || e === xE ? 4 : e === aE || e === nE || e === oE || e === lE || e === uE || e === dE || e === hE || e === cE ? 8 : e === pE || e === mE || e === gE ? 16 : void 0;
  }
  _getTypedArrayType(e) {
    return e === Mw ? Uint8Array : e === Bw ? Int8Array : e === Rw ? Uint8Array : e === Cw ? Int8Array : e === Ow ? Uint8Array : e === Iw ? Int8Array : e === Uw ? Uint8Array : e === Dw ? Int8Array : e === Yw ? Uint8Array : e === Qw ? Int8Array : e === jw || e === Xw ? Uint8Array : e === Kw ? Int8Array : e === Fw ? Uint16Array : e === Pw ? Int16Array : e === Ww ? Uint16Array : e === Hw ? Int16Array : e === lE ? Uint16Array : e === uE ? Int16Array : e === Lw || e === qw || e === dE || e === Vw ? Uint16Array : e === kw ? Int16Array : e === eE ? Uint16Array : e === tE ? Int16Array : e === hE ? Uint16Array : e === cE ? Int16Array : e === Gw ? Uint32Array : e === $w ? Int32Array : e === zw ? Float32Array : e === aE ? Uint32Array : e === nE ? Int32Array : e === oE ? Float32Array : e === pE ? Uint32Array : e === mE ? Int32Array : e === gE ? Float32Array : e === Zw || e === Jw ? Uint8Array : e === iE || e === rE || e === sE ? Uint32Array : e === yE ? Float32Array : e === fE || e === bE ? Uint32Array : e === xE ? Float32Array : void 0;
  }
  _getDimension(e) {
    let t2;
...
function SR(e, r2) {
  ...
  if (o2 && (h2 = r2.features.has(BA.TextureFormatsTier1), false === h2 && Oi("WebGPURenderer: Unable to use normalized textures without texture-formats-tier1 feature.")), true === e.isCompressedTexture || true === e.isCompressedArrayTexture) switch (s2) {
    case Jt:
    case qt:
      i2 = u2 === je ? TE : _E;
      break;
    ...
    case Et:
      switch (n2) {
        case kt:
          ...
          break;
        case zt:
          r2 && false === r2.features.has(BA.Depth32FloatStencil8) && Pi('WebGPURenderer: Depth textures with DepthStencilFormat + FloatType can only be used with the "depth32float-stencil8" GPU feature.'), i2 = xE;
          break;
        default:
...
var wR = /^[fn]*\s*([a-z_0-9]+)?\s*\(([\s\S]*?)\)\s*[\-\>]*\s*([a-z_0-9]+(?:<[\s\S]+?>)?)/i;
var ER = /([a-z_0-9]+)\s*:\s*([a-z_0-9]+(?:<[\s\S]+?>)?)/gi;
var AR = { f32: "float", i32: "int", u32: "uint", bool: "bool", "vec2<f32>": "vec2", "vec2<i32>": "ivec2", "vec2<u32>": "uvec2", "vec2<bool>": "bvec2", vec2f: "vec2", vec2i: "ivec2", vec2u: "uvec2", vec2b: "bvec2", "vec3<f32>": "vec3", "vec3<i32>": "ivec3", "vec3<u32>": "uvec3", "vec3<bool>": "bvec3", vec3f: "vec3", vec3i: "ivec3", vec3u: "uvec3", vec3b: "bvec3", "vec4<f32>": "vec4", "vec4<i32>": "ivec4", "vec4<u32>": "uvec4", "vec4<bool>": "bvec4", vec4f: "vec4", vec4i: "ivec4", vec4u: "uvec4", vec4b: "bvec4", "mat2x2<f32>": "mat2", mat2x2f: "mat2", "mat3x3<f32>": "mat3", mat3x3f: "mat3", "mat4x4<f32>": "mat4", mat4x4f: "mat4", sampler: "sampler", texture_1d: "texture", texture_2d: "texture", texture_2d_array: "texture", texture_multisampled_2d: "cubeTexture", texture_depth_2d: "depthTexture", texture_depth_2d_array: "depthTexture", texture_depth_multisampled_2d: "depthTexture", texture_depth_cube: "depthTexture", texture_depth_cube_array: "depthTexture", texture_3d: "texture3D", texture_cube: "cubeTexture", texture_cube_array: "cubeTexture", texture_storage_1d: "storageTexture", texture_storage_2d: "storageTexture", texture_storage_2d_array: "storageTexture", texture_storage_3d: "storageTexture" };
var RR = class extends qN {
  constructor(e) {
    let { type: t2, inputs: r2, name: i2, inputsCode: s2, blockCode: a2, outputType: n2 } = ((e2) => {
      let t3 = (e2 = e2.trim()).match(wR);
      if (null !== t3 && 4 === t3.length) {
        let r3 = t3[2], i3 = [], s3 = null;
        for (; null !== (s3 = ER.exec(r3)); ) i3.push({ name: s3[1], type: s3[2] });
        let a3 = [];
        for (let e3 = 0; e3 < i3.length; e3++) {
          let { name: t4, type: r4 } = i3[e3], s4 = r4;
          s4.startsWith("ptr") ? s4 = "pointer" : (s4.startsWith("texture") && (s4 = r4.split("<")[0]), s4 = AR[s4]), a3.push(new FN(s4, t4));
        }
        let n3 = e2.substring(t3[0].length), o2 = t3[3] || "void", l2 = void 0 !== t3[1] ? t3[1] : "";
        return { type: AR[o2] || o2, inputs: a3, name: l2, inputsCode: r3, blockCode: n3, outputType: o2 };
      }
...
var kR = class extends MN {
  ...
  generateWrapFunction(e) {
    let t2 = `tsl_coord_${BR[e.wrapS]}S_${BR[e.wrapT]}T_${e.is3DTexture || e.isData3DTexture ? "3d" : "2d"}`, r2 = DR[t2];
    if (void 0 === r2) {
      let i2 = [], s2 = e.is3DTexture || e.isData3DTexture ? "vec3f" : "vec2f", a2 = `fn ${t2}( coord : ${s2} ) -> ${s2} {

	return ${s2}(
`, n2 = (e2, t3) => {
        e2 === ut ? (i2.push(OR.repeatWrapping_float), a2 += `		tsl_repeatWrapping_float( coord.${t3} )`) : e2 === ct ? (i2.push(OR.clampWrapping_float), a2 += `		tsl_clampWrapping_float( coord.${t3} )`) : e2 === pt ? (i2.push(OR.mirrorWrapping_float), a2 += `		tsl_mirrorWrapping_float( coord.${t3} )`) : (a2 += `		coord.${t3}`, Oi(`WebGPURenderer: Unsupported texture wrap type "${e2}" for vertex shader.`));
      };
      n2(e.wrapS, "x"), a2 += ",\n", n2(e.wrapT, "y"), (e.is3DTexture || e.isData3DTexture) && (a2 += ",\n", n2(e.wrapR, "z")), a2 += "\n	);\n\n}\n", DR[t2] = r2 = new Qx(a2, i2);
    }
  ...
  generateTextureDimension(e, t2, r2) {
    ...
    if (void 0 === i2.dimensionsSnippet[r2]) {
      ...
      n2 = e.is3DTexture || e.isData3DTexture ? "vec3<u32>" : "vec2<u32>", a2 = l2 || e.isStorageTexture ? t2 : `${t2}${r2 ? `, u32( ${r2} )` : ""}`, s2 = new xl2(new du(`textureDimensions( ${a2} )`, n2)), i2.dimensionsSnippet[r2] = s2, (e.isArrayTexture || e.isDataArrayTexture || e.is3DTexture || e.isData3DTexture) && (i2.arrayLayerCount = new xl2(new du(`textureNumLayers(${t2})`, "u32"))), e.isTextureCube && (i2.cubeFaceCount = new xl2(new du("6u", "u32")));
    }
  ...
  getStorageAccess(e, t2) {
    return MR[this.getNodeAccess(e, t2)];
  }
  getUniformFromNode(e, t2, r2, i2 = null) {
    ...
    if (void 0 === a2.uniformGPU) {
      ...
      if ("texture" === t2 || "cubeTexture" === t2 || "cubeDepthTexture" === t2 || "storageTexture" === t2 || "texture3D" === t2) {
        ...
        if ("texture" === t2 || "storageTexture" === t2 ? i3 = true === e.value.is3DTexture ? new GS(s2.name, s2.node, o2, a3) : new VS(s2.name, s2.node, o2, a3) : "cubeTexture" === t2 || "cubeDepthTexture" === t2 ? i3 = new kS(s2.name, s2.node, o2, a3) : "texture3D" === t2 && (i3 = new GS(s2.name, s2.node, o2, a3)), i3.store = true === e.isStorageTextureNode, i3.mipLevel = i3.store ? e.mipLevel : 0, i3.setVisibility(FR[r2]), true === e.value.isCubeTexture || false === this.isUnfilterable(e.value) && false === i3.store || null !== e.gatherNode) {
          let e2 = new PA(`${s2.name}_sampler`, s2.node, o2);
          e2.setVisibility(FR[r2]), u2.push(e2, i3), n2 = [e2, i3];
        ...
        void 0 === l3 && (l3 = new ("buffer" === t2 ? wS : DA)(e, o2), a3.buffer = l3), l3.setVisibility(l3.getVisibility() | FR[r2]), u2.push(l3), n2 = l3, s2.name = i2 || "NodeBuffer_" + s2.id;
      } else {
        let e2 = this.uniformGroups[l2];
        void 0 === e2 && (e2 = new RS(l2, o2), e2.setVisibility(gw.VERTEX | gw.FRAGMENT | gw.COMPUTE), this.uniformGroups[l2] = e2), -1 === u2.indexOf(e2) && u2.push(e2), n2 = this.getNodeUniform(s2, t2);
        let r3 = n2.name;
        e2.uniforms.some((e3) => e3.name === r3) || e2.addUniform(n2);
      }
      a2.uniformGPU = n2;
    ...
    for (let a3 of r2) {
      ...
      if ("texture" === a3.type || "cubeTexture" === a3.type || "cubeDepthTexture" === a3.type || "storageTexture" === a3.type || "texture3D" === a3.type) {
        ...
        if (u2 > 1 && (l2 = "_multisampled"), true === s3.isCubeTexture && true === s3.isDepthTexture) n3 = "texture_depth_cube";
          ...
          let r5 = SR(s3, t2.device), i3 = this.getStorageAccess(a3.node, e), o3 = a3.node.value.is3DTexture, l3 = a3.node.value.isArrayTexture;
...
`), s2 += `${r3.code}
  ...
  isAvailable(e) {
    let t2 = PR[e];
    return void 0 === t2 && ("float32Filterable" === e ? t2 = this.renderer.hasFeature("float32-filterable") : "clipDistance" === e && (t2 = this.renderer.hasFeature("clip-distances")), PR[e] = t2), t2;
  }
  _getWGSLMethod(e) {
    return void 0 !== OR[e] && this._include(e), IR[e];
  }
  _include(e) {
    let t2 = OR[e];
    return t2.build(this), this.addInclude(t2), t2;
...
var GR = new GA();
var $R = new $A();
var zR = /* @__PURE__ */ new Map([[Int8Array, ["sint8", "snorm8"]], [Uint8Array, ["uint8", "unorm8"]], [Int16Array, ["sint16", "snorm16"]], [Uint16Array, ["uint16", "unorm16"]], [Int32Array, ["sint32", "snorm32"]], [Uint32Array, ["uint32", "unorm32"]], [Float32Array, ["float32"]]]);
typeof Float16Array < "u" && zR.set(Float16Array, ["float16"]);
var WR = /* @__PURE__ */ new Map([[Zr, ["float16"]]]);
var HR = /* @__PURE__ */ new Map([[Int32Array, "sint32"], [Int16Array, "sint32"], [Uint32Array, "uint32"], [Uint16Array, "uint32"], [Float32Array, "float32"]]);
var qR = class {
  constructor(e) {
    this.backend = e;
  }
  createAttribute(e, t2) {
    ...
    if (void 0 === a2) {
      ...
      GR.label = r2.name, GR.size = d2, GR.usage = t2, GR.mappedAtCreation = true, a2 = o2.createBuffer(GR), GR.reset(), new l2.constructor(a2.getMappedRange()).set(l2), a2.unmap(), s2.buffer = a2;
    }
  }
  updateAttribute(e) {
  ...
  createShaderVertexBuffers(e) {
    ...
    for (let e2 = 0; e2 < t2.length; e2++) {
      ...
      if (void 0 === n2) {
        let e3, t3;
        true === i2.isInterleavedBufferAttribute ? (e3 = i2.data.stride * s2, t3 = i2.data.isInstancedInterleavedBuffer ? MA : CA) : (e3 = i2.itemSize * s2, t3 = i2.isInstancedBufferAttribute ? MA : CA, i2.itemSize > 1 && e3 % 4 != 0 && (e3 = 4 * Math.floor((e3 + 3) / 4))), n2 = { arrayStride: e3, attributes: [], stepMode: t3 }, r2.set(a2, n2);
      }
  ...
  async getArrayBufferAsync(e, t2 = null, r2 = 0, i2 = -1) {
    ...
    if (null !== t2 && t2.isReadbackBuffer) {
      ...
      if (t2._mapped = true, void 0 === e2.readBufferGPU) {
        GR.label = `${t2.name}_readback`, GR.size = t2.maxByteLength, GR.usage = GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ, s2 = n2.createBuffer(GR), GR.reset();
        let r3 = () => {
    ...
    } else GR.label = `${e.name}_readback`, GR.size = l2, GR.usage = GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ, s2 = n2.createBuffer(GR), GR.reset();
    $R.label = `readback_encoder_${e.name}`;
    let u2 = n2.createCommandEncoder($R);
    if ($R.reset(), u2.copyBufferToBuffer(o2, r2, s2, 0, l2), VA(n2, u2.finish()), await s2.mapAsync(GPUMapMode.READ, 0, l2), null === t2) {
  ...
  _getVertexFormat(e) {
    ...
    if (1 === r2) t2 = HR.get(s2);
    else {
      let e2 = (WR.get(a2) || zR.get(s2))[i2 ? 1 : 0];
      if (e2) {
...
var QR = class {
  ...
  createBindingsLayout(e) {
    ...
    return void 0 === n2 && (n2 = new YR(r2.createBindGroupLayout({ entries: s2 })), this._bindGroupLayoutCache.set(a2, n2)), n2.usedTimes++, i2.layout = n2, i2.layoutKey = a2, n2.layoutGPU;
  }
  ...
  createBindGroupIndex(e, t2) {
    ...
    XR.label = "bindingCameraIndex_" + s2, XR.size = 16, XR.usage = i2;
    let a2 = r2.createBuffer(XR);
    XR.reset(), r2.queue.writeBuffer(a2, 0, e, 0), jR.reset(), jR.label = "bindGroupCameraIndex_" + s2, jR.layout = t2, jR.entries.push({ binding: 0, resource: { buffer: a2 } });
    let n2 = r2.createBindGroup(jR);
    return jR.reset(), n2;
  }
  createBindGroup(e, t2) {
    let r2 = this.backend, i2 = r2.device, s2 = 0;
    jR.reset(), jR.label = "bindGroup_" + e.name, jR.layout = t2;
    for (let t3 of e.bindings) {
      if (t3.isUniformBuffer) {
        let e2 = r2.get(t3);
        jR.entries.push({ binding: s2, resource: { buffer: e2.buffer } });
      } else if (t3.isStorageBuffer) {
        let e2 = r2.get(t3.attribute).buffer;
        jR.entries.push({ binding: s2, resource: { buffer: e2 } });
      } else if (t3.isSampledTexture) {
        ...
        if (void 0 !== a3.externalTexture) e2 = i2.importExternalTexture({ source: a3.externalTexture });
          ...
          if (a3.texture.depthOrArrayLayers > 1 && (s3 += `-${a3.texture.depthOrArrayLayers}`), s3 += `-${r3}-${i3}`, e2 = a3[s3], void 0 === e2) {
            let n2, o2 = "all";
            n2 = t3.isSampledCubeTexture ? AA : t3.texture.isArrayTexture || t3.texture.isDataArrayTexture || t3.texture.isCompressedArrayTexture ? EA : t3.isSampledTexture3D || t3.texture.is3DTexture ? RA : wA, KR.aspect = o2, KR.dimension = n2, KR.mipLevelCount = r3, KR.baseMipLevel = i3, e2 = a3[s3] = a3.texture.createView(KR), KR.reset();
          }
        }
        jR.entries.push({ binding: s2, resource: e2 });
      } else if (t3.isSampler) {
        let e2 = r2.get(t3);
        jR.entries.push({ binding: s2, resource: e2.sampler });
      }
      s2++;
    }
    let a2 = i2.createBindGroup(jR);
    return jR.reset(), a2;
  }
  _createLayoutEntries(e) {
    ...
    for (let i2 of e.bindings) {
      ...
      if (i2.isUniformBuffer || i2.isStorageBuffer) {
        let e3 = {};
        i2.isStorageBuffer && (i2.visibility & gw.COMPUTE && (i2.access === Wi.READ_WRITE || i2.access === Wi.WRITE_ONLY) ? e3.type = "storage" : e3.type = "read-only-storage"), s2.buffer = e3;
      } else if (i2.isSampledTexture && i2.store) {
        let e3 = {};
        e3.format = this.backend.get(i2.texture).texture.format;
        let t3 = i2.access;
        e3.access = t3 === Wi.READ_WRITE ? "read-write" : t3 === Wi.WRITE_ONLY ? "write-only" : "read-only", i2.texture.isArrayTexture ? e3.viewDimension = EA : i2.texture.is3DTexture && (e3.viewDimension = RA), s2.storageTexture = e3;
      } else if (i2.isSampledTexture) {
        let t3 = {}, { primarySamples: r3 } = e2.utils.getTextureSampleData(i2.texture);
        if (r3 > 1 && (t3.multisampled = true, i2.texture.isDepthTexture || (t3.sampleType = SA)), i2.texture.isDepthTexture) e2.compatibilityMode && null === i2.texture.compareFunction ? t3.sampleType = SA : t3.sampleType = "depth";
        else {
          let e3 = i2.texture.type;
          e3 === _t ? t3.sampleType = "sint" : e3 === At ? t3.sampleType = "uint" : e3 === zt && (this.backend.hasFeature("float32-filterable") ? t3.sampleType = "float" : t3.sampleType = SA);
        }
        i2.isSampledCubeTexture ? t3.viewDimension = AA : i2.texture.isArrayTexture || i2.texture.isDataArrayTexture || i2.texture.isCompressedArrayTexture ? t3.viewDimension = EA : i2.isSampledTexture3D && (t3.viewDimension = RA), s2.texture = t3;
...
var iC = class {
  ...
  createRenderPipeline(e, t2) {
    ...
    eC.bindGroupLayouts = c2;
    let S2 = u2.createPipelineLayout(eC);
    eC.reset(), rC.label = `renderPipeline_${a2.name || a2.type}_${a2.id}`, rC.vertex = Object.assign({}, y2, { buffers: m2 }), rC.fragment = Object.assign({}, x2, { targets: b2 }), rC.primitive = _2, rC.multisample.count = N2, rC.multisample.alphaToCoverageEnabled = a2.alphaToCoverage && N2 > 1, rC.layout = S2;
    let w2 = {}, E = e.context.depth, A2 = e.context.stencil;
    (true === E || true === A2) && (true === E && (w2.format = v2, w2.depthWriteEnabled = a2.depthWrite, w2.depthCompare = T2), true === A2 && (w2.stencilFront = g2, w2.stencilBack = g2, w2.stencilReadMask = a2.stencilFuncMask, w2.stencilWriteMask = a2.stencilWriteMask), true === a2.polygonOffset && _2.topology === mw && (w2.depthBias = a2.polygonOffsetUnits, w2.depthBiasSlopeScale = a2.polygonOffsetFactor, w2.depthBiasClamp = 0), rC.depthStencil = w2), u2.pushErrorScope("validation");
    let R = [{ program: n2, module: y2.module }, { program: o2, module: x2.module }], C2 = rC.label;
    if (null === t2) h2.pipeline = u2.createRenderPipeline(rC), rC.reset(), u2.popErrorScope().then((e2) => {
      null !== e2 && (h2.error = true, Pi(`WebGPURenderer: Render pipeline creation failed (${C2}): ${e2.message}`), this._reportShaderDiagnostics(R, C2));
    });
    else {
      let e2 = u2.createRenderPipelineAsync(rC), r3 = u2.popErrorScope();
      rC.reset();
      let i3 = new Promise(async (t3) => {
        try {
          ...
          if (null !== i4 || null !== t4) {
            ...
            Pi(`WebGPURenderer: Async render pipeline creation failed (${C2}): ${e3}`), await this._reportShaderDiagnostics(R, C2);
          }
        } finally {
          t3();
        }
  ...
  createBundleEncoder(e, t2 = "renderBundleEncoder") {
    ...
    tC.label = t2, tC.colorFormats = n2, tC.depthStencilFormat = a2, tC.sampleCount = o2;
    let l2 = s2.createRenderBundleEncoder(tC);
    return tC.reset(), l2;
  }
  createComputePipeline(e, t2) {
    ...
    i2.pushErrorScope("validation"), eC.bindGroupLayouts = n2;
    let u2 = i2.createPipelineLayout(eC);
    eC.reset(), JR.label = l2, JR.compute = s2, JR.layout = u2, a2.pipeline = i2.createComputePipeline(JR), JR.reset(), i2.popErrorScope().then((e2) => {
  ...
  _getBlending(e) {
    ...
    if (i2 === g) {
      ...
      let s3 = (e2, i3, s4, a3) => {
        t2 = { srcFactor: e2, dstFactor: i3, operation: NA }, r2 = { srcFactor: s4, dstFactor: a3, operation: NA };
      };
...
var nC = new $A();
var oC = new sC();
var lC = class extends hw {
  constructor(e, t2, r2 = 2048) {
    super(r2), this.device = e, this.type = t2, oC.label = `queryset_global_timestamp_${t2}`, oC.type = "timestamp", oC.count = this.maxQueries, this.querySet = this.device.createQuerySet(oC), oC.reset();
    let i2 = 8 * this.maxQueries;
    aC.label = `buffer_timestamp_resolve_${t2}`, aC.size = i2, aC.usage = GPUBufferUsage.QUERY_RESOLVE | GPUBufferUsage.COPY_SRC, this.resolveBuffer = this.device.createBuffer(aC), aC.reset(), aC.label = `buffer_timestamp_result_${t2}`, aC.size = i2, aC.usage = GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ, this.resultBuffer = this.device.createBuffer(aC), aC.reset();
  }
  allocateQueriesForContext(e) {
  ...
  async _resolveQueries() {
    ...
    try {
      ...
      let i2 = this.device.createCommandEncoder(nC);
      ...
      let s2 = i2.finish();
      if (VA(this.device, s2), "unmapped" !== this.resultBuffer.mapState) return this.lastValue;
...
var xC = new YA();
var _C = new uR();
var TC = class extends ZS {
  constructor(e = {}) {
    super(e), this.isWebGPUBackend = true, this.parameters.alpha = void 0 === e.alpha || e.alpha, this.parameters.requiredLimits = void 0 === e.requiredLimits ? {} : e.requiredLimits, this.compatibilityMode = null, this.device = null, this.defaultRenderPassdescriptor = null, this.utils = new IA(this), this.attributeUtils = new qR(this), this.bindingUtils = new QR(this), this.capabilities = new ZR(this), this.pipelineUtils = new iC(this), this.textureUtils = new NR(this), this.occludedResolveCache = /* @__PURE__ */ new Map();
  ...
  async init(e) {
    ...
    }, this.device = t2, this.trackTimestamp = this.trackTimestamp && this.hasFeature(BA.TimestampQuery), this.updateSize();
  }
  setXRRenderTargetTextures(e, t2, r2 = null) {
  ...
  _getDefaultRenderPassDescriptor() {
    ...
    if (void 0 === s2 || r2.samples !== i2) {
      if (s2 = new HA(), s2.colorAttachments.push(new WA()), true === e.depth || true === e.stencil) {
        let t4 = new uC();
  ...
  _createExternalTextureViews(e, t2) {
    ...
    else r2.push({ view: t2.texture.createView({ dimension: wA, baseArrayLayer: e.activeCubeFace, arrayLayerCount: 1 }), resolveTarget: void 0, depthSlice: void 0 });
    return r2;
  }
  _getRenderPassDescriptor(e, t2 = {}) {
    ...
    if (void 0 === o2 || s2) {
      ...
      for (let i3 = 0; i3 < s3.length; i3++) {
        ...
        if (true !== a3.externalTexture) {
          if (xC.label = `colorAttachment_${i3}`, xC.baseMipLevel = e.activeMipmapLevel, xC.mipLevelCount = 1, xC.baseArrayLayer = e.activeCubeFace, xC.arrayLayerCount = 1, xC.dimension = wA, r2.isRenderTarget3D) t3 = e.activeCubeFace, xC.baseArrayLayer = 0, xC.dimension = RA;
          else if (r2.isRenderTarget && s3[i3].image.depth > 1) if (true === u2) {
            let t4 = e.camera.cameras;
            for (let e2 = 0; e2 < t4.length; e2++) {
              xC.baseArrayLayer = e2, xC.arrayLayerCount = 1, xC.dimension = wA;
              let t5 = a3.texture.createView(xC);
              l3.push({ view: t5, resolveTarget: void 0, depthSlice: void 0 });
            }
          } else xC.dimension = EA;
          if (true !== u2) {
            let e2, r3, i4 = a3.texture.createView(xC);
      ...
      for (let e2 = 0; e2 < l3.length; e2++) {
        let t4 = l3[e2], r3 = new WA();
        r3.view = t4.view, r3.depthSlice = t4.depthSlice, r3.resolveTarget = t4.resolveTarget, d2.push(r3);
      }
      if (o2 = { textureViews: l3, colorAttachments: d2, descriptor: new HA() }, e.depth) {
        let t4 = this.get(e.depthTexture);
        (e.depthTexture.isArrayTexture || e.depthTexture.isCubeTexture) && (xC.dimension = wA, xC.arrayLayerCount = 1, xC.baseArrayLayer = e.activeCubeFace);
        let r3 = new uC();
        r3.view = t4.texture.createView(xC), o2.depthStencilAttachment = r3, xC.reset();
      }
    ...
    for (let e2 = 0; e2 < o2.colorAttachments.length; e2++) {
      ...
      0 === e2 && t2.clearValue && (i3 = t2.clearValue), r3.loadOp = t2.loadOp || ww, r3.storeOp = t2.storeOp || Sw, r3.clearValue = i3, l2.colorAttachments.push(r3);
    }
  ...
  beginRender(e) {
    ...
    a2 > 0 && (i2.currentOcclusionQuerySet && i2.currentOcclusionQuerySet.destroy(), i2.currentOcclusionQueryBuffer && i2.currentOcclusionQueryBuffer.destroy(), i2.currentOcclusionQuerySet = i2.occlusionQuerySet, i2.currentOcclusionQueryBuffer = i2.occlusionQueryBuffer, i2.currentOcclusionQueryObjects = i2.occlusionQueryObjects, mC.label = `occlusionQuerySet_${e.id}`, mC.type = "occlusion", mC.count = a2, t2 = s2.createQuerySet(mC), mC.reset(), i2.occlusionQuerySet = t2, i2.occlusionQueryIndex = 0, i2.occlusionQueryObjects = new Array(a2), i2.lastOcclusionObject = null), r2 = null === e.textures ? this._getDefaultRenderPassDescriptor() : this._getRenderPassDescriptor(e, { loadOp: ww }), this.initTimestampQuery(wi.RENDER, this.getTimestampUID(e), r2), r2.occlusionQuerySet = t2;
    let n2 = r2.depthStencilAttachment;
    if (null !== e.textures) {
      let t3 = r2.colorAttachments;
      for (let r3 = 0; r3 < t3.length; r3++) {
        let i3 = t3[r3];
        e.clearColor ? (0 === r3 ? i3.clearValue = e.clearColorValue : (dC.r = 0, dC.g = 0, dC.b = 0, dC.a = 1, i3.clearValue = dC), i3.loadOp = Ew) : i3.loadOp = ww, i3.storeOp = Sw;
      }
    } else {
      let t3 = r2.colorAttachments[0];
      e.clearColor ? (t3.clearValue = e.clearColorValue, t3.loadOp = Ew) : t3.loadOp = ww, t3.storeOp = Sw;
    }
    e.depth && (e.clearDepth ? (n2.depthClearValue = e.clearDepthValue, n2.depthLoadOp = Ew) : n2.depthLoadOp = ww, n2.depthStoreOp = Sw), e.stencil && (e.clearStencil ? (n2.stencilClearValue = e.clearStencilValue, n2.stencilLoadOp = Ew) : n2.stencilLoadOp = ww, n2.stencilStoreOp = Sw), cC.label = "renderContext_" + e.id;
    let o2 = s2.createCommandEncoder(cC);
    if (cC.reset(), true === this._isRenderCameraDepthArray(e)) {
  ...
  _createArrayCameraLayerDescriptors(e, t2, r2, i2) {
    ...
    for (let n2 = 0; n2 < i2.length; n2++) {
      let i3 = r2.colorAttachments[0], o2 = new WA();
      ...
      if (l2.label = r2.label, l2.occlusionQuerySet = r2.occlusionQuerySet, l2.timestampWrites = r2.timestampWrites, l2.colorAttachments.push(o2), r2.depthStencilAttachment) {
        let t3 = n2;
        a2.viewCache[t3] || (xC.dimension = wA, xC.baseArrayLayer = n2, xC.arrayLayerCount = 1, a2.viewCache[t3] = a2.texture.createView(xC), xC.reset());
        let r3 = new uC();
        r3.view = a2.viewCache[t3], r3.depthLoadOp = s2.depthLoadOp || Ew, r3.depthStoreOp = s2.depthStoreOp || Sw, r3.depthClearValue = s2.depthClearValue || 1, e.stencil && (r3.stencilLoadOp = s2.stencilLoadOp, r3.stencilStoreOp = s2.stencilStoreOp, r3.stencilClearValue = s2.stencilClearValue), l2.depthStencilAttachment = r3;
      } else {
        let e2 = new uC();
  ...
  _updateArrayCameraLayerDescriptors(e, t2, r2) {
    for (let i2 = 0; i2 < r2.length; i2++) {
      ...
      if (r3.depthStencilAttachment) {
        ...
        e.depth && (e.clearDepth ? (t3.depthClearValue = e.clearDepthValue, t3.depthLoadOp = Ew) : t3.depthLoadOp = ww), e.stencil && (e.clearStencil ? (t3.stencilClearValue = e.clearStencilValue, t3.stencilLoadOp = Ew) : t3.stencilLoadOp = ww);
      }
    }
  }
  finishRender(e) {
    ...
    if (r2 > 0) {
      ...
      void 0 === s2 && (hC.size = i3, hC.usage = GPUBufferUsage.QUERY_RESOLVE | GPUBufferUsage.COPY_SRC, s2 = this.device.createBuffer(hC), hC.reset(), this.occludedResolveCache.set(i3, s2)), hC.size = i3, hC.usage = GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ;
      let a2 = this.device.createBuffer(hC);
      hC.reset(), t2.encoder.resolveQuerySet(t2.occlusionQuerySet, 0, r2, s2, 0), t2.encoder.copyBufferToBuffer(s2, 0, a2, 0, i3), t2.occlusionQueryBuffer = a2, this.resolveOccludedAsync(e);
    }
    if (VA(this.device, t2.encoder.finish()), null !== e.textures) {
      let t3 = e.textures;
      for (let e2 = 0; e2 < t3.length; e2++) {
        let r3 = t3[e2];
  ...
  clear(e, t2, r2, i2 = null) {
    ...
    if (e) {
      ...
      dC.r = e2.r, dC.g = e2.g, dC.b = e2.b, dC.a = e2.a;
    }
    if (null === i2) {
      ...
      if (e) {
        ...
        let e2 = u2[0];
        e2.clearValue = dC, e2.loadOp = Ew, e2.storeOp = Sw;
      }
      (a2 || n2) && (s2 = t3.depthStencilAttachment);
    } else {
      a2 = i2.depth, n2 = i2.stencil;
      let o3 = { loadOp: e ? Ew : ww, clearValue: e ? dC : void 0 };
      a2 && (o3.depthLoadOp = t2 ? Ew : ww, o3.depthClearValue = t2 ? l2.getClearDepth() : void 0, o3.depthStoreOp = Sw), n2 && (o3.stencilLoadOp = r2 ? Ew : ww, o3.stencilClearValue = r2 ? l2.getClearStencil() : void 0, o3.stencilStoreOp = Sw);
      let d3 = this._getRenderPassDescriptor(i2, o3);
      u2 = d3.colorAttachments, s2 = d3.depthStencilAttachment;
    }
    a2 && s2 && (t2 ? (s2.depthLoadOp = Ew, s2.depthClearValue = l2.getClearDepth(), s2.depthStoreOp = Sw) : (s2.depthLoadOp = ww, s2.depthStoreOp = Sw)), n2 && s2 && (r2 ? (s2.stencilLoadOp = Ew, s2.stencilClearValue = l2.getClearStencil(), s2.stencilStoreOp = Sw) : (s2.stencilLoadOp = ww, s2.stencilStoreOp = Sw)), cC.label = "clear";
    let d2 = o2.createCommandEncoder(cC);
    cC.reset(), d2.beginRenderPass({ colorAttachments: u2, depthStencilAttachment: s2 }).end(), VA(o2, d2.finish());
  }
  beginCompute(e) {
    let t2 = this.get(e), r2 = "computeGroup_" + e.id;
    pC.label = r2, cC.label = r2, this.initTimestampQuery(wi.COMPUTE, this.getTimestampUID(e), pC), t2.cmdEncoderGPU = this.device.createCommandEncoder(cC), t2.passEncoderGPU = t2.cmdEncoderGPU.beginComputePass(pC), t2.currentPipeline = null, cC.reset(), pC.reset();
  }
  compute(e, t2, r2, i2, s2 = null) {
  ...
  finishCompute(e) {
    let t2 = this.get(e);
    t2.passEncoderGPU.end(), VA(this.device, t2.cmdEncoderGPU.finish());
  }
  ...
  initTimestampQuery(e, t2, r2) {
    ...
    this.timestampQueryPool[e] || (this.timestampQueryPool[e] = new lC(this.device, e, 2048));
    let i2 = this.timestampQueryPool[e], s2 = i2.allocateQueriesForContext(t2);
    fC.querySet = i2.querySet, fC.beginningOfPassWriteIndex = s2, fC.endOfPassWriteIndex = s2 + 1, r2.timestampWrites = fC;
  }
  createNodeBuilder(e, t2) {
    return new kR(e, t2);
  }
  createProgram(e) {
    let t2 = this.get(e);
    gC.label = e.stage + ("" !== e.name ? `_${e.name}` : ""), gC.code = e.code, t2.module = { module: this.device.createShaderModule(gC), entryPoint: "main" }, gC.reset();
  }
  destroyProgram(e) {
    this.delete(e);
  }
  ...
  createUniformBuffer(e) {
    ...
    if (void 0 === t2.buffer) {
      ...
      e.visibility & gw.VERTEX && s2.push("vertex"), e.visibility & gw.FRAGMENT && s2.push("fragment"), e.visibility & gw.COMPUTE && s2.push("compute");
      let a2 = `(${s2.join(",")})`;
      hC.label = `bindingBuffer${e.id}_${e.name}_${a2}`, hC.size = r2, hC.usage = i2;
      let n2 = this.device.createBuffer(hC);
      hC.reset(), t2.buffer = n2;
    }
  }
  destroyUniformBuffer(e) {
  ...
  hasFeature(e) {
    return void 0 !== FA[e] && (e = FA[e]), this.device.features.has(e);
  }
  copyTextureToTexture(e, t2, r2 = null, i2 = null, s2 = 0, a2 = 0) {
    let n2 = 0, o2 = 0, l2 = 0, u2 = 0, d2 = 0, h2 = 0, c2 = e.image.width, p2 = e.image.height, m2 = 1;
    null !== r2 && (true === r2.isBox3 ? (u2 = r2.min.x, d2 = r2.min.y, h2 = r2.min.z, c2 = r2.max.x - r2.min.x, p2 = r2.max.y - r2.min.y, m2 = r2.max.z - r2.min.z) : (u2 = r2.min.x, d2 = r2.min.y, c2 = r2.max.x - r2.min.x, p2 = r2.max.y - r2.min.y, m2 = 1)), null !== i2 && (n2 = i2.x, o2 = i2.y, l2 = i2.z || 0), cC.label = "copyTextureToTexture_" + e.id + "_" + t2.id;
    let g2 = this.device.createCommandEncoder(cC);
    cC.reset();
    let f2 = this.get(e).texture, b2 = this.get(t2).texture;
    bC.texture = f2, bC.mipLevel = s2, bC.origin.x = u2, bC.origin.y = d2, bC.origin.z = h2, yC.texture = b2, yC.mipLevel = a2, yC.origin.x = n2, yC.origin.y = o2, yC.origin.z = l2, _C.width = c2, _C.height = p2, _C.depthOrArrayLayers = m2, g2.copyTextureToTexture(bC, yC, _C), bC.reset(), yC.reset(), _C.reset(), VA(this.device, g2.finish()), 0 === a2 && t2.generateMipmaps && this.textureUtils.generateMipmaps(t2);
  }
  copyFramebufferToTexture(e, t2, r2) {
    ...
    if (s2.format === n2.format) if (i2.currentPass ? (i2.currentPass.end(), a2 = i2.encoder) : (cC.label = "copyFramebufferToTexture_" + e.id, a2 = this.device.createCommandEncoder(cC), cC.reset()), bC.texture = s2, bC.origin.x = r2.x, bC.origin.y = r2.y, yC.texture = n2, _C.width = r2.z, _C.height = r2.w, a2.copyTextureToTexture(bC, yC, _C), bC.reset(), yC.reset(), _C.reset(), e.generateMipmaps && this.textureUtils.generateMipmaps(e, a2), i2.currentPass) {
      let { descriptor: e2 } = i2;
      for (let t3 = 0; t3 < e2.colorAttachments.length; t3++) e2.colorAttachments[t3].loadOp = ww;
      t2.depth && (e2.depthStencilAttachment.depthLoadOp = ww), t2.stencil && (e2.depthStencilAttachment.stencilLoadOp = ww), i2.currentPass = a2.beginRenderPass(e2), i2.currentSets = { attributes: {}, bindingGroups: [], pipeline: null, index: null }, t2.viewport && this.updateViewport(t2), t2.scissor && this.updateScissor(t2);
    } else VA(this.device, a2.finish());
...
var SC = class extends nS {
  constructor() {
    super(), this.addMaterial(Gm, "MeshPhongMaterial"), this.addMaterial(Mf, "MeshStandardMaterial"), this.addMaterial(Ff, "MeshPhysicalMaterial"), this.addMaterial(Df, "MeshToonMaterial"), this.addMaterial(Fm, "MeshBasicMaterial"), this.addMaterial(Vm, "MeshLambertMaterial"), this.addMaterial(xm, "MeshNormalMaterial"), this.addMaterial(Vf, "MeshMatcapMaterial"), this.addMaterial(am, "LineBasicMaterial"), this.addMaterial(om, "LineDashedMaterial"), this.addMaterial(Hf, "PointsMaterial"), this.addMaterial($f, "SpriteMaterial"), this.addMaterial(Kf, "ShadowMaterial"), this.addLight(JT, nl), this.addLight(LN, ll), this.addLight(WN, cl), this.addLight(DN, rl), this.addLight(PN, ul), this.addLight(UN, Jo), this.addLight(IN, dl), this.addLight(ON, vC), this.addLight(kN, NC), this.addToneMapping(Gx, Q), this.addToneMapping($x, $), this.addToneMapping(zx, K), this.addToneMapping(Hx, tt), this.addToneMapping(Kx, it), this.addToneMapping(Yx, st);
  }
};
var wC = class extends xS {
  constructor(e = {}) {
    let t2;
    e.forceWebGL ? t2 = pw : (t2 = TC, e.getFallback = () => (Oi("WebGPURenderer: WebGPU is not available, running under WebGL2 backend."), new pw(e))), super(new t2(e), e), this.library = new SC(), this.isWebGPURenderer = true, typeof __THREE_DEVTOOLS__ < "u" && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", { detail: this }));
  }
};
var EC = class {
  constructor(e, t2 = ca(0, 0, 1, 1)) {
    ...
    let r2 = new im();
    r2.name = "RenderPipeline", this._quadMesh = new Ky(r2), this._quadMesh.name = "Render Pipeline", this._context = null, this._toneMapping = e.toneMapping, this._outputColorSpace = e.outputColorSpace;
  }
  render() {
    let e = this.renderer;
...
var CC = (qv.BRDF_GGX, qv.BRDF_Lambert, qv.BasicPointShadowFilter, qv.BasicShadowFilter, qv.Break);
var MC = (qv.Const, qv.Continue, qv.DFGLUT, qv.D_GGX, qv.Discard);
var BC = (qv.EPSILON, qv.F_Schlick, qv.Fn);
var FC = (qv.INFINITY, qv.If);
var PC = qv.Loop;
var LC = (qv.NodeAccess, qv.NodeShaderStage, qv.NodeType, qv.NodeUpdateType);
var UC = (qv.PCFShadowFilter, qv.PCFSoftShadowFilter, qv.PI);
var DC = (qv.PI2, qv.TWO_PI, qv.HALF_PI, qv.PointShadowFilter);
var OC = qv.Return;
var IC = (qv.Schlick_to_F0, qv.ShaderNode, qv.Stack, qv.Switch, qv.TBNViewMatrix, qv.VSMShadowFilter, qv.V_GGX_SmithCorrelated, qv.Var, qv.VarIntent, qv.abs);
var VC = (qv.acesFilmicToneMapping, qv.acos);
var kC = (qv.acosh, qv.add, qv.addMethodChaining, qv.addNodeElement, qv.agxToneMapping, qv.all, qv.alphaT, qv.ambientOcclusion, qv.and, qv.anisotropy, qv.anisotropyB, qv.anisotropyT, qv.any);
var GC = (qv.append, qv.array, qv.asin);
var $C = (qv.asinh, qv.assign, qv.atan);
var zC = (qv.atanh, qv.atomicAdd);
var WC = (qv.atomicAnd, qv.atomicFunc, qv.atomicLoad);
var HC = (qv.atomicMax, qv.atomicMin, qv.atomicOr, qv.atomicStore);
var qC = qv.atomicSub;
var jC = (qv.atomicXor, qv.attenuationColor, qv.attenuationDistance, qv.attribute);
var XC = (qv.attributeArray, qv.backgroundBlurriness, qv.backgroundIntensity, qv.backgroundRotation, qv.batch, qv.bentNormalView, qv.billboarding, qv.bitAnd, qv.bitNot, qv.bitOr, qv.bitXor, qv.bitangentGeometry, qv.bitangentLocal, qv.bitangentView, qv.bitangentWorld, qv.bitcast);
var KC = (qv.blendBurn, qv.blendColor, qv.blendDodge, qv.blendOverlay, qv.blendScreen, qv.blur, qv.bool);
var YC = qv.buffer;
var QC = (qv.bufferAttribute, qv.bumpMap, qv.builtin, qv.builtinAOContext, qv.builtinShadowContext, qv.bvec2, qv.bvec3, qv.bvec4, qv.bypass, qv.cache, qv.call, qv.cameraFar, qv.cameraIndex, qv.cameraNear);
var ZC = (qv.cameraNormalMatrix, qv.cameraPosition);
var JC = qv.cameraProjectionMatrix;
var eM = qv.cameraProjectionMatrixInverse;
var tM = qv.cameraViewMatrix;
var rM = (qv.cameraViewport, qv.cameraWorldMatrix);
var iM = (qv.cbrt, qv.cdl, qv.ceil, qv.checker, qv.cineonToneMapping, qv.clamp);
var sM = qv.clearcoat;
var aM = qv.clearcoatNormalView;
var nM = qv.clearcoatRoughness;
var oM = (qv.clipSpace, qv.code, qv.color);
var lM = (qv.colorSpaceToWorking, qv.colorToDirection, qv.compute, qv.computeKernel, qv.computeSkinning, qv.context, qv.convert, qv.convertColorSpace, qv.convertToTexture);
var uM = (qv.countLeadingZeros, qv.countOneBits, qv.countTrailingZeros, qv.cos);
var dM = (qv.cosh, qv.cross);
var hM = qv.cubeTexture;
var cM = (qv.cubeTextureBase, qv.dFdx);
var pM = qv.dFdy;
var mM = (qv.dashSize, qv.debug, qv.decrement, qv.decrementBefore, qv.defaultBuildStages, qv.defaultShaderStages, qv.defined, qv.degrees, qv.deltaTime, qv.densityFog, qv.densityFogFactor, qv.depth);
var gM = (qv.depthPass, qv.determinant, qv.difference, qv.diffuseColor);
var fM = (qv.directPointLight, qv.directionToColor, qv.directionToFaceDirection, qv.dispersion, qv.distance);
var bM = (qv.div, qv.dot);
var yM = (qv.drawIndex, qv.dynamicBufferAttribute, qv.element, qv.emissive);
var xM = (qv.equal, qv.equirectDirection, qv.equirectUV, qv.exp);
var _M = qv.exp2;
var TM = (qv.exponentialHeightFogFactor, qv.expression, qv.faceDirection);
var vM = (qv.faceForward, qv.faceforward, qv.float);
var NM = (qv.floatBitsToInt, qv.floatBitsToUint, qv.floor);
var SM = qv.fog;
var wM = qv.fract;
var EM = (qv.frameGroup, qv.frameId, qv.frontFacing);
var AM = qv.fwidth;
var RM = (qv.gain, qv.gapSize, qv.getConstNodeType, qv.getCurrentStack, qv.getDirection, qv.getDistanceAttenuation, qv.getGeometryRoughness, qv.getNormalFromDepth, qv.interleavedGradientNoise);
var CM = qv.vogelDiskSample;
var MM = (qv.getParallaxCorrectNormal, qv.getRoughness, qv.getScreenPosition, qv.getShIrradianceAt, qv.getShadowMaterial, qv.getShadowRenderObjectFunction, qv.getTextureIndex, qv.getViewPosition);
var BM = qv.globalId;
var FM = (qv.glsl, qv.glslFn, qv.grayscale, qv.greaterThan, qv.greaterThanEqual, qv.hash, qv.highpModelNormalViewMatrix, qv.highpModelViewMatrix, qv.hue);
var PM = (qv.increment, qv.incrementBefore, qv.instance, qv.instanceIndex);
var LM = qv.instancedArray;
var UM = qv.instancedBufferAttribute;
var DM = qv.instancedDynamicBufferAttribute;
var OM = (qv.instancedMesh, qv.int);
var IM = (qv.intBitsToFloat, qv.inverse, qv.inverseSqrt);
var VM = (qv.inversesqrt, qv.invocationLocalIndex, qv.invocationSubgroupIndex, qv.ior);
var kM = qv.iridescence;
var GM = qv.iridescenceIOR;
var $M = qv.iridescenceThickness;
var zM = qv.ivec2;
var WM = qv.ivec3;
var HM = (qv.ivec4, qv.js, qv.label, qv.length);
var qM = (qv.lengthSq, qv.lessThan, qv.lessThanEqual, qv.lightPosition, qv.lightProjectionUV, qv.lightShadowMatrix, qv.lightTargetDirection);
var jM = (qv.lightTargetPosition, qv.lightViewPosition, qv.lightingContext);
var XM = (qv.lights, qv.linearDepth, qv.linearToneMapping, qv.localId);
var KM = (qv.log, qv.log2);
var YM = (qv.logarithmicDepthToViewZ, qv.luminance);
var QM = (qv.mat2, qv.mat3);
var ZM = qv.mat4;
var JM = (qv.matcapUV, qv.materialAO, qv.materialAlphaTest, qv.materialAnisotropy, qv.materialAnisotropyVector, qv.materialAttenuationColor, qv.materialAttenuationDistance, qv.materialClearcoat, qv.materialClearcoatNormal, qv.materialClearcoatRoughness, qv.materialColor);
var eB = (qv.materialDispersion, qv.materialEmissive, qv.materialEnvIntensity);
var tB = (qv.materialEnvRotation, qv.materialIOR, qv.materialIridescence, qv.materialIridescenceIOR, qv.materialIridescenceThickness, qv.materialLightMap, qv.materialLineDashOffset, qv.materialLineDashSize, qv.materialLineGapSize, qv.materialLineScale, qv.materialLineWidth, qv.materialMetalness, qv.materialNormal, qv.materialOpacity, qv.materialPointSize, qv.materialReference, qv.materialReflectivity, qv.materialRefractionRatio, qv.materialRotation, qv.materialRoughness, qv.materialSheen, qv.materialSheenRoughness, qv.materialShininess, qv.materialSpecular, qv.materialSpecularColor, qv.materialSpecularIntensity, qv.materialSpecularStrength, qv.materialThickness, qv.materialTransmission, qv.max);
var rB = (qv.maxMipLevel, qv.mediumpModelViewMatrix, qv.metalness);
var iB = qv.min;
var sB = qv.mix;
var aB = (qv.mixElement, qv.mod);
var nB = (qv.modelDirection, qv.modelNormalMatrix);
var oB = (qv.modelPosition, qv.modelRadius, qv.modelScale);
var lB = qv.modelViewMatrix;
var uB = (qv.modelViewPosition, qv.modelViewProjection);
var dB = qv.modelWorldMatrix;
var hB = qv.modelWorldMatrixInverse;
var cB = (qv.morphReference, qv.mrt);
var pB = qv.mul;
var mB = (qv.mx_aastep, qv.mx_add, qv.mx_atan2, qv.mx_cell_noise_float, qv.mx_contrast, qv.mx_divide, qv.mx_fractal_noise_float, qv.mx_fractal_noise_vec2, qv.mx_fractal_noise_vec3, qv.mx_fractal_noise_vec4, qv.mx_frame, qv.mx_heighttonormal, qv.mx_hsvtorgb, qv.mx_ifequal, qv.mx_ifgreater, qv.mx_ifgreatereq, qv.mx_invert, qv.mx_modulo, qv.mx_multiply, qv.mx_noise_float, qv.mx_noise_vec3, qv.mx_noise_vec4, qv.mx_place2d, qv.mx_power, qv.mx_ramp4, qv.mx_ramplr, qv.mx_ramptb, qv.mx_rgbtohsv, qv.mx_rotate2d, qv.mx_rotate3d, qv.mx_safepower, qv.mx_separate, qv.mx_splitlr, qv.mx_splittb, qv.mx_srgb_texture_to_lin_rec709, qv.mx_subtract, qv.mx_timer, qv.mx_transform_uv, qv.mx_unifiednoise2d, qv.mx_unifiednoise3d, qv.mx_worley_noise_float, qv.mx_worley_noise_vec2, qv.mx_worley_noise_vec3, qv.negate, qv.negateOnBackSide);
var gB = (qv.neutralToneMapping, qv.nodeArray, qv.nodeImmutable, qv.nodeObject);
var fB = (qv.nodeObjectIntent, qv.nodeObjects, qv.nodeProxy, qv.nodeProxyIntent, qv.normalFlat, qv.normalGeometry);
var bB = qv.normalLocal;
var yB = (qv.normalMap, qv.normalView);
var xB = (qv.normalViewGeometry, qv.normalWorld);
var _B = (qv.normalWorldGeometry, qv.normalize);
var TB = (qv.not, qv.notEqual);
var vB = (qv.numWorkgroups, qv.objectDirection, qv.objectGroup, qv.objectPosition, qv.objectRadius, qv.objectScale, qv.objectViewPosition, qv.objectWorldMatrix, qv.OnBeforeObjectUpdate, qv.OnBeforeMaterialUpdate, qv.OnObjectUpdate, qv.OnMaterialUpdate, qv.oneMinus);
var NB = (qv.or, qv.orthographicDepthToViewZ);
var SB = (qv.oscSawtooth, qv.oscSine, qv.oscSquare, qv.oscTriangle, qv.output);
var wB = qv.outputStruct;
var EB = (qv.overloadingFn, qv.overrideNode, qv.overrideNodes, qv.packHalf2x16, qv.packSnorm2x16, qv.packUnorm2x16, qv.packNormalToRGB);
var AB = (qv.parabola, qv.parallaxDirection, qv.parallaxUV, qv.parameter, qv.pass);
var RB = qv.passTexture;
var CB = (qv.pcurve, qv.perspectiveDepthToViewZ);
var MB = qv.pmremTexture;
var BB = (qv.pointShadow, qv.pointUV, qv.pointWidth, qv.positionGeometry);
var FB = qv.positionLocal;
var PB = qv.positionPrevious;
var LB = qv.positionView;
var UB = qv.positionViewDirection;
var DB = qv.positionWorld;
var OB = (qv.positionWorldDirection, qv.posterize, qv.pow);
var IB = qv.pow2;
var VB = (qv.pow3, qv.pow4);
var kB = qv.premultiplyAlpha;
var GB = qv.property;
var $B = (qv.radians, qv.rand);
var zB = (qv.range, qv.rangeFog, qv.rangeFogFactor);
var WB = (qv.reciprocal, qv.reference, qv.referenceBuffer, qv.reflect);
var HB = (qv.reflectVector, qv.reflectView, qv.reflector, qv.refract);
var qB = (qv.refractVector, qv.refractView, qv.reinhardToneMapping, qv.remap, qv.remapClamp, qv.renderGroup);
var jB = (qv.renderOutput, qv.rendererReference, qv.replaceDefaultUV, qv.rotate, qv.rotateUV, qv.roughness);
var XB = qv.round;
var KB = (qv.rtt, qv.sRGBTransferEOTF, qv.sRGBTransferOETF, qv.sample, qv.sampler);
var YB = (qv.samplerComparison, qv.saturate, qv.saturation);
var QB = (qv.screen, qv.screenCoordinate);
var ZB = (qv.screenDPR, qv.screenSize, qv.screenUV);
var JB = qv.select;
var eF = (qv.setCurrentStack, qv.setName, qv.shaderStages, qv.shadow, qv.shadowPositionWorld, qv.shapeCircle, qv.sharedUniformGroup, qv.sheen);
var tF = qv.sheenRoughness;
var rF = (qv.shiftLeft, qv.shiftRight, qv.shininess);
var iF = qv.sign;
var sF = qv.sin;
var aF = (qv.sinh, qv.sinc, qv.skinning, qv.smoothstep);
var nF = (qv.smoothstepElement, qv.specularColor);
var oF = qv.specularF90;
var lF = (qv.spherizeUV, qv.split, qv.spritesheetUV, qv.sqrt);
var uF = (qv.stack, qv.step);
var dF = (qv.stepElement, qv.storage);
var hF = (qv.storageBarrier, qv.storageTexture, qv.storageTexture3D);
var cF = (qv.struct, qv.sub);
var pF = (qv.subgroupAdd, qv.subgroupAll, qv.subgroupAnd, qv.subgroupAny, qv.subgroupBallot, qv.subgroupBroadcast, qv.subgroupBroadcastFirst, qv.subBuild);
var mF = (qv.subgroupElect, qv.subgroupExclusiveAdd, qv.subgroupExclusiveMul, qv.subgroupInclusiveAdd, qv.subgroupInclusiveMul, qv.subgroupIndex, qv.subgroupMax, qv.subgroupMin, qv.subgroupMul, qv.subgroupOr, qv.subgroupShuffle, qv.subgroupShuffleDown, qv.subgroupShuffleUp, qv.subgroupShuffleXor, qv.subgroupSize, qv.subgroupXor, qv.tan);
var gF = (qv.tanh, qv.tangentGeometry, qv.tangentLocal, qv.tangentView, qv.tangentWorld, qv.texture);
var fF = qv.texture3D;
var bF = (qv.textureBarrier, qv.textureBicubic, qv.textureBicubicLevel, qv.textureCubeUV, qv.textureLoad, qv.textureSize);
var yF = (qv.textureLevel, qv.textureStore, qv.thickness, qv.time);
var xF = (qv.toneMapping, qv.toneMappingExposure, qv.toonOutlinePass, qv.transformDirection);
var _F = (qv.transformNormal, qv.transformNormalByInverseViewMatrix, qv.transformNormalByViewMatrix, qv.transformNormalToView);
var TF = (qv.transformedClearcoatNormalView, qv.transformedNormalView, qv.transformedNormalWorld, qv.transmission, qv.transpose, qv.triNoise3D, qv.triplanarTexture, qv.triplanarTextures, qv.trunc, qv.uint);
var vF = (qv.uintBitsToFloat, qv.uniform);
var NF = qv.uniformArray;
var SF = (qv.uniformCubeTexture, qv.uniformGroup, qv.uniformFlow, qv.uniformTexture, qv.unpackHalf2x16, qv.unpackSnorm2x16, qv.unpackUnorm2x16, qv.unpackRGBToNormal, qv.unpremultiplyAlpha);
var wF = qv.userData;
var EF = qv.uv;
var AF = (qv.uvec2, qv.uvec3);
var RF = (qv.uvec4, qv.varying, qv.varyingProperty);
var CF = qv.vec2;
var MF = qv.vec3;
var BF = qv.vec4;
var FF = (qv.vectorComponents, qv.velocity);
var PF = qv.vertexColor;
var LF = qv.vertexIndex;
var UF = qv.vertexStage;
var DF = (qv.vibrance, qv.viewZToLogarithmicDepth, qv.viewZToOrthographicDepth, qv.viewZToPerspectiveDepth, qv.viewZToReversedOrthographicDepth, qv.viewZToReversedPerspectiveDepth, qv.viewport, qv.viewportCoordinate, qv.viewportDepthTexture, qv.viewportLinearDepth, qv.viewportMipTexture, qv.viewportOpaqueMipTexture, qv.viewportResolution, qv.viewportSafeUV, qv.viewportSharedTexture, qv.viewportSize, qv.viewportTexture, qv.viewportUV, qv.wgsl);
var OF = qv.wgslFn;
var IF = qv.workgroupArray;
var VF = qv.workgroupBarrier;
var kF = qv.workgroupId;
qv.workingToColorSpace, qv.xor;
...
//# sourceMappingURL=chunk-HD2QPSO7.js.map
