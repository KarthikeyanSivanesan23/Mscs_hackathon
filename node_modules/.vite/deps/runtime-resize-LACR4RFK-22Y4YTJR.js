...
// node_modules/@splinetool/runtime/build/runtime-resize-LACR4RFK.js
var c = class {
  constructor(t, i, s3, a2, n, r, o, c2) {
    this.eventId = t, this.id = i, this.data = s3, this.dataEvent = a2, this.object = n, this.stage = false, this.actions = O(a2, s3.actions, r, o, c2, n);
  }
  disconnect() {
    w(this.actions);
  }
...
var h = class extends s2 {
  constructor(t, i) {
    super(t), this.eventManager = i, this.breakpoints = [], this.resize = (t2, i2) => {
      this.breakpoints.forEach((s3) => {
        let e2, a2 = za.deviceToSize(s3.data.size), n = "horizontal" === s3.dataEvent.orientation ? t2 : i2;
  ...
  connect() {
    ...
    i.traverseEntity((i2) => {
      var _a;
      (s(i2) || i2 instanceof q) && ((_a = i2.frame) == null ? void 0 : _a.traverse((t) => {
        a2(t);
      })), a2(i2);
    });
  }
...
//# sourceMappingURL=runtime-resize-LACR4RFK-22Y4YTJR.js.map
