...
// node_modules/@splinetool/runtime/build/runtime-tracking-MC74576T.js
var E = new Ki();
var f = new Ki();
var w2 = new Ki();
var y = new Ki();
...
var x = (function() {
  let e2 = new As();
  return (n2, i) => {
    n2.position.copy(i), null !== n2.parent && (e2.copy(n2.parent.matrixWorld).invert(), n2.position.applyMatrix4(e2)), e2.copy(n2.hiddenMatrix).invert(), n2.position.applyMatrix4(e2), n2.updateMatrix(), n2.hasNonUniformScale && (n2.updateMatrixWorld(), n2.updateMatrixWorldRigid()), n2 instanceof $t && j(n2.parent) && n2.invalidateDownstreamBooleanData(true);
  };
})();
var D = class {
  constructor(e2, t, n2, i, s3, a3) {
    this.data = e2, this.id = t, this.object = n2, this.paused = false, this.currentDampingFactor = 1, this.snapComplete = false, this.isReset = false, this.worldPosition0 = new Ki(), this.timeoutId = null, this.delayFinished = true, this.wasOutside = false, this.data = { ...Ea.defaultData, ...e2, ...void 0 === e2.resetOnPointerLeave && { resetOnPointerLeave: false } }, void 0 === e2.target || "cursor" === e2.target || (this.target = i.find(e2.target)), this.data.dampingFactor && (this.currentDampingFactor = this.data.dampingFactor), this.resetDampingFactor = 80 / this.data.resetSpeed + 1, this.object.getWorldPosition(this.worldPosition0), this.actions = O(e2, e2.actions, i, s3, a3, n2);
  }
};
...
var Q2 = new Ki();
var z = new mn();
var T = { type: "requestRender" };
var W = { type: "changeRotation" };
var V = (function() {
  let e2 = new As();
  return function(n2, i) {
    null !== n2.parent ? e2.multiplyMatrices(n2.parent.matrixWorld, n2.hiddenMatrix) : e2.copy(n2.hiddenMatrix), i.premultiply(Q(e2).invert()), n2.rotation.setFromRotationMatrix(i), n2.updateMatrix(), n2 instanceof $t && j(n2.parent) && n2.invalidateDownstreamBooleanData(true);
  };
})();
var A = class {
  constructor(e2, t, n2, i) {
    this.id = t, this.object = n2, this.paused = false, this.currentDampingFactor = 1, this.isReset = false, this.worldQuaternion0 = new Qi(), this.timeoutId = null, this.delayFinished = true, this.wasOutside = false, this.data = { ...Ia.defaultData, ...e2, ...void 0 === e2.resetOnPointerLeave && { resetOnPointerLeave: false } }, void 0 === e2.target || "cursor" === e2.target || (this.target = i.find(e2.target)), this.data.dampingFactor && (this.currentDampingFactor = this.data.dampingFactor), this.object.getWorldQuaternion(this.worldQuaternion0), isNaN(this.worldQuaternion0.x) && (this.worldQuaternion0.x = 0), isNaN(this.worldQuaternion0.y) && (this.worldQuaternion0.y = 0), isNaN(this.worldQuaternion0.z) && (this.worldQuaternion0.z = 0), isNaN(this.worldQuaternion0.w) && (this.worldQuaternion0.w = 1), this.resetDampingFactor = 80 / this.data.resetSpeed + 1;
  }
};
var U = class extends s {
  ...
  updateSingleEvent(e2) {
    ...
    if (h.getWorldPosition(S), !e2.isReset) if (e2.target) e2.target.getWorldPosition(k);
    else {
      if ("custom" === s3 ? (l().getWorldDirection(j2), j2.negate(), z.setFromNormalAndCoplanarPoint(j2, S)) : ("xy" === s3 ? b.set(0, 0, 1) : "xz" === s3 ? b.set(0, 1, 0) : "yz" === s3 && b.set(1, 0, 0), z.setFromNormalAndCoplanarPoint(b, S)), !u.ray.intersectPlane(z, k)) return;
      i > 0 && ("custom" === s3 || void 0 === s3) && k.addScaledVector(j2, i);
    }
    if (e2.isReset || (c ? "target" === t ? O2.copy(c.up).applyMatrix4(C.extractRotation(c.matrixWorld)).normalize() : o.some((e3) => false === e3) ? ("x" === n2 ? (Q2.set(0, 0, 1), false === o[2] && Q2.set(0, 1, 0)) : "y" === n2 ? (Q2.set(1, 0, 0), false === o[0] && Q2.set(0, 0, 1)) : (Q2.set(0, 1, 0), false === o[1] && Q2.set(1, 0, 0)), O2.copy(Q2).applyQuaternion(e2.worldQuaternion0).normalize()) : O2.set(0, 1, 0) : "custom" === s3 ? O2.set(0, 1, 0) : O2.copy(b)), e2.isReset) N.copy(e2.worldQuaternion0);
    else if (S.distanceTo(k) > a3 && r && c) {
      ...
      (function(e3, t2, n3, i2, s4, a4) {
        let o2 = C.elements;
        Y.subVectors(t2, n3), 0 === Y.lengthSq() && (Y.z = 1), Y.normalize(), I.crossVectors(i2, Y), 0 === I.lengthSq() && (1 === Math.abs(i2.z) ? Y.x += 1e-4 : Y.z += 1e-4, Y.normalize(), I.crossVectors(i2, Y)), I.normalize(), B.crossVectors(Y, I), "x" === s4 ? 1 === a4.z ? [I, B, Y] = [Y, I, B] : (I.negate(), [I, Y] = [Y, I]) : "y" === s4 ? 1 === a4.x ? [I, B, Y] = [B, Y, I] : (I.negate(), [B, Y] = [Y, B]) : 1 === a4.x && (I.negate(), [I, B] = [B, I]), o2[0] = I.x, o2[4] = B.x, o2[8] = Y.x, o2[1] = I.y, o2[5] = B.y, o2[9] = Y.y, o2[2] = I.z, o2[6] = B.z, o2[10] = Y.z;
      })(0, k, S, O2, n2, Q2), N.setFromRotationMatrix(C), R.setFromUnitVectors(Q2.applyQuaternion(N), O2), o.some((e3) => false === e3) && "target" !== t && N.premultiply(R).normalize();
    }
    e2.currentDampingFactor > 1 ? (h.updateWorldMatrix(true, false), R.setFromRotationMatrix(Q(h.matrixWorld)), R.slerp(N, 1 / e2.currentDampingFactor), V(h, C.makeRotationFromQuaternion(R)), e2.paused = 8 * (1 - R.dot(N)) < 1e-6) : (V(h, C.makeRotationFromQuaternion(N)), e2.paused = true), (_a = e2.object) == null ? void 0 : _a.dispatchEvent({ type: "beginEvent", eventName: "LookAt" }), h.dispatchEvent(T), h.dispatchEvent(W);
  }
};
var B = new Ki();
var I = new Ki();
var Y = new Ki();
e("Follow", ({ eventContext: e2, eventManager: t }) => new P(e2, t)), e("LookAt", ({ eventContext: e2 }) => new U(e2)), a("tracking");
//# sourceMappingURL=runtime-tracking-MC74576T-HCQHSLAO.js.map
