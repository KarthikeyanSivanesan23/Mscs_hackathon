...
// node_modules/@splinetool/runtime/build/runtime-chunk-5JEZ42OM.js
var n = class extends c(su) {
...
var p = class extends T(nl, n) {
  constructor(s, t, i) {
    ...
    let d = new Ki(-e.far + this.position.x, -e.far + this.position.y, -e.far + this.position.z), n2 = new Ki(e.far + this.position.x, e.far + this.position.y, e.far + this.position.z), p2 = new wr(d, n2), c2 = new pu(p2, new rr(16755200));
...
//# sourceMappingURL=chunk-D3ZVVCME.js.map
