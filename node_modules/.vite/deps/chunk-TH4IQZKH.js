...
// node_modules/@splinetool/runtime/build/runtime-chunk-E3IEBR27.js
var l = new wr();
var u = new Ki();
function m(e) {
  let i2 = false;
...
var y = class extends lr {
  ...
  createGeometryByControls(s2) {
    ...
    let o = (_a = this.localGeometry) == null ? void 0 : _a.uuid, { originalGeometry: r, subdividedGeometry: h, subdivPointer: a } = Ps.build(s2, this.subdivPointer, this.smoothShading, this.hasNonUniformScale ? this.shearScale : void 0);
  ...
  updateMesh(e = false, i2 = false, s2 = false) {
    i2 && this.subdividedGeometry || Ps.buildLevel(this.subdivPointer, true, this.smoothShading ? this.phongAngle : -1, this.originalGeometry, e && this.hasNonUniformScale ? this.shearScaleInv : void 0, s2), this.subdividedGeometry && Ps.buildLevel(this.subdivPointer, false, this.smoothShading ? this.phongAngle : -1, this.subdividedGeometry, e && this.hasNonUniformScale ? this.shearScaleInv : void 0);
  }
  updateTopology() {
    var _a;
    let s2 = (_a = this.localGeometry) == null ? void 0 : _a.uuid;
    this.originalGeometry.dispose(), this.originalGeometry = Ps.buildLevel(this.subdivPointer, true, this.smoothShading ? this.phongAngle : -1), this.subdividedGeometry && (this.subdividedGeometry.dispose(), this.subdividedGeometry = Ps.buildLevel(this.subdivPointer, false, this.smoothShading ? this.phongAngle : -1)), this.localGeometry = this.subdividedGeometry ?? this.originalGeometry, i(this), s(this), this.calcBoundingBox(), s2 && (this.localGeometry.uuid = s2);
  }
  raycast(e, i2) {
    let t = this.localGeometry;
    this.localGeometry = this.originalGeometryNew, $t.prototype.raycast.call(this, e, i2), this.localGeometry = t;
  }
  ...
  freeSubdivPointer() {
    var _a, _b;
    this.subdivPointer && (Ps.freeSubdivPointer(this.subdivPointer), this.subdivPointer = 0), this.localGeometry = void 0, (_a = this.originalGeometry) == null ? void 0 : _a.dispose(), (_b = this.subdividedGeometry) == null ? void 0 : _b.dispose();
  }
  dispose() {
  ...
  updateSubdivisionLevel(s2) {
    var _a;
    if (true === this.skipReactionUpdate) return;
    let o = this.localGeometry, r = o == null ? void 0 : o.uuid, h = o == null ? void 0 : o.userData.parameters, a = s2.subdivisions > 0 ? Ps.buildRefined(this.subdivPointer, s2.subdivisions, this.smoothShading ? s2.phongAngle ?? 35 : -1) : null;
  ...
  updateByPatchedOpGeometry(e, i2, t) {
    super.updateByPatchedOpGeometry(e, i2, t), this.localGeometry && (0 === e.type && 0 === e.path.length && As2(e.props) && this.subdivPointer ? this.updateSubdivisionLevel(i2) : this.createGeometryByControls(i2));
  }
};
...
//# sourceMappingURL=chunk-TH4IQZKH.js.map
