...
// node_modules/@splinetool/runtime/build/runtime-chunk-DK66VKWP.js
function ve(e, t = false) {
  let i2 = null !== e[0].index, s2 = new Set(Object.keys(e[0].attributes)), r4 = new Set(Object.keys(e[0].morphAttributes)), n = {}, a = {}, o2 = e[0].morphTargetsRelative, l3 = new ha(), h = 0;
  for (let d = 0; d < e.length; ++d) {
    ...
    for (let e2 in u.attributes) {
      ...
      void 0 === n[e2] && (n[e2] = []), n[e2].push(u.attributes[e2]), p++;
    }
    if (p !== s2.size) return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index " + d + ". Make sure all geometries have the same number of attributes."), null;
  ...
  for (let e2 in n) {
    ...
    l3.setAttribute(e2, t2);
  }
  for (let e2 in a) {
    let t2 = a[e2][0].length;
    if (0 !== t2) {
      l3.morphAttributes = l3.morphAttributes || {}, l3.morphAttributes[e2] = [];
...
function be(e) {
  ...
  let a = new t(n), o2 = new qr(a, i2, s2), l3 = 0;
...
function xe(e, t = 1e-4) {
  ...
  let i2 = {}, s2 = e.getIndex(), r4 = e.getAttribute("position"), n = s2 ? s2.count : r4.count, a = 0, o2 = Object.keys(e.attributes), l3 = {}, h = {}, d = [], u = ["getX", "getY", "getZ", "getW"], p = ["setX", "setY", "setZ", "setW"];
  for (let t2 = 0, i3 = o2.length; t2 < i3; t2++) {
    let i4 = o2[t2], s3 = e.attributes[i4];
    l3[i4] = new s3.constructor(new s3.array.constructor(s3.count * s3.itemSize), s3.itemSize, s3.normalized);
  ...
  let c = 0.5 * t, m = Math.log10(1 / t), g = Math.pow(10, m), f = c * g;
  for (let t2 = 0; t2 < n; t2++) {
    let r5 = s2 ? s2.getX(t2) : t2, n2 = "";
    for (let t3 = 0, i3 = o2.length; t3 < i3; t3++) {
      let i4 = o2[t3], s3 = e.getAttribute(i4), a2 = s3.itemSize;
      for (let e2 = 0; e2 < a2; e2++) n2 += ~~(s3[u[e2]](r5) * g + f) + ",";
    }
    if (n2 in i2) d.push(i2[n2]);
    else {
      for (let t3 = 0, i3 = o2.length; t3 < i3; t3++) {
        let i4 = o2[t3], s3 = e.getAttribute(i4), n3 = e.morphAttributes[i4], d2 = s3.itemSize, c2 = l3[i4], m2 = h[i4];
        for (let e2 = 0; e2 < d2; e2++) {
          let t4 = u[e2], i5 = p[e2];
          if (c2[i5](a, s3[t4](r5)), n3) for (let e3 = 0, s4 = n3.length; e3 < s4; e3++) m2[e3][i5](a, n3[e3][t4](r5));
        }
      }
      i2[n2] = a, d.push(a), a++;
    }
...
var Ce = (function() {
  ...
  return e.vertEq = function(e2, t) {
    ...
    var a, o2, l3;
    e.vertLeq(t, i2) || (l3 = t, t = i2, i2 = l3), e.vertLeq(s2, r4) || (l3 = s2, s2 = r4, r4 = l3), e.vertLeq(t, s2) || (l3 = t, t = s2, s2 = l3, l3 = i2, i2 = r4, r4 = l3), e.vertLeq(s2, i2) ? e.vertLeq(i2, r4) ? ((a = e.edgeEval(t, s2, i2)) + (o2 = e.edgeEval(s2, i2, r4)) < 0 && (a = -a, o2 = -o2), n.s = e.interpolate(a, s2.s, o2, i2.s)) : ((a = e.edgeSign(t, s2, i2)) + (o2 = -e.edgeSign(t, r4, i2)) < 0 && (a = -a, o2 = -o2), n.s = e.interpolate(a, s2.s, o2, r4.s)) : n.s = (s2.s + i2.s) / 2, e.transLeq(t, i2) || (l3 = t, t = i2, i2 = l3), e.transLeq(s2, r4) || (l3 = s2, s2 = r4, r4 = l3), e.transLeq(t, s2) || (l3 = t, t = s2, s2 = l3, l3 = i2, i2 = r4, r4 = l3), e.transLeq(s2, i2) ? e.transLeq(i2, r4) ? ((a = e.transEval(t, s2, i2)) + (o2 = e.transEval(s2, i2, r4)) < 0 && (a = -a, o2 = -o2), n.t = e.interpolate(a, s2.t, o2, i2.t)) : ((a = e.transSign(t, s2, i2)) + (o2 = -e.transSign(t, r4, i2)) < 0 && (a = -a, o2 = -o2), n.t = e.interpolate(a, s2.t, o2, r4.t)) : n.t = (s2.t + i2.t) / 2;
  }, e;
})();
var Ee = function() {
...
var Le = (function() {
  ...
  return e.prototype.makeEdge_ = function(e2) {
    ...
    var e2, t, i2, s2, r4, n, a = this.fHead, o2 = this.vHead, l3 = this.eHead;
    ...
    for (_e(i2.prev === s2 && null === i2.anEdge), n = l3, n = l3; (r4 = n.next) !== l3; n = r4) _e(r4.Sym.next === n.Sym), _e(r4.Sym !== r4), _e(r4.Sym.Sym === r4), _e(null !== r4.Org), _e(null !== r4.Dst), _e(r4.Lnext.Onext.Sym === r4), _e(r4.Onext.Sym.Lnext === r4);
...
var Be = (function() {
  function e(e2, t) {
    ...
    for (var i2 = 0; i2 < e2 + 1; i2++) this.nodes[i2] = new Ue(), this.handles[i2] = new ze();
...
var Ne = (function() {
  ...
  return e.regionBelow = function(e2) {
    ...
    var o2, l3, h, d, u = true;
    h = s2;
    do {
      _e(Ce.vertLeq(h.Org, h.Dst)), e.addRegionBelow(t, i2, h.Sym), h = h.Onext;
    } while (h !== r4);
    for (null === n && (n = e.regionBelow(i2).eUp.Rprev), l3 = i2, d = n; (h = (o2 = e.regionBelow(l3)).eUp.Sym).Org === d.Org; ) h.Onext !== d && (t.mesh.splice(h.Oprev, h), t.mesh.splice(d.Oprev, h)), o2.windingNumber = l3.windingNumber - h.winding, o2.inside = e.isWindingInside(t, o2.windingNumber), l3.dirty = true, !u && e.checkForRightSplice(t, l3) && (e.addWinding(h, d), e.deleteRegion(t, l3), t.mesh.delete(d)), u = false, l3 = o2, d = h;
    l3.dirty = true, _e(l3.windingNumber - h.winding === o2.windingNumber), a && e.walkDirtyRegions(t, l3);
    ...
    var s2, r4, n = e.regionBelow(i2), a = i2.eUp, o2 = n.eUp, l3 = a.Org, h = o2.Org, d = a.Dst, u = o2.Dst, p = new De();
    if (_e(!Ce.vertEq(u, d)), _e(Ce.edgeSign(d, t.event, l3) <= 0), _e(Ce.edgeSign(u, t.event, h) >= 0), _e(l3 !== t.event && h !== t.event), _e(!i2.fixUpperEdge && !n.fixUpperEdge), l3 === h || Math.min(l3.t, d.t) > Math.max(h.t, u.t)) return false;
    if (Ce.vertLeq(l3, h)) {
      if (Ce.edgeSign(u, l3, h) > 0) return false;
    } else if (Ce.edgeSign(d, h, l3) < 0) return false;
    return e.debugEvent(t), Ce.intersect(d, l3, u, h, p), _e(Math.min(l3.t, d.t) <= p.t), _e(p.t <= Math.max(h.t, u.t)), _e(Math.min(u.s, d.s) <= p.s), _e(p.s <= Math.max(h.s, l3.s)), Ce.vertLeq(p, t.event) && (p.s = t.event.s, p.t = t.event.t), s2 = Ce.vertLeq(l3, h) ? l3 : h, Ce.vertLeq(s2, p) && (p.s = s2.s, p.t = s2.t), Ce.vertEq(p, l3) || Ce.vertEq(p, h) ? (e.checkForRightSplice(t, i2), false) : !Ce.vertEq(d, t.event) && Ce.edgeSign(d, t.event, p) >= 0 || !Ce.vertEq(u, t.event) && Ce.edgeSign(u, t.event, p) <= 0 ? u === t.event ? (t.mesh.splitEdge(a.Sym), t.mesh.splice(o2.Sym, a), i2 = e.topLeftRegion(t, i2), a = e.regionBelow(i2).eUp, e.finishLeftRegions(t, e.regionBelow(i2), n), e.addRightEdges(t, i2, a.Oprev, a, a, true), true) : d === t.event ? (t.mesh.splitEdge(o2.Sym), t.mesh.splice(a.Lnext, o2.Oprev), n = i2, i2 = e.topRightRegion(i2), r4 = e.regionBelow(i2).eUp.Rprev, n.eUp = o2.Oprev, o2 = e.finishLeftRegions(t, n, null), e.addRightEdges(t, i2, o2.Onext, a.Rprev, r4, true), true) : (Ce.edgeSign(d, t.event, p) >= 0 && (e.regionAbove(i2).dirty = i2.dirty = true, t.mesh.splitEdge(a.Sym), a.Org.s = t.event.s, a.Org.t = t.event.t), Ce.edgeSign(u, t.event, p) <= 0 && (i2.dirty = n.dirty = true, t.mesh.splitEdge(o2.Sym), o2.Org.s = t.event.s, o2.Org.t = t.event.t), false) : (t.mesh.splitEdge(a.Sym), t.mesh.splitEdge(o2.Sym), t.mesh.splice(o2.Oprev, a), a.Org.s = p.s, a.Org.t = p.t, a.Org.pqHandle = t.pq.insert(a.Org), e.getIntersectData(t, a.Org, l3, d, h, u), e.regionAbove(i2).dirty = i2.dirty = n.dirty = true, false);
    ...
    var r4, n = s2.Onext, a = e.regionBelow(i2), o2 = i2.eUp, l3 = a.eUp, h = false;
    o2.Dst !== l3.Dst && e.checkForIntersect(t, i2), Ce.vertEq(o2.Org, t.event) && (t.mesh.splice(n.Oprev, o2), i2 = e.topLeftRegion(t, i2), n = e.regionBelow(i2).eUp, e.finishLeftRegions(t, e.regionBelow(i2), a), h = true), Ce.vertEq(l3.Org, t.event) && (t.mesh.splice(s2, l3.Oprev), s2 = e.finishLeftRegions(t, a, null), h = true), h ? e.addRightEdges(t, i2, s2.Onext, n, n, true) : (r4 = Ce.vertLeq(l3.Org, o2.Org) ? l3.Oprev : o2, r4 = t.mesh.connect(s2.Lprev, r4), e.addRightEdges(t, i2, r4, r4.Onext, r4.Onext, false), r4.Sym.activeRegion.fixUpperEdge = true, e.walkDirtyRegions(t, i2));
  }, e.connectLeftDegenerate = function(t, i2, s2) {
    var r4, n, a, o2, l3;
    return r4 = i2.eUp, Ce.vertEq(r4.Org, s2) ? (_e(false), void e.spliceMergeVertices(t, r4, s2.anEdge)) : Ce.vertEq(r4.Dst, s2) ? (_e(false), i2 = e.topRightRegion(i2), n = o2 = (a = (l3 = e.regionBelow(i2)).eUp.Sym).Onext, l3.fixUpperEdge && (_e(n !== a), e.deleteRegion(t, l3), t.mesh.delete(a), a = n.Oprev), t.mesh.splice(s2.anEdge, a), Ce.edgeGoesLeft(n) || (n = null), void e.addRightEdges(t, i2, a.Onext, o2, n, true)) : (t.mesh.splitEdge(r4.Sym), i2.fixUpperEdge && (t.mesh.delete(r4.Onext), i2.fixUpperEdge = false), t.mesh.splice(s2.anEdge, r4), void e.sweepEvent(t, s2));
  }, e.connectLeftVertex = function(t, i2) {
    var s2, r4, n, a, o2, l3, h = new Re();
    if (h.eUp = i2.anEdge.Sym, s2 = t.dict.search(h).key, r4 = e.regionBelow(s2)) {
      ...
      n = Ce.vertLeq(o2.Dst, a.Dst) ? s2 : r4, s2.inside || n.fixUpperEdge ? (l3 = n === s2 ? t.mesh.connect(i2.anEdge.Sym, a.Lnext) : t.mesh.connect(o2.Dnext, i2.anEdge).Sym, n.fixUpperEdge ? e.fixUpperEdge(t, n, l3) : e.computeWinding(t, e.addRegionBelow(t, s2, l3)), e.sweepEvent(t, i2)) : e.addRightEdges(t, s2, i2.anEdge, i2.anEdge, null, true);
    }
    ...
    for (r4 += 8, t = e2.pq = new Be(r4, Ce.vertLeq), i2 = (s2 = e2.mesh.vHead).next; i2 !== s2; i2 = i2.next) i2.pqHandle = t.insert(i2);
...
var ke = (function() {
  ...
  return e.prototype.dot_ = function(e2, t) {
    ...
    var t, i2, s2, r4, n, a, o2 = [0, 0, 0], l3 = [0, 0, 0], h = [0, 0, 0], d = [0, 0, 0], u = [0, 0, 0], p = [null, null, null], c = [null, null, null], m = this.mesh.vHead;
    t = m.next;
    for (var g = 0; g < 3; ++g) r4 = t.coords[g], l3[g] = r4, c[g] = t, o2[g] = r4, p[g] = t;
    for (t = m.next; t !== m; t = t.next) for (var f = 0; f < 3; ++f) (r4 = t.coords[f]) < l3[f] && (l3[f] = r4, c[f] = t), r4 > o2[f] && (o2[f] = r4, p[f] = t);
    var y = 0;
    if (o2[1] - l3[1] > o2[0] - l3[0] && (y = 1), o2[2] - l3[2] > o2[y] - l3[y] && (y = 2), l3[y] >= o2[y]) return e2[0] = 0, e2[1] = 0, void (e2[2] = 1);
    for (a = 0, i2 = c[y], s2 = p[y], h[0] = i2.coords[0] - s2.coords[0], h[1] = i2.coords[1] - s2.coords[1], h[2] = i2.coords[2] - s2.coords[2], t = m.next; t !== m; t = t.next) d[0] = t.coords[0] - s2.coords[0], d[1] = t.coords[1] - s2.coords[1], d[2] = t.coords[2] - s2.coords[2], u[0] = h[1] * d[2] - h[2] * d[1], u[1] = h[2] * d[0] - h[0] * d[2], u[2] = h[0] * d[1] - h[1] * d[0], (n = u[0] * u[0] + u[1] * u[1] + u[2] * u[2]) > a && (a = n, e2[0] = u[0], e2[1] = u[1], e2[2] = u[2]);
    ...
    for (var o2 = true, l3 = i2.next; l3 !== i2; l3 = l3.next) o2 ? (this.bmin[0] = this.bmax[0] = l3.s, this.bmin[1] = this.bmax[1] = l3.t, o2 = false) : (l3.s < this.bmin[0] && (this.bmin[0] = l3.s), l3.s > this.bmax[0] && (this.bmax[0] = l3.s), l3.t < this.bmin[1] && (this.bmin[1] = l3.t), l3.t > this.bmax[1] && (this.bmax[1] = l3.t));
    ...
    for (var l3 = e2.vHead.next; l3 !== e2.vHead; l3 = l3.next) l3.n = -1;
    for (var h = e2.fHead.next; h !== e2.fHead; h = h.next) if (h.n = -1, h.inside) {
      r4 = h.anEdge, n = 0;
      do {
        -1 === (l3 = r4.Org).n && (l3.n = o2, o2++), n++, r4 = r4.Lnext;
      } while (r4 !== h.anEdge);
      if (n > i2) throw "Face vertex greater that support polygon";
      h.n = a, ++a;
    }
    for (this.elementCount = a, t === Me.CONNECTED_POLYGONS && (a *= 2), this.elements = [], this.elements.length = a * i2, this.vertexCount = o2, this.vertices = [], this.vertices.length = o2 * s2, this.vertexIndices = [], this.vertexIndices.length = o2, l3 = e2.vHead.next; l3 !== e2.vHead; l3 = l3.next) if (-1 !== l3.n) {
      var d = l3.n * s2;
      this.vertices[d + 0] = l3.coords[0], this.vertices[d + 1] = l3.coords[1], s2 > 2 && (this.vertices[d + 2] = l3.coords[2]), this.vertexIndices[l3.n] = l3.idx;
    }
    var u = 0;
    for (h = e2.fHead.next; h !== e2.fHead; h = h.next) if (h.inside) {
      r4 = h.anEdge, n = 0;
      do {
        l3 = r4.Org, this.elements[u++] = l3.n, n++, r4 = r4.Lnext;
      } while (r4 !== h.anEdge);
    ...
    for (r4 = 0, a = e2.fHead.next; a !== e2.fHead; a = a.next) if (a.inside) {
      n = 0, s2 = i2 = a.anEdge;
      do {
        this.vertices[o2++] = i2.Org.coords[0], this.vertices[o2++] = i2.Org.coords[1], t > 2 && (this.vertices[o2++] = i2.Org.coords[2]), this.vertexIndices[l3++] = this.vertexIdCallback ? this.vertexIdCallback(i2) : i2.Org.idx, n++, i2 = i2.Lnext;
      } while (i2 !== s2);
...
function Fe(e) {
  var t = e.windingRule, i2 = void 0 === t ? we.ODD : t, s2 = e.elementType, r4 = void 0 === s2 ? Me.POLYGONS : s2, n = e.polySize, a = void 0 === n ? 3 : n, o2 = e.vertexSize, l3 = void 0 === o2 ? 2 : o2, h = e.normal, d = void 0 === h ? [0, 0, 1] : h, u = e.contours, p = void 0 === u ? [] : u, c = e.strict, m = void 0 === c || c, g = e.debug, f = void 0 !== g && g;
  if (!p && m) throw new Error("Contours can't be empty");
  if (p) {
    var y = new ke();
    e.edgeCreateCallback && (y.edgeCreateCallback = e.edgeCreateCallback), e.vertexIdCallback && (y.vertexIdCallback = e.vertexIdCallback);
    for (var v = 0; v < p.length; v++) y.addContour(l3 || 2, p[v]);
    return y.tesselate(i2, r4, a, l3, d, m), { vertices: y.vertices, vertexIndices: y.vertexIndices, vertexCount: y.vertexCount, elements: y.elements, elementCount: y.elementCount, mesh: f ? y.mesh : void 0 };
  }
}
...
function it(e) {
  ...
  let i2 = new Gi();
  return i2.addVectors(e.v2, Ze.subVectors(e.v1, e.v2).multiplyScalar(2 / 3)), new sh(e.v0, t, i2, e.v2);
}
...
function ot(e, t, i2) {
  return ct2(e, t) && ct2(t, i2) && lt(e.position, t.position, i2.position);
}
function lt(e, t, i2) {
  return 0 === Xe.copy(t).sub(e).cross(Ze.copy(i2).sub(e));
}
function ht(e, t, i2, s2, r4) {
  let n = Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2)), a = (e.y + t.y) / 2, o2 = (e.x + t.x) / 2, l3 = Math.sqrt(Math.pow(i2, 2) - Math.pow(n / 2, 2)) * (e.y - t.y) / n, h = Math.sqrt(Math.pow(i2, 2) - Math.pow(n / 2, 2)) * (t.x - e.x) / n;
  return s2.set(o2 + l3, a + h), r4.set(o2 - l3, a - h), [s2, r4];
}
function dt(e, t, i2) {
  return e.distanceTo(i2) < t.distanceTo(i2) ? t : e;
}
function ut(e, t, i2, s2, r4, n) {
  let a, o2 = t.x - e.x, l3 = t.y - e.y, h = i2.x - e.x, d = i2.y - e.y, u = Math.sqrt((o2 + h) * (o2 + h) + (l3 + d) * (l3 + d));
  return at(t, e, i2) > Math.PI && (u *= -1), a = st(d, l3) ? (l3 + d) * (s2 / u - 0.5) * 8 / 3 / (o2 - h) : (o2 + h) * (s2 / u - 0.5) * 8 / 3 / (d - l3), r4.set(t.x - a * l3, t.y + a * o2), n.set(i2.x + a * d, i2.y - a * h), [r4, n];
}
function pt2(e, t) {
...
function mt(e, t = 12, i2 = false) {
  let s2 = [];
  for (let r4 = 0, n = e.length; r4 < n; r4++) {
    let n2 = e[r4], a = 0;
    if (i2 && void 0 !== n2.roundedCurveCorner) {
      let e2 = 0.5 * gt(n2.roundedCurveCorner, t);
      r4 > 0 && (s2[r4 - 1] += e2), a += e2;
    }
    void 0 !== n2.curveAfter && (a += gt(n2.curveAfter, t)), s2.push(a);
  }
  return e.length > 0 && i2 && void 0 !== e[0].roundedCurveCorner && (s2[e.length - 1] += 0.5 * gt(e[0].roundedCurveCorner, t)), s2;
}
function gt(e, t = 12) {
...
var St = class extends ph {
  ...
  extractShapePointsToBuffer(e, t = 12, i2 = false) {
    ...
    return (function(e2, t2, i3 = 12, s3 = true) {
      ...
      for (let s4 = 0; s4 < t2.length; s4++) {
        let l3 = Ye(t2[s4]), h = Xe, d = gt(l3, i3);
        o2.push(d);
        for (let t3 = 0; t3 <= d; t3++) if (l3 instanceof sh || l3 instanceof hh || l3 instanceof ah) {
          if (l3.getPoint(t3 / d, h), n.set(h.x, h.y, 0), void 0 !== r4 && nt(r4, n)) continue;
  ...
  computeCurveDivisions(e = 12) {
    return this.curveDivisions = mt(this.points, e, false), this.roundedCurveDivisions = mt(this.points, e, true), this.curveDivisions;
  }
  extractFilteredShapePointsToBuffer(e, t, i2 = 12) {
    return 2 * (function(e2, t2, i3, s2 = 12, r4 = true) {
      ...
      for (let r5 = 0; r5 < t2.length; r5++) {
        ...
        let l3, h = Ye(t2[r5]), d = Xe, u = gt(h, s2);
        o2.push(u);
        for (let t3 = 0; t3 <= u; t3++) if (h instanceof sh || h instanceof hh || h instanceof ah) {
          if (h.getPoint(t3 / u, d), n.set(d.x, d.y, 0), l3 == null ? void 0 : l3.equals(n)) continue;
          void 0 === l3 ? l3 = et : (e2.setXYZ(a, l3.x, l3.y, l3.z), a++, e2.setXYZ(a, n.x, n.y, n.z), a++), l3.copy(n);
        }
      }
  ...
  extractShapePointsToFlatArray(e, t = 12) {
    return this.subdivision = t, void 0 === this.curveDivisions && this.computeCurveDivisions(t), (function(e2, t2, i2 = 12, s2 = true) {
      ...
      for (let s3 = 0; s3 < t2.length; s3++) {
        let a = Ye(t2[s3]), o2 = gt(a, i2), l3 = Xe;
        for (let t3 = 0; t3 <= o2; t3++) if (a instanceof sh || a instanceof hh || a instanceof ah) {
          if (a.getPoint(t3 / o2, l3), void 0 !== r4 && rt(r4, l3, Ve)) continue;
          void 0 === r4 && (r4 = Ze), r4.copy(l3), e2.push(l3.x, l3.y), n++;
        }
      }
  ...
  getCurveIndexFromVertexId(e, t = false) {
    ...
    t && void 0 !== this.points[0].roundedCurveCorner && (r4 = 0.5 * gt(this.points[0].roundedCurveCorner, this.subdivision));
    let n = e - r4;
  ...
  _applyCurveForPoint(e, t) {
    pt2(t, e) ? this.lineTo(e.position.x, e.position.y) : this.bezierCurveTo(t.controls[1].position.x, t.controls[1].position.y, e.controls[0].position.x, e.controls[0].position.y, e.position.x, e.position.y);
    ...
    if (this.points.length > 2) {
      ...
      for (let t = 0, i2 = this.points.length; t < i2; t++) {
        ...
        if (!i3.controlsMoved() && n > 0 && !a) {
          ...
          let a2, o2 = i3.roundedCurveBefore, l3 = i3.roundedCurveAfter, h = s3 instanceof ah ? s3.v1.distanceTo(s3.v2) : s3.getLength(), d = r5 instanceof ah ? r5.v1.distanceTo(r5.v2) : r5.getLength(), u = Math.min(n, 0.499 * h), p = Math.min(n, 0.499 * d), c = Math.min(u, p), m = 1 - c / h, g = c / d, f = s3.getPointAt(m, ft2), y = r5.getPointAt(g, yt);
          if (this._subSplitCurve(s3, o2, m, f, void 0), this._subSplitCurve(r5, l3, g, void 0, y), this.useCubicForRoundedCorners) {
            let e3 = at(f, i3.position, y) / 2, t2 = Math.tan(e3) * f.distanceTo(i3.position), [s4, r6] = ht(f, y, t2, vt, bt), n2 = dt(s4, r6, i3.position), [o3, l4] = ut(n2, f, y, t2, xt, wt);
            a2 = new sh(f.clone(), o3.clone(), l4.clone(), y.clone());
  ...
  _subSplitCurve(e, t, i2, s2, r4) {
    if (!(e instanceof ah)) {
      let n = e, a = t, o2 = n.getUtoTmapping(i2, 0), l3 = (function(e2, t2, i3, s3, r5 = 0.5) {
        let n2 = Xe.subVectors(t2, e2).multiplyScalar(r5).add(e2), a2 = Ze.subVectors(i3, t2).multiplyScalar(r5).add(t2), o3 = Je.subVectors(s3, i3).multiplyScalar(r5).add(i3), l4 = n2, h = $e.subVectors(a2, n2).multiplyScalar(r5).add(n2), d = Ke.subVectors(o3, a2).multiplyScalar(r5).add(a2), u = o3, p = Qe.subVectors(d, h).multiplyScalar(r5).add(h);
        return [e2.x, e2.y, l4.x, l4.y, h.x, h.y, p.x, p.y, d.x, d.y, u.x, u.y, s3.x, s3.y];
      })(n.v0, n.v1, n.v2, n.v3, o2);
      return void 0 !== s2 && (a.v0.set(l3[0], l3[1]), a.v1.set(l3[2], l3[3]), a.v2.set(l3[4], l3[5]), a.v3.set(l3[6], l3[7])), void 0 !== r4 && (a.v0.set(l3[6], l3[7]), a.v1.set(l3[8], l3[9]), a.v2.set(l3[10], l3[11]), a.v3.set(l3[12], l3[13])), a;
    }
  ...
  fromJSON(e) {
    ...
    for (let i2 = 0; i2 < t; i2++) {
      let t2 = 7 * i2, s2 = e.points[t2 + 0], r4 = e.points[t2 + 1], n = e.points[t2 + 2], a = e.points[t2 + 3], o2 = e.points[t2 + 4], l3 = e.points[t2 + 5], h = e.points[t2 + 6], d = new qe(Zi.generateUUID(), new Gi(s2, r4));
      d.controls[0].position.set(n, a), d.controls[1].position.set(o2, l3), d.roundness = h, this.points.push(d);
    }
...
var Mt = class {
  ...
  realloc(e, t = false) {
    ...
    n += 3 * e;
    let l3 = new Float32Array(s2, n * r4, 2 * e);
    t ? (a.set(this.positions.subarray(0, 3 * this.size)), o2.set(this.normals.subarray(0, 3 * this.size)), l3.set(this.uvs.subarray(0, 2 * this.size))) : (a.set(this.positions), o2.set(this.normals), l3.set(this.uvs)), this.buffer = s2, this.positions = a, this.normals = o2, this.uvs = l3, this.capacity = e;
  }
  get(e = 1) {
    let t = this.size + e;
    if (t > this.capacity) {
...
function At(e, t, i2, s2) {
  this.x = e, this.y = t, this.h = i2, this.d = (function(e2, t2, i3) {
    ...
    for (let n of i3) for (let i4 = 0, a = n.length, o2 = a - 1; i4 < a; o2 = i4++) {
      let a2 = n[i4], l3 = n[o2];
      a2[1] > t2 != l3[1] > t2 && e2 < (l3[0] - a2[0]) * (t2 - a2[1]) / (l3[1] - a2[1]) + a2[0] && (s3 = !s3), r4 = Math.min(r4, _t(e2, t2, a2, l3));
    }
...
var Ct2 = { vertices: [160, 160, -160, 160, -160, -160, 160, -160], vertexIndices: [1, 0, 3, 2], vertexCount: 4, elements: [0, 4], elementCount: 1, mesh: void 0 };
var Et2 = { vertices: [], vertexIndices: [], vertexCount: 0, elements: [], elementCount: 0, mesh: void 0 };
...
var Lt = class extends ha {
  constructor(e, t, i2 = 0, s2 = 12, r4 = 3, n = we.ODD, a = false) {
    ...
    let o2, l3, h, d = this._shape.extractShapePointsToFlatArray([], s2), u = this._shape.shapeHoles.map((e2) => {
    ...
    for (let e2 = 0; e2 < d.length; e2 += 2) c.push([d[e2], d[e2 + 1]]);
    p.push(c);
    ...
    o2 = e.isText ? 0.1 * new Xl().setFromPoints(e.points.map((e2) => e2.position)).getSize(new Gi()).length() : 0 === p[0].length ? i2 : i2 > 0 ? (function(e2, t2, i3 = 1, s3 = false) {
      let r5 = 1 / 0, n2 = 1 / 0, a2 = -1 / 0, o3 = -1 / 0;
      for (let [t3, i4] of e2[0]) t3 < r5 && (r5 = t3), i4 < n2 && (n2 = i4), t3 > a2 && (a2 = t3), i4 > o3 && (o3 = i4);
      let l4 = a2 - r5, h2 = o3 - n2, d2 = Math.max(i3, Math.min(l4, h2));
      if (d2 === i3) {
        let e3 = [r5, n2];
        return e3.distance = 0, e3.distance;
      }
      let u2 = new Pt([], (e3, t3) => t3.max - e3.max), p2 = (function(e3) {
        let t3 = 0, i4 = 0, s4 = 0, r6 = e3[0];
        for (let e4 = 0, n4 = r6.length, a3 = n4 - 1; e4 < n4; a3 = e4++) {
          let n5 = r6[e4], o4 = r6[a3], l5 = n5[0] * o4[1] - o4[0] * n5[1];
          i4 += (n5[0] + o4[0]) * l5, s4 += (n5[1] + o4[1]) * l5, t3 += 3 * l5;
        }
        let n3 = new At(i4 / t3, s4 / t3, 0, e3);
        return 0 === t3 || n3.d < 0 ? new At(r6[0][0], r6[0][1], 0, e3) : n3;
      })(e2), c2 = new At(r5 + l4 / 2, n2 + h2 / 2, 0, e2);
      c2.d > p2.d && (p2 = c2);
      let m2 = 2;
      function g2(r6, n3, a3) {
        let o4 = new At(r6, n3, a3, e2);
        if (m2++, o4.max > p2.d + i3 && u2.push(o4), o4.d > p2.d && (p2 = o4, s3 && console.log(`found best ${Math.round(1e4 * o4.d) / 1e4} after ${m2} probes`), p2.d > t2)) return t2;
      }
      let f2 = d2 / 2;
      for (let e3 = r5; e3 < a2; e3 += d2) for (let t3 = n2; t3 < o3; t3 += d2) g2(e3 + f2, t3 + f2, f2);
      for (; u2.length; ) {
        let { max: e3, x: t3, y: s4, h: r6 } = u2.pop();
        if (e3 - p2.d <= i3) break;
        f2 = r6 / 2, g2(t3 - f2, s4 - f2, f2), g2(t3 + f2, s4 - f2, f2), g2(t3 - f2, s4 + f2, f2), g2(t3 + f2, s4 + f2, f2);
      }
      s3 && console.log(`num probes: ${m2}
best distance: ${p2.d}`);
      let y2 = [p2.x, p2.y];
      return y2.distance = p2.d, y2.distance;
    })(p, i2) : 1e-5, i2 <= 0 ? (this._bevel = 0, this._bevelSegments = 0) : (this._bevel = Math.min(i2, o2, t / 2), this._bevelSegments = Math.floor(r4));
    try {
      l3 = Fe({ windingRule: n, elementType: Me.BOUNDARY_CONTOURS, vertexSize: 2, strict: true, contours: [d] });
    } catch {
      l3 = Ct2;
    }
    try {
    ...
    if (!l3) throw new Error("error generating geometry");
    let m = l3.elementCount;
    if (h) {
      l3.elementCount += h.elementCount;
      for (let e2 = 0; e2 < h.elements.length; e2++) {
        let t2 = h.elements[e2], i3 = e2 % 2 == 0 ? l3.vertexCount : 0;
        l3.elements.push(t2 + i3);
      }
      for (let e2 = 0; e2 < h.vertexIndices.length; e2++) {
        let t2 = h.vertexIndices[e2], i3 = l3.vertexCount;
        l3.vertexIndices.push(t2 + i3);
      }
    ...
    let g = 1 / 0, f = -1 / 0, y = 1 / 0, v = -1 / 0;
    for (let e2 = 0, t2 = l3.vertexCount; e2 < t2; e2++) {
      let t3 = 2 * e2, i3 = l3.vertices[t3 + 0], s3 = l3.vertices[t3 + 1];
      i3 < g && (g = i3), i3 > f && (f = i3), s3 < y && (y = s3), s3 > v && (v = s3);
    }
    this._minX = g, this._minY = y, this._width = f - g, this._height = v - y, this._buffer = new Ot(this._computeBufferEstimatedSize(l3));
    let b = [], x = [];
    for (let e2 = l3.elementCount - 1; e2 >= 0; e2--) {
      let t2 = e2 >= m, i3 = 2 * e2, r5 = l3.elements[i3 + 0], n2 = l3.elements[i3 + 1], h2 = r5 + n2, d2 = { start: r5, count: n2, normals: [], continuous: [], concave: [] }, p2 = r5, c2 = h2 - 1, g2 = r5 + 1, f2 = this._shape.roundedCurves.length;
      do {
        let e3 = p2 - r5, i4 = l3.vertices[2 * c2 + 0], s3 = l3.vertices[2 * c2 + 1], a2 = l3.vertices[2 * p2 + 0], o3 = l3.vertices[2 * p2 + 1], u2 = l3.vertices[2 * g2 + 0], m2 = l3.vertices[2 * g2 + 1], y3 = a2 - i4, v3 = o3 - s3, b2 = Math.sqrt(y3 * y3 + v3 * v3);
        y3 /= b2, v3 /= b2;
        let x2 = a2 - u2, w4 = o3 - m2, S3 = Math.sqrt(x2 * x2 + w4 * w4);
        x2 /= S3, w4 /= S3, d2.normals[2 * e3 + 0] = -w4, d2.normals[2 * e3 + 1] = x2, d2.concave[e3] = y3 * w4 - v3 * x2 > 0;
        let M2 = l3.vertexIndices[p2];
        ...
        t2 && (d2.normals[2 * e3 + 0] *= -1, d2.normals[2 * e3 + 1] *= -1), [c2, p2, g2] = [p2, g2, g2 + 1], g2 >= h2 && (g2 -= n2);
      } while (g2 !== r5 + 1);
      let y2 = [];
      y2.push({ bevelI: 0, angle: 0, size: 0, boundary: { vertices: l3.vertices.slice(2 * r5, 2 * h2), vertexCount: n2, vertexIndices: new Array(n2).fill(true).map((e3, t3) => [t3, t3]), elements: [0, n2], elementCount: 1, mesh: null }, reverseMap: [], insetPoints: l3.vertices.slice(2 * r5, 2 * h2) });
      let v2 = 0;
      for (let e3 = 1; e3 <= this._bevelSegments; e3++) {
        let i4 = e3 / this._bevelSegments * Math.PI / 2, r6 = (1 - Math.cos(i4)) * this._bevel, a2 = [], o3 = [], h3 = [], u2 = [], p3 = 0;
        for (let e4 = 0; e4 < n2; e4++) {
          let i5 = 2 * e4, c4 = (e4 - 1 + n2) % n2 * 2, m2 = l3.vertices[2 * d2.start + i5 + 0], g3 = l3.vertices[2 * d2.start + i5 + 1], f3 = -d2.normals[c4 + 0] * r6, y3 = -d2.normals[c4 + 1] * r6, v3 = -d2.normals[i5 + 0] * r6, b2 = -d2.normals[i5 + 1] * r6;
          if (d2.concave[e4] || !d2.concave[e4] && t2) {
            let i6 = Math.atan2(y3, f3), n3 = Math.atan2(b2, v3);
            n3 > i6 && (n3 -= 2 * Math.PI);
            let o4 = n3 - i6;
            if (d2.continuous[e4] || t2) {
              let s3 = i6 + o4 / 2, n4 = Math.cos(s3) * r6, l4 = Math.sin(s3) * r6;
              a2[2 * p3 + 0] = m2 + n4 * (t2 ? -1 : 1), a2[2 * p3 + 1] = g3 + l4 * (t2 ? -1 : 1), u2[p3] = e4, p3++;
            } else {
              let t3 = Math.max(1, Math.floor(s2 / 4 * Math.abs(o4) / Math.PI));
              for (let s3 = 0; s3 <= t3; s3++) {
                let n4 = i6 + o4 * (s3 / t3), l4 = Math.cos(n4) * r6, h4 = Math.sin(n4) * r6;
                a2[2 * p3 + 0] = m2 + l4, a2[2 * p3 + 1] = g3 + h4, u2[p3] = e4, p3++;
              }
            }
          } else a2[2 * p3 + 0] = m2 + f3, a2[2 * p3 + 1] = g3 + y3, u2[p3] = e4, o3[e4] = p3, p3++, a2[2 * p3 + 0] = m2, a2[2 * p3 + 1] = g3, u2[p3] = e4, p3++, a2[2 * p3 + 0] = m2 + v3, a2[2 * p3 + 1] = g3 + b2, u2[p3] = e4, h3[e4] = p3, p3++;
        }
        let c3 = Fe({ windingRule: we.POSITIVE, elementType: Me.BOUNDARY_CONTOURS, vertexSize: 2, strict: true, contours: [a2], edgeCreateCallback: (e4) => {
        ...
        if (!c3) throw console.log("Error"), new Error(`error generating bevel geometry for ${e3}'th loop`);
        if (!c3.vertexCount) {
          let t3 = (e3 - 1) / this._bevelSegments * Math.PI / 2;
          v2 = (1 - Math.sin(t3)) * this._bevel;
          break;
        }
        for (let e4 = 0; e4 < c3.vertexIndices.length; e4++) {
          let [t3, i5] = c3.vertexIndices[e4];
          if (t3 === i5) continue;
          let s3 = i5;
          i5 < t3 && (s3 += n2);
          for (let r7 = t3; r7 < s3; r7++) {
            ...
            if (!d2.continuous[s4] || !d2.continuous[a3]) {
              c3.vertexIndices[e4] = [t3, s4], c3.vertexIndices.splice(e4 + 1, 0, [a3, i5]), c3.vertices.splice(2 * (e4 + 1), 0, c3.vertices[2 * e4], c3.vertices[2 * e4 + 1]);
              break;
            }
          }
        }
        y2.push({ bevelI: e3, angle: i4, size: r6, boundary: c3, reverseMap: u2, insetPoints: a2 });
      }
      let w3 = (e3, t3, i4) => {
      ...
      for (let e3 = 1; e3 < y2.length; e3++) {
        ...
        if (!s3 || !r6) break;
        let o3 = d2.concave.length, l4 = 0, h3 = Dt(l4, n2);
        for (; !t3.boundary.vertexIndices.filter(h3).length || !i4.boundary.vertexIndices.filter(h3).length; ) l4++, h3 = Dt(l4, n2);
        let u2 = t3.boundary.vertexIndices.findIndex(h3), p3 = i4.boundary.vertexIndices.findIndex(h3);
        do {
          u2 = (u2 + 1) % s3;
        } while (h3(t3.boundary.vertexIndices[u2]));
        do {
          p3 = (p3 + 1) % r6;
        } while (h3(i4.boundary.vertexIndices[p3]));
        l4 = (l4 + 1) % n2;
        let c3, m2, g3 = l4, f3 = 0, v3 = this._buildBevelVert(d2, t3, (u2 - 1 + s3) % s3, void 0, f3), x2 = this._buildBevelVert(d2, i4, (p3 - 1 + r6) % r6, void 0, f3), S3 = false;
        do {
          f3 = (l4 || o3) / o3, h3 = Dt(l4, n2);
          let e4 = w3(t3, u2, h3), g4 = w3(i4, p3, h3), y3 = S3;
          if (S3 = false, e4 && !g4) {
            for (let i5 = 0; i5 < e4; i5++) c3 = this._buildBevelVert(d2, t3, (u2 + i5) % s3, i5 / (e4 - 1), f3), b.push(v3.topN, c3.topP, x2.topN), false === a && b.push(c3.bottomP, v3.bottomN, x2.bottomN), v3 = c3;
            S3 = true;
          } else if (!e4 && g4) for (let e5 = 0; e5 < g4; e5++) m2 = this._buildBevelVert(d2, i4, (p3 + e5) % r6, e5 / (g4 - 1), f3), b.push(x2.topN, v3.topP, m2.topP), false === a && b.push(v3.bottomP, x2.bottomN, m2.bottomP), x2 = m2;
          else if (e4 && g4) if (c3 = this._buildBevelVert(d2, t3, u2, 0, f3), m2 = this._buildBevelVert(d2, i4, p3, 0, f3), y3 ? (b.push(v3.topN, m2.topP, x2.topN), b.push(v3.topN, c3.topP, m2.topP), false === a && (b.push(m2.bottomP, v3.bottomN, x2.bottomN), b.push(m2.bottomP, c3.bottomP, v3.bottomN))) : (b.push(x2.topN, v3.topN, c3.topP), b.push(x2.topN, c3.topP, m2.topP), false === a && (b.push(c3.bottomP, v3.bottomN, x2.bottomN), b.push(c3.bottomP, x2.bottomN, m2.bottomP))), v3 = c3, x2 = m2, e4 === g4) for (let n3 = 1; n3 < e4; n3++) c3 = this._buildBevelVert(d2, t3, (u2 + n3) % s3, n3 / (e4 - 1), f3), m2 = this._buildBevelVert(d2, i4, (p3 + n3) % r6, n3 / (g4 - 1), f3), b.push(v3.topN, c3.topP, x2.topN), b.push(x2.topN, c3.topP, m2.topP), false === a && (b.push(c3.bottomP, v3.bottomN, x2.bottomN), b.push(c3.bottomP, x2.bottomN, m2.bottomP)), v3 = c3, x2 = m2;
          else if (e4 > g4) {
            let n3 = e4 / g4, o4 = 0;
            for (let l5 = 1; l5 < e4; l5++) c3 = this._buildBevelVert(d2, t3, (u2 + l5) % s3, l5 / (e4 - 1), f3), b.push(v3.topN, c3.topP, x2.topN), false === a && b.push(c3.bottomP, v3.bottomN, x2.bottomN), v3 = c3, l5 > (o4 + 1) * n3 && (o4++, m2 = this._buildBevelVert(d2, i4, (p3 + o4) % r6, o4 / (g4 - 1), f3), b.push(x2.topN, c3.topP, m2.topP), false === a && b.push(c3.bottomP, x2.bottomN, m2.bottomP), x2 = m2);
          } else {
            let n3 = g4 / e4, o4 = 0;
            for (let l5 = 1; l5 < g4; l5++) m2 = this._buildBevelVert(d2, i4, (p3 + l5) % r6, l5 / (g4 - 1), f3), b.push(x2.topN, c3.topP, m2.topP), false === a && b.push(c3.bottomP, x2.bottomN, m2.bottomP), x2 = m2, l5 > (o4 + 1) * n3 && (o4++, c3 = this._buildBevelVert(d2, t3, (u2 + o4) % s3, o4 / (e4 - 1), f3), b.push(v3.topN, c3.topP, x2.topN), false === a && b.push(c3.bottomP, v3.bottomN, x2.bottomN), v3 = c3);
          }
          u2 = (u2 + e4) % s3, p3 = (p3 + g4) % r6, l4 = (l4 + 1) % o3;
        } while (l4 !== g3);
      }
  ...
  _buildSurfaceVert(e, t, i2) {
    ...
    let l3 = this._buffer.get(this.forPathBevel ? 1 : 2), h = 3 * l3, d = 2 * l3, u = { top: l3 + 0, bottom: l3 + 1 };
  ...
  _buildBevelVert(e, t, i2, s2 = 1, r4) {
    ...
    let a, o2, l3, h, [d, u] = t.boundary.vertexIndices[i2];
    d !== u ? (o2 = d, a = u, h = false, l3 = e.continuous[o2] && e.continuous[a]) : (a = d, o2 = (a - 1 + e.count) % e.count, h = e.concave[a] && t.bevelI > 0, l3 = e.continuous[a] || h);
    let p = Math.cos(t.angle), c = Math.sin(t.angle), m = 2 * i2, g = 2 * a, f = 2 * o2, y = t.boundary.vertices[m + 0], v = t.boundary.vertices[m + 1], b = (1 - c) * this._bevel, x = (y - this._minX) / this._width, w2 = (v - this._minY) / this._height;
    this.forPathBevel && (void 0 !== r4 && (x = r4), w2 = 1);
    let S = e.normals[g + 0], M = e.normals[g + 1], O2 = e.normals[f + 0], P = e.normals[f + 1];
    if (h) {
      S += (O2 - S) * (1 - s2), M += (P - M) * (1 - s2);
      let e2 = Math.sqrt(S * S + M * M);
      S /= e2, M /= e2;
    }
    let A = this.forPathBevel ? this._buffer.get(l3 ? 1 : 2) : this._buffer.get(l3 ? 2 : 4), _ = 3 * A, C = 2 * A, E2 = { i: i2, fi: a, topP: A + 0, topN: A + 0, bottomP: A + 1, bottomN: A + 1, pathBevelUCoord: r4 };
    return this._buffer.positions[_ + 0] = y, this._buffer.positions[_ + 1] = v, this._buffer.positions[_ + 2] = (this.forPathBevel ? this._bevel : this._depth) - b, this._buffer.normals[_ + 0] = S * p, this._buffer.normals[_ + 1] = M * p, this._buffer.normals[_ + 2] = c, this._buffer.uvs[C + 0] = x, this._buffer.uvs[C + 1] = w2, false === this.forPathBevel && (this._buffer.positions[_ + 3] = y, this._buffer.positions[_ + 4] = v, this._buffer.positions[_ + 5] = b, this._buffer.normals[_ + 3] = S * p, this._buffer.normals[_ + 4] = M * p, this._buffer.normals[_ + 5] = -c, this._buffer.uvs[C + 2] = w2, this._buffer.uvs[C + 3] = x), l3 || (this.forPathBevel ? (A += 1, _ += 3, C += 2) : (A += 2, _ += 6, C += 4), E2.topP = A + 0, E2.bottomP = A + 1, this._buffer.positions[_ + 0] = y, this._buffer.positions[_ + 1] = v, this._buffer.positions[_ + 2] = (this.forPathBevel ? this._bevel : this._depth) - b, this._buffer.normals[_ + 0] = O2 * p, this._buffer.normals[_ + 1] = P * p, this._buffer.normals[_ + 2] = c, this._buffer.uvs[C + 0] = x, this._buffer.uvs[C + 1] = w2, false === this.forPathBevel && (this._buffer.positions[_ + 3] = y, this._buffer.positions[_ + 4] = v, this._buffer.positions[_ + 5] = b, this._buffer.normals[_ + 3] = O2 * p, this._buffer.normals[_ + 4] = P * p, this._buffer.normals[_ + 5] = -c, this._buffer.uvs[C + 2] = w2, this._buffer.uvs[C + 3] = x)), this.vertexCache[n] = E2, E2;
  }
  clone() {
...
var Ut = class extends ha {
  constructor(e, t = 12, i2 = {}) {
    ...
    let s2, r4, n, a = this._shape.extractShapePointsToFlatArray([], this._curveSegments), o2 = this._shape.shapeHoles.map((e2) => e2.extractShapePointsToFlatArray([], this._curveSegments)), l3 = true, h = true;
    for (let e2 = 0, t2 = a.length / 2; e2 < t2; e2++) {
      let t3 = 2 * e2, i3 = a[t3 + 0], s3 = a[t3 + 1];
      if (void 0 !== r4 && i3 !== r4 && (l3 = false), void 0 !== n && s3 !== n && (h = false), r4 = i3, n = s3, !l3 && !h) break;
    }
    if (!l3 && !h) try {
    ...
    if (this._positionAttribute = new qr(new Float32Array(3 * d), 3), this._normalAttribute = new qr(new Float32Array(3 * d), 3), this._uvAttribute = new qr(new Float32Array(2 * d), 2), this._indexAttribute = new qr(new Uint32Array(3 * u), 1), s2) {
      ...
      for (let n3 = 0, a3 = d; n3 < a3; n3++) {
        let a4 = 2 * n3, o3 = s2.vertices[a4 + 0], l4 = s2.vertices[a4 + 1];
        o3 < e2 && (e2 = o3), o3 > t2 && (t2 = o3), l4 < i3 && (i3 = l4), l4 > r5 && (r5 = l4);
      }
      let n2 = t2 - e2, a2 = r5 - i3;
      for (let t3 = 0, r6 = d; t3 < r6; t3++) {
        let r7 = 2 * t3, o3 = s2.vertices[r7 + 0], l4 = s2.vertices[r7 + 1], h2 = (o3 - e2) / n2, d2 = (l4 - i3) / a2;
        this._positionAttribute.setXYZ(t3, o3, l4, 0), this._normalAttribute.setXYZ(t3, 0, 0, 1), this._uvAttribute.setXY(t3, h2, d2);
      }
...
var Bt = class {
  ...
  static normalizeInputs(e, t) {
    ...
    return { parameters: Object.assign(s2, { width: r4, height: n, depth: a, roundness: l3 }), shape: h };
  }
  static build(e) {
    let t, { depth: i2, extrudeBevelSize: s2, extrudeBevelSegments: r4, subdivisions: n, roundness: a, windingRule: o2 } = e.parameters;
    return e.shape.roundness = a, t = i2 <= 0 ? new Ut(e.shape, n, { windingRule: o2 }) : new zt3(e.shape, i2, s2, n, r4, o2), Object.assign(t, { userData: { ...e, type: "VectorGeometry" } });
  }
};
function Rt2() {
  let e = new ha();
...
var Ht2 = class extends ha {
  ...
  update(e, t) {
    ...
    let { width: s2, height: r4, depth: n, extrudeBevelSize: a, extrudeBevelSegments: o2, text: l3, textTransform: h } = e, d = ya.getDisplayedValue(l3), u = (function(e2, t2, i3, s3) {
    ...
    })(e, i2, 2 === h ? d.toUpperCase() : 3 === h ? d.toLowerCase() : d, t), { shapes: p, charWidths: c, charCoords: m } = i2.generateShapes(u, e, t), g = 0.5 * ("number" == typeof s2 ? s2 : Number(t.getVariable(s2))), y = 0.5 * ("number" == typeof r4 ? r4 : Number(t.getVariable(r4))), v = p.map((e2) => new St().fromShape(e2, true));
    this.vectorShapes = v;
    ...
    x.translate(-g, y, 0), this.dispose(), this.wrappedText = u, this.charCoords = m, this.charWidths = c, this.deleteAttribute("extrudeNormal"), Object.entries(x.attributes).forEach(([e2, t2]) => {
...
function $t2() {
  if ("webgpu" === qt) {
    ...
    Wt || (Wt = true, console.warn('[spe] Material backend is "webgpu" but no TSL material factory is registered — import spe/src/renderer/webgpu before creating materials. Falling back to WebGL materials.'));
  }
  if (void 0 === Tt2) throw new Error('[spe] Classic (WebGL) materials are not available in this build — it was compiled WebGPU-only. Re-export the scene with renderer "Both" or "WebGL 2", or load the full runtime.');
  return Tt2;
}
function Kt(e, t) {
  return $t2().createRootMaterial(e, t);
}
function Qt2(e, t, i2) {
  return $t2().createSharedMaterial(e, t, i2);
}
function ei(e) {
...
var bi = class extends Wo {
  ...
  parse(e) {
    ...
    n.pos = 0;
    let a, o2, l3, h = (function(e2) {
      let s3, r5, n2 = /^#\?(\S+)/, a2 = /^\s*GAMMA\s*=\s*(\d+(\.\d+)?)\s*$/, o3 = /^\s*EXPOSURE\s*=\s*(\d+(\.\d+)?)\s*$/, l4 = /^\s*FORMAT=(\S+)\s*$/, h2 = /^\s*\-Y\s+(\d+)\s+\+X\s+(\d+)\s*$/, d2 = { valid: 0, string: "", comments: "", programtype: "RGBE", format: "", gamma: 1, exposure: 1, width: 0, height: 0 };
      for ((e2.pos >= e2.byteLength || !(s3 = i2(e2))) && t(1, "no header found"), (r5 = s3.match(n2)) || t(3, "bad initial token"), d2.valid |= 1, d2.programtype = r5[1], d2.string += s3 + "\n"; s3 = i2(e2), false !== s3; ) if (d2.string += s3 + "\n", "#" !== s3.charAt(0)) {
        if ((r5 = s3.match(a2)) && (d2.gamma = parseFloat(r5[1])), (r5 = s3.match(o3)) && (d2.exposure = parseFloat(r5[1])), (r5 = s3.match(l4)) && (d2.valid |= 2, d2.format = r5[1]), (r5 = s3.match(h2)) && (d2.valid |= 4, d2.height = parseInt(r5[1], 10), d2.width = parseInt(r5[2], 10)), 2 & d2.valid && 4 & d2.valid) break;
      } else d2.comments += s3 + "\n";
      return 2 & d2.valid || t(3, "missing format specifier"), 4 & d2.valid || t(3, "missing image size specifier"), d2;
    })(n), d = h.width, u = h.height, p = (function(e2, i3, s3) {
      let r5 = i3;
      ...
      let a2 = 0, o3 = 0, l4 = 4 * r5, h2 = new Uint8Array(4), d2 = new Uint8Array(l4), u2 = s3;
      for (; u2 > 0 && o3 < e2.byteLength; ) {
        ...
        let i4, s4 = 0;
        for (; s4 < l4 && o3 < e2.byteLength; ) {
          i4 = e2[o3++];
          let r6 = i4 > 128;
          if (r6 && (i4 -= 128), (0 === i4 || s4 + i4 > l4) && t(3, "bad scanline data"), r6) {
            let t2 = e2[o3++];
    ...
    switch (this.type) {
      case zt:
        l3 = p.length / 4;
        let e2 = new Float32Array(4 * l3);
        for (let t3 = 0; t3 < l3; t3++) s2(p, 4 * t3, e2, 4 * t3);
        a = e2, o2 = zt;
        break;
      case Tt:
        l3 = p.length / 4;
        let t2 = new Uint16Array(4 * l3);
        for (let e3 = 0; e3 < l3; e3++) r4(p, 4 * e3, t2, 4 * e3);
        a = t2, o2 = Tt;
        break;
      default:
...
var Oi = class extends yi {
  constructor(e, t) {
    super(e, t.imageHolderCache), this.data = e, this.shared = t, this.instanceId = ++Mi, this.loaded = false, this.isVideo = false, this.isBuffer = false, this.isHdr = false, this._cache = { 1e3: {}, 1001: {}, 1002: {} }, this.isVideo = "video" === e.type, this.isBuffer = true === e.isWebGLRenderTarget, this.loadPromise = this.updateSrc(this.isBuffer ? e : e.data);
  }
  async updateSrc(e) {
    ...
    if (this.isBuffer) this.img = e, this.loaded = true;
    ...
    } else if (e instanceof Uint8Array ? xi(e) : "string" == typeof e && /\.hdr($|[?#])/i.test(e)) {
      ...
      let s2 = null !== i2 && xi(i2) ? (function(e2) {
        try {
          let t2 = new bi().parse(e2.buffer.slice(e2.byteOffset, e2.byteOffset + e2.byteLength));
          if (!t2 || !t2.width || !t2.height) return null;
          let { width: i3, height: s3 } = t2, r4 = t2.data, n = new Uint16Array(r4.length), a = 4 * i3, o2 = (e3) => Wr.toHalfFloat(Math.pow(Math.max(Wr.fromHalfFloat(e3), 0), 1 / 2.2)), l3 = /* @__PURE__ */ new Map(), h = (e3) => {
            let t3 = l3.get(e3);
            return void 0 === t3 && (t3 = o2(e3), l3.set(e3, t3)), t3;
          };
      ...
      return "string" == typeof e2 ? e2 : (hi || (hi = new gi()), hi.load(e2));
...
var Pi = class extends Oi {
};
var Ai = 2 * Math.PI;
function _i({ x: e, y: t }, i2, s2, r4, n) {
...
var Di = class {
  ...
  static build(e) {
    let t, { width: i2, height: s2, spikes: r4, angle: n, innerRadius: a, depth: o2, extrudeBevelSize: l3, extrudeBevelSegments: h } = e.parameters, d = e.shape, u = (function(e2, t2, i3, s3, r5, n2) {
      if (s3 >= Ii) return r5 > 30 || r5 % 4 == 0 ? ((function(e3, t3, i4, s4 = 0, r6 = 0, n3 = 0) {
        let a3 = 0.5522847498, o4 = t3 * a3, l5 = i4 * a3;
        e3.addPoint(zi(r6 - t3, n3, r6 - t3, n3 - l5, r6 - t3, n3 + l5)), e3.addPoint(zi(r6, n3 + i4, r6 - o4, n3 + i4, r6 + o4, n3 + i4)), e3.addPoint(zi(r6 + t3, n3, r6 + t3, n3 + l5, r6 + t3, n3 - l5)), e3.addPoint(zi(r6, n3 - i4, r6 + o4, n3 - i4, r6 - o4, n3 - i4)), s4 > 0 && Ri(e3, t3, i4, s4);
      })(e2, t2, i3, n2), Math.round(r5 / 4)) : Li(e2, s3, r5, t2, i3, n2);
      let a2 = { x: 0, y: i3 }, o3 = (s3 = Math.max(s3, 1e-3)) + 0.5 * Math.PI, l4 = { x: Math.cos(o3) * t2, y: Math.sin(o3) * i3 }, h2 = (function({ px: e3, py: t3, cx: i4, cy: s4, rx: r6, ry: n3, largeArcFlag: a3, sweepFlag: o4 }) {
        let l5 = [];
        if (0 === r6 || 0 === n3) return [];
        ...
        let p = (function(e4, t4, i5, s5, r7, n4, a4, o5, l6, h4) {
          let d3 = Math.pow(r7, 2), u3 = Math.pow(n4, 2), p2 = Math.pow(a4, 2), c2 = Math.pow(o5, 2), m2 = d3 * u3 - d3 * c2 - u3 * p2;
          m2 < 0 && (m2 = 0), m2 /= d3 * c2 + u3 * p2, m2 = Math.sqrt(m2) * (l6 === h4 ? -1 : 1);
          let g2 = m2 * r7 / n4 * o5, f2 = m2 * -n4 / r7 * a4, y2 = g2 + (e4 + i5) / 2, v2 = f2 + (t4 + s5) / 2, b = (a4 - g2) / r7, x = (o5 - f2) / n4, w2 = (-a4 - g2) / r7, S = (-o5 - f2) / n4, M = Ei(1, 0, b, x), O2 = Ei(b, x, w2, S);
          return !h4 && O2 > 0 && (O2 -= Ai), h4 && O2 < 0 && (O2 += Ai), { centerx: y2, centery: v2, ang1: M, ang2: O2 };
        })(e3, t3, i4, s4, r6, n3, h3, d2, a3, o4), { ang1: c, ang2: m } = p, { centerx: g, centery: f } = p, y = Math.abs(m) / (Ai / 4);
        Math.abs(1 - y) < 1e-7 && (y = 1);
        let v = Math.max(Math.ceil(y), 1);
        m /= v;
        for (let e4 = 0; e4 < v; e4++) l5.push(Ci(c, m)), c += m;
        return l5.map((e4) => {
          let { x: t4, y: i5 } = _i(e4[0], r6, n3, g, f), { x: s5, y: a4 } = _i(e4[1], r6, n3, g, f), { x: o5, y: l6 } = _i(e4[2], r6, n3, g, f);
          return { x1: t4, y1: i5, x2: s5, y2: a4, x: o5, y: l6 };
        });
      })({ px: a2.x, py: a2.y, cx: l4.x, cy: l4.y, rx: t2, ry: i3, largeArcFlag: s3 > Math.PI, sweepFlag: true });
      return r5 > 30 || r5 % h2.length === 0 ? (function(e3, t3, i4, s4, r6, n3, a3, o4) {
        let l5 = Math.round(r6 / s4.length);
        e3.addPoint(Ui(t3, i4));
        for (let t4 = 0, i5 = s4.length; t4 < i5; t4++) {
          let i6 = s4[t4], r7 = e3.points[t4], n4 = Ui(i6.x, i6.y);
          r7.controls[1].position.set(i6.x1, i6.y1), n4.controls[0].position.set(i6.x2, i6.y2), e3.addPoint(n4);
        }
        return o4 > 0 ? Bi(e3, n3, a3, o4) : e3.addPoint(Ui(0, 0)), l5;
      })(e2, a2.x, a2.y, h2, r5, t2, i3, n2) : Li(e2, s3, r5, t2, i3, n2);
    })(d, 0.5 * i2, 0.5 * s2, n * Math.PI / 180, r4, a);
    return d.isClosed = true, d.update(), 0 === n ? (t = new ha(), t.setAttribute("position", new Hr([], 3))) : t = Bt.create({ shape: d, parameters: { subdivisions: u, depth: o2, extrudeBevelSize: l3, extrudeBevelSegments: h } }), Object.assign(t, { userData: { ...e, type: "EllipseGeometry" } });
  }
};
function Li(e, t, i2, s2, r4, n) {
  let a = -t / i2;
  for (let t2 = 0; t2 <= i2; t2++) {
    let i3 = a * t2, n2 = Math.sin(i3) * s2, o2 = Math.cos(i3) * r4;
    e.addPoint(Ui(n2, o2));
  }
  return t < Ii ? n > 0 ? Bi(e, s2, r4, n) : e.addPoint(Ui(0, 0)) : (e.removePoint(e.points[e.points.length - 1]), n > 0 && Ri(e, s2, r4, n)), 1;
}
function Ui(e, t) {
...
function Bi(e, t, i2, s2) {
  Gi2(e, t, i2, s2).forEach((t2) => e.addPoint(t2));
}
function Ri(e, t, i2, s2) {
  let r4 = Gi2(e, t, i2, s2), n = new St();
...
var ki = class {
  ...
  static build(e) {
    let { width: t, height: i2, spikes: s2, cornerRadius: r4, depth: n, extrudeBevelSize: a, extrudeBevelSegments: o2 } = e.parameters, l3 = e.shape, h = 0.5 * t, d = 0.5 * i2, u = 2 * Math.PI / s2;
    for (let e2 = 0; e2 < s2; e2++) {
      let t2 = u * e2, i3 = 0 + Math.sin(t2) * h, s3 = 0 + Math.cos(t2) * d;
      l3.addPoint(l3.createPoint(i3, s3));
    }
    l3.isClosed = true;
    for (let e2 = 0, t2 = l3.points.length; e2 < t2; e2++) l3.points[e2].roundness = r4;
    l3.roundness = r4, l3.update();
    let p = Bt.create({ shape: l3, parameters: { roundness: r4, depth: n, extrudeBevelSize: a, extrudeBevelSegments: o2 } });
    return Object.assign(p, { userData: { ...e, type: "PolygonGeometry" } });
  }
};
var Fi = class {
  static create(e) {
  ...
  static build(e) {
    let t = e.shape, { width: i2, height: s2, cornerRadius: r4, cornerType: n, depth: a, extrudeBevelSize: o2, extrudeBevelSegments: l3 } = e.parameters, h = { x: 0.5 * i2, y: 0.5 * s2 }, d = { x: -h.x, y: -h.y }, u = { x: h.x, y: h.y };
    function p(e2, t2, r5) {
      return t2 > i2 && r5 > s2 ? Math.min(e2 * i2 / t2, e2 * s2 / r5) : t2 > i2 ? e2 * i2 / t2 : r5 > s2 ? e2 * s2 / r5 : e2;
    }
    let c = [];
    c[0] = 0 === r4[0] ? 0 : p(r4[0], r4[0] + r4[3], r4[0] + r4[1]), c[1] = 0 === r4[1] ? 0 : p(r4[1], r4[1] + r4[2], r4[1] + r4[0]), c[2] = 0 === r4[2] ? 0 : p(r4[2], r4[2] + r4[1], r4[2] + r4[3]), c[3] = 0 === r4[3] ? 0 : p(r4[3], r4[3] + r4[0], r4[3] + r4[2]);
    let m = d.x, g = u.x, f = u.y, y = d.y;
    t.addPoint(t.createPoint(m, f)), t.addPoint(t.createPoint(g, f)), t.addPoint(t.createPoint(g, y)), t.addPoint(t.createPoint(m, y)), t.isClosed = true;
    let v = true;
    for (let e2 = 0, i3 = t.points.length; e2 < i3; e2++) t.points[e2].roundness = c[e2], e2 > 0 && c[e2] !== c[e2 - 1] && (v = false);
    v && (t.roundness = c[0]), t.useCubicForRoundedCorners = 1 !== n, t.update();
    let b = Bt.create({ shape: t, parameters: { depth: a, extrudeBevelSize: o2, extrudeBevelSegments: l3 } });
...
var Vi = class {
  ...
  static build(e) {
    let { width: t, height: i2, innerRadiusPercent: s2, spikes: r4, cornerRadius: n, angle: a, depth: o2, extrudeBevelSize: l3, extrudeBevelSegments: h } = e.parameters, d = e.shape, u = 0.5 * t, p = 0.5 * i2, c = a * Math.PI / 360 / r4, m = Math.PI / 2 * 3 * -1, g = u * s2 / 100, f = p * s2 / 100;
    if (3 === r4 && 50 === s2) {
      c = 2 * Math.PI / r4;
      for (let e2 = 0; e2 < r4; e2++) {
        let t2 = c * e2, i3 = 0 + Math.sin(t2) * u, s3 = 0 + Math.cos(t2) * p;
        d.addPoint(d.createPoint(i3, s3));
      }
    } else for (let e2 = 0; e2 < r4; e2++) {
      let e3 = 0 + Math.cos(m) * u, t2 = 0 + Math.sin(m) * p;
      d.addPoint(d.createPoint(e3, t2)), m += c, e3 = 0 + Math.cos(m) * g, t2 = 0 + Math.sin(m) * f, d.addPoint(d.createPoint(e3, t2)), m += c;
    }
    d.isClosed = true;
    for (let e2 = 0, t2 = d.points.length; e2 < t2; e2++) d.points[e2].roundness = n;
    d.roundness = n, d.update();
    let y = Bt.create({ shape: d, parameters: { roundness: n, depth: o2, extrudeBevelSize: l3, extrudeBevelSegments: h } });
    return Object.assign(y, { userData: { ...e, type: "StarGeometry" } });
  }
};
var ji = new Promise((e) => {
  Ti = e;
});
var Hi = false;
function qi(e) {
  if (!Hi) return Ni || (Ni = (async function() {
    let t = e ?? "https://cdn.spline.design/@splinetool/runtime@2.0.8/build", i2 = import("./process-ROKFKRQM.js"), [s2, r4] = await Promise.all([i2, fetch(`${t}/process.wasm`).then((e2) => e2.arrayBuffer())]), n = s2.default, a = await n({ wasmBinary: r4 });
    Ti(a), Hi = true;
  })());
}
var Wi = class {
  ...
  static build(e) {
    let t, { width: i2, depth: s2, height: r4, radialSegments: n, heightSegments: a, openEnded: o2, thetaStart: l3, thetaLength: h, radiusTop: d, radiusBottom: u, cornerRadius: p, cornerSegments: c, hollow: m } = e.parameters;
    0 === h ? (t = new ha(), t.setAttribute("position", new Hr([], 3))) : t = p || m ? new Xi(d, u, r4, n, a, o2, l3, h * Math.PI / 180, p, p, c, m) : new Un(d, u, r4, n, a, o2, l3, h * Math.PI / 180);
    let g = s2 / i2;
    return 1 !== g && t.scale(1, 1, g), Object.assign(t, { userData: { ...e, type: "CylinderGeometry" } });
  }
};
function Yi(e) {
...
var Xi = class extends ha {
  constructor(e, t, i2, s2, r4, n, a, o2, l3, h, d, u, p = false) {
    super(), this.type = "RoundedCylinderBufferGeometry", e = void 0 !== e ? e : 1, t = void 0 !== t ? t : 1, i2 = i2 || 1, s2 = Math.floor(s2) || 8, r4 = Math.floor(r4) || 1, n = void 0 !== n && n, a = void 0 !== a ? a : 0, o2 = void 0 !== o2 ? o2 : 2 * Math.PI, n && (l3 = 0, h = 0);
    let c = i2 / 2;
    p && 0 == e && (e = l3), p && 0 == t && (t = h);
    let m = new Gi(e, c), g = new Gi(t, -c), f = null, y = null, v = null, b = null, x = m.clone().sub(g), w2 = 0, S = 0, M = 0;
    ...
    if (l3 = Math.min(l3, (e - S) / I, x.length() / E2), h = Math.min(h, (t - M) / L, x.length() / E2), l3 > 0) {
      let e2 = l3 / _;
      f = m.clone().sub(new Gi(e2, l3)), u && (v = f.clone(), v.x -= w2 - E2 * l3), m.sub(x.clone().setLength(e2));
    }
    if (h > 0) {
      let e2 = h / C;
      y = g.clone().sub(new Gi(e2, -h)), g.add(x.clone().setLength(e2)), u && (b = y.clone(), b.x -= w2 - E2 * h, O2.sub(x.clone().setLength(e2)));
    }
    x = m.clone().sub(g);
    let U = x.length() < 0.5, z = [], B = [], R = [], G = [], T = [], N = [], k = (e2, t2, s3, r5, n2) => {
      for (let a2 = 0; a2 < d + 1; a2++) {
        let o3 = a2 / d, l4 = r5 < 0 ? o3 : 1 - o3;
        n2 && (l4 -= 1), l4 *= e2;
        let h2 = Math.sin(l4), u2 = Math.cos(l4) * r5, p2 = u2 * t2 + s3.y;
        z.push(h2 * t2 + s3.x), B.push(p2), R.push(h2), G.push(u2), T.push(0.5 + p2 / i2), N.push(false);
      }
    }, F = (e2, t2, i3) => {
      let s3 = [e2, t2];
      i3 < 0 && s3.reverse();
      for (let e3 of s3) z.push(e3), B.push(c * i3), R.push(0), G.push(i3), T.push(0.5), N.push(true);
    };
    if (b && y ? (k(P, h, b, -1, true), k(A, h, y, -1, false)) : y ? (F(y.x, 0, -1), k(A, h, y, -1, false)) : n || F(t, M, -1), !U) {
      let e2 = Yi(x).normalize();
      for (let t2 = 0; t2 <= r4; t2++) {
        let s3 = t2 / r4, n2 = x.y * s3 + g.y;
        z.push(x.x * s3 + g.x), B.push(n2), R.push(e2.x), G.push(e2.y), T.push(0.5 + n2 / i2), N.push(false);
      }
    }
    if (v && f ? (k(P, l3, f, 1, false), k(A, l3, v, 1, true)) : f ? (k(P, l3, f, 1, false), F(f.x, 0, 1)) : n || F(e, S, 1), u && !U) {
      let e2 = Yi(x).multiplyScalar(-1).normalize();
      for (let t2 = 0; t2 <= r4; t2++) {
        let s3 = t2 / r4, n2 = x.y * -s3 + O2.y;
        z.push(x.x * -s3 + O2.x), B.push(n2), R.push(e2.x), G.push(e2.y), T.push(0.5 + n2 / i2), N.push(false);
      }
    }
    let V = z.length, j = V + (u && !n ? 1 : 0), H = (e2, t2) => e2 * V + (t2 === V ? 0 : t2), q = o2 < 2 * Math.PI, W = (s2 + 1) * V + (q ? 2 * (1 + j) : 0), Y2 = new Float32Array(3 * W), X = new Float32Array(3 * W), Z = new Float32Array(2 * W), J2 = W - 1 > 65535 ? new Uint32Array(s2 * Math.max(0, j - 1) * 6 + (q ? 2 * (j + 1) * 3 : 0)) : new Uint16Array(s2 * Math.max(0, j - 1) * 6 + (q ? 2 * (j + 1) * 3 : 0)), $ = 0, K = 0;
    for (let e2 = 0; e2 <= s2; e2++) {
      let t2 = e2 / s2, i3 = t2 * o2 + a, r5 = Math.sin(i3), n2 = Math.cos(i3);
      for (let e3 = 0; e3 < V; e3++) {
        let i4 = 3 * K, s3 = 2 * K, a2 = z[e3], o3 = R[e3];
        Y2[i4] = a2 * r5, Y2[i4 + 1] = B[e3], Y2[i4 + 2] = a2 * n2, X[i4] = o3 * r5, X[i4 + 1] = G[e3], X[i4 + 2] = o3 * n2, N[e3] ? (Z[s3] = 0.5, Z[s3 + 1] = 0.5) : (Z[s3] = t2, Z[s3 + 1] = T[e3]), K++;
      }
    }
    for (let e2 = 0; e2 < s2; e2++) for (let t2 = 0; t2 < j - 1; t2++) {
      if (n && u && t2 == r4) continue;
      let i3 = H(e2, t2), s3 = H(e2 + 1, t2), a2 = H(e2 + 1, t2 + 1), o3 = H(e2, t2 + 1), l4 = Y2[3 * a2 + 0], h2 = Y2[3 * a2 + 2];
      J2[$++] = i3, J2[$++] = s3, J2[$++] = o3, (0 != l4 || 0 != h2) && (J2[$++] = s3, J2[$++] = a2, J2[$++] = o3);
    }
    function Q(i3, s3, r5) {
      let n2 = Math.sin(r5), a2 = Math.cos(r5), o3 = -a2, l4 = n2, h2 = i3 < 0 ? (e2, t2, i4) => {
        J2[$++] = e2, J2[$++] = t2, J2[$++] = i4;
      } : (e2, t2, i4) => {
        J2[$++] = e2, J2[$++] = i4, J2[$++] = t2;
      }, d2 = (e + t + S + M) / 4, u2 = 3 * K, p2 = 2 * K;
      Y2[u2] = d2 * n2, Y2[u2 + 1] = 0, Y2[u2 + 2] = d2 * a2, X[u2] = o3, X[u2 + 1] = 0, X[u2 + 2] = l4, Z[p2] = 0.5, Z[p2 + 1] = 0.5;
      let c2 = K++;
      for (let e2 = 0; e2 < j; e2++) {
        let t2 = 3 * (s3 + (e2 === V ? 0 : e2));
        u2 = 3 * K, p2 = 2 * K, Y2[u2] = Y2[t2], Y2[u2 + 1] = Y2[t2 + 1], Y2[u2 + 2] = Y2[t2 + 2], X[u2] = o3, X[u2 + 1] = 0, X[u2 + 2] = l4;
        let i4 = t2 / 3 * 2 | 0;
        Z[p2] = Z[i4], Z[p2 + 1] = Z[i4 + 1], K++;
      }
      for (let e2 = c2 + 1; e2 < K - 1; e2++) h2(c2, e2, e2 + 1);
      h2(c2, K - 1, c2 + 1);
    }
    q && (Q(-1, 0, a), Q(1, s2 * V, a + o2)), this.setIndex(new qr(J2.slice(0, $), 1)), this.setAttribute("position", new qr(Y2, 3)), this.setAttribute("normal", new qr(X, 3)), this.setAttribute("uv", new qr(Z, 2));
  }
};
var Zi2 = Math.PI / 2;
var Ji = class extends ha {
  constructor(e = 1, t = 1, i2 = 1, s2 = 1, r4 = 1, n = 1, a = 0, o2 = 4) {
    ...
    let l3 = (a = Math.min(a, e / 2, t / 2, i2 / 2)) > 0, h = o2 + 1, d = 2 * ((n + 1) * (r4 + 1) + (s2 + 1) * (n + 1) + (s2 + 1) * (r4 + 1)) + (l3 ? 4 * h * (n + 1 + (s2 + 1) + (r4 + 1)) + h * (h + 1) / 2 * 8 : 0), u = 2 * (n * r4 + s2 * n + s2 * r4) + (l3 ? 4 * o2 * (n + s2 + r4) : 0), p = l3 ? 8 * o2 * o2 : 0, c = new Float32Array(3 * d), m = new Float32Array(3 * d), g = new Float32Array(2 * d), f = d - 1 > 65535 ? new Uint32Array(6 * u + 3 * p) : new Uint16Array(6 * u + 3 * p), y = 0, v = 0, b = new Float64Array(h), x = new Float64Array(h), w2 = new Float64Array(h), S = new Float64Array(h);
    ...
    let M = h * (h + 1) / 2, O2 = new Float64Array(3 * M), P = new Float64Array(3 * M);
    {
      ...
      for (let e2 = 0; e2 <= o2; e2++) {
        let t2 = Zi2 * (1 - e2 / o2), i3 = Math.cos(t2), n2 = Math.sin(t2), l4 = 0;
        for (let t3 = 0; t3 <= e2; t3++) {
          let t4 = i3 * Math.cos(l4), o3 = n2, h2 = i3 * Math.sin(l4);
          O2[3 * r5] = t4, O2[3 * r5 + 1] = o3, O2[3 * r5 + 2] = h2, P[3 * r5] = s3.x + t4 * a, P[3 * r5 + 1] = s3.y + o3 * a, P[3 * r5 + 2] = s3.z + h2 * a, r5++, l4 += Zi2 / e2;
        }
      }
    }
    function A(e2, t2, i3, s3, r5, n2, o3, l4, h2, d2) {
      let u2 = (n2 - 2 * a) / h2, p2 = (o3 - 2 * a) / d2, b2 = n2 / 2 - a, x2 = o3 / 2 - a, w3 = l4 / 2, S2 = h2 + 1, M2 = d2 + 1, O3 = 0, P2 = new Ki();
      for (let n3 = 0; n3 < M2; n3++) {
        let a2 = n3 * p2 - x2;
        for (let o4 = 0; o4 < S2; o4++) {
          let p3 = o4 * u2 - b2, f2 = 3 * (y + O3), v2 = 2 * (y + O3);
          P2[e2] = p3 * s3, P2[t2] = a2 * r5, P2[i3] = w3, c[f2] = P2.x, c[f2 + 1] = P2.y, c[f2 + 2] = P2.z, P2[e2] = 0, P2[t2] = 0, P2[i3] = l4 > 0 ? 1 : -1, m[f2] = P2.x, m[f2 + 1] = P2.y, m[f2 + 2] = P2.z, g[v2] = o4 / h2, g[v2 + 1] = 1 - n3 / d2, O3 += 1;
        }
      }
    ...
    function _(e2, t2, i3, s3, r5, n2, l4, h2, d2, u2) {
      let p2 = (l4 - 2 * a) / u2, M2 = l4 / 2 - a, O3 = h2 / 2 - a, P2 = d2 / 2, A2 = u2 + 1, _2 = 0, C2 = new Ki(), E2 = new Ki();
      for (let a2 = 0; a2 < o2 + 1; a2++) {
        ...
        for (let t3 = 0; t3 < A2; t3++) {
          ...
          c[r6] = C2.x, c[r6 + 1] = C2.y, c[r6 + 2] = C2.z, m[r6] = E2.x, m[r6 + 1] = E2.y, m[r6 + 2] = E2.z, g[n3] = t3 / u2, g[n3 + 1] = 0, _2 += 1;
        }
      }
    ...
    function C(e2, t2, i3) {
      ...
      for (let s4 = 0; s4 < M; s4++) {
        ...
        c[n2] = e2 * P[r6], c[n2 + 1] = t2 * P[r6 + 1], c[n2 + 2] = i3 * P[r6 + 2], m[n2] = e2 * O2[r6], m[n2 + 1] = t2 * O2[r6 + 1], m[n2 + 2] = i3 * O2[r6 + 2], g[a2] = 0, g[a2 + 1] = 0, y++;
      }
    ...
    A("z", "y", "x", -1, -1, i2, t, e, n, r4), A("z", "y", "x", 1, -1, i2, t, -e, n, r4), A("x", "z", "y", 1, 1, e, i2, t, s2, n), A("x", "z", "y", 1, -1, e, i2, -t, s2, n), A("x", "y", "z", 1, -1, e, t, i2, s2, r4), A("x", "y", "z", -1, -1, e, t, -i2, s2, r4), a > 0 && (_("z", "y", "x", -1, -1, 1, i2, t, e, n), _("z", "y", "x", 1, -1, -1, i2, t, e, n), _("z", "y", "x", -1, 1, -1, i2, t, e, n), _("z", "y", "x", 1, 1, 1, i2, t, e, n), _("x", "y", "z", -1, -1, -1, e, t, i2, s2), _("x", "y", "z", 1, -1, 1, e, t, i2, s2), _("x", "y", "z", -1, 1, 1, e, t, i2, s2), _("x", "y", "z", 1, 1, -1, e, t, i2, s2), _("y", "x", "z", -1, -1, 1, t, e, i2, r4), _("y", "x", "z", 1, -1, -1, t, e, i2, r4), _("y", "x", "z", 1, 1, 1, t, e, i2, r4), _("y", "x", "z", -1, 1, -1, t, e, i2, r4), C(1, 1, 1), C(-1, 1, 1), C(1, -1, 1), C(-1, -1, 1), C(1, 1, -1), C(-1, 1, -1), C(1, -1, -1), C(-1, -1, -1)), this.setIndex(new qr(f, 1)), this.setAttribute("position", new qr(c, 3)), this.setAttribute("normal", new qr(m, 3)), this.setAttribute("uv", new qr(g, 2));
  }
};
var $i = class extends ha {
  constructor(e = [], t = [], i2 = "", s2 = 1, r4 = 0.2, n = 4) {
    ...
    return (function() {
      ...
      a = new Float64Array(P), o2 = new Float64Array(P), l3 = new Float64Array(P / 3 * 2);
      let A = (e2, t2, i3) => {
        let s3 = h / 3 * 2;
        l3[s3] = Math.atan2(i3, -e2) / 2 / Math.PI + 0.5, l3[s3 + 1] = 1 - (Math.atan2(-t2, Math.sqrt(e2 * e2 + i3 * i3)) / Math.PI + 0.5);
      }, _ = (e2) => {
      ...
      }, E2 = (n + 2) * (n + 3) / 2, I = new Float64Array(3 * E2), D2 = new Float64Array(3 * E2), L = new Float64Array(2 * E2), U = b(2 * d * f, () => new Ki()), B = b(n * Math.max(0, n - 1) / 2, () => new Ki()), R = u.clone(), G = u.clone(), T = u.clone(), N = u.clone(), k = u.clone(), F = [], V = b(x.length, () => b(d, () => u.clone()));
      for (let e2 = 0; e2 < x.length; e2++) {
        u.copy(x[e2]).normalize(), R.copy(u).multiplyScalar(g);
        let t2 = w2[e2];
        for (let i4 = 0; i4 < t2.length; i4++) {
          let s4 = t2[i4], r6 = t2[(i4 + 1) % d];
          c.setFromPointsAndIndices(x, e2, s4 % S, r6 % S), c.b.sub(c.a).setLength(1e10).add(c.a), c.c.sub(c.a).setLength(1e10).add(c.a), c.closestPointToPoint(R, V[e2][i4]);
        }
        let i3 = 0, s3 = [], r5 = [], b2 = new Ki();
        0 == n && [...V[e2]].reduce((e3, t3) => e3.add(t3), b2).multiplyScalar(1 / d);
        for (let t3 = 0; t3 < d; t3++) {
          let a2 = [], o3 = (t3 - 1 + d) % d, l4 = V[e2][o3], h2 = V[e2][t3];
          u.copy(l4).sub(R), p.copy(h2).sub(R);
          let c2 = R.angleTo(u), x2 = u.angleTo(p), w3 = Math.cos(c2) * m;
          0 == n ? G.copy(b2) : G.copy(R).setLength(g + w3), s3.push(w3);
          let S2 = [G, l4, h2];
        ...
        for (let e3 = 0; e3 < d; e3++) {
          ...
          for (let a2 = 1; a2 < f; a2++) {
            let o3 = U[t3 + a2], l4 = U[i4 + a2];
            n2.push(o3);
            for (let t4 = 1, i5 = a2 - P2 + 1; t4 <= i5; t4++) u.lerpVectors(o3, l4, t4 / (i5 + 1)), u.sub(R).setLength(s3[e3]).add(R), n2.push(B[r6++].copy(u));
            n2.push(l4);
          }
          ...
          for (let e4 = 0, t4 = M.length; e4 < t4; e4++) {
            ...
            a[h] = I[t5], a[h + 1] = I[t5 + 1], a[h + 2] = I[t5 + 2], o2[h] = D2[t5], o2[h + 1] = D2[t5 + 1], o2[h + 2] = D2[t5 + 2], l3[s4] = L[i5], l3[s4 + 1] = L[i5 + 1], h += 3;
          }
        }
      }
      let j = [];
      ...
      for (; j.length; ) {
        let e2, t2, i3, [s3, r5] = j.splice(0, 2);
        e2 = r5;
        let n2 = [s3];
        for (; s3 != e2; ) n2.push(e2), t2 = j.indexOf(e2), i3 = t2 % 2, e2 = j.splice(t2 - i3, 2)[1 - i3];
      ...
      let e2 = new Ki(), t2 = new Ki(), i3 = new Ki(), s3 = new Ki(), r5 = new Gi(), n2 = new Gi(), o3 = new Gi(), d = (e3, t3, i4, s4) => {
        s4 < 0 && 1 === e3.x && (l3[t3] = e3.x - 1), 0 === i4.x && 0 === i4.z && (l3[t3] = s4 / 2 / Math.PI + 0.5);
      };
      for (let u2 = 0, c = 0; u2 < h; u2 += 9, c += 6) {
        e2.set(a[u2 + 0], a[u2 + 1], a[u2 + 2]), t2.set(a[u2 + 3], a[u2 + 4], a[u2 + 5]), i3.set(a[u2 + 6], a[u2 + 7], a[u2 + 8]), r5.set(l3[c + 0], l3[c + 1]), n2.set(l3[c + 2], l3[c + 3]), o3.set(l3[c + 4], l3[c + 5]), s3.copy(e2).add(t2).add(i3).divideScalar(3);
        let h2 = p(s3);
        d(r5, c + 0, e2, h2), d(n2, c + 2, t2, h2), d(o3, c + 4, i3, h2);
      }
      let u = h / 3 * 2;
      for (let e3 = 0; e3 < u; e3 += 6) {
        let t3 = l3[e3 + 0], i4 = l3[e3 + 2], s4 = l3[e3 + 4], r6 = Math.max(t3, i4, s4), n3 = Math.min(t3, i4, s4);
        r6 > 0.9 && n3 < 0.1 && (t3 < 0.2 && (l3[e3 + 0] += 1), i4 < 0.2 && (l3[e3 + 2] += 1), s4 < 0.2 && (l3[e3 + 4] += 1));
      }
      function p(e3) {
        return Math.atan2(e3.z, -e3.x);
      }
    })(), this.setAttribute("position", new qr(new Float32Array(a.subarray(0, h)), 3)), this.setAttribute("normal", new qr(new Float32Array(o2.subarray(0, h)), 3)), void this.setAttribute("uv", new qr(new Float32Array(l3.subarray(0, h / 3 * 2)), 2));
  }
  static fromJSON(e) {
    return new $i(e.vertices, e.indices, e.radius, e.corner, e.cornerSides);
  }
};
var Ki2 = class extends $i {
  ...
  static fromJSON(e) {
    return new Ki2(e.radius, e.corner, e.cornerSides);
  }
};
var Qi2 = class extends $i {
  constructor(e = 1, t = 0.2, i2 = 4) {
...
var is = class {
  ...
  modify(e) {
    let t = (function(e2) {
      ...
      let i3 = e2.getAttribute("uv"), s2 = e2.getIndex(), r4 = t2.count, n = /* @__PURE__ */ new Map(), a = new Uint32Array(r4), o2 = [], l3 = 0;
      for (let e3 = 0; e3 < r4; e3++) {
        let i4 = t2.getX(e3), s3 = t2.getY(e3), r5 = t2.getZ(e3), h2 = Math.round(i4 * es), d2 = Math.round(s3 * es), u2 = Math.round(r5 * es), p2 = n.get(h2);
        void 0 === p2 && (p2 = /* @__PURE__ */ new Map(), n.set(h2, p2));
        let c2 = p2.get(d2);
        void 0 === c2 && (c2 = /* @__PURE__ */ new Map(), p2.set(d2, c2));
        let m2 = c2.get(u2);
        void 0 === m2 && (m2 = l3++, c2.set(u2, m2), o2.push(i4, s3, r5)), a[e3] = m2;
      }
      let h = [], d = [], u = void 0 === i3 ? null : [], p = null !== s2 ? s2.count : r4, c = (e3, t3) => {
        let n2 = null !== s2 ? s2.getX(e3) : e3, o3 = null !== s2 ? s2.getX(e3 + 1) : e3 + 1, l4 = null !== s2 ? s2.getX(e3 + 2) : e3 + 2;
        if (!(n2 < r4 && o3 < r4 && l4 < r4)) return;
        let p2 = a[n2], c2 = a[o3], m2 = a[l4];
        p2 === c2 || c2 === m2 || m2 === p2 || (h.push(p2, c2, m2), d.push(t3), null !== u && u.push(i3.getX(n2), i3.getY(n2), i3.getX(o3), i3.getY(o3), i3.getX(l4), i3.getY(l4)));
      }, m = e2.groups;
      if (m.length > 0) for (let e3 = 0; e3 < m.length; e3++) {
        let t3 = m[e3], i4 = void 0 === t3.materialIndex ? 0 : t3.materialIndex, s3 = Math.max(t3.start, 0), r5 = Math.min(t3.start + t3.count, p);
        for (let e4 = s3; e4 < r5 && e4 + 2 < p; e4 += 3) c(e4, i4);
      }
      else for (let e3 = 0; e3 + 2 < p; e3 += 3) c(e3, 0);
    ...
    return (function(e2, t2) {
      let { positions: i3, faces: s2, materialIndices: r4, uvs: n } = e2, a = i3.length / 3, o2 = s2.length / 3, l3 = new Float64Array(3 * a);
      for (let e3 = 0; e3 < o2; e3++) {
        let t3 = 3 * s2[3 * e3], r5 = 3 * s2[3 * e3 + 1], n2 = 3 * s2[3 * e3 + 2], a2 = i3[n2] - i3[r5], o3 = i3[n2 + 1] - i3[r5 + 1], h2 = i3[n2 + 2] - i3[r5 + 2], d2 = i3[t3] - i3[r5], u2 = i3[t3 + 1] - i3[r5 + 1], p2 = i3[t3 + 2] - i3[r5 + 2], c2 = o3 * p2 - h2 * u2, m = h2 * d2 - a2 * p2, g = a2 * u2 - o3 * d2;
        l3[t3] += c2, l3[t3 + 1] += m, l3[t3 + 2] += g, l3[r5] += c2, l3[r5 + 1] += m, l3[r5 + 2] += g, l3[n2] += c2, l3[n2 + 1] += m, l3[n2 + 2] += g;
      }
      for (let e3 = 0; e3 < a; e3++) {
        let t3 = l3[3 * e3], i4 = l3[3 * e3 + 1], s3 = l3[3 * e3 + 2], r5 = Math.sqrt(t3 * t3 + i4 * i4 + s3 * s3) || 1;
        l3[3 * e3] = t3 / r5, l3[3 * e3 + 1] = i4 / r5, l3[3 * e3 + 2] = s3 / r5;
      }
      let h = 3 * o2, d = new Float32Array(3 * h), u = new Float32Array(3 * h), p = null !== n && n.length > 0 ? new Float32Array(2 * h) : null;
      for (let e3 = 0; e3 < h; e3++) {
        let t3 = 3 * s2[e3];
        d[3 * e3] = i3[t3], d[3 * e3 + 1] = i3[t3 + 1], d[3 * e3 + 2] = i3[t3 + 2], u[3 * e3] = l3[t3], u[3 * e3 + 1] = l3[t3 + 1], u[3 * e3 + 2] = l3[t3 + 2];
      }
      null !== p && p.set(n.subarray(0, 2 * h));
      let c = new ha();
      c.setAttribute("position", new qr(d, 3)), h > 0 && (c.setAttribute("normal", new qr(u, 3)), c.setAttribute("color", new qr(new Float32Array(3 * h).fill(1), 3))), null !== p && c.setAttribute("uv", new qr(p, 2));
      for (let e3 = 0; e3 < o2; ) {
        let t3 = r4[e3], i4 = e3;
        do {
          e3++;
        } while (e3 < o2 && r4[e3] === t3);
        c.addGroup(3 * i4, 3 * (e3 - i4), t3);
      }
      return null !== t2.boundingBox && (c.boundingBox = t2.boundingBox.clone()), null !== t2.boundingSphere && (c.boundingSphere = t2.boundingSphere.clone()), c;
    })(t, e);
  }
};
function ss(e) {
  let { positions: t, faces: i2, materialIndices: s2, uvs: r4 } = e, n = t.length / 3, a = i2.length / 3, o2 = null !== r4 && a > 0, l3 = 3 * a, h = new Uint32Array(l3), d = new Uint32Array(l3), u = new Uint32Array(l3), p = new Uint32Array(l3), c = new Uint32Array(l3), m = 0, g = 8;
  for (; g < 2 * l3; ) g *= 2;
  let f = g - 1, y = new Int32Array(g).fill(-1), v = (e2, t2) => {
    let i3 = (Math.imul(e2, 2654435761) ^ t2) & f;
    for (; ; ) {
      let s3 = y[i3];
      if (-1 === s3) return y[i3] = m, h[m] = e2, d[m] = t2, m++;
    ...
    1 === n2 ? p[r5] = s3 : 2 === n2 && (c[r5] = s3), x[e2]++, x[i3]++, w2[3 * e2] += t[3 * i3], w2[3 * e2 + 1] += t[3 * i3 + 1], w2[3 * e2 + 2] += t[3 * i3 + 2], w2[3 * i3] += t[3 * e2], w2[3 * i3 + 1] += t[3 * e2 + 1], w2[3 * i3 + 2] += t[3 * e2 + 2];
  };
  for (let e2 = 0; e2 < a; e2++) {
    let t2 = i2[3 * e2], s3 = i2[3 * e2 + 1], r5 = i2[3 * e2 + 2];
    S(t2, s3, r5), S(s3, r5, t2), S(r5, t2, s3);
  }
  let M = new Float64Array(3 * m);
  for (let e2 = 0; e2 < m; e2++) {
    let i3 = 3 * h[e2], s3 = 3 * d[e2];
    if (2 === u[e2]) {
      let r5 = 3 * p[e2], n2 = 3 * c[e2];
  ...
  let A = new Float64Array(3 * (n + m));
  A.set(P), A.set(M, 3 * n);
  let _ = new Uint32Array(12 * a), C = new Array(4 * a), E2 = o2 ? new Float64Array(24 * a) : null;
  for (let e2 = 0; e2 < a; e2++) {
    let t2 = i2[3 * e2], a2 = i2[3 * e2 + 1], o3 = i2[3 * e2 + 2], l4 = b(t2, a2) + n, h2 = b(a2, o3) + n, d2 = b(o3, t2) + n, u2 = 12 * e2;
    _[u2++] = l4, _[u2++] = h2, _[u2++] = d2, _[u2++] = t2, _[u2++] = l4, _[u2++] = d2, _[u2++] = a2, _[u2++] = h2, _[u2++] = l4, _[u2++] = o3, _[u2++] = d2, _[u2++] = h2;
    let p2 = s2[e2];
    if (C[4 * e2] = p2, C[4 * e2 + 1] = p2, C[4 * e2 + 2] = p2, C[4 * e2 + 3] = p2, null !== E2) {
      let t3 = 6 * e2, i3 = r4[t3], s3 = r4[t3 + 1], n2 = r4[t3 + 2], a3 = r4[t3 + 3], o4 = r4[t3 + 4], l5 = r4[t3 + 5], h3 = ts(i3, n2), d3 = ts(s3, a3), u3 = ts(n2, o4), p3 = ts(a3, l5), c2 = ts(i3, o4), m2 = ts(s3, l5), g2 = 24 * e2;
      E2[g2++] = h3, E2[g2++] = d3, E2[g2++] = u3, E2[g2++] = p3, E2[g2++] = c2, E2[g2++] = m2, E2[g2++] = i3, E2[g2++] = s3, E2[g2++] = h3, E2[g2++] = d3, E2[g2++] = c2, E2[g2++] = m2, E2[g2++] = n2, E2[g2++] = a3, E2[g2++] = u3, E2[g2++] = p3, E2[g2++] = h3, E2[g2++] = d3, E2[g2++] = o4, E2[g2++] = l5, E2[g2++] = c2, E2[g2++] = m2, E2[g2++] = u3, E2[g2++] = p3;
    }
  }
...
var as = new Ki();
var os = new Ki();
function ls(e, t, i2, s2, r4, n) {
  let a = as.copy(t).sub(e), o2 = os.copy(i2).sub(e), l3 = a.angleTo(o2);
  if (a.normalize(), o2.normalize(), s2 === r4) {
    let t2 = a.add(o2).normalize();
    n.copy(e).addScaledVector(t2, s2 / Math.sin(l3 / 2));
  } else {
    let t2 = a.angleTo(o2);
...
var ds = class extends ha {
  constructor(e = 0.5, t = 1, i2 = 4, s2 = 1, r4 = false, n = 0, a = 4) {
    super(), i2 = Math.floor(Math.max(3, i2)), s2 = Math.floor(s2), a = Math.floor(a);
    let o2, l3 = [], h = [], d = [], u = [], p = 0, c = t / 2, m = Math.PI / i2, g = e * Math.cos(Math.PI / i2), f = 2 * Math.PI / i2, y = (i2 - 2) * Math.PI / i2, v = Math.PI - y, b = new Ki(0, -c, 0), x = new Ki(0, c, 0), w2 = new Gi(e, -c), S = new Gi(g, -c), M = new Gi(0, x.y).sub(S), O2 = new Gi(0, x.y).sub(w2), P = new Gi(M.y, -M.x).normalize(), A = new Gi(O2.y, -O2.x).normalize(), _ = e * Math.cos(Math.PI / i2) * Math.tan((Math.PI - M.angle()) / 2) - 1e-8;
    n = Math.min(n, _);
    {
    ...
    if (!r4) {
      ...
      let e2 = p++, t2 = [], s3 = w2.clone(), r5 = C / Math.cos(Math.PI / i2);
      s3.x -= r5;
      for (let e3 = 0; e3 < i2; e3++) {
        let r6 = e3 / i2 * Math.PI * 2 + m;
        ns(s3, new Gi(Math.sin(r6), Math.cos(r6)), I), h.push(I.x, I.y, I.z), d.push(0, -1, 0), u.push(0, 0), t2.push(p++);
      }
      for (let i3 = 0; i3 < t2.length; i3++) l3.push(t2[i3], e2, t2[(i3 + 1) % t2.length]);
    }
    let L = [];
    {
      let e2 = new Ki(), t2 = new Ki(), s3 = new Ki(), r5 = new Ki(), c2 = new Ki(), g2 = new Ki();
      for (let f2 = 0; f2 < i2; f2++) {
        let y2 = f2 / i2 * Math.PI * 2 + m, v2 = (f2 + 0.5) / i2 * Math.PI * 2 + m, S2 = (f2 + 1) / i2 * Math.PI * 2 + m, O3 = new Gi(Math.sin(y2), Math.cos(y2)), _2 = new Gi(Math.sin(v2), Math.cos(v2)), I2 = new Gi(Math.sin(S2), Math.cos(S2));
        ns(w2, O3, t2), ns(w2, I2, s3), ns(P, _2, e2), ls(x, t2, s3, E2, E2, r5), h.push(r5.x, r5.y, r5.z), ls(t2, x, s3, E2, C, c2), h.push(c2.x, c2.y, c2.z), ls(s3, t2, x, C, E2, g2), h.push(g2.x, g2.y, g2.z), d.push(e2.x, e2.y, e2.z), d.push(e2.x, e2.y, e2.z), d.push(e2.x, e2.y, e2.z), u.push(0, 0), u.push(0, 0), u.push(0, 0);
        let R = p++, G = p++, T = p++;
        if (l3.push(R, G, T), n > 0) {
          {
            ...
            U(e3, g2.clone().sub(c2), r6, M.angle());
          }
          let m2, f3;
          {
            let e3 = new Ki();
            ns(A, I2, e3);
            let t3 = g2.clone().add(r5).multiplyScalar(0.5);
            t3 = hs(t3, s3, x);
            let i3 = g2.clone().sub(r5);
            [m2, f3] = U(t3, i3, e3, o2, r5.y);
          }
          {
            let e3 = m2, t3 = e3.clone().setY(0).normalize(), i3 = new Ki(0, -1, 0), s4 = t3.clone().cross(i3);
            B(e3, t3, i3, s4);
          }
          L.concat(f3);
          {
            ...
            for (let t4 = 0; t4 < a; t4++) {
              let l4 = [], m4 = Math.PI / 2 - s4 * t4 / a, g3 = Math.cos(m4), f4 = Math.sin(m4), y3 = v2;
              for (let s5 = 0; s5 <= t4; s5++) {
                let s6 = Math.cos(y3), a2 = Math.sin(y3);
                e2.x = g3 * a2, e2.y = f4, e2.z = g3 * s6, o3.copy(r6).addScaledVector(e2, n), h.push(o3.x, o3.y, o3.z), d.push(e2.x, e2.y, e2.z), u.push(0, 0), l4.push(p++), y3 += 2 * Math.PI / t4 / i2;
              }
              c3.push(l4);
            }
            f3.reverse(), c3.push(f3);
            let m3 = c3.length - 1;
            for (let e3 = 0; e3 < m3; e3++) {
              let t4 = c3[e3], i3 = c3[e3 + 1], s5 = t4.length - 1;
              l3.push(i3[1], t4[0], i3[0]);
              for (let e4 = 1; e4 <= s5; e4++) l3.push(t4[e4], t4[e4 - 1], i3[e4]), l3.push(i3[e4 + 1], t4[e4], i3[e4]);
            }
          }
        }
      }
    ...
    function U(e2, t2, i3, s3, r5) {
      let o3 = -s3 / 2, c2 = (Math.PI - s3) / 2, m2 = t2.clone().normalize().cross(i3);
      e2.addScaledVector(i3, -n / Math.sin(c2));
      let g2 = new Ki(), f2 = new Ki(), y2 = p, v2 = [];
      for (let l4 = 0; l4 <= a; l4++) {
        let c3 = o3 + l4 / a * s3;
        f2.set(0, 0, 0), f2.addScaledVector(m2, Math.sin(c3)), f2.addScaledVector(i3, Math.cos(c3));
        for (let i4 = 0; i4 <= 1; i4++) {
          let s4 = i4 / 1 - 0.5;
          if (g2.copy(e2), g2.addScaledVector(t2, s4), g2.addScaledVector(f2, n), null != r5) {
            let e3 = Math.max(0, g2.y - r5);
            g2.addScaledVector(t2, -e3 / t2.y);
          }
          h.push(g2.x, g2.y, g2.z), d.push(f2.x, f2.y, f2.z), u.push(0, 0), 0 === i4 && v2.push(p), p++;
        }
      }
      for (let e3 = 0; e3 < a; e3++) for (let t3 = 0; t3 < 1; t3++) {
        let i4 = y2 + t3 + 2 * e3, s4 = i4 + 2, r6 = s4 + 1, n2 = i4 + 1;
        l3.push(i4, s4, n2), l3.push(s4, r6, n2);
      }
      return [e2.clone().addScaledVector(t2, 0.5), v2];
    }
    function B(e2, t2, i3, s3) {
      let r5 = Math.PI / 2, o3 = O2.angle() - r5, c2 = [], m2 = new Ki(), g2 = new Ki();
      for (let l4 = 0; l4 <= a; l4++) {
        let f3 = [], y2 = l4 / a;
        for (let a2 = 0; a2 <= l4; a2++) {
          let c3 = ((l4 ? a2 / l4 : 0) - 0.5) * v, b2 = Math.cos(c3), x2 = Math.sin(c3), w3 = (r5 + Math.atan(Math.tan(o3) * b2)) * y2, S2 = Math.cos(w3), M2 = Math.sin(w3);
          m2.set(0, 0, 0), m2.addScaledVector(t2, M2 * b2), m2.addScaledVector(i3, S2), m2.addScaledVector(s3, M2 * x2), g2.copy(e2).addScaledVector(m2, n), h.push(g2.x, g2.y, g2.z), d.push(m2.x, m2.y, m2.z), u.push(0, 0), f3.push(p++);
        }
        c2.push(f3);
      }
      let f2 = c2.length - 1;
      for (let e3 = 0; e3 < f2; e3++) {
        let t3 = c2[e3], i4 = c2[e3 + 1], s4 = t3.length - 1;
        l3.push(t3[0], i4[1], i4[0]);
        for (let e4 = 1; e4 <= s4; e4++) l3.push(t3[e4 - 1], t3[e4], i4[e4]), l3.push(t3[e4], i4[e4 + 1], i4[e4]);
      }
    }
    this.setIndex(l3), this.setAttribute("position", new Hr(h, 3)), this.setAttribute("normal", new Hr(d, 3)), this.setAttribute("uv", new Hr(u, 2));
  }
};
var us = class extends ha {
  constructor(e = 1, t = 1, i2 = 1, s2 = 90, r4 = 10, n = 24) {
    ...
    let d = [], u = Math.PI / 2, p = (e2 = 0, t2 = 0, i3 = 0) => new Ki(e2, t2, i3), c = p(), m = p(), [g, f, y] = [t / 2, e / 2, i2 / 2], v = -f, b = +f, [x, w2, S] = [p(v, -g, +y), p(v, -g, -y), p(v, +g, -y)], M = (e2, t2 = false) => Math.sin(e2 - Math.PI / (+t2 + 1)), O2 = (e2, t2 = false) => Math.cos(e2 - Math.PI / (+t2 + 1));
    S.y = Math.sin(s2) * t - g;
    let P = Math.cos(s2) * t - y, A = x.z - h;
    s2 <= u ? (S.z = Math.min(P, A), S.z == A && (S.y -= (P - A) / Math.tan(u - s2))) : w2.z = Math.min(w2.z - P - y, x.z - h), c.subVectors(x, w2), m.subVectors(S, w2);
    let _ = Math.min(c.length(), m.length()) * r4 / 100, C = _ * Math.tan(s2 / 2), E2 = _ / Math.cos(s2 / 2), I = c.clone().normalize().add(m.normalize()).setLength(E2).add(w2);
    c.set(0, M(s2, true), O2(s2, true)), d.push([S, c.clone()]);
    let D2 = (Math.PI - s2) / n;
    for (let e2 = 0; e2 <= n; e2++) {
      let t2 = u + s2 + e2 * D2;
      c.set(0, Math.sin(t2) * C, Math.cos(t2) * C), c.add(I), m.set(0, M(t2), O2(t2)), d.push([c.clone(), m.clone()]);
    }
    d.push([x, p(0, 1, 0)]);
    ...
    d[U].push(0);
    let G, T, N, [k, F, V] = d[0];
    for (let e2 = 1; e2 < d.length; e2++) [G, T, N] = d[e2], a.push(v, k.y, k.z, v, G.y, G.z, b, k.y, k.z, b, k.y, k.z, v, G.y, G.z, b, G.y, G.z), o2.push(0, F.y, F.z, 0, T.y, T.z, 0, F.y, F.z, 0, F.y, F.z, 0, T.y, T.z, 0, T.y, T.z), l3.push(0, V, 0, N, 1, V, 1, V, 0, N, 1, N), [k, F, V] = [G, T, N];
    this.setAttribute("position", new Hr(a, 3)), this.setAttribute("normal", new Hr(o2, 3)), this.setAttribute("uv", new Hr(l3, 2));
  }
};
var ps = { ConeGeometry: class {
  ...
  static build(e) {
    let t, { width: i2, depth: s2, height: r4, radialSegments: n, heightSegments: a, openEnded: o2, thetaStart: l3, thetaLength: h, cornerRadiusTop: d, cornerRadiusBottom: u, cornerSegments: p } = e.parameters;
    0 === h ? (t = new ha(), t.setAttribute("position", new Hr([], 3))) : t = d > 0 || u > 0 || h < 360 ? new Xi(0, i2 / 2, r4, n, a, o2, l3, h * Math.PI / 180, d, u, p, 0, true) : new jn(i2 / 2, r4, n, a, o2);
    let c = s2 / i2;
    return 1 !== c && t.scale(1, 1, c), Object.assign(t, { userData: { ...e, type: "ConeGeometry" } });
  }
}, CubeGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  ...
  static build(e) {
    let t, { width: i2, height: s2, depth: r4, widthSegments: n, heightSegments: a, depthSegments: o2, cornerRadius: l3, cornerSegments: h } = e.parameters;
    return t = 0 === l3 ? new Wn(i2, s2, r4, n, a, o2) : new Ji(i2, s2, r4, n, a, o2, l3, h), Object.assign(t, { userData: { ...e, type: "CubeGeometry" } });
  }
}, CylinderGeometry: Wi, DodecahedronGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  }
  static normalizeInputs(e, t) {
  ...
  static build(e) {
    let { width: t, height: i2, depth: s2, detail: r4, corner: n, cornerSides: a } = e.parameters, o2 = 0 === r4 && 0 !== n ? new Ki2(0.5 * t, n, a) : new qn(0.5 * t, r4), l3 = i2 / t, h = s2 / t;
    return (1 !== l3 || 1 !== h) && o2.scale(1, l3, h), Object.assign(o2, { userData: { ...e, type: "DodecahedronGeometry" } });
  }
}, EllipseGeometry: Di, HelixGeometry: Et, IcosahedronGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  }
  static normalizeInputs(e, t) {
  ...
  static build(e) {
    let { width: t, height: i2, depth: s2, detail: r4, corner: n, cornerSides: a } = e.parameters, o2 = 0 === r4 && 0 !== n ? new Qi2(0.5 * t, n, a) : new Uh(0.5 * t, r4), l3 = i2 / t, h = s2 / t;
    return (1 !== l3 || 1 !== h) && o2.scale(1, l3, h), Object.assign(o2, { userData: { ...e, type: "IcosahedronGeometry" } });
  }
}, LatheGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  ...
  static normalizeInputs(e, t) {
    ...
    void 0 === t ? (s2.computeBoundingBox(), s2.boundingBox.getSize(rs), i2 = { width: rs.x, height: rs.y, depth: rs.z, subdivisions: 0 }) : i2 = t.parameters;
  ...
  static build(e) {
    ...
    })(n), n.boundingBox.getSize(rs)) : rs.set(a.width, a.height, a.depth), (t !== rs.x || i2 !== rs.y || s2 !== rs.z) && n.scale(0 === rs.x ? 1 : t / rs.x, 0 === rs.y ? 1 : i2 / rs.y, 0 === rs.z ? 1 : s2 / rs.z);
    let o2 = n.originalGeometry;
    try {
      r4 > 0 ? (void 0 === o2 || (a == null ? void 0 : a.subdivisions) !== r4) && (void 0 === o2 && (o2 = n), n = new is(r4).modify(o2)) : (void 0 !== o2 && (n = o2), o2 = void 0, void 0 === n.getAttribute("normal") && n.computeVertexNormals());
    } catch {
  ...
  static loadFromUrl(e, t, i2) {
    new fl(i2).load(e, (e2) => {
      ...
      e2.boundingBox.getSize(rs);
      let s2 = 100 / rs.x;
      Object.assign(i3.parameters, { width: 100, height: rs.y * s2, depth: rs.z * s2 }), t(this.build(i3));
    });
  }
}, PolygonGeometry: ki, PyramidGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  }
  static normalizeInputs(e, t) {
  ...
  static build(e) {
    let { width: t, height: i2, depth: s2, radialSegments: r4, heightSegments: n, openEnded: a, cornerRadius: o2, cornerSegments: l3 } = e.parameters, h = new ds(0.5 * t, i2, r4, n, a, o2, l3), d = s2 / t;
    return 1 !== d && h.scale(1, 1, d), Object.assign(h, { userData: { ...e, type: "PyramidGeometry" } });
  }
}, RectangleGeometry: Fi, SphereGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  }
  static normalizeInputs(e, t) {
  ...
  static build(e) {
    let t, { width: i2 = 100, height: s2 = i2, depth: r4 = i2, widthSegments: n = 64, heightSegments: a = 64, phiStart: o2, phiLength: l3, thetaStart: h, thetaLength: d } = e.parameters;
    return 0 === d ? (t = new ha(), t.setAttribute("position", new Hr([], 3))) : t = new qh(0.5 * i2, n, a, o2, l3, h, d * Zi.DEG2RAD), t.scale(1, s2 / i2, r4 / i2), Object.assign(t, { userData: { ...e, type: "SphereGeometry" } });
  }
}, PlaneGeometry: class {
  static create(e) {
    return this.build(this.normalizeInputs(e));
  ...
  static build(e) {
    let { width: t, height: i2, depth: s2, angle: r4, cornerRadius: n, cornerSegments: a } = e.parameters, o2 = new us(t, i2, s2, r4, n, a);
  ...
  static build(e) {
    let { width: t, height: i2, depth: s2, radialSegments: r4, tubularSegments: n, arc: a, cornerRadius: o2, cornerSegments: l3 } = e.parameters, d = (function(e2, t2, i3, s3, r5, n2, a2, o3, l4, d2, u) {
      [t2, i3] = [i3, t2], a2 = t2 / 2;
      let p = Zi.clamp(r5 / 360, 0, 1);
      if (0 === p) {
        let e3 = new ha();
        return e3.setAttribute("position", new Hr([], 3)), e3;
      }
      return 1 === p && (d2 = 0), new Vt(true, e2, t2, i3, s3, p, n2, a2, 0, l4, d2, u);
    })(t, i2, s2, 0.5 * t, a, n, 0, 0, r4, o2, l3);
  ...
  static build(e) {
    ...
    o2 !== i2 && (o2 -= i2);
    let l3 = new Yh(o2, i2, s2, r4, n, a);
    return Object.assign(l3, { userData: { ...e, type: "TorusKnotGeometry" } });
  }
  ...
  static build(e) {
    let { width: t = 100, height: i2, cornerRadius: s2, depth: r4, extrudeBevelSize: n, extrudeBevelSegments: a, isRect: o2 } = e.parameters, l3 = e.shape, h = 0.5 * t, d = 0.5 * i2;
    o2 ? (l3.addPoint(l3.createPoint(-h, d)), l3.addPoint(l3.createPoint(h, -d)), l3.addPoint(l3.createPoint(-h, -d))) : (l3.addPoint(l3.createPoint(0, d)), l3.addPoint(l3.createPoint(h, -d)), l3.addPoint(l3.createPoint(-h, -d))), l3.isClosed = true;
    for (let e2 = 0, t2 = l3.points.length; e2 < t2; e2++) l3.points[e2].roundness = s2;
    l3.roundness = s2, l3.update();
    let u = Bt.create({ shape: l3, parameters: { roundness: s2, depth: r4, extrudeBevelSize: n, extrudeBevelSegments: a } });
...
function gs2(e, t, i2, s2) {
  ...
  let o2, l3 = { parameters: n, type: n.type };
  if ("PathGeometry" === n.type) l3.path = n.path;
  else if ("VectorGeometry" === n.type) {
    let e2 = St.createFromState(n.shape, n.width, n.height);
    l3.shape = e2;
  } else if ("NonParametricGeometry" === n.type) {
    if (n.data.groups && ((_a = n.data.groups) == null ? void 0 : _a.forEach((e2) => e2.materialIndex = Math.max(e2.materialIndex ?? 0, 0))), l3.geometry = new fl().parse(n), 0 === l3.geometry.groups.length) {
      let e2 = l3.geometry;
    ...
    if ("TextGeometry" === n.type || "InputGeometry" === n.type) {
      ...
      return cs({ ...n, shape: i3, type: "VectorGeometry" });
    }
    if ("UIGeometry" === n.type) return Fi.create({ parameters: { width: n.width, height: n.height, cornerRadius: n.cornerRadius, cornerType: n.cornerType } });
  }
  try {
    o2 = cs(l3);
  } catch (e2) {
    console.error(e2), console.error(`Error generating geometry with inputs: ${l3}`);
    let t2 = St.createFromState(ur.defaultData(), 100, 100);
    l3.shape = t2, l3.type = "VectorGeometry", o2 = cs(l3);
  }
  return o2;
}
var fs = new As();
...
function vs2(e, t, i2, s2) {
  let r4, n, a, o2 = e.position.array, l3 = e.normal.array, h = fs.makeScale(t, i2, s2).invert().elements;
  for (let e2 = 0, d = o2.length; e2 < d; e2 += 3) o2[e2] *= t, o2[e2 + 1] *= i2, o2[e2 + 2] *= s2, r4 = l3[e2], n = l3[e2 + 1], a = l3[e2 + 2], l3[e2] = h[0] * r4 + h[4] * n + h[8] * a, l3[e2 + 1] = h[1] * r4 + h[5] * n + h[9] * a, l3[e2 + 2] = h[2] * r4 + h[6] * n + h[10] * a;
...
var Ss = new Float32Array([10, 10, 0, -10, 10, 0, -10, -10, 0, 10, -10, 0]);
var Ms = new Uint32Array([0, 1, 2, 3]);
var Os = new Uint8Array([4]);
var Ps = class extends ha {
  constructor(e, t) {
  ...
  mutateDirectlyScaleBaked(e, t) {
    ...
    this.subdividedGeometry && vs2(this.subdividedGeometry.attributes, ...s2), this.originalGeometry && vs2(this.originalGeometry.attributes, ...s2), this.data = e;
    let r4 = this.userData.parameters;
    this.userData.parameters = { width: r4.width * s2[0], height: r4.height * s2[1], depth: r4.depth * s2[2] }, this.originalGeometry.boundingSphere.center.multiply(ws.fromArray(s2));
    let n = ws.set(r4.width, r4.height, r4.depth).length();
  ...
  mutateDirectlySubdivisions(e) {
    ...
    if (e.subdivisions > 0) {
      let s3 = 0;
      try {
        s3 = Ps.allocate(e), i2 = Ps.buildRefined(s3, e.subdivisions, t);
      } catch (t2) {
        console.error(t2, e);
      } finally {
        s3 && Ps.freeSubdivPointer(s3);
      }
    }
  ...
  rebuild() {
    let e, t, i2;
    try {
      ({ originalGeometry: e, subdividedGeometry: t, subdivPointer: i2 } = Ps.build(this.data, void 0, !this.flatShading, void 0));
    } catch {
  ...
  freeSubdivPointer() {
    this.subdivPointer && (Ps.freeSubdivPointer(this.subdivPointer), this.subdivPointer = 0);
  }
  dispose() {
  ...
  calcBoundingBox() {
    ...
    xs.setFromBufferAttribute(t), xs.getCenter(i2), e.boundingSphere.radius = i2.distanceTo(xs.max), isNaN(e.boundingSphere.radius) && console.error('THREE.BufferGeometry.computeBoundingSphere(): Computed radius is NaN. The "position" attribute is likely to have NaN values.', this), xs.getSize(ws);
    let s2 = { width: ws.x, height: ws.y, depth: ws.z };
    return this.userData.parameters = s2, s2;
  }
  static build(e, t, i2, s2) {
    let r4, n, a = (e == null ? void 0 : e.phongAngle) ?? 35;
    false === i2 && (a = -1), t && (bs.free_bvh(t), bs.free_subdivision_surface(t));
    try {
      r4 = Ps.allocate(e, s2);
    } catch (t2) {
      console.error(t2, e), r4 = Ps.allocate({ positionWASM: Ss, indexWASM: Ms, verticesPerFaceWASM: Os }, s2);
    }
    bs.set_destination_refinement_level(r4, 0);
    let o2 = Ps.buildLevel(r4, true, a);
    return n = e.subdivisions > 0 ? Ps.buildRefined(r4, e.subdivisions, a) : null, { subdivPointer: r4, originalGeometry: o2, subdividedGeometry: n };
  }
  static buildRefined(e, t, i2) {
    try {
      return bs.set_destination_refinement_level(e, t), Ps.buildLevel(e, false, i2) ?? null;
    } catch {
      try {
        return bs.set_destination_refinement_level(e, t - 1), Ps.buildLevel(e, false, i2) ?? null;
      } catch {
        return null;
      }
    }
  ...
  static primitiveToQuads(e, t, i2) {
    ...
    let s2, r4 = void 0 !== e.shape || void 0 !== e.path ? t.geometry : gs2(e, i2, false, t);
    s2 = Ct(e) ? r4.getClosedTorusIndicesForBooleanOrSubdiv() : r4.getIndex();
    let n, { positions: a, triIndices: o2, triOriginals: h } = _s(r4.getAttribute("position"), s2);
    ...
    let { indices: d, verticesPerFace: u, uvs: p } = (function(e2, t2, i3, s3, r5) {
      let n2 = [], a2 = [], o3 = r5 ? i3.getAttribute("uv") : void 0, l3 = o3 && 2 === o3.itemSize ? [] : void 0, h2 = (e3) => {
        if (l3) {
          let t3 = r5[e3];
          l3.push(o3.getX(t3), o3.getY(t3));
        }
      };
      ...
      for (; u2 < t2.length; ) {
        ...
        if (t2[u2 + 1] === t2[u2 + 3] && t2[u2 + 2] === t2[u2 + 5] || t2[u2 + 0] === t2[u2 + 3] && t2[u2 + 2] === t2[u2 + 4]) {
          Cs.set(e2[3 * t2[u2]], e2[3 * t2[u2] + 1], e2[3 * t2[u2] + 2]), Es.set(e2[3 * t2[u2 + 1]], e2[3 * t2[u2 + 1] + 1], e2[3 * t2[u2 + 1] + 2]), Is.set(e2[3 * t2[u2 + 4]], e2[3 * t2[u2 + 4] + 1], e2[3 * t2[u2 + 4] + 2]), Ds.set(e2[3 * t2[u2 + 5]], e2[3 * t2[u2 + 5] + 1], e2[3 * t2[u2 + 5] + 2]), Es.sub(Cs).normalize(), Is.sub(Cs).normalize(), Ds.sub(Cs).normalize();
          let i4 = Es.cross(Is).dot(Ds), r6 = u2;
      ...
      if (i3.useNgonForTopBottomFaceDuringBake) {
        ...
        t3.reverse(), n2.push(...t3, ...s4), a2.push(r6, r6), l3 = void 0;
      }
      return { indices: n2, verticesPerFace: a2, uvs: l3 };
    })(a, o2, r4, n, h);
    return { positions: a, indices: d, verticesPerFace: u, uvs: p };
  }
  static allocate(e, t) {
    var _a;
    let i2, s2, r4, n = [], a = [];
    e.positionWASM && e.positionWASM.length > 0 ? (i2 = e.positionWASM, s2 = e.indexWASM, r4 = e.verticesPerFaceWASM, bs.alloc_subdivision_surface_uvs && e.uvWASM && e.uvWASM.length === 2 * s2.length && (a = e.uvWASM)) : (i2 = Ss, s2 = Ms, r4 = Os);
    let o2, l3 = i2.length, h = s2.length, d = r4.length, u = i2.length + n.length + a.length, p = s2.length + r4.length, c = u * Float32Array.BYTES_PER_ELEMENT + p * Uint32Array.BYTES_PER_ELEMENT, m = u * Float32Array.BYTES_PER_ELEMENT, g = bs._malloc(c), f = new Float32Array(bs.HEAPF32.buffer, g, u), y = new Uint32Array(bs.HEAPU32.buffer, g + m, p);
    f.set(i2, 0), f.set(n, i2.length), f.set(a, i2.length + n.length), y.set(s2, 0), y.set(r4, s2.length), ((_a = e == null ? void 0 : e.scaleBaked) == null ? void 0 : _a.some((e2) => 1 !== e2)) && (o2 = new As().makeScale(...e.scaleBaked.map((e2) => "number" == typeof e2 ? e2 : 1))), t && (o2 ? o2.premultiply(t) : o2 = t);
    let v = g + (i2.length + n.length) * Float32Array.BYTES_PER_ELEMENT, b = a.length ? o2 ? bs.alloc_subdivision_surface_uvs2(g, l3, g + m, h, g + m + s2.length * Uint32Array.BYTES_PER_ELEMENT, d, v, a.length, o2.elements) : bs.alloc_subdivision_surface_uvs(g, l3, g + m, h, g + m + s2.length * Uint32Array.BYTES_PER_ELEMENT, d, v, a.length) : o2 ? bs.alloc_subdivision_surface2(g, l3, g + m, h, g + m + s2.length * Uint32Array.BYTES_PER_ELEMENT, d, o2.elements) : bs.alloc_subdivision_surface(g, l3, g + m, h, g + m + s2.length * Uint32Array.BYTES_PER_ELEMENT, d);
    return bs._free(g), b;
  }
  static buildLevel(e, t, i2, s2, r4, n = false) {
    let a = r4 ? bs.get_mesh_data2(e, t ? bs.Level.CONTROL : bs.Level.REFINED, i2, r4.elements) : bs.get_mesh_data(e, t ? bs.Level.CONTROL : bs.Level.REFINED, i2), o2 = bs.HEAPU32.subarray(a >> 2, 10 + (a >> 2)), l3 = o2.subarray(4, 8), h = 0, d = bs.HEAPU32[o2[h] >> 2], u = bs.HEAPF32.subarray(d >> 2, (d >> 2) + l3[h]);
    h++;
    let p = bs.HEAPU32[o2[h] >> 2], c = bs.HEAPF32.subarray(p >> 2, (p >> 2) + l3[h]);
    h++;
    let m = bs.HEAPU32[o2[h] >> 2], g = bs.HEAPU32.subarray(m >> 2, (m >> 2) + l3[h]);
    h++;
    let f, y = bs.HEAPU32[o2[h] >> 2], v = bs.HEAPU32.subarray(y >> 2, (y >> 2) + l3[h]);
    if (h++, bs.alloc_subdivision_surface_uvs) {
      let e2 = o2[9];
      if (e2 > 0) {
        let t2 = bs.HEAPU32[o2[8] >> 2];
        f = bs.HEAPF32.subarray(t2 >> 2, (t2 >> 2) + e2);
      }
    }
    if (void 0 === s2) {
      let e2 = new ha();
      if (e2.setIndex(new Yr(v, 1)), e2.setAttribute("position", new Hr(u, 3)), e2.setAttribute("normal", new Hr(c, 3)), f && e2.setAttribute("uv", new Hr(f, 2)), t) {
        e2.setAttribute("faceMap", new Yr(g, 1));
        let t2 = new Float32Array(c.length / 3 * 4).fill(0);
        e2.setAttribute("color", new qr(t2, 4));
      }
      return bs.free_mesh_data(a), e2.userData.type = "SubdivGeometry", e2;
    }
    if (s2.getAttribute("position").copyArray(u), s2.getAttribute("normal").copyArray(c), s2.attributes.position.needsUpdate = true, s2.attributes.normal.needsUpdate = true, n) {
      let e2 = s2.getIndex();
      null !== e2 && e2.array.length === v.length && (e2.copyArray(v), e2.needsUpdate = true);
    }
    let b = s2.getAttribute("uv");
    f && b && b.array.length === f.length && (b.copyArray(f), b.needsUpdate = true), bs.free_mesh_data(a);
  }
  static freeSubdivPointer(e) {
    bs.free_bvh(e), bs.free_subdivision_surface(e);
  }
  static buildControlCageWireframe(e, t, i2) {
    let s2 = bs.get_wireframe_data_for_base_level(e), r4 = bs.HEAPU32.subarray(s2 >> 2, 4 + (s2 >> 2)), n = r4.subarray(2, 4), a = 0, o2 = bs.HEAPU32[r4[a] >> 2], l3 = bs.HEAPF32.subarray(o2 >> 2, (o2 >> 2) + n[a]);
    a++;
    let h = bs.HEAPU32[r4[a] >> 2], d = bs.HEAPU32.subarray(h >> 2, (h >> 2) + n[a]);
    if (void 0 === t) {
      let e2 = new ha();
      e2.setAttribute("position", new Hr(l3, 3));
      let t2 = new Float32Array(l3.length);
      for (let e3 = 0, s3 = l3.length; e3 < s3; ) t2[e3++] = i2.r, t2[e3++] = i2.g, t2[e3++] = i2.b;
      return e2.setAttribute("color", new qr(t2, 3)), e2.setIndex(new Yr(d, 1)), bs.free_wireframe_data_for_base_level(s2), e2;
    }
    t.getAttribute("position").copyArray(l3), t.attributes.position.needsUpdate = true, bs.free_wireframe_data_for_base_level(s2);
  }
  static updateCollabMesh(e, t, i2) {
    let s2 = 0 === t;
    s2 || bs.set_destination_refinement_level(e, t);
    let r4 = i2 ? bs.get_topological_data2(e, s2 ? bs.Level.CONTROL : bs.Level.REFINED, i2.elements) : bs.get_topological_data(e, s2 ? bs.Level.CONTROL : bs.Level.REFINED), n = bs.HEAPU32.subarray(r4 >> 2, 8 + (r4 >> 2)), a = n.subarray(3, 6), o2 = 0, l3 = bs.HEAPU32[n[o2] >> 2], h = new Float32Array(bs.HEAPF32.subarray(l3 >> 2, (l3 >> 2) + a[o2]));
    o2++;
    let d = bs.HEAPU32[n[o2] >> 2], u = new Uint32Array(bs.HEAPU32.subarray(d >> 2, (d >> 2) + a[o2]));
    o2++;
    let p, c = bs.HEAPU32[n[o2] >> 2], m = new Uint8Array(bs.HEAPU32.subarray(c >> 2, (c >> 2) + a[o2]));
    if (bs.alloc_subdivision_surface_uvs) {
      let e2 = n[7];
      if (e2 > 0) {
        let t2 = bs.HEAPU32[n[6] >> 2];
        p = new Float32Array(bs.HEAPF32.subarray(t2 >> 2, (t2 >> 2) + e2));
      }
    }
    return bs.free_topological_data(r4), { positions: h, indices: u, verticesPerFace: m, uvs: p };
  }
};
function As2(e) {
  let t = Object.keys(e);
...
function _s(e, t) {
  ...
  for (let l4 = 0; l4 < i2; l4++) {
    let i3 = t ? t.getX(l4) : l4, h2 = e.getX(i3), d = e.getY(i3), u = e.getZ(i3), p = Math.round(h2 * r4), c = Math.round(d * r4), m = Math.round(u * r4), g = n.get(p);
    void 0 === g && (g = /* @__PURE__ */ new Map(), n.set(p, g));
    let f = g.get(c);
    void 0 === f && (f = /* @__PURE__ */ new Map(), g.set(c, f));
    let y = f.get(m);
    void 0 === y && (y = s2++, f.set(m, y), o2.push(h2, d, u)), a[l4] = y;
  }
  let l3 = [], h = [];
  for (let e2 = 0; e2 < a.length; e2 += 3) a[e2] === a[e2 + 1] || a[e2] === a[e2 + 2] || a[e2 + 1] === a[e2 + 2] || (l3.push(a[e2], a[e2 + 1], a[e2 + 2]), h.push(t ? t.getX(e2) : e2, t ? t.getX(e2 + 1) : e2 + 1, t ? t.getX(e2 + 2) : e2 + 2));
  return { positions: o2, triIndices: l3, triOriginals: h };
}
var Cs = new Ki();
var Es = new Ki();
var Is = new Ki();
...
var Us = (e, t, i2) => Math.max(0, Math.min(1, Number(t.getVariable("number" == typeof e ? 100 * e : e, i2) ?? 100) / 100)) ?? 1;
var zs = (e, t, i2) => "number" == typeof e ? e : t.getVariable(e, i2);
function Bs(e) {
...
var ks = class extends Ns {
  ...
  expand() {
    ...
    for (; t; ) {
      ...
      (i2 == null ? void 0 : i2.object) !== t && (i2 && this.remove(i2), i2 = new ks(t), this.add(i2), this.children.splice(e, 0, this.children.pop()), i2.matrixWorldNeedsUpdate = true, i2.matrixAutoUpdate = false, i2.matrix = t.matrix, i2.hiddenMatrix = t.hiddenMatrix, i2.pivotMatrix = t.pivotMatrix), i2.expand(), e += 1, t = this.object.entityChildren(e);
    }
...
var js = class extends Vs {
  ...
  createObject(e, t, i2) {
    let s2 = gs2(e, t, this.flatShading, i2);
    return s2.computeBoundingSphere(), s2;
  }
};
var Hs = { markNeedsUpdateRendererDirty: () => {
} };
function qs(e) {
  return "variable_" + e;
}
...
var Zs = new Ki();
var Js = new Rs();
var $s2 = class extends vi {
  constructor(e) {
    super(), this.shared = e;
  }
  create(e) {
    return new Oi(e, this.shared);
  }
};
var Ks = class {
  constructor(e, t = {}, i2 = true, s2 = false) {
    if (this.data = e, this.needsJitter = i2, this.enableLocalStorageForPersistentVariables = s2, this.geometryCache = new js(true), this.geometryCache2 = new js(false), this.imageHolderCache = new $s2(this), this.thisContext = { scene: Hs, shared: this }, this.deletedImage = new Pi(l2.emptyImage, this), this.deletedVideo = new Pi(Ht.defaultVideo, this), this.materials = {}, this.images = {}, this.uiBuffers = {}, this.videos = {}, this.colors = {}, this.audios = {}, this.particles = {}, this.fonts = {}, this.timelineAnimations = {}, this.variables = {}, this.userAPIs = {}, this.userWebhooks = {}, this.mouseProperty = null, this.raycastProperty = null, this.requestRender = () => {
  ...
  reset(e, t = false, i2 = false) {
    ...
    for (let [t2, i3] of Object.entries(e.timelineAnimations ?? {})) this.addAnimation(t2, i3);
  }
  addMaterial(e, t) {
  ...
  addImage(e, t) {
    return this.images[e] ? (this.onColorOrImageUpdate && this.onColorOrImageUpdate(), this.images[e].updateSrc(t.data), true) : (this.images[e] = new Pi(t, this), false);
  }
  deleteImage(e) {
    let t = this.images[e];
  ...
  addUIBuffer(e, t) {
    return this.uiBuffers[e] ? (this.onColorOrImageUpdate && this.onColorOrImageUpdate(), this.uiBuffers[e].updateSrc(t), true) : (this.uiBuffers[e] = new Pi(t, this), false);
  }
  uiBuffer(e) {
    return this.uiBuffers[e];
  }
  addVideo(e, t) {
    return this.videos[e] ? (this.videos[e].updateSrc(t.data), true) : (this.videos[e] = new Pi(t, this), false);
  }
  deleteVideo(e) {
    let t = this.videos[e];
  ...
  addColor(e, t) {
    return this.colors[e] ? (this.onColorOrImageUpdate && this.onColorOrImageUpdate(), "a" in t ? this.colors[e].setRGBA(t.r, t.g, t.b, t.a) : this.colors[e].setRGBA(t.r, t.g, t.b, 1), true) : (this.colors[e] = new Fs(t.r, t.g, t.b, "a" in t ? t.a : 1), false);
  }
  updateColor(e, t) {
    if (this.colors[e]) {
  ...
  color(e) {
    let t;
    if ("string" != typeof e) return new ci(e.r, e.g, e.b, "a" in e ? e.a : 1);
    {
      let i2 = this.getColor(e);
      i2 ? t = i2 : (console.warn("Tried to create color layer params with a color key that does not exist in the assets manager"), t = new ci(0, 0, 0, 0));
    }
    return t;
  }
  addAudio(e, t) {
  ...
  addAnimation(e, t) {
    this.timelineAnimations[e] = t;
  }
  getAnimation(e) {
    return this.timelineAnimations[e];
  }
  deleteAniamtion(e) {
    this.timelineAnimations[e] && delete this.timelineAnimations[e];
  }
  dispose() {
  ...
  addVariableHolder(e, t) {
    if (void 0 === this.variables[e]) {
      ...
      if (this.enableLocalStorageForPersistentVariables && t.persistent) {
        let s2 = localStorage.getItem(qs(e));
  ...
  updateVariable(e, t) {
    ...
    this.variables[e].value = t, this.enableLocalStorageForPersistentVariables && this.variables[e].persistent && localStorage.setItem(qs(e), JSON.stringify(t));
    let i2 = t;
    ...
    for (let t2 = this.variables[e].locations.length - 1; t2 >= 0; t2--) {
      ...
      if ("material" === n[0]) {
        ...
        if (o2 = s2.find(n[0]), "ParticleEmitter" === o2.type && o2.updateVariableState(i2, n), ct.is(o2)) if ("position" === n[1] || "rotation" === n[1] || "scale" === n[1]) o2.onVariableUpdate();
  ...
  updateEntityGeometryParams(e, t) {
    ...
    let l3 = { ...r4, ...o2 };
    return i2.dataPatched = { ...s2, geometry: l3 }, this.transientGeometryKeys.has(r4) && i2.chooseGeoemtryCache(this).forceDelete(s2.geometry), this.transientGeometryKeys.add(l3), i2.createGeometryDelayed(this.entityOpContext), i2.onVariableUpdate(true), i2.invalidateDownstreamBooleanData(), this.entityOpContext.scene.markShadowsDirty(), this.requestRender(), true;
  }
  ...
  updateEntityGeometryVertices(e, t) {
    ...
    if (void 0 === n || "number" != typeof n.length || n.length < 9 || n.length % 3 != 0 || n.length / 3 > Ks.MAX_TRANSIENT_VERTICES) return false;
    let a, o2, l3, h = n instanceof Float32Array ? n : Float32Array.from(n), d = h.length / 3;
    if (void 0 !== t.normals) {
    ...
    if (void 0 !== t.indices) {
      ...
      l3 = { array: e2, itemSize: 1, type: e2.constructor.name, normalized: false };
    } else {
    ...
    let u = 1 / 0, p = 1 / 0, c = 1 / 0, m = -1 / 0, g = -1 / 0, f = -1 / 0;
    for (let e2 = 0; e2 < h.length; e2 += 3) {
      let t2 = h[e2], i3 = h[e2 + 1], s3 = h[e2 + 2];
      t2 < u && (u = t2), t2 > m && (m = t2), i3 < p && (p = i3), i3 > g && (g = i3), s3 < c && (c = s3), s3 > f && (f = s3);
    }
    let y = (e2, t2) => ({ array: e2, itemSize: t2, type: "Float32Array", normalized: false }), v = { position: y(h, 3) };
    a && (v.normal = y(a, 3)), o2 && (v.uv = y(o2, 2));
    let b = { ...r4, width: m - u, height: g - p, depth: f - c, data: { attributes: v, ...l3 ? { index: l3 } : {} } }, x = this.transientGeometryKeys.has(r4);
  ...
  updateEntityMaterialParams(e, t) {
    ...
    let r4 = { scene: this.entityOpContext.scene, shared: this }, n = (e2) => e2.toLowerCase().replace(/[\s_.-]+/g, ""), a = (e2) => {
      ...
      return s3 instanceof Fs ? e2.setValue(t2, new ci(i3.r, i3.g, i3.b, r5)) : "function" == typeof s3.setRGBA ? s3.setRGBA(i3.r, i3.g, i3.b, r5) : s3.setRGB(i3.r, i3.g, i3.b), true;
    }, l3 = false;
    for (let e2 of s2) {
      let i3 = e2.data.layers ?? [], s3 = (t2) => e2.layers.find((e3) => e3.uuid === t2);
      if (void 0 !== t.color) {
        let n2 = a(t.color), h = i3.find((e3) => "color" === e3.data.type), d = h && s3(h.id);
        if (n2 && d && o2(d, "color", n2) && (l3 = true, void 0 !== n2.a)) {
          let t2 = n2.a < 1 || Ls(e2.data, this);
          e2.setTransparent ? e2.setTransparent(t2, r4.scene) : e2.transparent = t2;
        }
      }
      "number" == typeof t.alpha && isFinite(t.alpha) && ((_a = e2.onVariableUpdate) == null ? void 0 : _a.call(e2, ["alphaOverride"], Math.max(0, Math.min(t.alpha, 100)), r4), l3 = true);
      for (let h of t.layers ?? []) {
        ...
        if (!t2 || !d) continue;
        let u = Gs[t2.data.type] ?? [], p = Object.keys(t2.data);
        for (let [i4, s4] of Object.entries(h)) {
          if ("id" === i4 || "index" === i4 || "type" === i4) continue;
          let h2 = p.find((e3) => e3 === i4) ?? p.find((e3) => n(e3) === n(i4)) ?? i4;
          if (u.includes(h2)) continue;
          let c = a(s4);
          if (c && o2(d, h2, c)) l3 = true;
          else if ("number" == typeof s4 && isFinite(s4)) (_b = e2.onVariableUpdate) == null ? void 0 : _b.call(e2, ["layer", t2.id, h2], s4, r4), l3 = true;
    ...
    return l3 && this.requestRender(), l3;
  }
  deleteVariable(e) {
  ...
  getVariable(e, t) {
    ...
    if (Array.isArray(e)) {
      ...
      if (("position" === e[1] || "rotation" === e[1]) && e.length > 2 && ((_c = t2 == null ? void 0 : t2.getPhysicsLocalMatrix) == null ? void 0 : _c.call(t2, Ws))) return Ws.decompose(Ys, Xs, Zs), "position" === e[1] ? Ys[e[2]] : (Js.setFromQuaternion(Xs, t2.rotation.order), Js[e[2]] * Zi.RAD2DEG);
...
function tr(e) {
  return er(e) || true === (e == null ? void 0 : e.isTSLNodeMaterial);
}
Qs.MAX_TRANSIENT_VERTICES = 6e4, new Qs(wa.emptyData());
var ir = class extends $t {
  ...
  updateByPatchedOp(e, t, i2) {
    if (super.updateByPatchedOp(e, t, i2), O(e.path, ["geometry"]) && this.syncShadowCatcher(i2), null !== D(e.path, ["materials"]) && 0 === e.type && Array.isArray(this.material)) for (let [t2, s2] of Object.entries(e.props)) {
      ...
      r4 !== e2 && ir.disposeOneMaterial(e2), this.material[Number(t2)] = r4;
    }
...
var lr = class extends ir {
  ...
  get geometry() {
    ...
    if (this.geometryCreateDeleyed instanceof Qs) {
  ...
  updateGeometryInteractions(e, t) {
    ...
    if ("NonParametricGeometry" === i2 || "SubdivGeometry" === i2) {
      ...
      if (void 0 === this.localGeometry) {
        ...
        this.localGeometry = gs2(e2, t, this.data.flatShading, this);
      }
      n.scaleBaked ? [i3, s2, r4] = n.scaleBaked : { width: i3, height: s2, depth: r4 } = n;
      let a = this.localGeometry.userData, o2 = "number" == typeof i3 ? i3 : 1, l3 = "number" == typeof s2 ? s2 : 1, h = "number" == typeof r4 ? r4 : 1;
      void 0 !== a.sxPrev && vs2(this.localGeometry.attributes, o2 / a.sxPrev, l3 / a.syPrev, h / a.szPrev), a.sxPrev = o2, a.syPrev = l3, a.szPrev = h;
    } else {
      let i3 = gs2({ ...this.data.geometry, ...e }, t, this.data.flatShading, this);
      void 0 !== this.localGeometry && this.supportsInPlaceGeometryUpdate(this.localGeometry) && ys(this.localGeometry, i3) ? i3.dispose() : ((_a = this.localGeometry) == null ? void 0 : _a.dispose(), this.localGeometry = i3);
    }
  }
  ...
  updateByPatchedOpGeometry(e, t, i2) {
    var _a;
    let s2 = false;
    if (0 === e.type && 0 === e.path.length && Object.keys(e.props).includes("scaleBaked") && this.geometryCreateDeleyed instanceof Ps && this.chooseGeoemtryCache(i2.shared).mutateIfUnique(this.geometryCreateDeleyed.data, t) === this.geometryCreateDeleyed && (s2 = true, this.geometryCreateDeleyed.mutateDirectlyScaleBaked(t, e.props.scaleBaked), this.refreshAttachedCloners(i2), this.refreshAttachedPaths(i2)), !s2 && 0 === e.type && 0 === e.path.length && As2(e.props) && this.geometryCreateDeleyed instanceof Ps && this.chooseGeoemtryCache(i2.shared).mutateIfUnique(this.geometryCreateDeleyed.data, t) === this.geometryCreateDeleyed && (s2 = true, this.geometryCreateDeleyed.mutateDirectlySubdivisions(t), this.refreshAttachedCloners(i2), this.refreshAttachedPaths(i2)), !s2 && 0 === e.type && 0 === e.path.length && this.geometryCreateDeleyed instanceof ha && !(this.geometryCreateDeleyed instanceof Ps) && this.supportsInPlaceGeometryUpdate(this.geometryCreateDeleyed) && void 0 !== this._geometryCacheKey) {
      ...
      if (t2.getCached(this._geometryCacheKey) === r4 && true !== r4.isShared) {
        let n = this.dataPatched.geometry, a = gs2(n, e2, this.data.flatShading, this);
        ys(r4, a) ? (a.dispose(), r4.computeBoundingSphere(), t2.mutateIfUnique(this._geometryCacheKey, n)) : (a.computeBoundingSphere(), t2.forceDelete(this._geometryCacheKey), t2.adopt(n, a), this.geometryCreateDeleyed = a), this._geometryCacheKey = n, s2 = true, this.refreshAttachedCloners(i2), this.refreshAttachedPaths(i2);
      }
    }
  ...
  applyTransientGeometryData(e, t) {
    ...
    if (this.geometryCreateDeleyed instanceof ha && !(this.geometryCreateDeleyed instanceof Ps) && this.supportsInPlaceGeometryUpdate(this.geometryCreateDeleyed) && void 0 !== this._geometryCacheKey) {
      let t2 = this.chooseGeoemtryCache(i2), r4 = this.geometryCreateDeleyed;
      if (t2.getCached(this._geometryCacheKey) === r4 && true !== r4.isShared) {
        let n = gs2(s2, i2, this.data.flatShading, this);
        return ys(r4, n) ? (n.dispose(), r4.computeBoundingSphere(), t2.mutateIfUnique(this._geometryCacheKey, s2)) : (n.computeBoundingSphere(), t2.forceDelete(this._geometryCacheKey), t2.adopt(s2, n), this.geometryCreateDeleyed = n), this._geometryCacheKey = s2, this.refreshAttachedCloners(e), void this.refreshAttachedPaths(e);
      }
    }
  ...
  boneTransform(e, t) {
    ...
    rr2.fromBufferAttribute(s2.attributes.skinIndex, e), nr.fromBufferAttribute(s2.attributes.skinWeight, e), sr.copy(t).applyMatrix4(this.bindMatrix), t.set(0, 0, 0);
    for (let e2 = 0; e2 < 4; e2++) {
      let s3 = nr.getComponent(e2);
      if (0 !== s3) {
        let r4 = rr2.getComponent(e2);
        or.multiplyMatrices(i2.bones[r4].matrixWorld, i2.boneInverses[r4]), t.addScaledVector(ar.copy(sr).applyMatrix4(or), s3);
      }
    }
...
//# sourceMappingURL=chunk-EXQGW6OA.js.map
