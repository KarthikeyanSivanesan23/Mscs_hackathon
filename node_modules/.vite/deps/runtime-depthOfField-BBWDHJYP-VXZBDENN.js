...
var T = class extends to {
  ...
  get worldFocusDistance() {
    return -S(this.focusDistance, this.near, this.far);
  }
  ...
  get worldFocusRange() {
    return -S(this.focusRange, this.near, this.far);
  }
...
var M = class extends to {
  constructor(e = null) {
    super({ name: "MaskMaterial", uniforms: { maskTexture: new Vl(e), inputBuffer: new Vl(null), strength: new Vl(1) }, blending: p, depthWrite: false, depthTest: false, fragmentShader: "#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D inputBuffer;\n#else\nuniform lowp sampler2D inputBuffer;\n#endif\n#ifdef MASK_PRECISION_HIGH\nuniform mediump sampler2D maskTexture;\n#else\nuniform lowp sampler2D maskTexture;\n#endif\n#if MASK_FUNCTION != 0\nuniform float strength;\n#endif\nvarying vec2 vUv;void main(){\n#if COLOR_CHANNEL == 0\nfloat mask=texture2D(maskTexture,vUv).r;\n#elif COLOR_CHANNEL == 1\nfloat mask=texture2D(maskTexture,vUv).g;\n#elif COLOR_CHANNEL == 2\nfloat mask=texture2D(maskTexture,vUv).b;\n#else\nfloat mask=texture2D(maskTexture,vUv).a;\n#endif\n#if MASK_FUNCTION == 0\n#ifdef INVERTED\nmask=step(mask,0.0);\n#else\nmask=1.0-step(mask,0.0);\n#endif\n#else\nmask=clamp(mask*strength,0.0,1.0);\n#ifdef INVERTED\nmask=1.0-mask;\n#endif\n#endif\n#if MASK_FUNCTION == 2\ngl_FragColor=vec4(mask*texture2D(inputBuffer,vUv).rgb,mask);\n#else\ngl_FragColor=mask*texture2D(inputBuffer,vUv);\n#endif\n}", vertexShader: C }), this.toneMapped = false, this.setColorChannel(0), this.setMaskFunction(0);
  }
  set inputBuffer(e) {
    this.uniforms.inputBuffer.value = e;
  }
...
var H = class extends P {
  constructor({ resolutionScale: e = 0.5, width: t3 = z.AUTO_SIZE, height: r = z.AUTO_SIZE, kernelSize: n2 = G.LARGE } = {}) {
    ...
    let i = this.resolution = new z(this, t3, r, e);
...
var W = class extends O {
  constructor(e, { blendFunction: t3 = R, worldFocusDistance: r, worldFocusRange: n2, focusDistance: i = 0, focalLength: a = 0.1, focusRange: l = a, bokehScale: u = 1, width: c = z.AUTO_SIZE, height: f = z.AUTO_SIZE } = {}) {
    ...
    p2.maskFunction = 1, p2.colorChannel = 1, this.bokehNearBasePass = new L(new A(false, true)), this.bokehNearBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehNearFillPass = new L(new A(true, true)), this.bokehNearFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehFarBasePass = new L(new A(false, false)), this.bokehFarBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.bokehFarFillPass = new L(new A(true, false)), this.bokehFarFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.target = new Ki(), this.bokehScale = u;
  }
  get cocTexture() {
...
//# sourceMappingURL=runtime-depthOfField-BBWDHJYP-VXZBDENN.js.map
