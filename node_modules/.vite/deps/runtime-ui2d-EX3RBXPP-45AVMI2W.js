...
// node_modules/@splinetool/runtime/build/runtime-ui2d-EX3RBXPP.js
function E(e2, t, i2, r) {
  return r ? i2 : 2048 / Math.max(1, e2, t);
}
var U2 = new hl(-1, 1, 1, -1, 0, 1);
var B = new class extends ha {
  constructor() {
    super(), this.setAttribute("position", new Hr([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), this.setAttribute("uv", new Hr([0, 2, 0, 0, 2, 0], 2));
  }
}();
var M = new to({ defines: {}, uniforms: { tDiffuse: new Vl(null) }, vertexShader: "\n	varying vec2 vUv;\n	void main() {\n		vUv = uv;\n		gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n	}", fragmentShader: "\n	uniform sampler2D tDiffuse;\n	varying vec2 vUv;\n	void main() {\n		vec4 texel = texture2D( tDiffuse, vUv );\n		gl_FragColor = texel;\n	}" });
var z = new class {
  constructor(e2) {
    this._mesh = new Za(B, e2);
  }
  dispose() {
    this._mesh.geometry.dispose();
  }
  render(e2) {
    e2.render(this._mesh, U2);
  }
  get material() {
...
var C = class {
  constructor(t, i2, r, s) {
    ...
    this.uuid = t, this.width = i2, this.height = r, this.context = s, this.enabled = true, this.isScreenSpace = false, this.dpr = window.devicePixelRatio, this.isFrameDirty = false, this.onRenderRequestedDownstream = () => {
      ...
      this.renderer.dpr = E(e2, t2, this.dpr, this.isScreenSpace), this.renderer.setSize(e2, t2);
    ...
    }, this.scene2d = new K(Zi.generateUUID(), x.defaultData, { dpr: window.devicePixelRatio, shared: s.shared }), this.canvas = (null === G && (G = document.createElement("canvas")), G), this.renderer = (n = this.canvas, null === k && (k = new ht(n)), k), this.promise = this.init(), this.renderTarget = new Ms(1, 1, { type: Tt, stencilBuffer: false, depthBuffer: false }), s.shared.addUIBuffer(this.uuid, this.renderTarget), this.textureHolder = s.shared.uiBuffer(this.uuid);
  }
  get canvasTexture() {
    return this._canvasTexture || (this._canvasTexture = new Fn(this.canvas)), this._canvasTexture;
  }
  async init() {
    var _a;
  ...
  render(e2) {
    ...
    if (this.isFrameDirty) {
      if (this.isFrameDirty = false, this._innerApplySize(), this.renderer.clear(), (_a = this.frameOverride) == null ? void 0 : _a.draw(this.renderer), this.renderer.render(), this.canvasTexture.needsUpdate = true, e2.blitTextureToTarget) e2.blitTextureToTarget(this.canvasTexture, this.renderTarget);
        ...
        M.uniforms.tDiffuse.value = this.canvasTexture;
  ...
  applySize(e2, t = window.devicePixelRatio) {
    ...
    let a2 = (function(e3, t2, i3, r2) {
      let a3 = E(e3, t2, i3, r2), s = Math.max(i3, 512 / Math.min(e3, t2)), n = Math.min(s, a3);
  ...
  applyFrame(e2) {
    ...
    if (t && t instanceof X) return this.disposeFrameOverride(), this.frameRoot = t, this.frameOverride = t.clone({ dpr: this.renderer.dpr, shared: this.context.shared }), this.scene2d.add(this.frameOverride), this.applySize(), (_a = this.frame) == null ? void 0 : _a.addEventListener("render", this.onRenderRequestedDownstream), this.frameOverride.traverse((e3) => {
...
function L({ objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s }) {
  if (e2 instanceof X && t instanceof X || e2 instanceof W && t instanceof W) for (let n = 0, h = e2.children.length; n < h; n++) {
    let h2 = e2.children[n], d = t.children[n];
    h2 && d && h2.uuid === d.uuid && V({ objectOverride: h2, objectRoot: d, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s });
  }
}
function V({ objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s }) {
  let [n, h] = (function(e3) {
...
function A(e2) {
  return e2 instanceof N || e2 instanceof X || e2 instanceof U || e2 instanceof j;
}
var N2 = class extends lr {
  constructor(e2, t, i2) {
  ...
  updateGeometryInteractions(e2, t) {
    ...
    (_a = this.localGeometry) == null ? void 0 : _a.dispose(), this.localGeometry = gs(i2, t, this.data.flatShading, this);
  }
};
i("UIGeometry", (e2, t, i2) => new N2(e2, t, i2)), p({ Scene2D: K, UICanvas: C, loadHanaUIRUNTIME: v, setHanaUIWasmUrl: y }), a("ui-2d");
//# sourceMappingURL=runtime-ui2d-EX3RBXPP-45AVMI2W.js.map
