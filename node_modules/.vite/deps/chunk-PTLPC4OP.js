...
// node_modules/@splinetool/runtime/build/runtime-chunk-KE6HNYUL.js
var c;
var p2;
var f;
var x = b((t, e) => {
  ...
  !(function(t2, e2) {
    ...
    var r, s = {}, n2 = { svg_path: xt2 }, a2 = xt2, h = function(t3) {
      ...
      return jt("Z");
    }, x2 = /^[Ll]/, g2 = ut2(["L", "l"], false, false), m3 = function(t3, e3) {
      return jt(t3, e3);
    }, y2 = /^[Hh]/, v2 = ut2(["H", "h"], false, false), w2 = function(t3, e3) {
      return jt(t3, e3.map(function(t4) {
        return { x: t4 };
      }));
    }, _3 = /^[Vv]/, S3 = ut2(["V", "v"], false, false), B2 = function(t3, e3) {
      return jt(t3, e3.map(function(t4) {
        return { y: t4 };
      }));
    ...
    }, E2 = /^[Tt]/, O3 = ut2(["T", "t"], false, false), H2 = /^[Aa]/, L2 = ut2(["A", "a"], false, false), F2 = function(t3, e3, i2, r2, s2, n3) {
      ...
      return 1 * t3.join("");
    }, I2 = /^[01]/, D3 = ut2(["0", "1"], false, false), W2 = function(t3) {
      return "1" == t3;
    }, X2 = function() {
      return "";
    }, V2 = ",", q2 = dt2(",", false), Y3 = function(t3) {
      return t3.join("");
    }, $2 = ".", G2 = dt2(".", false), Q2 = /^[eE]/, J2 = ut2(["e", "E"], false, false), Z2 = /^[+\-]/, K2 = ut2(["+", "-"], false, false), tt2 = /^[0-9]/, et2 = ut2([["0", "9"]], false, false), it2 = function(t3) {
      return t3.join("");
    ...
    function mt2() {
      ...
      return c2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(p3)), i2 !== s && (i2 = f2()), (e3 = i2) === s && (e3 = (function() {
        ...
        if (e4 = nt2, x2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(g2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s && (n3 = yt()) !== s ? e4 = i3 = m3(i3, n3) : (nt2 = e4, e4 = s);
        } else nt2 = e4, e4 = s;
        return e4;
      })()) === s && (e3 = (function() {
        var e4, i3, r2, n3;
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, _3.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(S3)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
        ...
        if (e4 = nt2, b3.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(M2)), i3 !== s) {
          ...
          r2 !== s ? (n3 = (function() {
            ...
            return t3;
          })(), n3 !== s ? e4 = i3 = m3(i3, n3) : (nt2 = e4, e4 = s)) : (nt2 = e4, e4 = s);
        } else nt2 = e4, e4 = s;
        return e4;
      })()) === s && (e3 = (function() {
        var e4, i3, r2, n3;
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, H2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(L2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = (function() {
            var t3, e5, i4, r3, n4, a3;
            if (t3 = nt2, (e5 = Bt()) !== s) {
    ...
    function Bt() {
      ...
      return t3 = nt2, (e3 = Mt()) !== s ? ((i2 = At()) === s && (i2 = null), i2 !== s && (r2 = Mt()) !== s ? ((n3 = At()) === s && (n3 = null), n3 !== s && (a3 = Ct()) !== s && At() !== s && (h2 = kt()) !== s ? ((o2 = At()) === s && (o2 = null), o2 !== s && (l2 = kt()) !== s ? ((d2 = At()) === s && (d2 = null), d2 !== s && (u2 = bt()) !== s ? t3 = e3 = F2(e3, r2, a3, h2, l2, u2) : (nt2 = t3, t3 = s)) : (nt2 = t3, t3 = s)) : (nt2 = t3, t3 = s)) : (nt2 = t3, t3 = s)) : (nt2 = t3, t3 = s), t3;
    }
    function bt() {
      var t3, e3, i2, r2;
    ...
    function kt() {
      var e3;
      return I2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(D3)), e3 !== s && (e3 = W2(e3)), e3;
    }
    function At() {
      var t3, e3, i2, r2, n3;
    ...
    function Tt() {
      var e3;
      return 44 === t2.charCodeAt(nt2) ? (e3 = V2, nt2++) : (e3 = s, 0 === lt2 && ft2(q2)), e3;
    }
    function Pt() {
      var e3, i2, r2;
    ...
    function Rt() {
      var e3;
      return Z2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(K2)), e3;
    }
    function Et() {
      var e3, i2;
    ...
    function Ot() {
      var e3;
      return rt2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(st2)), e3 !== s && (e3 = X2()), e3;
    }
    var Ht, Lt, Ft, Ut = { m: "moveto", l: "lineto", h: "horizontal lineto", v: "vertical lineto", c: "curveto", s: "smooth curveto", q: "quadratic curveto", t: "smooth quadratic curveto", a: "elliptical arc", z: "closepath" };
    ...
    throw r !== s && nt2 < t2.length && ft2({ type: "end" }), Ht = ot2, Lt = ht2 < t2.length ? t2.charAt(ht2) : null, Ft = ht2 < t2.length ? pt2(ht2, ht2 + 1) : pt2(ht2, ht2), new i(i.buildMessage(Ht, Lt), Ht, Lt, Ft);
  } };
});
var g = b((t, e) => {
  var i = x().parse;
...
function v() {
  ...
  })(await import("./hana-ui-4NSWPV4K.js"), f ?? (function() {
    let t = typeof process < "u" ? "2.0.8" : void 0;
...
((t) => {
  ...
  t.identity = function() {
    ...
    let [s, n2, a2, h, o, l] = e(i), [d, u, c2, p3, f2, x2] = e(r), g2 = d * s + u * a2, m3 = d * n2 + u * h, y2 = c2 * s + p3 * a2, v2 = c2 * n2 + p3 * h, w2 = f2 * s + x2 * a2 + o, _3 = f2 * n2 + x2 * h + l;
    return t.create(g2, m3, y2, v2, w2, _3);
  }, t.prepend = function(i, r) {
    let [s, n2, a2, h, o, l] = e(i), [d, u, c2, p3, f2, x2] = e(r), g2 = s, m3 = n2, y2 = a2, v2 = h;
    (1 !== d || 0 !== u || 0 !== c2 || 1 !== p3) && (g2 = s * d + n2 * c2, m3 = s * u + n2 * p3, y2 = a2 * d + h * c2, v2 = a2 * u + h * p3);
    let w2 = o * d + l * c2 + f2, _3 = o * u + l * p3 + x2;
    return t.create(g2, m3, y2, v2, w2, _3);
...
var P = (t, e, i) => {
  let r = t.getCenter(), s = t.getHalfSize(), n2 = _2.append(e, t.worldMatrix);
  0 === s[0] && 0 === s[1] ? i.push(_2.apply(r, n2)) : T2.forEach((t2) => {
    let e2 = [t2[0] * s[0] + r[0], t2[1] * s[1] + r[1]];
    i.push(_2.apply(e2, n2));
  });
};
var z = class {
  constructor() {
    this.matrix = _2.identity(), this.min = [1 / 0, 1 / 0], this.max = [-1 / 0, -1 / 0], this.vertices = [], this.edges = [];
  }
  setFromObjectSize(t, e = false) {
    t.updateWorldMatrix(), this.makeEmpty(), _2.copy(t.worldMatrix, this.matrix);
    let i = _2.invert(t.worldMatrix);
  ...
  setFromSize(t, e, i) {
    this.makeEmpty(), _2.copy(i, this.matrix), this.expandBySize(t, e, i);
  }
  expandBySize(t, e, i) {
    [_2.apply([0, 0], i), _2.apply([0, e], i), _2.apply([t, e], i), _2.apply([t, 0], i)].forEach((t2) => this.expandByPoint(t2));
  }
  getCenter() {
    let [t, e] = this.min, [i, r] = this.getHalfSize();
    return _2.apply([t + i, e + r], this.matrix);
  }
  getSize() {
  ...
  computeVertices() {
    let [t, e] = this.getHalfSize(), i = this.getCenter(), [r, s, n2, a2] = _2.getAbcdef(this.matrix), h = _2.create(r, s, n2, a2, i[0], i[1]);
    this.vertices = T2.map(([i2, r2]) => _2.apply([i2 * t, r2 * e], h));
  }
  computeEdges() {
    this.edges = [];
  ...
  project(t, e) {
    let i = this.matrix;
    return e && (i = _2.append(e.worldMatrix, i)), _2.applyInverse(t, i);
  }
  intersects(t, e, i) {
  ...
  copy(t) {
    this.min = [...t.min], this.max = [...t.max], _2.copy(t.matrix, this.matrix), this.computeVertices(), this.computeEdges();
  }
  clone() {
    let t = new z();
...
var R = class {
  constructor(e, i, r) {
    this.uuid = e, this.data = i, this.isObject2D = true, this.localMatrix = _2.identity(), this.worldMatrix = _2.identity(), this.ignoreCameraZoom = false, this.visible = true, this._singleBBox = new z(), this._recursiveBBox = new z(), this.singleBBoxNeedsUpdate = true, this.recursiveBBoxNeedsUpdate = true, this.stateSelection = null, this.prevState = null, this.currentState = null, this.reversibleToState = null, this.currentTransitionEvent = null, this.previousAction = null, this.name = "", this.position = [0, 0], this.scale = [1, 1], this.rotation = 0, this.shear = [0, 0], this.emitter = n(), this.dpr = r.dpr ?? 1, this.dataPatched = i;
  }
  project(t, e) {
  ...
  updateLocalMatrix() {
    this.localMatrix = _2.compose(this.position, this.scale, this.rotation * w, S.getPivot(this.dataPatched), this.shear);
  }
  updateWorldMatrix(t, e, i) {
    let r = this.parent;
    e && null != r && r.updateWorldMatrix(t, true, false), t && this.updateLocalMatrix(), this.parent ? this.worldMatrix = _2.append(this.parent.worldMatrix, this.localMatrix) : this.worldMatrix = _2.copy(this.localMatrix), this.singleBBoxNeedsUpdate = true, this.recursiveBBoxNeedsUpdate = true;
  }
  get pivot() {
...
var F = class extends R {
  ...
  clone(t) {
    let e = new F(this.uuid, this.data, t);
    return e.parent = void 0, e;
  }
};
...
var D2 = class extends R {
  ...
  add(t) {
    t.parent && t.parent instanceof D2 && t.parent.remove(t), this.children.push(t), t.parent = this;
  }
  remove(t) {
  ...
  traverse(t) {
    let e = t(this);
    if (true !== e) for (let i of this.children) i instanceof D2 ? i.traverse(t) : e = t(i);
  }
  intersectsChildrenHelper(t, e, i, r, s) {
    for (let n2 of this.children) if (n2.intersects(t, e, i, false) && (s.push(n2), r) || n2 instanceof D2 && n2.intersectsChildrenHelper(t, e, i, r, s)) return true;
    return false;
  }
  ...
  intersectsChildrenHelperReverse(t, e, i, r, s) {
    for (let n2 of this.children) if (n2 instanceof D2 && n2.intersectsChildrenHelperReverse(t, e, i, r, s) || n2.intersects(t, e, i, false) && (s.push(n2), r)) return true;
    return false;
  }
  ...
  clone(t) {
    let e = new D2(this.uuid, this.data, t);
    e.parent = void 0;
...
var X = class extends D2 {
  constructor(t, e, i) {
    super(t, e, i), this.uuid = t, this.width = 0, this.height = 0, this.clipped = true, this.background = new N(t + "-background", D.defaultData, i), this.background.parent = this, this.updateState(e, i);
  }
  get fill() {
  ...
  clone(t) {
    let e = new X(this.uuid, this.data, t);
    e.parent = void 0;
    for (let i of this.children) e.add(i.clone(t));
    return e;
  }
...
function Q(t, e = 1, i = 1) {
  ...
  if (1 === e && 1 === i) return t;
  try {
    return J((0, V.parseSVG)(t).map((t2) => {
      let r = { ...t2 };
...
var Z = class {
  constructor(t, e, i) {
    this.uuid = t, this.data = e, this.group = new W(Z.GROUP_ID, { ..._.defaultData }, i), this.createChildrenObjects(e.objects, this.group, i);
  }
    ...
    let a2 = (function(t2, e2, i2) {
      switch (e2.type) {
        ...
        case "path2d":
          return new $(t2, e2, i2);
        case "frame2d":
          return new X(t2, e2, i2);
        default:
          return new W(t2, e2, i2);
      }
    })(t, e, n2);
    a2 && (r.add(a2), r.children.splice(s, 0, r.children.pop()), a2.updateWorldMatrix(), i.length > 0 && (a2 instanceof W || a2 instanceof X) && this.createChildrenObjects(i, a2, n2));
  }
  ...
  updateTreeByOp(t, e) {
    if (0 === t.path.length && 7 === t.type) {
      ...
      void 0 !== i && i instanceof D2 && (this.createObject(t.id, t.data, t.children, i, t.localIndex, e), i.requestRender());
    } else if (0 === t.path.length && 8 === t.type) {
      let e2 = this.find(t.id);
      if (void 0 !== e2 && void 0 !== e2.parent && e2.parent instanceof D2) {
        let t2 = e2.parent;
...
function et(t, e, i, r, s, n2, a2, h, o, l) {
  ...
  let d = n2 * Math.PI / 180, u = Math.cos(d), c2 = Math.sin(d), p3 = (e - o) / 2, f2 = (i - l) / 2, x2 = u * p3 + c2 * f2, g2 = -c2 * p3 + u * f2, m3 = x2 * x2 / (r * r) + g2 * g2 / (s * s);
  if (m3 > 1) {
    let t2 = Math.sqrt(m3);
    r *= t2, s *= t2;
  }
  let y2 = r * r, v2 = s * s, w2 = y2 * v2 - y2 * g2 * g2 - v2 * x2 * x2, _3 = y2 * g2 * g2 + v2 * x2 * x2, S3 = (a2 !== h ? 1 : -1) * Math.sqrt(Math.max(0, w2 / _3)), B2 = S3 * (r * g2) / s, b3 = S3 * (-s * x2) / r, M2 = u * B2 - c2 * b3 + (e + o) / 2, C2 = c2 * B2 + u * b3 + (i + l) / 2, k2 = Math.atan2((g2 - b3) / s, (x2 - B2) / r), A2 = Math.atan2((-g2 - b3) / s, (-x2 - B2) / r) - k2;
  ...
  for (let e2 = 0; e2 < T3; e2++) {
    let e3 = R2 + P2, i2 = Math.cos(R2), n3 = Math.sin(R2), a3 = Math.cos(e3), h2 = Math.sin(e3), o2 = M2 + r * a3 * u - s * h2 * c2, l2 = C2 + r * a3 * c2 + s * h2 * u, d2 = -r * n3 * u - s * i2 * c2, p4 = -r * n3 * c2 + s * i2 * u, f3 = -r * h2 * u - s * a3 * c2, x3 = -r * h2 * c2 + s * a3 * u;
...
var ht = class {
  constructor(t, e = 1) {
    this.canvas = t, this._dpr = e, this._width = 0, this._height = 0, this._isSizeDirty = false, this._crashed = false, this._shapes = [], this._lastPushedJSON = "", this._ctm = _2.identity(), this._stack = [], this._clips = [], this._pathEls = [], this._simpleShape = null, this._pathPrimitives = 0, this._fillColor = wt.transparent, this._strokeColor = wt.transparent, this._lineWidth = 1, this._strokeMode = "inside", this._layerBlur = 0, this._backgroundBlur = 0, this._dropShadowBlur = 0, this._dropShadowOffsetX = 0, this._dropShadowOffsetY = 0, this._dropShadowColor = wt.transparent, this._innerShadowBlur = 0, this._innerShadowOffsetX = 0, this._innerShadowOffsetY = 0, this._innerShadowSpread = 0, this._innerShadowColor = wt.transparent, this._fonts = /* @__PURE__ */ new Map(), this._fontsFlushed = /* @__PURE__ */ new Set(), this._fontXPerEm = /* @__PURE__ */ new Map(), this._measureCache = /* @__PURE__ */ new Map();
    try {
  ...
  async init() {
    if (!this._engine && !this._crashed) {
      try {
        this._context = await m2(), this._engine = await this._context.createEngine(this.canvas);
      } catch (t) {
  ...
  registerFont(t, e) {
    ...
    let i = (function(t2) {
      try {
        let e2 = new DataView(t2), i2 = e2.getUint32(0);
        if (65536 !== i2 && 1330926671 !== i2 && 1953658213 !== i2) return;
        let r = e2.getUint16(4), s = -1, n2 = -1;
        for (let t3 = 0; t3 < r; t3++) {
          let i3 = 12 + 16 * t3, r2 = e2.getUint32(i3);
          1751474532 === r2 && (s = e2.getUint32(i3 + 8)), 1330851634 === r2 && (n2 = e2.getUint32(i3 + 8));
        }
        if (s < 0 || n2 < 0) return;
  ...
  _flushFonts() {
    ...
    if (t) for (let [e, i] of this._fonts) this._fontsFlushed.has(e) || (this._fontsFlushed.add(e), this._guard(() => {
      t.scene.addLocalFont(e, new Uint8Array(i));
    }));
  }
  set strokeColor(t) {
    this._strokeColor = t;
  ...
  save() {
    this._stack.push({ ctm: _2.copy(this._ctm), clipLen: this._clips.length });
  }
  restore() {
  ...
  setTransform(t, e = false) {
    var _a;
    let i = _2.identity();
    if (((_a = this.camera) == null ? void 0 : _a.enabled) && (i = _2.append(i, this.camera.worldMatrix), e)) {
      let t2 = _2.getScale(this.camera.worldMatrix);
      i = _2.scale(i, 1 / t2[0], 1 / t2[1]);
    }
    this._ctm = _2.append(i, t);
  }
  transform(t) {
    this._ctm = _2.append(this._ctm, t);
  }
  beginPath() {
  ...
  clipRect(t, e, i, r, s = 0, n2 = 0, a2 = 0, h = 0) {
    let o = _2.invert(this._ctm);
    !o || this._clips.push({ m: _2.copy(this._ctm), inv: o, rect: { x: t, y: e, w: i, h: r, radii: [s, n2, a2, h] } });
  }
  fill() {
    this._emit(true);
  }
  ...
  _emit(t) {
    ...
    i = r;
    let s = { shape: i, color: t ? ut(this._fillColor) : [0, 0, 0, 0], transform: _2.getAbcdef(this._ctm) };
  ...
  _emitClippedRectStroke(t, e) {
    ...
    let x2 = { shape: { Custom: f2 }, color: ut(this._strokeColor), transform: _2.getAbcdef(this._ctm) };
  ...
  _effectChain(t) {
    ...
    if (t && this._dropShadowColor.a > 0 && i.push({ DropShadow: { position: [this._dropShadowOffsetX * e, this._dropShadowOffsetY * e], blur: { Uniform: { size: 2 * this._dropShadowBlur * e } }, spread: 0, color: ut(this._dropShadowColor) } }), t && this._backgroundBlur > 0) {
      let [t2, e2] = _2.getScale(this._ctm), r = (t2 + e2) / 2;
    ...
    if (this._layerBlur > 0 && i.push({ LayerBlur: { blur: { Uniform: { size: 2 * this._layerBlur * e } } } }), t && this._innerShadowColor.a > 0) {
      let [t2, r, s, n2] = _2.getAbcdef(this._ctm), a2 = this._innerShadowOffsetX, h = this._innerShadowOffsetY;
  ...
  _applyClips(t) {
    ...
    for (let t2 of this._clips) {
      let i = _2.append(t2.inv, this._ctm), [r, s, n2, a2, h, o] = _2.getAbcdef(i), l = Math.abs(s) <= 1e-6 * (Math.abs(r) + Math.abs(a2)) && Math.abs(n2) <= 1e-6 * (Math.abs(r) + Math.abs(a2)), d = xt(e);
      if (!d) return e;
      if (!l) {
        at();
        continue;
      }
      let u = r * d.minX + h, c2 = r * d.maxX + h, p3 = a2 * d.minY + o, f2 = a2 * d.maxY + o, x2 = Math.min(u, c2), g2 = Math.max(u, c2), m3 = Math.min(p3, f2), y2 = Math.max(p3, f2), v2 = t2.rect, w2 = Math.max(x2, v2.x), S3 = Math.max(m3, v2.y), B2 = Math.min(g2, v2.x + v2.w), b3 = Math.min(y2, v2.y + v2.h);
      if (w2 >= B2 || S3 >= b3) return "skip";
      if (w2 === x2 && S3 === m3 && B2 === g2 && b3 === y2) continue;
      let M2 = ft(e);
      if (!M2 || 0 === r || 0 === a2) {
        at();
        continue;
      }
      let C2 = (w2 - h) / r, k2 = (B2 - h) / r, A2 = (S3 - o) / a2, T3 = (b3 - o) / a2, P2 = Math.min(C2, k2), z2 = Math.min(A2, T3), R2 = Math.abs(k2 - C2), E2 = Math.abs(T3 - A2), [O3, H2, L2, F2] = M2.radii, U2 = P2 !== M2.x, N2 = z2 !== M2.y, j2 = P2 + R2 !== M2.x + M2.w, I2 = z2 + E2 !== M2.y + M2.h, D3 = Math.min(R2, E2) / 2;
      e = pt({ x: P2, y: z2, w: R2, h: E2, radii: [U2 || N2 ? 0 : Math.min(O3, D3), j2 || N2 ? 0 : Math.min(H2, D3), j2 || I2 ? 0 : Math.min(L2, D3), U2 || I2 ? 0 : Math.min(F2, D3)] }, 0);
    }
    return e;
  }
  drawText(t, e) {
    let i = this._fontXPerEm.get(e.font), r = i ? i / st : 1, s = { TextSimple: { text: t, font_size: e.fontSize * rt * r, size: [e.width, e.height], horizontal_align: lt[e.horizontalAlign] ?? "Left", vertical_align: dt[e.verticalAlign] ?? "Top" } }, n2 = this._effectChain(true), a2 = this._fillColor.a > 0, h = this._strokeColor.a > 0 && this._lineWidth > 0;
    if (a2 || h || n2) {
      let t2 = { shape: s, color: a2 ? ut(this._fillColor) : [0, 0, 0, 0], transform: _2.getAbcdef(_2.append(this._ctm, _2.translate(_2.identity(), e.x, e.y))) };
      h && (t2.stroke = this._strokeDesc()), n2 && (t2.effect_chain = n2), this._shapes.push(t2);
    }
  ...
  clear() {
    this._shapes = [], this._ctm = _2.identity(), this._stack.length = 0, this._clips.length = 0;
  }
  render() {
    let t = this._engine;
    if (!t || this._crashed) return;
...
//# sourceMappingURL=chunk-PTLPC4OP.js.map
