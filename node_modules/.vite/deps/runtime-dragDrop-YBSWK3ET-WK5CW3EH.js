...
// node_modules/@splinetool/runtime/build/runtime-dragDrop-YBSWK3ET.js
var m = new Ki();
var g = new Ki();
var E = new Ki();
var f = new mn();
...
var k = class extends s {
      ...
      if (this.lastDropDestination = null, 0 !== i.length) {
        for (let t2 of this.events) {
          ...
          for (let { obj: a4, pointEnd: r2, pointStart: o } of t2.dragItems) {
            if (a4 === i[0].object || a4 === i[0].object.object || ct.is(a4) && a4.isAncestorOf(i[0].object.uuid)) {
  ...
  updateCursorFromRaycast() {
    ...
    for (let t2 of this.events) {
      for (let { obj: e3 } of t2.dragItems) if (e3 === ((_a = a2[0]) == null ? void 0 : _a.object) || e3 === ((_c = (_b = a2[0]) == null ? void 0 : _b.object) == null ? void 0 : _c.object) || ct.is(e3) && e3.isAncestorOf((_d = a2[0]) == null ? void 0 : _d.object.uuid)) {
...
e("DragDrop", ({ eventContext: t, eventManager: e2 }) => new k(t, e2)), a("dragdrop");
//# sourceMappingURL=runtime-dragDrop-YBSWK3ET-WK5CW3EH.js.map
