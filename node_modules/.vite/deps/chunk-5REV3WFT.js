...
// node_modules/@splinetool/runtime/build/runtime-chunk-EJJZJ5MV.js
function i(r) {
  if (Array.isArray(r.material)) {
    for (let e of r.material) if (0 === e.getLayersOfType("outline").length) return;
  } else if (!er(r.material) || 0 === r.material.getLayersOfType("outline").length) return;
  r instanceof lr && r.is2DAndNoDepth ? (function(e) {
...
//# sourceMappingURL=chunk-5REV3WFT.js.map
