...
// node_modules/@splinetool/runtime/build/runtime-chunk-YULW5JRE.js
var b = new As();
var A = new As();
var M = new As();
var S = new As();
...
function B(e, t, s3, o) {
  ...
  try {
    return 0 === i2 ? 0 : Gt(s3, D.subarray(0, 16 * i2));
  } finally {
    qt(s3);
  }
}
var O;
var P = class extends ir {
  constructor(e, t, s3) {
  ...
  recomputeBoolean(s3, o = true) {
    ...
    for (let e = 0; e < this.children.length; e++) {
      ...
      t instanceof P && true === t.dataPatched.visible && t.recomputeBoolean(true === s3, o);
    }
    this.meshSetAddresses = [];
    for (let e = 0; e < this.children.length; e++) {
      let t = this.children[e];
      if (t instanceof $t && true === t.dataPatched.visible && ((_a = t.geometry.attributes.position) == null ? void 0 : _a.count) > 0 && t.geometry.drawRange.count > 0 && 0 !== t.booleanMeshSetAddress) {
        ...
        try {
          ...
          if (-1 === t.booleanMeshSetAddress) {
            if ((t.geometry.index ?? t.geometry.getAttribute("position")).count / 3 < 15e5) {
              let r2 = Lt(t.geometry, true === s3, o);
              t.booleanMeshSetAddress = void 0 === e2 || -1 === r2 ? r2 : B(t, e2, r2, b);
            }
            if (-1 === t.booleanMeshSetAddress) return;
            void 0 === e2 && kt(t.booleanMeshSetAddress, b), t.booleanMatrixInvOld.copy(b).invert(), t.booleanWasTransformed = false;
          } else t instanceof P && true === t.needsTransformForDownstream ? (void 0 === e2 ? kt(t.booleanMeshSetAddress, b) : t.booleanMeshSetAddress = B(t, e2, t.booleanMeshSetAddress, b), t.needsTransformForDownstream = false) : true === t.booleanWasTransformed && (kt(t.booleanMeshSetAddress, A.multiplyMatrices(b, t.booleanMatrixInvOld)), t.booleanMatrixInvOld.copy(b).invert(), t.booleanWasTransformed = false);
        } catch (e2) {
    ...
    if (true === s3) return jt(this.meshSetAddresses, this.booleanOp);
    let r = this.geometry;
    r.dispose(), this.geometry = new ha(), this.geometry.userData = r.userData, this.geometry.boundingSphere = r.boundingSphere;
    try {
      this.booleanMeshSetAddress = Ft(this.meshSetAddresses, this.booleanOp, this.geometry, this.phongAngle);
    } catch (e) {
...
(O || (O = {})).is = function(e) {
  return ct.is(e) && e instanceof jo;
};
...
var F = (e) => e instanceof $t;
var j = (e) => null !== e && e instanceof P;
var k = (e) => s2.is(e);
...
//# sourceMappingURL=chunk-KTNZXI2Q.js.map
