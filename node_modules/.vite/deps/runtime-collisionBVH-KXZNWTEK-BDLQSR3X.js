...
// node_modules/@splinetool/runtime/build/runtime-collisionBVH-KXZNWTEK.js
var h = Math.pow(2, -24);
...
var L = Math.pow(2, 32);
function E(e) {
  return "count" in e ? 1 : 1 + E(e.left) + E(e.right);
}
function O(e, t2, n) {
  return _ = new Float32Array(n), z = new Uint32Array(n), D = new Uint16Array(n), V = new Uint8Array(n), N(e, t2);
}
function N(e, t2) {
  ...
  {
    let { left: r2, right: i2, splitAxis: o2 } = t2, s = N(e + 32, r2), a3 = s / 32 - e / 32;
    if (a3 > L) throw new Error("MeshBVH: Cannot store relative child node offset greater than 32 bits.");
    return z[n + 6] = a3, z[n + 7] = o2, N(s, i2);
  }
}
function X(e, t2) {
  ...
  a3.offset = s.offset, e.computePrimitiveBounds(s.offset, s.count, a3), e._roots = r.map((r2) => {
    let i2 = (function(e2, t3, n2, r3, i3, o3) {
      let { maxDepth: s2, verbose: a4, maxLeafSize: l3, strategy: u2, onProgress: c2 } = i3, f = e2.primitiveBuffer, d = e2.primitiveBufferStride, p = new Float32Array(6), y = false, h2 = new H();
    ...
    })(e, a3, r2.offset, r2.count, t2, s), o2 = E(i2), l2 = new n(32 * o2);
    return O(0, i2, l2), l2;
  });
}
var j;
...
function $(e, t2, n, r, i, o) {
  j = W.getPrimitive(), Z = W.getPrimitive(), Y.push(j, Z), G.setBuffer(e._roots[t2]);
  let s = K(0, e.geometry, n, r, i, o);
  G.clearBuffer(), W.releasePrimitive(j), W.releasePrimitive(Z), Y.pop(), Y.pop();
  let a3 = Y.length;
  return a3 > 0 && (Z = Y[a3 - 1], j = Y[a3 - 2]), s;
}
function K(e, t2, n, r, i = null, o = 0, s = 0) {
  let { float32Array: a3, uint16Array: l2, uint32Array: u2 } = G, c2 = 2 * e;
  if (A(c2, l2)) {
    let t3 = T(e, u2), n2 = S(c2, l2);
    return x(e, a3, j), r(t3, n2, false, s, o + e / 8, j);
  }
  {
    ...
    if (i && (d = j, p = Z, x(w2, a3, d), x(B2, a3, p), c3 = i(d), f = i(p), f < c3)) {
      w2 = g2, B2 = m2;
      let e2 = c3;
      c3 = f, f = e2, d = p;
    }
...
var ge = (function() {
  let e = new Ki(), t2 = new Ki(), n = new mn(), i = new tu();
  return function(r, o) {
...
var be = class extends Mr {
  constructor(...e) {
    super(...e), this.isExtendedTriangle = true, this.satAxes = new Array(4).fill().map(() => new Ki()), this.satBounds = new Array(4).fill().map(() => new ye()), this.points = [this.a, this.b, this.c], this.plane = new mn(), this.isDegenerateIntoSegment = false, this.isDegenerateIntoPoint = false, this.degenerateSegment = new tu(), this.needsUpdate = true;
  }
  intersectsSphere(e) {
    return ge(e, this);
  }
...
be.prototype.closestPointToSegment = (function() {
  let e = new Ki(), t2 = new Ki(), n = new tu();
  ...
  let e = new be(), t2 = new ye(), i = new ye(), s = new Ki(), a3 = new Ki(), l2 = new Ki(), u2 = new Ki(), c2 = new tu(), f = new tu(), d = new Ki(), p = new Gi(), y = new Gi();
  ...
  return function(t3, n = null, r = false) {
    ...
    let V2 = xe[_2], R2 = this.a[V2], q2 = this.b[V2], C2 = this.c[V2], H2 = t3.a[V2], L2 = t3.b[V2], E2 = t3.c[V2];
    if (g2(this, R2, q2, C2, P2, A2, m3, b2, v2, p, c2)) return h2(this, t3, n, r);
    if (g2(t3, H2, L2, E2, U2, I2, T2, S2, M2, y, f)) return h2(this, t3, n, r);
    if (p.y < p.x) {
      let e2 = p.y;
  ...
  let e = new Ki(), t2 = new Ki(), n = ["a", "b", "c"], i = new tu(), s = new tu();
...
ve.prototype.update = function() {
  ...
  let e = ["x", "y", "z"], t2 = new Array(12).fill().map(() => new tu()), n = new Array(12).fill().map(() => new tu()), i = new Ki(), s = new Ki();
...
var qe = new Ki();
var Ce = new Ki();
function He(e, t2, i, o, a3, l2, u2, c2, f, y, h2) {
...
function Ee(e, t2, n, r, i, o, s) {
  ...
  if (Array.isArray(t2)) {
    ...
    for (let a4 = 0, f2 = d.length; a4 < f2; a4++) {
      ...
      if (e2 >= f3 && e2 < f3 + g2) {
        let e3 = He(n, p, y, h2, m2, l2, u2, c2, Le(t2[x2]), o, s);
        if (e3) {
    ...
    let e2 = He(n, p, y, h2, m2, l2, u2, c2, Le(t2), o, s);
    if (e2) {
...
function Ge(e, t2, n, r, i, o, s) {
  ...
  if (A(c2, l2)) !(function(e2, t3, n2, r2, i2, o2, s2, a4) {
    ...
    for (let e3 = r2, u4 = r2 + i2; e3 < u4; e3++) Ee(l3, t3, n2, e3, o2, s2, a4);
  })(t2, n, r, T(e, u2), S(c2, l2), i, o, s);
  else {
    let l3 = M(e);
    je(l3, a3, r, o, s) && Ge(l3, t2, n, r, i, o, s);
    let c3 = U(e, u2);
    je(c3, a3, r, o, s) && Ge(c3, t2, n, r, i, o, s);
  }
}
var Ye = ["x", "y", "z"];
...
function $e(e, t2, n, r, i, o) {
  ...
  if (A(u2, a3)) return (function(e2, t3, n2, r2, i2, o2, s2) {
    ...
    for (let e3 = r2, l4 = r2 + i2; e3 < l4; e3++) {
      let r3;
      r3 = Ee(a4, t3, n2, e3, null, o2, s2), r3 && r3.distance < u3 && (c2 = r3, u3 = r3.distance);
    }
    return c2;
  })(t2, n, r, T(e, l2), S(u2, a3), i, o);
  {
    ...
    let p = je(a4, s, r, i, o) ? $e(a4, t2, n, r, i, o) : null;
    if (p) {
      let e2 = p.point[f];
      if (d ? e2 <= s[u3 + c2] : e2 >= s[u3 + c2 + 3]) return p;
    }
    let y = je(u3, s, r, i, o) ? $e(u3, t2, n, r, i, o) : null;
...
function ht(e, t2, n, r, i, o, s) {
  ...
  if (A(c2, l2)) !(function(e2, t3, n2, r2, i2, o2, s2, a4) {
    let { geometry: l3, _indirectBuffer: u3 } = e2;
    for (let e3 = r2, c3 = r2 + i2; e3 < c3; e3++) Ee(l3, t3, n2, u3 ? u3[e3] : e3, o2, s2, a4);
  })(t2, n, r, T(e, u2), S(c2, l2), i, o, s);
  else {
    let l3 = M(e);
    je(l3, a3, r, o, s) && ht(l3, t2, n, r, i, o, s);
    let c3 = U(e, u2);
    je(c3, a3, r, o, s) && ht(c3, t2, n, r, i, o, s);
  }
}
var mt = ["x", "y", "z"];
...
function xt(e, t2, n, r, i, o) {
  ...
  if (A(u2, a3)) return (function(e2, t3, n2, r2, i2, o2, s2) {
    ...
    for (let e3 = r2, f = r2 + i2; e3 < f; e3++) {
      let r3;
      r3 = Ee(a4, t3, n2, l3 ? l3[e3] : e3, null, o2, s2), r3 && r3.distance < u3 && (c2 = r3, u3 = r3.distance);
    }
    return c2;
  })(t2, n, r, T(e, l2), S(u2, a3), i, o);
  {
    ...
    d ? (a4 = M(e), u3 = U(e, l2)) : (a4 = U(e, l2), u3 = M(e));
    let p = je(a4, s, r, i, o) ? xt(a4, t2, n, r, i, o) : null;
    if (p) {
      let e2 = p.point[f];
      if (d ? e2 <= s[u3 + c2] : e2 >= s[u3 + c2 + 3]) return p;
    }
    let y = je(u3, s, r, i, o) ? xt(u3, t2, n, r, i, o) : null;
    return p && y ? p.distance <= y.distance ? p : y : p || y || null;
  }
}
var wt = new wr();
...
var Nt = class extends pe {
  ...
  raycastObject3D(e, t2, n = []) {
    let { material: r } = e;
    if (void 0 === r) return;
    Lt.copy(e.matrixWorld).invert(), Ct.copy(t2.ray).applyMatrix4(Lt), Et.setFromMatrixScale(e.matrixWorld), Ht.copy(Ct.direction).multiply(Et);
    let i = Ht.length(), o = t2.near / i, s = t2.far / i;
  ...
  refit(e = null) {
    return (this.indirect ? pt : Xe)(this, e);
  }
  ...
  shapecast(e) {
    let t2 = Pe.getPrimitive(), n = super.shapecast({ ...e, intersectsPrimitive: e.intersectsTriangle, scratchPrimitive: t2, iterate: this.indirect ? Ze : Ne });
  ...
  bvhcast(e, t2, n) {
    ...
    if (i) {
      if (!(e instanceof Nt)) throw new Error('MeshBVH: "intersectsTriangles" callback can only be used with another MeshBVH.');
...
a2(Nt), a("collision-bvh");
//# sourceMappingURL=runtime-collisionBVH-KXZNWTEK-BDLQSR3X.js.map
