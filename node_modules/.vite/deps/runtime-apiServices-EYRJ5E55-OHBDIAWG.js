...
// node_modules/@splinetool/runtime/build/runtime-apiServices-EYRJ5E55.js
...
var E = class {
  constructor(t2, s2, r) {
    ...
    }, "OpenAI" === ((_a = s2 == null ? void 0 : s2.integration) == null ? void 0 : _a.type) ? this.result = { content: "" } : "GET" === s2.method && "" !== s2.url && (this.prefetchPromise = this.prefetch(r)), this._debouncedCallUserAPI = this._innerCallUserAPI, this._updateDebouncedCallUserAPI(), this._debouncedPrefetch = e(this.prefetch, 1e3, { trailing: true });
  }
  _updateDebouncedCallUserAPI() {
    this._debouncedCallUserAPI = void 0 !== this.userAPI.debounce && this.userAPI.debounce > 0 ? e(this._innerCallUserAPI, this.userAPI.debounce, { leading: true, trailing: true }) : this._innerCallUserAPI;
  }
  async prefetch(e3) {
  ...
  update(e3, t2, s2 = true) {
    this.userAPI = e3, this._updateDebouncedCallUserAPI(), "" !== this.userAPI.url && "GET" === this.userAPI.method && s2 && this._debouncedPrefetch(t2);
  }
  retrieveValue(e3) {
    if (this.result) try {
...
var y = class {
  constructor(t2, s2) {
    this.id = t2, this.userWebhook = s2, this.result = void 0, this._connected = false, this.emitter = n2(), this.reconnectWaitFor = P, this._onError = (e3) => {
      var _a, _b, _c;
      ...
      clearTimeout(this.scheduledReconnectHandle), this.reconnectWaitFor = P, this._connected = true;
    }, this._onDisconnected = () => {
      clearTimeout(this.scheduledReconnectHandle), this.reconnectWaitFor = P, this._connected = false;
    }, this._onMessage = (e3) => {
      let t3, s3 = e3.data;
      try {
        t3 = JSON.parse(s3);
  ...
  _scheduleReconnect() {
    this.reconnectWaitFor *= 2, this.reconnectWaitFor > I && (this.reconnectWaitFor = I), clearTimeout(this.scheduledReconnectHandle), this.scheduledReconnectHandle = setTimeout(() => {
...
//# sourceMappingURL=runtime-apiServices-EYRJ5E55-OHBDIAWG.js.map
