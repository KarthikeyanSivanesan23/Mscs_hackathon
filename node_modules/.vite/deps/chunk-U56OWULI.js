// node_modules/@splinetool/runtime/build/runtime-chunk-4KZXQGUQ.js
function e(e2, t2 = 0, r2 = {}) {
  let n2, i2, f2, a2, o2, s2 = true === r2.leading, u2 = false !== r2.trailing, c = void 0 !== r2.maxWait ? Math.max(r2.maxWait, t2) : void 0, l = 0, g = (t3) => {
    let r3 = i2, n3 = f2;
  ...
  }, d = (e3) => (n2 = void 0, u2 && i2 ? g(e3) : (i2 = f2 = void 0, a2)), p = () => {
    let e3 = Date.now();
    ...
    let r3 = Date.now(), u3 = y(r3);
    if (i2 = e3, f2 = this, o2 = r3, u3) {
...
//# sourceMappingURL=chunk-U56OWULI.js.map
